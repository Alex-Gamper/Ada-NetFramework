...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Pkcs.PublicKeyInfo is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Pkcs.PublicKeyInfo";
   ...
   function Algorithm
   (
      this : in out PublicKeyInfo.Kind
   )
