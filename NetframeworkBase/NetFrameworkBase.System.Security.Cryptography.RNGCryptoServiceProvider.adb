...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.RNGCryptoServiceProvider is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.RNGCryptoServiceProvider";
   ...
   procedure GetBytes
   (
      this : in out RNGCryptoServiceProvider.Kind;
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetNonZeroBytes");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p0_Parameters : aliased LPSAFEARRAY := null;
      p0_Bounds     : aliased SAFEARRAYBOUND := (data'Length , 0);
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.RNGCryptoServiceProvider.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.RNGCryptoServiceProvider.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.RNGCryptoServiceProvider.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.RNGCryptoServiceProvider.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.RNGCryptoServiceProvider.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.RNGCryptoServiceProvider.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
