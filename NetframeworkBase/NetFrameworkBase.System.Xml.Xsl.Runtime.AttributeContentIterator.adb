...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Xsl.Runtime.AttributeContentIterator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Xsl.Runtime.AttributeContentIterator";
   ...
   procedure Create
   (
      this : in out AttributeContentIterator.Kind;
