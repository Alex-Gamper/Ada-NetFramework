...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.Microsoft.SqlServer.Server.DataAccessKind is
   ...
   This_TypeName     : constant Standard.Wide_String := "Microsoft.SqlServer.Server.DataAccessKind";
