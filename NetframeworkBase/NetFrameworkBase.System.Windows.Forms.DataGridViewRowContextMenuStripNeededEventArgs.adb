...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DataGridViewRowContextMenuStripNeededEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DataGridViewRowContextMenuStripNeededEventArgs";
   ...
   function RowIndex
   (
      this : in out DataGridViewRowContextMenuStripNeededEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.DataGridViewRowContextMenuStripNeededEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.DataGridViewRowContextMenuStripNeededEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.DataGridViewRowContextMenuStripNeededEventArgs.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
