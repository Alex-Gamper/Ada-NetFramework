...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.UploadFileCompletedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.UploadFileCompletedEventArgs";
   ...
   function Result
   (
      this : in out UploadFileCompletedEventArgs.Kind
   )
