...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Drawing.Printing.PrintingPermissionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Drawing.Printing.PrintingPermissionAttribute";
   ...
   function Level
   (
      this : in out PrintingPermissionAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Drawing.Printing.PrintingPermissionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Drawing.Printing.PrintingPermissionAttribute.Kind_Ptr := new NetFrameworkBase.System.Drawing.Printing.PrintingPermissionAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
