...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Xsl.Runtime.NamespaceIterator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Xsl.Runtime.NamespaceIterator";
   ...
   procedure Create
   (
      this : in out NamespaceIterator.Kind;
