...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Serialization.SafeSerializationEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Serialization.SafeSerializationEventArgs";
   ...
   procedure AddSerializedState
   (
      this : in out SafeSerializationEventArgs.Kind;
      serializedState : NetFrameworkBase.System.Runtime.Serialization.ISafeSerializationData.Kind_Ptr
   ) is
      ...
      p_MethodName  : BSTR := To_BSTR("AddSerializedState");
   ...
   begin
      ...
      p_Value.field_1.field_1.field_1.punkVal := serializedState;
   ...
   return NetFrameworkBase.System.Runtime.Serialization.StreamingContext.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("StreamingContext");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
