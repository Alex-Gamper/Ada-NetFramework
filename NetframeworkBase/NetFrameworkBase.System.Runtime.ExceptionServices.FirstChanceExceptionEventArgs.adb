...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.ExceptionServices.FirstChanceExceptionEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.ExceptionServices.FirstChanceExceptionEventArgs";
   ...
   (
      this : in out FirstChanceExceptionEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Runtime.ExceptionServices.FirstChanceExceptionEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.ExceptionServices.FirstChanceExceptionEventArgs.Kind_Ptr := new NetFrameworkBase.System.Runtime.ExceptionServices.FirstChanceExceptionEventArgs.Kind do
      declare
