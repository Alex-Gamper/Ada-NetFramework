...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.ResourcePermissionBaseEntry is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.ResourcePermissionBaseEntry";
   ...
   return NetFrameworkBase.BSTR_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("PermissionAccessPath");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.Security.Permissions.ResourcePermissionBaseEntry.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.ResourcePermissionBaseEntry.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.ResourcePermissionBaseEntry.Kind do
   ...
   return NetFrameworkBase.System.Security.Permissions.ResourcePermissionBaseEntry.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.ResourcePermissionBaseEntry.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.ResourcePermissionBaseEntry.Kind do
      declare
         ...
         p1_Bounds     : aliased SAFEARRAYBOUND := (permissionAccessPath'Length , 0);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(permissionAccess);
         ...
         begin
            ...
            for i in permissionAccessPath'range loop
               p1_Index(1) := Interfaces.C.long(i) - 1;
               p1_Tmp := permissionAccessPath(i);
