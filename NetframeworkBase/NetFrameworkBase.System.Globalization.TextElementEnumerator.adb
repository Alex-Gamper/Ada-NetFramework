...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Globalization.TextElementEnumerator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Globalization.TextElementEnumerator";
   ...
   function MoveNext
   (
      this : in out TextElementEnumerator.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetTextElement");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ElementIndex");
      p_RetVal      : aliased VARIANT;
