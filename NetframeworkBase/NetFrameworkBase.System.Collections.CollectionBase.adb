...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Collections.CollectionBase is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Collections.CollectionBase";
   ...
   function Capacity
   (
      this : in out CollectionBase.Kind
   )
