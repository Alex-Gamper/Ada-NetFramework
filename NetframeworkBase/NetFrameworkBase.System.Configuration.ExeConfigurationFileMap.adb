...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.ExeConfigurationFileMap is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.ExeConfigurationFileMap";
   ...
   function Clone
   (
      this : in out ExeConfigurationFileMap.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ExeConfigFilename");
      p_RetVal      : aliased VARIANT;
   ...
   function RoamingUserConfigFilename
   (
      this : in out ExeConfigurationFileMap.Kind
   )
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RoamingUserConfigFilename");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   procedure RoamingUserConfigFilename
   (
      this : in out ExeConfigurationFileMap.Kind;
      value : NetFrameworkBase.BSTR
   ) is
   ...
   function LocalUserConfigFilename
   (
      this : in out ExeConfigurationFileMap.Kind
   )
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("LocalUserConfigFilename");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   procedure LocalUserConfigFilename
   (
      this : in out ExeConfigurationFileMap.Kind;
      value : NetFrameworkBase.BSTR
   ) is
   ...
   function Constructor return NetFrameworkBase.System.Configuration.ExeConfigurationFileMap.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.ExeConfigurationFileMap.Kind_Ptr := new NetFrameworkBase.System.Configuration.ExeConfigurationFileMap.Kind do
   ...
   return NetFrameworkBase.System.Configuration.ExeConfigurationFileMap.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.ExeConfigurationFileMap.Kind_Ptr := new NetFrameworkBase.System.Configuration.ExeConfigurationFileMap.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(machineConfigFileName);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
