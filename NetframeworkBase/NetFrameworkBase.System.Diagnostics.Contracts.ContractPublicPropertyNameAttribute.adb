...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.Contracts.ContractPublicPropertyNameAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.Contracts.ContractPublicPropertyNameAttribute";
   ...
   function Name
   (
      this : in out ContractPublicPropertyNameAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Diagnostics.Contracts.ContractPublicPropertyNameAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.Contracts.ContractPublicPropertyNameAttribute.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.Contracts.ContractPublicPropertyNameAttribute.Kind do
      declare
