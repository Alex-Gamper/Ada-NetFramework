...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Principal.WindowsPrincipal is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Principal.WindowsPrincipal";
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_MethodName  : BSTR := To_BSTR("IsInRole");
      p_RetVal      : aliased VARIANT;
      p_roleEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Principal.WindowsBuiltInRole.Instance;
      p_roleEnum : aliased VARIANT := To_Variant (CreateEnum (p_roleEnumType, role'Enum_rep));
      RetVal        : NetFrameworkBase.Boolean;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
   ...
   return NetFrameworkBase.System.Security.Principal.WindowsPrincipal.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Principal.WindowsPrincipal.Kind_Ptr := new NetFrameworkBase.System.Security.Principal.WindowsPrincipal.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (ntIdentity.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
