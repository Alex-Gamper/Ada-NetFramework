...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.AccessControl.CryptoKeyAuditRule is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.AccessControl.CryptoKeyAuditRule";
   ...
   (
      this : in out CryptoKeyAuditRule.Kind
   )
   ...
   return NetFrameworkBase.System.Security.AccessControl.CryptoKeyAuditRule.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.AccessControl.CryptoKeyAuditRule.Kind_Ptr := new NetFrameworkBase.System.Security.AccessControl.CryptoKeyAuditRule.Kind do
      declare
