...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.AttributeUsageAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.AttributeUsageAttribute";
   ...
   function ValidOn
   (
      this : in out AttributeUsageAttribute.Kind
   )
   return NetFrameworkBase.System.AttributeTargets.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.AttributeTargets.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ValidOn");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.AttributeTargets.Kind;
   begin
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AllowMultiple");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Inherited");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Boolean;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.AttributeUsageAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.AttributeUsageAttribute.Kind_Ptr := new NetFrameworkBase.System.AttributeUsageAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_validOnEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.AttributeTargets.Instance;
         p_validOnEnum : aliased VARIANT := To_Variant (CreateEnum (p_validOnEnumType, validOn'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := p_validOnEnum;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
