...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Threading.Tasks.TaskCanceledException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Threading.Tasks.TaskCanceledException";
   ...
   function Constructor return NetFrameworkBase.System.Threading.Tasks.TaskCanceledException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Threading.Tasks.TaskCanceledException.Kind_Ptr := new NetFrameworkBase.System.Threading.Tasks.TaskCanceledException.Kind do
   ...
   return NetFrameworkBase.System.Threading.Tasks.TaskCanceledException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Threading.Tasks.TaskCanceledException.Kind_Ptr := new NetFrameworkBase.System.Threading.Tasks.TaskCanceledException.Kind do
      declare
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (task_x.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
