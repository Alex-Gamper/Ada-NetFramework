...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.TabRenderer is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.TabRenderer";
   ...
   is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("DrawTabItem");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_stateEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Windows.Forms.VisualStyles.TabItemState.Instance;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 2;
      p_Value := To_Variant(tabItemText);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 3;
   ...
   is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("DrawTabPage");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
