...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Reflection.TypeDelegator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Reflection.TypeDelegator";
   ...
   return NetFrameworkBase.System.Reflection.TypeDelegator.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Reflection.TypeDelegator.Kind_Ptr := new NetFrameworkBase.System.Reflection.TypeDelegator.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (delegatingType.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
