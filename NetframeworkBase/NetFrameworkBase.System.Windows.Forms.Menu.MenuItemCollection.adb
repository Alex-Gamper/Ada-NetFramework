...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.Menu.MenuItemCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.Menu+MenuItemCollection";
   ...
   return NetFrameworkBase.System.Windows.Forms.MenuItem.Kind_Array is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      p_Bounds      : aliased SAFEARRAYBOUND := (2 , 0);
      ...
      function GetArray (sa : access NetFrameworkWin32.SAFEARRAY) return NetFrameworkBase.System.Windows.Forms.MenuItem.Kind_Array is
      ...
      begin
         ...
         declare
            RetVal : NetFrameworkBase.System.Windows.Forms.MenuItem.Kind_Array(1..integer(Index));
            Value  : NetFrameworkBase.System.Windows.Forms.MenuItem.Kind_Ptr;
            Var    : aliased VARIANT;
            Item   : PVOID;
         ...
         begin
            ...
            for I in RetVal'range loop
               ...
               Value := new NetFrameworkBase.System.Windows.Forms.MenuItem.Kind;
   ...
   return NetFrameworkBase.System.Windows.Forms.Menu.MenuItemCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.Menu.MenuItemCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.Menu.MenuItemCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
