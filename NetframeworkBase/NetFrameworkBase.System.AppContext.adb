...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.AppContext is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.AppContext";
   ...
   function TryGetSwitch
   (
      switchName : NetFrameworkBase.BSTR; 
      isEnabled : out NetFrameworkBase.Boolean
   )
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("TryGetSwitch");
      p_RetVal      : aliased VARIANT;
   ...
   (
      switchName : NetFrameworkBase.BSTR; 
      isEnabled : NetFrameworkBase.Boolean
   )
   is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SetSwitch");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
