...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.DebuggerDisplayAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.DebuggerDisplayAttribute";
   ...
   function Value
   (
      this : in out DebuggerDisplayAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Diagnostics.DebuggerDisplayAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.DebuggerDisplayAttribute.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.DebuggerDisplayAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
