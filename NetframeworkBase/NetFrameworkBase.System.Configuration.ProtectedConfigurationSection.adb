...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.ProtectedConfigurationSection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.ProtectedConfigurationSection";
   ...
   function Providers
   (
      this : in out ProtectedConfigurationSection.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("DefaultProvider");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.Configuration.ProtectedConfigurationSection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.ProtectedConfigurationSection.Kind_Ptr := new NetFrameworkBase.System.Configuration.ProtectedConfigurationSection.Kind do
