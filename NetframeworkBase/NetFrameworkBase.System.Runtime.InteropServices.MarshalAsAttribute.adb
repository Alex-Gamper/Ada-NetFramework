...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.InteropServices.MarshalAsAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.InteropServices.MarshalAsAttribute";
   ...
   function Value
   (
      this : in out MarshalAsAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Runtime.InteropServices.MarshalAsAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.InteropServices.MarshalAsAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.InteropServices.MarshalAsAttribute.Kind do
      declare
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(unmanagedType);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
