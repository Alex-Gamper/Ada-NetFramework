...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.TypedDataSetGenerator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.TypedDataSetGenerator";
   ...
   (
      ...
      codeGen : NetFrameworkBase.System.CodeDom.Compiler.ICodeGenerator.Kind_Ptr
   )
   is
   ...
   begin
      ...
      p_Value.field_1.field_1.field_1.punkVal := codeGen;
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GenerateIdName");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.Data.TypedDataSetGenerator.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Data.TypedDataSetGenerator.Kind_Ptr := new NetFrameworkBase.System.Data.TypedDataSetGenerator.Kind do
