...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Serialization.SoapSchemaMember is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Serialization.SoapSchemaMember";
   ...
   function MemberType
   (
      this : in out SoapSchemaMember.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Xml.Serialization.SoapSchemaMember.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Serialization.SoapSchemaMember.Kind_Ptr := new NetFrameworkBase.System.Xml.Serialization.SoapSchemaMember.Kind do
