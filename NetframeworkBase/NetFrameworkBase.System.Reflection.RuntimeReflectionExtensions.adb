...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Reflection.RuntimeReflectionExtensions is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Reflection.RuntimeReflectionExtensions";
   ...
   return NetFrameworkBase.System.Reflection.PropertyInfo.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("GetRuntimeProperty");
   ...
   return NetFrameworkBase.System.Reflection.EventInfo.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetRuntimeEvent");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   (
      type_x : NetFrameworkBase.System.Type_x.Kind_Ptr; 
      name : NetFrameworkBase.BSTR; 
      parameters : NetFrameworkBase.System.Type_x.Kind_Array
   )
   return NetFrameworkBase.System.Reflection.MethodInfo.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetRuntimeMethod");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Reflection.FieldInfo.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetRuntimeField");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   function GetRuntimeBaseDefinition
   (
   ...
   return NetFrameworkBase.System.Reflection.MethodInfo.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetRuntimeBaseDefinition");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Reflection.MethodInfo.Kind_Ptr := new NetFrameworkBase.System.Reflection.MethodInfo.Kind;
   begin
   ...
   function GetRuntimeInterfaceMap
   (
   ...
   return NetFrameworkBase.System.Reflection.InterfaceMapping.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetRuntimeInterfaceMap");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   (
      del : NetFrameworkBase.System.Delegate.Kind_Ptr
   )
   return NetFrameworkBase.System.Reflection.MethodInfo.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetMethodInfo");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Reflection.MethodInfo.Kind_Ptr := new NetFrameworkBase.System.Reflection.MethodInfo.Kind;
   begin
