...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.AccessControl.MutexAuditRule is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.AccessControl.MutexAuditRule";
   ...
   (
      this : in out MutexAuditRule.Kind
   )
   ...
   return NetFrameworkBase.System.Security.AccessControl.MutexAuditRule.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.AccessControl.MutexAuditRule.Kind_Ptr := new NetFrameworkBase.System.Security.AccessControl.MutexAuditRule.Kind do
      declare
