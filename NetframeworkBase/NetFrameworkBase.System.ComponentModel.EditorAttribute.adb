...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.EditorAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.EditorAttribute";
   ...
   function EditorBaseTypeName
   (
      this : in out EditorAttribute.Kind
   )
   return NetFrameworkBase.BSTR is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EditorBaseTypeName");
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EditorTypeName");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.ComponentModel.EditorAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.EditorAttribute.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.EditorAttribute.Kind do
   ...
   return NetFrameworkBase.System.ComponentModel.EditorAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.EditorAttribute.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.EditorAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(baseTypeName);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
