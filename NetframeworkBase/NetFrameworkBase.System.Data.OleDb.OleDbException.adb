...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.OleDb.OleDbException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.OleDb.OleDbException";
   ...
   function ErrorCode
   (
      this : in out OleDbException.Kind
   )
