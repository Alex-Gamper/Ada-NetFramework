...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.XmlSchemaAnnotated is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.XmlSchemaAnnotated";
   ...
   function Id
   (
      this : in out XmlSchemaAnnotated.Kind
   )
   ...
   return NetFrameworkBase.System.Xml.Schema.XmlSchemaAnnotation.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Annotation");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Xml.Schema.XmlSchemaAnnotation.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaAnnotation.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Xml.Schema.XmlSchemaAnnotated.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Schema.XmlSchemaAnnotated.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaAnnotated.Kind do
