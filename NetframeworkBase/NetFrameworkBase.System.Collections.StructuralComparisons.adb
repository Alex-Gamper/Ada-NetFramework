...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Collections.StructuralComparisons is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Collections.StructuralComparisons";
   ...
   function StructuralEqualityComparer
   return NetFrameworkBase.System.Collections.IEqualityComparer.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("StructuralEqualityComparer");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
