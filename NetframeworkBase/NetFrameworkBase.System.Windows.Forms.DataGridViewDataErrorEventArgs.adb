...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DataGridViewDataErrorEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DataGridViewDataErrorEventArgs";
   ...
   function Context
   (
      this : in out DataGridViewDataErrorEventArgs.Kind
   )
   return NetFrameworkBase.System.Windows.Forms.DataGridViewDataErrorContexts.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Windows.Forms.DataGridViewDataErrorContexts.Kind);
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Windows.Forms.DataGridViewDataErrorContexts.Kind;
   begin
   ...
   return NetFrameworkBase.System.Windows.Forms.DataGridViewDataErrorEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.DataGridViewDataErrorEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.DataGridViewDataErrorEventArgs.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
