...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.CallbackValidatorAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.CallbackValidatorAttribute";
   ...
   function Type_x
   (
      this : in out CallbackValidatorAttribute.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CallbackMethodName");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.Configuration.CallbackValidatorAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.CallbackValidatorAttribute.Kind_Ptr := new NetFrameworkBase.System.Configuration.CallbackValidatorAttribute.Kind do
