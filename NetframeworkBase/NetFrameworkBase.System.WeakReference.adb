...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.WeakReference is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.WeakReference";
   ...
   function TrackResurrection
   (
      this : in out WeakReference.Kind
   )
   return NetFrameworkBase.Boolean is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("TrackResurrection");
   ...
   return NetFrameworkBase.System.WeakReference.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.WeakReference.Kind_Ptr := new NetFrameworkBase.System.WeakReference.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(trackResurrection);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
