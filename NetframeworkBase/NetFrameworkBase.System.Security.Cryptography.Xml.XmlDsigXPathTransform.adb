...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Xml.XmlDsigXPathTransform is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Xml.XmlDsigXPathTransform";
   ...
   function InputTypes
   (
      this : in out XmlDsigXPathTransform.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.Xml.XmlDsigXPathTransform.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Xml.XmlDsigXPathTransform.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Xml.XmlDsigXPathTransform.Kind do
