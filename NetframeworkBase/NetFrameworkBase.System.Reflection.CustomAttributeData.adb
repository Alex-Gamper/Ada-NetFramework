...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Reflection.CustomAttributeData is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Reflection.CustomAttributeData";
   ...
   (
      this : in out CustomAttributeData.Kind
   )
   ...
   return NetFrameworkBase.System.Reflection.ConstructorInfo.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Constructor");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
