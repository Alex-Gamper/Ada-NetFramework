...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.CompilerServices.CompilationRelaxationsAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.CompilerServices.CompilationRelaxationsAttribute";
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_MethodName  : BSTR := To_BSTR("CompilationRelaxations");
   ...
   return NetFrameworkBase.System.Runtime.CompilerServices.CompilationRelaxationsAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.CompilerServices.CompilationRelaxationsAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.CompilerServices.CompilationRelaxationsAttribute.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(relaxations);
   ...
   begin
      ...
      declare
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_relaxationsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Runtime.CompilerServices.CompilationRelaxations.Instance;
         p_relaxationsEnum : aliased VARIANT := To_Variant (CreateEnum (p_relaxationsEnumType, relaxations'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := p_relaxationsEnum;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
