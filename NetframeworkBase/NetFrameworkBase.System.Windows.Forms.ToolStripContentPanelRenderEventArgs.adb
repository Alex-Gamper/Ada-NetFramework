...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ToolStripContentPanelRenderEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ToolStripContentPanelRenderEventArgs";
   ...
   function Graphics
   (
      this : in out ToolStripContentPanelRenderEventArgs.Kind
   )
   ...
   function ToolStripContentPanel
   (
      this : in out ToolStripContentPanelRenderEventArgs.Kind
   )
   return NetFrameworkBase.System.Windows.Forms.ToolStripContentPanel.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ToolStripContentPanel");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Windows.Forms.ToolStripContentPanelRenderEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ToolStripContentPanelRenderEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ToolStripContentPanelRenderEventArgs.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := GetObject (contentPanel.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
