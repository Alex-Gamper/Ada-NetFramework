...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.StreamWriter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.StreamWriter";
   ...
   begin
      return RetVal : NetFrameworkBase.System.IO.StreamWriter.Kind_Ptr := new NetFrameworkBase.System.IO.StreamWriter.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
