...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.DataTableClearEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.DataTableClearEventArgs";
   ...
   function Table
   (
      this : in out DataTableClearEventArgs.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("TableNamespace");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.Data.DataTableClearEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Data.DataTableClearEventArgs.Kind_Ptr := new NetFrameworkBase.System.Data.DataTableClearEventArgs.Kind do
      declare
