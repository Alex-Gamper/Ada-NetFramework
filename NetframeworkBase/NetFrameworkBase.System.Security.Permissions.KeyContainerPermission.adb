...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.KeyContainerPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.KeyContainerPermission";
   ...
   function Flags
   (
      this : in out KeyContainerPermission.Kind
   )
   return NetFrameworkBase.System.Security.Permissions.KeyContainerPermissionFlags.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Security.Permissions.KeyContainerPermissionFlags.Kind);
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Security.Permissions.KeyContainerPermissionFlags.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.Permissions.KeyContainerPermissionAccessEntryCollection.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AccessEntries");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Permissions.KeyContainerPermissionAccessEntryCollection.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.KeyContainerPermissionAccessEntryCollection.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   return NetFrameworkBase.System.Security.Permissions.KeyContainerPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.KeyContainerPermission.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.KeyContainerPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      declare
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_flagsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Permissions.KeyContainerPermissionFlags.Instance;
   ...
   begin
      ...
      declare
         ...
         p1_Bounds     : aliased SAFEARRAYBOUND := (accessList'Length , 0);
      ...
      begin
         ...
         begin
            ...
            for i in accessList'range loop
               p1_Index(1) := Interfaces.C.long(i) - 1;
               p1_Tmp := GetObject (accessList(i).m_Kind);
         ...
         -- fixme parameter type := [array] System.Security.Permissions.KeyContainerPermissionAccessEntry[]
