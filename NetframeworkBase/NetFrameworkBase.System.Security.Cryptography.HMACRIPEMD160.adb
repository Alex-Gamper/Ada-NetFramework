...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.HMACRIPEMD160 is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.HMACRIPEMD160";
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.HMACRIPEMD160.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.HMACRIPEMD160.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.HMACRIPEMD160.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.HMACRIPEMD160.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.HMACRIPEMD160.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.HMACRIPEMD160.Kind do
      declare
