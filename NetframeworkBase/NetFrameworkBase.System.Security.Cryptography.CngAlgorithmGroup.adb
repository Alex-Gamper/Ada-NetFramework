...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.CngAlgorithmGroup is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.CngAlgorithmGroup";
   ...
   return NetFrameworkBase.System.Security.Cryptography.CngAlgorithmGroup.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("DiffieHellman");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Security.Cryptography.CngAlgorithmGroup.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.CngAlgorithmGroup.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.CngAlgorithmGroup.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(algorithmGroup);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
