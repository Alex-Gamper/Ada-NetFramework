...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.MemoryFailPoint is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.MemoryFailPoint";
   ...
   procedure Dispose
   (
      this : in out MemoryFailPoint.Kind
   ) is
      Hr            : HResult := 0;
   ...
   return NetFrameworkBase.System.Runtime.MemoryFailPoint.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.MemoryFailPoint.Kind_Ptr := new NetFrameworkBase.System.Runtime.MemoryFailPoint.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(sizeInMegabytes);
