...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.Microsoft.SqlServer.Server.SqlFacetAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "Microsoft.SqlServer.Server.SqlFacetAttribute";
   ...
   (
      this : in out SqlFacetAttribute.Kind
   )
   ...
   function Constructor return NetFrameworkBase.Microsoft.SqlServer.Server.SqlFacetAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.Microsoft.SqlServer.Server.SqlFacetAttribute.Kind_Ptr := new NetFrameworkBase.Microsoft.SqlServer.Server.SqlFacetAttribute.Kind do
