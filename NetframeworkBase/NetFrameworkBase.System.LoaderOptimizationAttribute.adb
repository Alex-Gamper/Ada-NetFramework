...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.LoaderOptimizationAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.LoaderOptimizationAttribute";
   ...
   function Value
   (
      this : in out LoaderOptimizationAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.LoaderOptimizationAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.LoaderOptimizationAttribute.Kind_Ptr := new NetFrameworkBase.System.LoaderOptimizationAttribute.Kind do
      declare
