...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.WindowsFormsSynchronizationContext is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.WindowsFormsSynchronizationContext";
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AutoInstall");
      p_RetVal      : aliased VARIANT;
   ...
   is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Uninstall");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Windows.Forms.WindowsFormsSynchronizationContext.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.WindowsFormsSynchronizationContext.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.WindowsFormsSynchronizationContext.Kind do
