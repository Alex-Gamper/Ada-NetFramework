...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Xsl.Runtime.DecimalAggregator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Xsl.Runtime.DecimalAggregator";
   ...
   procedure Create
   (
      this : in out DecimalAggregator.Kind
   ) is
      Hr            : HResult := 0;
