...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.GacIdentityPermissionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.GacIdentityPermissionAttribute";
   ...
   (
      this : in out GacIdentityPermissionAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Security.Permissions.GacIdentityPermissionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.GacIdentityPermissionAttribute.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.GacIdentityPermissionAttribute.Kind do
      declare
