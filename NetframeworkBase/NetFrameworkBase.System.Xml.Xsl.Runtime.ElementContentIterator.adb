...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Xsl.Runtime.ElementContentIterator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Xsl.Runtime.ElementContentIterator";
   ...
   procedure Create
   (
      this : in out ElementContentIterator.Kind;
