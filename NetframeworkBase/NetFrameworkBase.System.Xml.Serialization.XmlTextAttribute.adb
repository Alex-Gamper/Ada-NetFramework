...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Serialization.XmlTextAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Serialization.XmlTextAttribute";
   ...
   function Type_x
   (
      this : in out XmlTextAttribute.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Xml.Serialization.XmlTextAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Serialization.XmlTextAttribute.Kind_Ptr := new NetFrameworkBase.System.Xml.Serialization.XmlTextAttribute.Kind do
