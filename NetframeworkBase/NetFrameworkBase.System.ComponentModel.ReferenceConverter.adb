...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.ReferenceConverter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.ReferenceConverter";
   ...
   return NetFrameworkBase.System.ComponentModel.ReferenceConverter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.ReferenceConverter.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.ReferenceConverter.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
