...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Environment.SpecialFolderOption is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Environment+SpecialFolderOption";
