...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.InteropServices.ComAwareEventInfo is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.InteropServices.ComAwareEventInfo";
   ...
   return NetFrameworkBase.System.Runtime.InteropServices.ComAwareEventInfo.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.InteropServices.ComAwareEventInfo.Kind_Ptr := new NetFrameworkBase.System.Runtime.InteropServices.ComAwareEventInfo.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
