...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.EnterpriseServices.Internal.ServerWebConfig is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.EnterpriseServices.Internal.ServerWebConfig";
   ...
   procedure Create
   (
      this : in out ServerWebConfig.Kind;
      FilePath : NetFrameworkBase.BSTR; 
      FilePrefix : NetFrameworkBase.BSTR; 
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AddElement");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.EnterpriseServices.Internal.ServerWebConfig.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.EnterpriseServices.Internal.ServerWebConfig.Kind_Ptr := new NetFrameworkBase.System.EnterpriseServices.Internal.ServerWebConfig.Kind do
