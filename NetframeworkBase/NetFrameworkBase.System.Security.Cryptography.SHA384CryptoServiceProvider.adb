...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.SHA384CryptoServiceProvider is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.SHA384CryptoServiceProvider";
   ...
   (
      this : in out SHA384CryptoServiceProvider.Kind
   ) is
      Hr            : HResult := 0;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.SHA384CryptoServiceProvider.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.SHA384CryptoServiceProvider.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.SHA384CryptoServiceProvider.Kind do
