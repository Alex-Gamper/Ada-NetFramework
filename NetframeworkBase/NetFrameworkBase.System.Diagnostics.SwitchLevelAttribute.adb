...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.SwitchLevelAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.SwitchLevelAttribute";
   ...
   function SwitchLevelType
   (
      this : in out SwitchLevelAttribute.Kind
   )
   return NetFrameworkBase.System.Type_x.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SwitchLevelType");
   ...
   return NetFrameworkBase.System.Diagnostics.SwitchLevelAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.SwitchLevelAttribute.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.SwitchLevelAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (switchLevelType.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
