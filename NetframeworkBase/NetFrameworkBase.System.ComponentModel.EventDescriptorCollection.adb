...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.EventDescriptorCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.EventDescriptorCollection";
   ...
   return NetFrameworkBase.System.ComponentModel.EventDescriptorCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.EventDescriptorCollection.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.EventDescriptorCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
         ...
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p0_Parameters : aliased LPSAFEARRAY := null;
         p0_Bounds     : aliased SAFEARRAYBOUND := (events'Length , 0);
         p0_Index      : aliased array(1..1) of aliased LONG := (others => 0);
      ...
      begin
         ...
         begin
            ...
            for i in events'range loop
               p0_Index(1) := Interfaces.C.long(i) - 1;
               p0_Tmp := GetObject (events(i).m_Kind);
         ...
         -- fixme parameter type := [array] System.ComponentModel.EventDescriptor[]
