...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.FormattableString is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.FormattableString";
   ...
   function Invariant
   (
      formattable : NetFrameworkBase.System.FormattableString.Kind_Ptr
   )
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (formattable.m_Kind);
   ...
   function ToString
   (
      this : in out FormattableString.Kind
   )
   return NetFrameworkBase.BSTR is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
   ...
   return NetFrameworkBase.System.Object.Kind_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetArguments");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Object.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetArgument");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
