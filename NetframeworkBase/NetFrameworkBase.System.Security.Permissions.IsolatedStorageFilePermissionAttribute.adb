...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.IsolatedStorageFilePermissionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.IsolatedStorageFilePermissionAttribute";
   ...
   (
      this : in out IsolatedStorageFilePermissionAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Security.Permissions.IsolatedStorageFilePermissionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.IsolatedStorageFilePermissionAttribute.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.IsolatedStorageFilePermissionAttribute.Kind do
      declare
