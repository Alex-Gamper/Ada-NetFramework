...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Threading.ExecutionContext is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Threading.ExecutionContext";
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (executionContext.m_Kind);
