...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.ConfigurationElement is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.ConfigurationElement";
   ...
   (
      this : in out ConfigurationElement.Kind
   )
   return NetFrameworkBase.System.Configuration.ConfigurationLockCollection.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("LockAttributes");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Configuration.ConfigurationLockCollection.Kind_Ptr := new NetFrameworkBase.System.Configuration.ConfigurationLockCollection.Kind;
   begin
   ...
   function LockAllAttributesExcept
   (
      this : in out ConfigurationElement.Kind
   )
   return NetFrameworkBase.System.Configuration.ConfigurationLockCollection.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("LockAllAttributesExcept");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Configuration.ConfigurationLockCollection.Kind_Ptr := new NetFrameworkBase.System.Configuration.ConfigurationLockCollection.Kind;
   begin
   ...
   return NetFrameworkBase.System.Configuration.ConfigurationLockCollection.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("LockElements");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Configuration.ConfigurationLockCollection.Kind_Ptr := new NetFrameworkBase.System.Configuration.ConfigurationLockCollection.Kind;
   begin
   ...
   function LockAllElementsExcept
   (
      this : in out ConfigurationElement.Kind
   )
   return NetFrameworkBase.System.Configuration.ConfigurationLockCollection.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("LockAllElementsExcept");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Configuration.ConfigurationLockCollection.Kind_Ptr := new NetFrameworkBase.System.Configuration.ConfigurationLockCollection.Kind;
   begin
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("LockItem");
      p_RetVal      : aliased VARIANT;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (compareTo.m_Kind);
   ...
   return NetFrameworkBase.System.Configuration.ElementInformation.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ElementInformation");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Configuration.ElementInformation.Kind_Ptr := new NetFrameworkBase.System.Configuration.ElementInformation.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   return NetFrameworkBase.System.Configuration.Configuration.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CurrentConfiguration");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
