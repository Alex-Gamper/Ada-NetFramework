...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Pkcs.ContentInfo is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Pkcs.ContentInfo";
   ...
   return NetFrameworkBase.Byte_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Content");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Security.Cryptography.Oid.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetContentType");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Pkcs.ContentInfo.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Pkcs.ContentInfo.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
         ...
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p0_Parameters : aliased LPSAFEARRAY := null;
         p0_Bounds     : aliased SAFEARRAYBOUND := (content'Length , 0);
         p0_Index      : aliased array(1..1) of aliased LONG := (others => 0);
         p0_Tmp        : aliased NetFrameworkBase.Byte;
         p0_Tmp_Ptr    : access NetFrameworkBase.Byte := p0_Tmp'access;
      begin
   ...
   begin
      ...
      declare
         ...
         p1_Bounds     : aliased SAFEARRAYBOUND := (content'Length , 0);
