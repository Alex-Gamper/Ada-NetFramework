...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.RegistryPermissionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.RegistryPermissionAttribute";
   ...
   function Read
   (
      this : in out RegistryPermissionAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Security.Permissions.RegistryPermissionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.RegistryPermissionAttribute.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.RegistryPermissionAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
