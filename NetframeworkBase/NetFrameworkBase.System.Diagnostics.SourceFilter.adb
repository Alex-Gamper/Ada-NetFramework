...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.SourceFilter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.SourceFilter";
   ...
   return NetFrameworkBase.System.Diagnostics.SourceFilter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.SourceFilter.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.SourceFilter.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
