...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Mail.SmtpFailedRecipientException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Mail.SmtpFailedRecipientException";
   ...
   (
      this : in out SmtpFailedRecipientException.Kind
   )
   return NetFrameworkBase.BSTR is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("FailedRecipient");
   ...
   function Constructor return NetFrameworkBase.System.Net.Mail.SmtpFailedRecipientException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Mail.SmtpFailedRecipientException.Kind_Ptr := new NetFrameworkBase.System.Net.Mail.SmtpFailedRecipientException.Kind do
   ...
   return NetFrameworkBase.System.Net.Mail.SmtpFailedRecipientException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Mail.SmtpFailedRecipientException.Kind_Ptr := new NetFrameworkBase.System.Net.Mail.SmtpFailedRecipientException.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(failedRecipient);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 2;
         p_Value := To_Variant(serverResponse);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
