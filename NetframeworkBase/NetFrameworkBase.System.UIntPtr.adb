...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.UIntPtr is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.UIntPtr";
   ...
   return NetFrameworkBase.System.UIntPtr.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.UIntPtr.Kind_Ptr := new NetFrameworkBase.System.UIntPtr.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
