...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9AttributeObject is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Pkcs.Pkcs9AttributeObject";
   ...
   function Oid
   (
      this : in out Pkcs9AttributeObject.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9AttributeObject.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9AttributeObject.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9AttributeObject.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9AttributeObject.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9AttributeObject.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9AttributeObject.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         ...
         p1_Bounds     : aliased SAFEARRAYBOUND := (encodedData'Length , 0);
      ...
      begin
         ...
         begin
            ...
            for i in encodedData'range loop
               p1_Index(1) := Interfaces.C.long(i) - 1;
               p1_Tmp := encodedData(i);
