...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.Design.DesigntimeLicenseContextSerializer is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.Design.DesigntimeLicenseContextSerializer";
   ...
   procedure Serialize
   (
      o : NetFrameworkBase.System.IO.Stream.Kind_Ptr; 
      cryptoKey : NetFrameworkBase.BSTR; 
      context : NetFrameworkBase.System.ComponentModel.Design.DesigntimeLicenseContext.Kind_Ptr
   )
   is
