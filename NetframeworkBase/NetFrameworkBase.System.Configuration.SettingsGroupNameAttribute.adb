...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.SettingsGroupNameAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.SettingsGroupNameAttribute";
   ...
   function GroupName
   (
      this : in out SettingsGroupNameAttribute.Kind
   )
   return NetFrameworkBase.BSTR is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GroupName");
   ...
   return NetFrameworkBase.System.Configuration.SettingsGroupNameAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.SettingsGroupNameAttribute.Kind_Ptr := new NetFrameworkBase.System.Configuration.SettingsGroupNameAttribute.Kind do
      declare
