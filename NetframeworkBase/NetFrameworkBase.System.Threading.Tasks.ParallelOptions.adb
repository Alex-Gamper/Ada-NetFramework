...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Threading.Tasks.ParallelOptions is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Threading.Tasks.ParallelOptions";
   ...
   procedure TaskScheduler
   (
      this : in out ParallelOptions.Kind;
      value : NetFrameworkBase.System.Threading.Tasks.TaskScheduler.Kind_Ptr
   ) is
   ...
   function MaxDegreeOfParallelism
   (
      this : in out ParallelOptions.Kind
   )
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("MaxDegreeOfParallelism");
      p_RetVal      : aliased VARIANT;
   ...
   procedure MaxDegreeOfParallelism
   (
      this : in out ParallelOptions.Kind;
   ...
   (
      this : in out ParallelOptions.Kind;
      value : NetFrameworkBase.System.Threading.CancellationToken.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   function Constructor return NetFrameworkBase.System.Threading.Tasks.ParallelOptions.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Threading.Tasks.ParallelOptions.Kind_Ptr := new NetFrameworkBase.System.Threading.Tasks.ParallelOptions.Kind do
