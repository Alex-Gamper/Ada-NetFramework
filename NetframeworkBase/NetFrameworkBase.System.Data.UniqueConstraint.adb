...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.UniqueConstraint is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.UniqueConstraint";
   ...
   function Columns
   (
      this : in out UniqueConstraint.Kind
   )
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsPrimaryKey");
      p_RetVal      : aliased VARIANT;
   ...
   (
      this : in out UniqueConstraint.Kind;
      key2 : NetFrameworkBase.System.Object.Kind_Ptr
   )
   return NetFrameworkBase.Boolean is
   ...
   begin
      return RetVal : NetFrameworkBase.System.Data.UniqueConstraint.Kind_Ptr := new NetFrameworkBase.System.Data.UniqueConstraint.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 2;
         p_Value := To_Variant(isPrimaryKey);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy (p1_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
