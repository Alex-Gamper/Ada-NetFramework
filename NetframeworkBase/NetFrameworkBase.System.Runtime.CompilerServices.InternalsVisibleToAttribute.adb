...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.CompilerServices.InternalsVisibleToAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.CompilerServices.InternalsVisibleToAttribute";
   ...
   (
      this : in out InternalsVisibleToAttribute.Kind
   )
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AllInternalsVisible");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Runtime.CompilerServices.InternalsVisibleToAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.CompilerServices.InternalsVisibleToAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.CompilerServices.InternalsVisibleToAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
