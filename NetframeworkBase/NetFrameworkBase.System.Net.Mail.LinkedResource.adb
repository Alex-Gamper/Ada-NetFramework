...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Mail.LinkedResource is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Mail.LinkedResource";
   ...
   (
      this : in out LinkedResource.Kind
   )
   return NetFrameworkBase.System.Uri.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ContentLink");
   ...
   return NetFrameworkBase.System.Net.Mail.LinkedResource.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      p_Bounds      : aliased SAFEARRAYBOUND := (1 , 0);
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CreateLinkedResourceFromString");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Net.Mail.LinkedResource.Kind_Ptr := new NetFrameworkBase.System.Net.Mail.LinkedResource.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.Net.Mail.LinkedResource.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Mail.LinkedResource.Kind_Ptr := new NetFrameworkBase.System.Net.Mail.LinkedResource.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
