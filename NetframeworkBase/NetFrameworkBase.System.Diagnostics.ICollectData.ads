...
--------------------------------------------------------------------------------
package NetFrameworkBase.System.Diagnostics.ICollectData is
   ...
   type Kind_Array_Ptr is access all Kind_Array;
      ...
      (
         this : in out ICollectData.Kind;
         id : NetFrameworkBase.Int32;
         valueName : NetFrameworkBase.IntPtr;
         data : NetFrameworkBase.IntPtr;
         totalBytes : NetFrameworkBase.Int32;
         res : NetFrameworkBase.IntPtr
   ...
   private
      ...
      This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.ICollectData";
