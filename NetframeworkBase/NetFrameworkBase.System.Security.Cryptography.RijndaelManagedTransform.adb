...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.RijndaelManagedTransform is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.RijndaelManagedTransform";
   ...
   procedure Dispose
   (
      this : in out RijndaelManagedTransform.Kind
   ) is
      Hr            : HResult := 0;
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("BlockSizeValue");
      p_RetVal      : aliased VARIANT;
