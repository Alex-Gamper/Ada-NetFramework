...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Policy.PolicyStatement is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Policy.PolicyStatement";
   ...
   return NetFrameworkBase.System.Security.Policy.PolicyStatementAttribute.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Security.Policy.PolicyStatementAttribute.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Policy.PolicyStatementAttribute.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   (
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_valueEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Policy.PolicyStatementAttribute.Instance;
   ...
   return NetFrameworkBase.System.Security.Policy.PolicyStatement.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Policy.PolicyStatement.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.PolicyStatement.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      declare
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_attributesEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Policy.PolicyStatementAttribute.Instance;
