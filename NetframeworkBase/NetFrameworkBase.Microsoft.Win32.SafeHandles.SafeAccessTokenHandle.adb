...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.Microsoft.Win32.SafeHandles.SafeAccessTokenHandle is
   ...
   This_TypeName     : constant Standard.Wide_String := "Microsoft.Win32.SafeHandles.SafeAccessTokenHandle";
   ...
   function IsInvalid
   (
      this : in out SafeAccessTokenHandle.Kind
   )
   ...
   return NetFrameworkBase.Microsoft.Win32.SafeHandles.SafeAccessTokenHandle.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("InvalidHandle");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.Microsoft.Win32.SafeHandles.SafeAccessTokenHandle.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.Microsoft.Win32.SafeHandles.SafeAccessTokenHandle.Kind_Ptr := new NetFrameworkBase.Microsoft.Win32.SafeHandles.SafeAccessTokenHandle.Kind do
      declare
