...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.EnterpriseServices.BYOT is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.EnterpriseServices.BYOT";
   ...
   function CreateWithTipTransaction
   (
   ...
   return NetFrameworkBase.System.Object.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("CreateWithTipTransaction");
   ...
   (
      transaction : NetFrameworkBase.System.Object.Kind_Ptr; 
      t : NetFrameworkBase.System.Type_x.Kind_Ptr
   )
   return NetFrameworkBase.System.Object.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CreateWithTransaction");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Object.Kind_Ptr := new NetFrameworkBase.System.Object.Kind;
   begin
