...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Text.DecoderReplacementFallbackBuffer is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Text.DecoderReplacementFallbackBuffer";
   ...
   function Fallback
   (
      this : in out DecoderReplacementFallbackBuffer.Kind;
   ...
   return NetFrameworkBase.Boolean is
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (bytesUnknown'Length , 0);
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Remaining");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Text.DecoderReplacementFallbackBuffer.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Text.DecoderReplacementFallbackBuffer.Kind_Ptr := new NetFrameworkBase.System.Text.DecoderReplacementFallbackBuffer.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (fallback.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
