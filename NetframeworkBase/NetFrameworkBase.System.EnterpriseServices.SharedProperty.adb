...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.EnterpriseServices.SharedProperty is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.EnterpriseServices.SharedProperty";
   ...
   function Value
   (
      this : in out SharedProperty.Kind
   )
