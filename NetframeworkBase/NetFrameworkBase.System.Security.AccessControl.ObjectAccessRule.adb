...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.AccessControl.ObjectAccessRule is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.AccessControl.ObjectAccessRule";
   ...
   function ObjectType
   (
      this : in out ObjectAccessRule.Kind
   )
   ...
   return NetFrameworkBase.System.Guid.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("InheritedObjectType");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Guid.Kind_Ptr := new NetFrameworkBase.System.Guid.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.AccessControl.ObjectAceFlags.Kind is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ObjectFlags");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
