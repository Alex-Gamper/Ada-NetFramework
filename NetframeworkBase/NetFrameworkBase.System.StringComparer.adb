...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.StringComparer is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.StringComparer";
   ...
   return NetFrameworkBase.System.StringComparer.Kind_Ptr is
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.StringComparer.Kind_Ptr := new NetFrameworkBase.System.StringComparer.Kind;
   begin
   ...
   return NetFrameworkBase.System.StringComparer.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("InvariantCultureIgnoreCase");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.StringComparer.Kind_Ptr := new NetFrameworkBase.System.StringComparer.Kind;
   begin
   ...
   return NetFrameworkBase.System.StringComparer.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CurrentCultureIgnoreCase");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.StringComparer.Kind_Ptr := new NetFrameworkBase.System.StringComparer.Kind;
   begin
   ...
   return NetFrameworkBase.System.StringComparer.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("OrdinalIgnoreCase");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.StringComparer.Kind_Ptr := new NetFrameworkBase.System.StringComparer.Kind;
   begin
