...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.WebBrowserSiteBase is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.WebBrowserSiteBase";
   ...
   procedure Dispose
   (
      this : in out WebBrowserSiteBase.Kind
   ) is
      Hr            : HResult := 0;
