...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.UriParser is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.UriParser";
   ...
   procedure Register
   (
      uriParser : NetFrameworkBase.System.UriParser.Kind_Ptr; 
      schemeName : NetFrameworkBase.BSTR; 
      defaultPort : NetFrameworkBase.Int32
   )
   is
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (uriParser.m_Kind);
      ...
      ------------------------------------------------------------
      p_Index(1) := 2;
      p_Value := To_Variant(defaultPort);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsKnownScheme");
      p_RetVal      : aliased VARIANT;
