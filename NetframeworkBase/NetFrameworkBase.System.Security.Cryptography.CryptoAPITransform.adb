...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.CryptoAPITransform is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.CryptoAPITransform";
   ...
   return NetFrameworkBase.IntPtr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("KeyHandle");
      p_RetVal      : aliased VARIANT;
