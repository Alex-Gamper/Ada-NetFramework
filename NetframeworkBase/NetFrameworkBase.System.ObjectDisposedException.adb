...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ObjectDisposedException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ObjectDisposedException";
   ...
   function ObjectName
   (
      this : in out ObjectDisposedException.Kind
   )
   return NetFrameworkBase.BSTR is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ObjectName");
   ...
   return NetFrameworkBase.System.ObjectDisposedException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ObjectDisposedException.Kind_Ptr := new NetFrameworkBase.System.ObjectDisposedException.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
