...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.SettingsProvider is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.SettingsProvider";
   ...
   (
      this : in out SettingsProvider.Kind;
      context : NetFrameworkBase.System.Configuration.SettingsContext.Kind_Ptr; 
      collection : NetFrameworkBase.System.Configuration.SettingsPropertyCollection.Kind_Ptr
   )
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := GetObject (collection.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   (
      this : in out SettingsProvider.Kind;
      context : NetFrameworkBase.System.Configuration.SettingsContext.Kind_Ptr; 
      collection : NetFrameworkBase.System.Configuration.SettingsPropertyValueCollection.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
