...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Drawing.Design.ToolboxItemCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Drawing.Design.ToolboxItemCollection";
   ...
   function Item
   (
      this : in out ToolboxItemCollection.Kind;
   ...
   return NetFrameworkBase.System.Drawing.Design.ToolboxItem.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Drawing.Design.ToolboxItem.Kind_Ptr := new NetFrameworkBase.System.Drawing.Design.ToolboxItem.Kind;
   begin
   ...
   (
      this : in out ToolboxItemCollection.Kind;
      value : NetFrameworkBase.System.Drawing.Design.ToolboxItem.Kind_Ptr
   )
   ...
   (
      this : in out ToolboxItemCollection.Kind;
      array_x : NetFrameworkBase.System.Drawing.Design.ToolboxItem.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Drawing.Design.ToolboxItem[]
   ...
   return NetFrameworkBase.System.Drawing.Design.ToolboxItemCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Drawing.Design.ToolboxItemCollection.Kind_Ptr := new NetFrameworkBase.System.Drawing.Design.ToolboxItemCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
