...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ScrollableControl.DockPaddingEdges is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ScrollableControl+DockPaddingEdges";
   ...
   function All_x
   (
      this : in out DockPaddingEdges.Kind
   )
