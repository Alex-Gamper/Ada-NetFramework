...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.TableLayoutColumnStyleCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.TableLayoutColumnStyleCollection";
   ...
   function Add
   (
      this : in out TableLayoutColumnStyleCollection.Kind;
      columnStyle : NetFrameworkBase.System.Windows.Forms.ColumnStyle.Kind_Ptr
   )
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (columnStyle.m_Kind);
   ...
   return NetFrameworkBase.System.Windows.Forms.ColumnStyle.Kind_Ptr is
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Windows.Forms.ColumnStyle.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ColumnStyle.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   (
      this : in out TableLayoutColumnStyleCollection.Kind;
      index : NetFrameworkBase.Int32; 
      value : NetFrameworkBase.System.Windows.Forms.ColumnStyle.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
