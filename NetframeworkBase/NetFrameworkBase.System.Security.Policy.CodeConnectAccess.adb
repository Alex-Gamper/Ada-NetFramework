...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Policy.CodeConnectAccess is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Policy.CodeConnectAccess";
   ...
   return NetFrameworkBase.System.Security.Policy.CodeConnectAccess.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("CreateOriginSchemeAccess");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Policy.CodeConnectAccess.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.CodeConnectAccess.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.Policy.CodeConnectAccess.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CreateAnySchemeAccess");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Policy.CodeConnectAccess.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.CodeConnectAccess.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.Policy.CodeConnectAccess.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Policy.CodeConnectAccess.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.CodeConnectAccess.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(allowScheme);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(allowPort);
