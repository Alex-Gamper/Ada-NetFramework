...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.Ports.SerialDataReceivedEventHandler is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.Ports.SerialDataReceivedEventHandler";
