...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ListBox.SelectedObjectCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ListBox+SelectedObjectCollection";
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (selectedObject.m_Kind);
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ListBox.SelectedObjectCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ListBox.SelectedObjectCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
