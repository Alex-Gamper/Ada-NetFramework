...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Remoting.Contexts.ContextProperty is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Remoting.Contexts.ContextProperty";
   ...
   function Name
   (
      this : in out ContextProperty.Kind
   )
