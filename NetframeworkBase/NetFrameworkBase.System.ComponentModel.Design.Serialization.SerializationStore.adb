...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.Design.Serialization.SerializationStore is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.Design.Serialization.SerializationStore";
   ...
   function Errors
   (
      this : in out SerializationStore.Kind
   )
