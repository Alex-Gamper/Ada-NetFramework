...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.TableLayoutStyleCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.TableLayoutStyleCollection";
   ...
   function Add
   (
      this : in out TableLayoutStyleCollection.Kind;
      style : NetFrameworkBase.System.Windows.Forms.TableLayoutStyle.Kind_Ptr
   )
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (style.m_Kind);
   ...
   return NetFrameworkBase.System.Windows.Forms.TableLayoutStyle.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      p_Bounds      : aliased SAFEARRAYBOUND := (1 , 0);
      ...
      RetVal        : NetFrameworkBase.System.Windows.Forms.TableLayoutStyle.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.TableLayoutStyle.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   (
      this : in out TableLayoutStyleCollection.Kind;
      index : NetFrameworkBase.Int32; 
      value : NetFrameworkBase.System.Windows.Forms.TableLayoutStyle.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
