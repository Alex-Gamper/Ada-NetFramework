...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.UploadStringCompletedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.UploadStringCompletedEventArgs";
   ...
   function Result
   (
      this : in out UploadStringCompletedEventArgs.Kind
   )
