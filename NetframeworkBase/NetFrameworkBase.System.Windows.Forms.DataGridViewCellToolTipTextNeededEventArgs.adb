...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DataGridViewCellToolTipTextNeededEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DataGridViewCellToolTipTextNeededEventArgs";
   ...
   (
      this : in out DataGridViewCellToolTipTextNeededEventArgs.Kind
   )
