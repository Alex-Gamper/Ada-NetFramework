...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.AccessControl.RegistryAuditRule is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.AccessControl.RegistryAuditRule";
   ...
   (
      this : in out RegistryAuditRule.Kind
   )
   ...
   return NetFrameworkBase.System.Security.AccessControl.RegistryAuditRule.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.AccessControl.RegistryAuditRule.Kind_Ptr := new NetFrameworkBase.System.Security.AccessControl.RegistryAuditRule.Kind do
      declare
