...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.Timer is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.Timer";
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("add_Tick");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("remove_Tick");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Windows.Forms.Timer.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.Timer.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.Timer.Kind do
   ...
   return NetFrameworkBase.System.Windows.Forms.Timer.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.Timer.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.Timer.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
