...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Nullable is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Nullable";
   ...
   (
      nullableType : NetFrameworkBase.System.Type_x.Kind_Ptr
   )
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (nullableType.m_Kind);
