...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Text.RegularExpressions.RegexMatchTimeoutException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Text.RegularExpressions.RegexMatchTimeoutException";
   ...
   function Pattern
   (
      this : in out RegexMatchTimeoutException.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Input");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.Text.RegularExpressions.RegexMatchTimeoutException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Text.RegularExpressions.RegexMatchTimeoutException.Kind_Ptr := new NetFrameworkBase.System.Text.RegularExpressions.RegexMatchTimeoutException.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(regexInput);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(regexPattern);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 2;
   ...
   function Constructor return NetFrameworkBase.System.Text.RegularExpressions.RegexMatchTimeoutException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Text.RegularExpressions.RegexMatchTimeoutException.Kind_Ptr := new NetFrameworkBase.System.Text.RegularExpressions.RegexMatchTimeoutException.Kind do
