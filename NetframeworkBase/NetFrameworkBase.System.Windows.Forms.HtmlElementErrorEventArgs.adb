...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.HtmlElementErrorEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.HtmlElementErrorEventArgs";
   ...
   (
      this : in out HtmlElementErrorEventArgs.Kind
   )
