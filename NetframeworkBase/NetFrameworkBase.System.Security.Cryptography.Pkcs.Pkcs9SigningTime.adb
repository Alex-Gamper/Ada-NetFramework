...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9SigningTime is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Pkcs.Pkcs9SigningTime";
   ...
   (
      this : in out Pkcs9SigningTime.Kind
   )
   return NetFrameworkBase.Date is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SigningTime");
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9SigningTime.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9SigningTime.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9SigningTime.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9SigningTime.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9SigningTime.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9SigningTime.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(signingTime);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      ...
      declare
         ...
         p0_Bounds     : aliased SAFEARRAYBOUND := (encodedSigningTime'Length , 0);
      ...
      begin
         ...
         begin
            ...
            for i in encodedSigningTime'range loop
               p0_Index(1) := Interfaces.C.long(i) - 1;
               p0_Tmp := encodedSigningTime(i);
