...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.CryptographicAttributeObjectEnumerator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.CryptographicAttributeObjectEnumerator";
   ...
   function Current
   (
      this : in out CryptographicAttributeObjectEnumerator.Kind
   )
