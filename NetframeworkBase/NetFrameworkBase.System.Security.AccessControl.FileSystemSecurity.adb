...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.AccessControl.FileSystemSecurity is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.AccessControl.FileSystemSecurity";
   ...
   (
      this : in out FileSystemSecurity.Kind;
      rule : NetFrameworkBase.System.Security.AccessControl.FileSystemAccessRule.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   (
      this : in out FileSystemSecurity.Kind;
      rule : NetFrameworkBase.System.Security.AccessControl.FileSystemAuditRule.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
