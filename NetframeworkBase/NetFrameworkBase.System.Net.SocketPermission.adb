...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.SocketPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.SocketPermission";
   ...
   return NetFrameworkBase.System.Collections.IEnumerator.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("ConnectList");
   ...
   return NetFrameworkBase.System.Collections.IEnumerator.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AcceptList");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Collections.IEnumerator.Kind_Ptr;
   begin
   ...
   (
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_access_xEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Net.NetworkAccess.Instance;
      p_access_xEnum : aliased VARIANT := To_Variant (CreateEnum (p_access_xEnumType, access_x'Enum_rep));
      p_transportEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Net.TransportType.Instance;
      p_transportEnum : aliased VARIANT := To_Variant (CreateEnum (p_transportEnumType, transport'Enum_rep));
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.Net.SocketPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.SocketPermission.Kind_Ptr := new NetFrameworkBase.System.Net.SocketPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
