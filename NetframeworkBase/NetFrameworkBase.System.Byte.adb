...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Byte is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Byte";
   ...
   begin
      ...
      -- set out parameter [result : System.Byte]
      p_Index(1) := 1;
   ...
   function Constructor return NetFrameworkBase.System.Byte.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Byte.Kind_Ptr := new NetFrameworkBase.System.Byte.Kind do
