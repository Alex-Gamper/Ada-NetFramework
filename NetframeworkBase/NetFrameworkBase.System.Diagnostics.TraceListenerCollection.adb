...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.TraceListenerCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.TraceListenerCollection";
   ...
   function Item
   (
      this : in out TraceListenerCollection.Kind;
      i : NetFrameworkBase.Int32
   )
   return NetFrameworkBase.System.Diagnostics.TraceListener.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Diagnostics.TraceListener.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.TraceListener.Kind;
   begin
   ...
   (
      this : in out TraceListenerCollection.Kind;
      i : NetFrameworkBase.Int32; 
      value : NetFrameworkBase.System.Diagnostics.TraceListener.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   (
      this : in out TraceListenerCollection.Kind;
      listener : NetFrameworkBase.System.Diagnostics.TraceListener.Kind_Ptr
   )
   return NetFrameworkBase.Int32 is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   (
      this : in out TraceListenerCollection.Kind;
      value : NetFrameworkBase.System.Diagnostics.TraceListener.Kind_Array
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Diagnostics.TraceListener[]
   ...
   (
      this : in out TraceListenerCollection.Kind;
      value : NetFrameworkBase.System.Diagnostics.TraceListenerCollection.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   (
      this : in out TraceListenerCollection.Kind;
      listeners : NetFrameworkBase.System.Diagnostics.TraceListener.Kind_Array; 
      ...
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p0_Parameters : aliased LPSAFEARRAY := null;
      p0_Bounds     : aliased SAFEARRAYBOUND := (listeners'Length , 0);
      p0_Index      : aliased array(1..1) of aliased LONG := (others => 0);
      p0_Tmp        : aliased IUnknown_Ptr;
      p0_Tmp_Ptr    : access IUnknown_Ptr := p0_Tmp'access;
   begin
      ...
      begin
         p0_Parameters := SafeArrayCreate (VT_UNKNOWN'enum_rep, 1, p0_Bounds'access);
         for i in listeners'range loop
            p0_Index(1) := Interfaces.C.long(i) - 1;
            p0_Tmp := GetObject (listeners(i).m_Kind);
            Hr := SafeArrayPutElement (p0_Parameters, p0_Index (p0_Index'first)'access, Convert (p0_Tmp));
         end loop;
         p_Value := To_Variant (p0_Parameters, VT_UNKNOWN);
      end;
