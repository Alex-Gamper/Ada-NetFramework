...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.UploadValuesCompletedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.UploadValuesCompletedEventArgs";
   ...
   function Result
   (
      this : in out UploadValuesCompletedEventArgs.Kind
   )
