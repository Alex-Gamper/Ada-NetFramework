...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.XmlSecureResolver is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.XmlSecureResolver";
   ...
   return NetFrameworkBase.System.Security.Policy.Evidence.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("CreateEvidenceForUrl");
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := To_Variant(securityUrl);
   ...
   return NetFrameworkBase.System.Xml.XmlSecureResolver.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.XmlSecureResolver.Kind_Ptr := new NetFrameworkBase.System.Xml.XmlSecureResolver.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := GetObject (permissionSet.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
