...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.Common.DbProviderFactories is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.Common.DbProviderFactories";
   ...
   function GetFactoryClasses
   return NetFrameworkBase.System.Data.DataTable.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetFactoryClasses");
   ...
   function GetFactory
   (
      providerInvariantName : NetFrameworkBase.BSTR
   )
   return NetFrameworkBase.System.Data.Common.DbProviderFactory.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetFactory");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Data.Common.DbProviderFactory.Kind_Ptr := new NetFrameworkBase.System.Data.Common.DbProviderFactory.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Static)'Enum_rep;
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := To_Variant(providerInvariantName);
   ...
   function GetFactory
   (
      providerRow : NetFrameworkBase.System.Data.DataRow.Kind_Ptr
   )
   return NetFrameworkBase.System.Data.Common.DbProviderFactory.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (providerRow.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   function GetFactory
   (
      connection : NetFrameworkBase.System.Data.Common.DbConnection.Kind_Ptr
   )
   return NetFrameworkBase.System.Data.Common.DbProviderFactory.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
