...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Remoting.Messaging.ConstructionCall is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Remoting.Messaging.ConstructionCall";
   ...
   return NetFrameworkBase.System.Object.Kind_Array is
      ...
      p_MethodName  : BSTR := To_BSTR("CallSiteActivationAttributes");
   ...
   return NetFrameworkBase.System.Type_x.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ActivationType");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ActivationTypeName");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Runtime.Remoting.Activation.IActivator.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Activator");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Runtime.Remoting.Activation.IActivator.Kind_Ptr;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   return NetFrameworkBase.System.Runtime.Remoting.Messaging.ConstructionCall.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Remoting.Messaging.ConstructionCall.Kind_Ptr := new NetFrameworkBase.System.Runtime.Remoting.Messaging.ConstructionCall.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
         ...
         p0_Bounds     : aliased SAFEARRAYBOUND := (headers'Length , 0);
      ...
      begin
         ...
         begin
            ...
            for i in headers'range loop
               ...
               p0_Tmp := GetObject (headers(i).m_Kind);
   ...
   begin
      ...
      begin
         ...
         p_Index(1) := 0;
         p_Value.field_1.field_1.vt := VT_UNKNOWN'Enum_rep;
         p_Value.field_1.field_1.field_1.punkVal := m;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
