...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.Design.ServiceContainer is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.Design.ServiceContainer";
   ...
   (
      ...
      p_MethodName  : BSTR := To_BSTR("AddService");
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (serviceType.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := GetObject (serviceInstance.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RemoveService");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.ComponentModel.Design.ServiceContainer.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.Design.ServiceContainer.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.Design.ServiceContainer.Kind do
   ...
   return NetFrameworkBase.System.ComponentModel.Design.ServiceContainer.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.Design.ServiceContainer.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.Design.ServiceContainer.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      ...
      begin
         ...
         p_Value.field_1.field_1.field_1.punkVal := parentProvider;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
