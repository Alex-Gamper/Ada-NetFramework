...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.ToBase64Transform is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.ToBase64Transform";
   ...
   (
      this : in out ToBase64Transform.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.ToBase64Transform.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.ToBase64Transform.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.ToBase64Transform.Kind do
