...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.NetworkInformation.IPAddressInformation is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.NetworkInformation.IPAddressInformation";
   ...
   function Address
   (
      this : in out IPAddressInformation.Kind
   )
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsDnsEligible");
      p_RetVal      : aliased VARIANT;
