...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Linq.Expressions.ExpressionVisitor is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Linq.Expressions.ExpressionVisitor";
   ...
   function Visit
   (
      this : in out ExpressionVisitor.Kind;
      node : NetFrameworkBase.System.Linq.Expressions.Expression.Kind_Ptr
   )
   return NetFrameworkBase.System.Linq.Expressions.Expression.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("Visit");
