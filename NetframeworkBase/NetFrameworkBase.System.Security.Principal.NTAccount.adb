...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Principal.NTAccount is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Principal.NTAccount";
   ...
   return NetFrameworkBase.System.Security.Principal.NTAccount.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Principal.NTAccount.Kind_Ptr := new NetFrameworkBase.System.Security.Principal.NTAccount.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(domainName);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(accountName);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
