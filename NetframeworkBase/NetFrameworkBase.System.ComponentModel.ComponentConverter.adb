...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.ComponentConverter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.ComponentConverter";
   ...
   (
      this : in out ComponentConverter.Kind;
   ...
   return NetFrameworkBase.System.ComponentModel.ComponentConverter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.ComponentConverter.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.ComponentConverter.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
