...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.Eventing.Reader.EventLogPropertySelector is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.Eventing.Reader.EventLogPropertySelector";
   ...
   procedure Dispose
   (
      this : in out EventLogPropertySelector.Kind
   ) is
      Hr            : HResult := 0;
