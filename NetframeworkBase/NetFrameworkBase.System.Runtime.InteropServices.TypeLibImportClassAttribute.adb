...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.InteropServices.TypeLibImportClassAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.InteropServices.TypeLibImportClassAttribute";
   ...
   function Value
   (
      this : in out TypeLibImportClassAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Runtime.InteropServices.TypeLibImportClassAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.InteropServices.TypeLibImportClassAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.InteropServices.TypeLibImportClassAttribute.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (importClass.m_Kind);
