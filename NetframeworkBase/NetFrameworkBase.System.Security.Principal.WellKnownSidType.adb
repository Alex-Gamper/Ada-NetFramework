...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Principal.WellKnownSidType is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Principal.WellKnownSidType";
