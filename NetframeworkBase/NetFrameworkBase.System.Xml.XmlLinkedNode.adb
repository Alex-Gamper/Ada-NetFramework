...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.XmlLinkedNode is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.XmlLinkedNode";
   ...
   (
      this : in out XmlLinkedNode.Kind
   )
