...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Drawing.Imaging.FrameDimension is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Drawing.Imaging.FrameDimension";
   ...
   function Guid
   (
      this : in out FrameDimension.Kind
   )
   ...
   function Time
   return NetFrameworkBase.System.Drawing.Imaging.FrameDimension.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Time");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Drawing.Imaging.FrameDimension.Kind_Ptr := new NetFrameworkBase.System.Drawing.Imaging.FrameDimension.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
   ...
   return NetFrameworkBase.System.Drawing.Imaging.FrameDimension.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Resolution");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Drawing.Imaging.FrameDimension.Kind_Ptr := new NetFrameworkBase.System.Drawing.Imaging.FrameDimension.Kind;
   begin
   ...
   return NetFrameworkBase.System.Drawing.Imaging.FrameDimension.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Page");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Drawing.Imaging.FrameDimension.Kind_Ptr := new NetFrameworkBase.System.Drawing.Imaging.FrameDimension.Kind;
   begin
   ...
   return NetFrameworkBase.System.Drawing.Imaging.FrameDimension.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Drawing.Imaging.FrameDimension.Kind_Ptr := new NetFrameworkBase.System.Drawing.Imaging.FrameDimension.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
