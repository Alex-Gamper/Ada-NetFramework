...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ScrollProperties is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ScrollProperties";
   ...
   function Enabled
   (
      this : in out ScrollProperties.Kind
   )
