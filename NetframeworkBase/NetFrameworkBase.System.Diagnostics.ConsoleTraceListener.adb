...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.ConsoleTraceListener is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.ConsoleTraceListener";
   ...
   procedure Close
   (
      this : in out ConsoleTraceListener.Kind
   ) is
      Hr            : HResult := 0;
   ...
   function Constructor return NetFrameworkBase.System.Diagnostics.ConsoleTraceListener.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.ConsoleTraceListener.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.ConsoleTraceListener.Kind do
   ...
   return NetFrameworkBase.System.Diagnostics.ConsoleTraceListener.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.ConsoleTraceListener.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.ConsoleTraceListener.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(useErrorStream);
