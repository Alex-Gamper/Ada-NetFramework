...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.Eventing.EventDescriptor is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.Eventing.EventDescriptor";
   ...
   return NetFrameworkBase.System.Diagnostics.Eventing.EventDescriptor.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.Eventing.EventDescriptor.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.Eventing.EventDescriptor.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 4;
         p_Value := To_Variant(opcode);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 5;
         p_Value := To_Variant(task_x);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 6;
