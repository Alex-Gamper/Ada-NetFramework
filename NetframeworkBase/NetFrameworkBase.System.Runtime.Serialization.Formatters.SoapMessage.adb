...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Serialization.Formatters.SoapMessage is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Serialization.Formatters.SoapMessage";
   ...
   function ParamNames
   (
      this : in out SoapMessage.Kind
   )
   return NetFrameworkBase.BSTR_Array is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ParamNames");
   ...
   return NetFrameworkBase.System.Object.Kind_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ParamValues");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Type_x.Kind_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ParamTypes");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Runtime.Remoting.Messaging.Header.Kind_Array is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      function GetArray (sa : access NetFrameworkWin32.SAFEARRAY) return NetFrameworkBase.System.Runtime.Remoting.Messaging.Header.Kind_Array is
         Hr     : NetFrameworkWin32.HRESULT := 0;
         LBound : aliased NetFrameworkWin32.LONG := 0;
         UBound : aliased NetFrameworkWin32.LONG := 0;
         Index  : aliased NetFrameworkWin32.LONG := 0;
      ...
      begin
         ...
         Index := UBound - LBound + 1;
         declare
            RetVal : NetFrameworkBase.System.Runtime.Remoting.Messaging.Header.Kind_Array(1..integer(Index));
            Value  : NetFrameworkBase.System.Runtime.Remoting.Messaging.Header.Kind_Ptr;
            Var    : aliased VARIANT;
            Item   : PVOID;
            function Convert is new Ada.Unchecked_Conversion (NetFrameworkWin32.Address, PVOID);
            function Convert is new Ada.Unchecked_Conversion (VOID, PVOID);
         begin
            ...
            for I in RetVal'range loop
               ...
               Var.field_1.field_1.vt := VT_UNKNOWN'Enum_rep;
               Var.field_1.field_1.field_1.byref := Item;
               Value := new NetFrameworkBase.System.Runtime.Remoting.Messaging.Header.Kind;
               SetObject (Value.m_Kind, Var);
               RetVal(integer(I)) := Value;
               Index := Index + 1;
            end loop;
   ...
   function Constructor return NetFrameworkBase.System.Runtime.Serialization.Formatters.SoapMessage.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Serialization.Formatters.SoapMessage.Kind_Ptr := new NetFrameworkBase.System.Runtime.Serialization.Formatters.SoapMessage.Kind do
