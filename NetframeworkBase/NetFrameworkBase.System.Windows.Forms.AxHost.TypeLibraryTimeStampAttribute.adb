...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.AxHost.TypeLibraryTimeStampAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.AxHost+TypeLibraryTimeStampAttribute";
   ...
   function Value
   (
      this : in out TypeLibraryTimeStampAttribute.Kind
   )
   ...
   (
      timestamp : NetFrameworkBase.BSTR
   )
   return NetFrameworkBase.System.Windows.Forms.AxHost.TypeLibraryTimeStampAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.AxHost.TypeLibraryTimeStampAttribute.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.AxHost.TypeLibraryTimeStampAttribute.Kind do
      declare
