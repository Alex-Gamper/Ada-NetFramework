...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.Contracts.ContractVerificationAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.Contracts.ContractVerificationAttribute";
   ...
   function Value
   (
      this : in out ContractVerificationAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Diagnostics.Contracts.ContractVerificationAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.Contracts.ContractVerificationAttribute.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.Contracts.ContractVerificationAttribute.Kind do
      declare
