...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.ConfigurationPropertyAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.ConfigurationPropertyAttribute";
   ...
   function Name
   (
      this : in out ConfigurationPropertyAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Configuration.ConfigurationPropertyOptions.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Configuration.ConfigurationPropertyOptions.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Configuration.ConfigurationPropertyOptions.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   (
      this : in out ConfigurationPropertyAttribute.Kind;
      value : NetFrameworkBase.System.Configuration.ConfigurationPropertyOptions.Kind
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_valueEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Configuration.ConfigurationPropertyOptions.Instance;
   ...
   return NetFrameworkBase.System.Configuration.ConfigurationPropertyAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.ConfigurationPropertyAttribute.Kind_Ptr := new NetFrameworkBase.System.Configuration.ConfigurationPropertyAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
