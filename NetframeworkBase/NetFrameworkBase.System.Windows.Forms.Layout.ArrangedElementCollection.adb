...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.Layout.ArrangedElementCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.Layout.ArrangedElementCollection";
   ...
   function Equals
   (
      this : in out ArrangedElementCollection.Kind;
