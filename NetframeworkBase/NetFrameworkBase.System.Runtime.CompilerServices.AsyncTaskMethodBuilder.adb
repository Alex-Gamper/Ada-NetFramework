...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.CompilerServices.AsyncTaskMethodBuilder is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.CompilerServices.AsyncTaskMethodBuilder";
   ...
   function Create
   return NetFrameworkBase.System.Runtime.CompilerServices.AsyncTaskMethodBuilder.Kind_Ptr is
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Runtime.CompilerServices.AsyncTaskMethodBuilder.Kind_Ptr := new NetFrameworkBase.System.Runtime.CompilerServices.AsyncTaskMethodBuilder.Kind;
   begin
   ...
   procedure SetStateMachine
   (
      this : in out AsyncTaskMethodBuilder.Kind;
      stateMachine : NetFrameworkBase.System.Runtime.CompilerServices.IAsyncStateMachine.Kind_Ptr
   ) is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SetStateMachine");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      ...
      p_Value.field_1.field_1.field_1.punkVal := stateMachine;
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SetResult");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SetException");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
