...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Remoting.ActivatedServiceTypeEntry is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Remoting.ActivatedServiceTypeEntry";
   ...
   (
      this : in out ActivatedServiceTypeEntry.Kind
   )
   ...
   return NetFrameworkBase.System.Runtime.Remoting.ActivatedServiceTypeEntry.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Remoting.ActivatedServiceTypeEntry.Kind_Ptr := new NetFrameworkBase.System.Runtime.Remoting.ActivatedServiceTypeEntry.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
