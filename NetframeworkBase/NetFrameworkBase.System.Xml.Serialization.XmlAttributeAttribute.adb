...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Serialization.XmlAttributeAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Serialization.XmlAttributeAttribute";
   ...
   function Type_x
   (
      this : in out XmlAttributeAttribute.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AttributeName");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.Xml.Serialization.XmlAttributeAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Serialization.XmlAttributeAttribute.Kind_Ptr := new NetFrameworkBase.System.Xml.Serialization.XmlAttributeAttribute.Kind do
