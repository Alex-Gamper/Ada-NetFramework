...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.InitializationEventAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.InitializationEventAttribute";
   ...
   function EventName
   (
      this : in out InitializationEventAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.ComponentModel.InitializationEventAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.InitializationEventAttribute.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.InitializationEventAttribute.Kind do
      declare
