...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.Tracing.EventDataAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.Tracing.EventDataAttribute";
   ...
   function Name
   (
      this : in out EventDataAttribute.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Diagnostics.Tracing.EventDataAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.Tracing.EventDataAttribute.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.Tracing.EventDataAttribute.Kind do
