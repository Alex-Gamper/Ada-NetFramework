...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Drawing.Text.FontCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Drawing.Text.FontCollection";
   ...
   procedure Dispose
   (
      this : in out FontCollection.Kind
   ) is
      Hr            : HResult := 0;
