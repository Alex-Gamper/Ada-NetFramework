...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Serialization.SoapSchemaExporter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Serialization.SoapSchemaExporter";
   ...
   (
      this : in out SoapSchemaExporter.Kind;
   ...
   return NetFrameworkBase.System.Xml.Serialization.SoapSchemaExporter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Serialization.SoapSchemaExporter.Kind_Ptr := new NetFrameworkBase.System.Xml.Serialization.SoapSchemaExporter.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
