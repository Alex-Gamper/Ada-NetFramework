...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.EnvironmentPermissionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.EnvironmentPermissionAttribute";
   ...
   return NetFrameworkBase.System.Security.Permissions.EnvironmentPermissionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.EnvironmentPermissionAttribute.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.EnvironmentPermissionAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
