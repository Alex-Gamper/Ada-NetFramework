...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Xsl.Runtime.FollowingSiblingIterator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Xsl.Runtime.FollowingSiblingIterator";
   ...
   procedure Create
   (
      this : in out FollowingSiblingIterator.Kind;
