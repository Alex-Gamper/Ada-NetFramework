...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.DataReceivedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.DataReceivedEventArgs";
   ...
   function Data
   (
      this : in out DataReceivedEventArgs.Kind
   )
