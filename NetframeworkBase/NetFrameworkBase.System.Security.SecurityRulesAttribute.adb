...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.SecurityRulesAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.SecurityRulesAttribute";
   ...
   function SkipVerificationInFullTrust
   (
      this : in out SecurityRulesAttribute.Kind
   )
   return NetFrameworkBase.Boolean is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SkipVerificationInFullTrust");
   ...
   procedure SkipVerificationInFullTrust
   (
      this : in out SecurityRulesAttribute.Kind;
   ...
   return NetFrameworkBase.System.Security.SecurityRuleSet.Kind is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RuleSet");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Security.SecurityRulesAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.SecurityRulesAttribute.Kind_Ptr := new NetFrameworkBase.System.Security.SecurityRulesAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_ruleSetEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.SecurityRuleSet.Instance;
         p_ruleSetEnum : aliased VARIANT := To_Variant (CreateEnum (p_ruleSetEnumType, ruleSet'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := p_ruleSetEnum;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
