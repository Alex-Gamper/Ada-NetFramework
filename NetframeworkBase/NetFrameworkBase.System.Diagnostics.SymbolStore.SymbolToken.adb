...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.SymbolStore.SymbolToken is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.SymbolStore.SymbolToken";
   ...
   (
      this : in out SymbolToken.Kind;
      obj : NetFrameworkBase.System.Diagnostics.SymbolStore.SymbolToken.Kind_Ptr
   )
   return NetFrameworkBase.Boolean is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   (
      a : NetFrameworkBase.System.Diagnostics.SymbolStore.SymbolToken.Kind_Ptr; 
      b : NetFrameworkBase.System.Diagnostics.SymbolStore.SymbolToken.Kind_Ptr
   )
   return NetFrameworkBase.Boolean is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   return NetFrameworkBase.System.Diagnostics.SymbolStore.SymbolToken.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.SymbolStore.SymbolToken.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.SymbolStore.SymbolToken.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
