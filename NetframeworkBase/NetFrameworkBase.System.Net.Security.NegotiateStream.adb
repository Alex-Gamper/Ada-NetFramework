...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Security.NegotiateStream is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Security.NegotiateStream";
   ...
   (
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_requiredProtectionLevelEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Net.Security.ProtectionLevel.Instance;
      p_requiredProtectionLevelEnum : aliased VARIANT := To_Variant (CreateEnum (p_requiredProtectionLevelEnumType, requiredProtectionLevel'Enum_rep));
      p_allowedImpersonationLevelEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Principal.TokenImpersonationLevel.Instance;
      p_allowedImpersonationLevelEnum : aliased VARIANT := To_Variant (CreateEnum (p_allowedImpersonationLevelEnumType, allowedImpersonationLevel'Enum_rep));
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
      ...
      ------------------------------------------------------------
      p_Index(1) := 2;
      p_Value := p_requiredProtectionLevelEnum;
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 3;
      p_Value := p_allowedImpersonationLevelEnum;
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (policy.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   (
      ...
      p_requiredProtectionLevelEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Net.Security.ProtectionLevel.Instance;
      p_requiredProtectionLevelEnum : aliased VARIANT := To_Variant (CreateEnum (p_requiredProtectionLevelEnumType, requiredProtectionLevel'Enum_rep));
      p_requiredImpersonationLevelEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Principal.TokenImpersonationLevel.Instance;
      p_requiredImpersonationLevelEnum : aliased VARIANT := To_Variant (CreateEnum (p_requiredImpersonationLevelEnumType, requiredImpersonationLevel'Enum_rep));
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
      ...
      ------------------------------------------------------------
      p_Index(1) := 2;
      p_Value := p_requiredImpersonationLevelEnum;
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.System.Security.Principal.IIdentity.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RemoteIdentity");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Net.Security.NegotiateStream.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Security.NegotiateStream.Kind_Ptr := new NetFrameworkBase.System.Net.Security.NegotiateStream.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
