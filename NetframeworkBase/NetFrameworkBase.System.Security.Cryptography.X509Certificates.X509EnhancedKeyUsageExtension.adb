...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509EnhancedKeyUsageExtension is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.X509Certificates.X509EnhancedKeyUsageExtension";
   ...
   function EnhancedKeyUsages
   (
      this : in out X509EnhancedKeyUsageExtension.Kind
   )
   return NetFrameworkBase.System.Security.Cryptography.OidCollection.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EnhancedKeyUsages");
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509EnhancedKeyUsageExtension.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509EnhancedKeyUsageExtension.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509EnhancedKeyUsageExtension.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509EnhancedKeyUsageExtension.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509EnhancedKeyUsageExtension.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509EnhancedKeyUsageExtension.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (enhancedKeyUsages.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (encodedEnhancedKeyUsages.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(critical);
