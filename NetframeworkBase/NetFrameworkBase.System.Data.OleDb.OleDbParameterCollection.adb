...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.OleDb.OleDbParameterCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.OleDb.OleDbParameterCollection";
   ...
   function Contains
   (
      this : in out OleDbParameterCollection.Kind;
   ...
   (
      this : in out OleDbParameterCollection.Kind;
      index : NetFrameworkBase.Int32; 
      value : NetFrameworkBase.System.Data.OleDb.OleDbParameter.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   (
      this : in out OleDbParameterCollection.Kind;
      parameterName : NetFrameworkBase.BSTR; 
      oleDbType : NetFrameworkBase.System.Data.OleDb.OleDbType.Kind
   )
   return NetFrameworkBase.System.Data.OleDb.OleDbParameter.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_oleDbTypeEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Data.OleDb.OleDbType.Instance;
      p_oleDbTypeEnum : aliased VARIANT := To_Variant (CreateEnum (p_oleDbTypeEnumType, oleDbType'Enum_rep));
      RetVal        : NetFrameworkBase.System.Data.OleDb.OleDbParameter.Kind_Ptr := new NetFrameworkBase.System.Data.OleDb.OleDbParameter.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
   ...
   (
      this : in out OleDbParameterCollection.Kind;
      values : NetFrameworkBase.System.Data.OleDb.OleDbParameter.Kind_Array
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Data.OleDb.OleDbParameter[]
   ...
   (
      this : in out OleDbParameterCollection.Kind;
      array_x : NetFrameworkBase.System.Data.OleDb.OleDbParameter.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
