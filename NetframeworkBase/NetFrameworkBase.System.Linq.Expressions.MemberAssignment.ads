...
--------------------------------------------------------------------------------
package NetFrameworkBase.System.Linq.Expressions.MemberAssignment is
   
   type Kind is new NetFrameworkBase.System.Linq.Expressions.MemberBinding.Kind with null record;
