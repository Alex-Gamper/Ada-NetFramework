...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.XmlImplementation is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.XmlImplementation";
   ...
   (
      this : in out XmlImplementation.Kind
   )
   return NetFrameworkBase.System.Xml.XmlDocument.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CreateDocument");
   ...
   (
      this : in out XmlImplementation.Kind;
      strFeature : NetFrameworkBase.BSTR; 
      strVersion : NetFrameworkBase.BSTR
   )
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("HasFeature");
      p_RetVal      : aliased VARIANT;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := To_Variant(strFeature);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := To_Variant(strVersion);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   function Constructor return NetFrameworkBase.System.Xml.XmlImplementation.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.XmlImplementation.Kind_Ptr := new NetFrameworkBase.System.Xml.XmlImplementation.Kind do
