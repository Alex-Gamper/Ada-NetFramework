...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.GridTablesFactory is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.GridTablesFactory";
   ...
   (
      gridTable : NetFrameworkBase.System.Windows.Forms.DataGridTableStyle.Kind_Ptr; 
      dataSource : NetFrameworkBase.System.Object.Kind_Ptr; 
      dataMember : NetFrameworkBase.BSTR; 
      bindingManager : NetFrameworkBase.System.Windows.Forms.BindingContext.Kind_Ptr
   )
   return NetFrameworkBase.System.Windows.Forms.DataGridTableStyle.Kind_Array is
      ...
      p_MethodName  : BSTR := To_BSTR("CreateGridTables");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   
      function GetArray (sa : access NetFrameworkWin32.SAFEARRAY) return NetFrameworkBase.System.Windows.Forms.DataGridTableStyle.Kind_Array is
      ...
      begin
         ...
         declare
            RetVal : NetFrameworkBase.System.Windows.Forms.DataGridTableStyle.Kind_Array(1..integer(Index));
            Value  : NetFrameworkBase.System.Windows.Forms.DataGridTableStyle.Kind_Ptr;
            Var    : aliased VARIANT;
            Item   : PVOID;
         ...
         begin
            ...
            for I in RetVal'range loop
               ...
               Value := new NetFrameworkBase.System.Windows.Forms.DataGridTableStyle.Kind;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (gridTable.m_Kind);
      ...
      ------------------------------------------------------------
      p_Index(1) := 3;
      p_Value := GetObject (bindingManager.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
