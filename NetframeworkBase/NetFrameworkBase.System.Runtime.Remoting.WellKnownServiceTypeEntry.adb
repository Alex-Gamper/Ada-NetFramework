...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Remoting.WellKnownServiceTypeEntry is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Remoting.WellKnownServiceTypeEntry";
   ...
   function ObjectUri
   (
      this : in out WellKnownServiceTypeEntry.Kind
   )
   return NetFrameworkBase.BSTR is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ObjectUri");
   ...
   return NetFrameworkBase.System.Runtime.Remoting.WellKnownObjectMode.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Runtime.Remoting.WellKnownObjectMode.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      RetVal        : NetFrameworkBase.System.Runtime.Remoting.WellKnownObjectMode.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   return NetFrameworkBase.System.Runtime.Remoting.Contexts.IContextAttribute.Kind_Array is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ContextAttributes");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   
      function GetArray (sa : access NetFrameworkWin32.SAFEARRAY) return NetFrameworkBase.System.Runtime.Remoting.Contexts.IContextAttribute.Kind_Array is
      ...
      begin
         ...
         declare
            RetVal : NetFrameworkBase.System.Runtime.Remoting.Contexts.IContextAttribute.Kind_Array(1..integer(Index));
            Value  : aliased NetFrameworkBase.System.Runtime.Remoting.Contexts.IContextAttribute.Kind_Ptr;
   ...
   procedure ContextAttributes
   (
      this : in out WellKnownServiceTypeEntry.Kind;
      value : NetFrameworkBase.System.Runtime.Remoting.Contexts.IContextAttribute.Kind_Array
   ) is
   ...
   --         p0_Tmp := GetObject (value(i).m_Kind); -- fixme [interface]
      ...
      -- fixme parameter type := [array] System.Runtime.Remoting.Contexts.IContextAttribute[]
   ...
   return NetFrameworkBase.System.Runtime.Remoting.WellKnownServiceTypeEntry.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Remoting.WellKnownServiceTypeEntry.Kind_Ptr := new NetFrameworkBase.System.Runtime.Remoting.WellKnownServiceTypeEntry.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
