...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Threading.CancellationTokenRegistration is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Threading.CancellationTokenRegistration";
   ...
   procedure Dispose
   (
      this : in out CancellationTokenRegistration.Kind
   ) is
      Hr            : HResult := 0;
   ...
   (
      this : in out CancellationTokenRegistration.Kind;
      other : NetFrameworkBase.System.Threading.CancellationTokenRegistration.Kind_Ptr
   )
   return NetFrameworkBase.Boolean is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
