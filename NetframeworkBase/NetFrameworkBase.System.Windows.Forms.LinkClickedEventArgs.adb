...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.LinkClickedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.LinkClickedEventArgs";
   ...
   function LinkText
   (
      this : in out LinkClickedEventArgs.Kind
   )
   return NetFrameworkBase.BSTR is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("LinkText");
   ...
   return NetFrameworkBase.System.Windows.Forms.LinkClickedEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.LinkClickedEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.LinkClickedEventArgs.Kind do
      declare
