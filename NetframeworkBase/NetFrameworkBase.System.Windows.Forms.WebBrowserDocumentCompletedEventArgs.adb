...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.WebBrowserDocumentCompletedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.WebBrowserDocumentCompletedEventArgs";
   ...
   function Url
   (
      this : in out WebBrowserDocumentCompletedEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.WebBrowserDocumentCompletedEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.WebBrowserDocumentCompletedEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.WebBrowserDocumentCompletedEventArgs.Kind do
      declare
