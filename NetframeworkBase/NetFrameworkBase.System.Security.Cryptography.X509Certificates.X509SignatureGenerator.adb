...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509SignatureGenerator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.X509Certificates.X509SignatureGenerator";
   ...
   function PublicKey
   (
      this : in out X509SignatureGenerator.Kind
   )
   ...
   function CreateForECDsa
   (
      key : NetFrameworkBase.System.Security.Cryptography.ECDsa.Kind_Ptr
   )
   return NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509SignatureGenerator.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CreateForECDsa");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509SignatureGenerator.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509SignatureGenerator.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function CreateForRSA
   (
      key : NetFrameworkBase.System.Security.Cryptography.RSA.Kind_Ptr; 
      signaturePadding : NetFrameworkBase.System.Security.Cryptography.RSASignaturePadding.Kind_Ptr
   )
   return NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509SignatureGenerator.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CreateForRSA");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509SignatureGenerator.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509SignatureGenerator.Kind;
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := GetObject (signaturePadding.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   function GetSignatureAlgorithmIdentifier
   (
      this : in out X509SignatureGenerator.Kind;
   ...
   return NetFrameworkBase.Byte_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetSignatureAlgorithmIdentifier");
      p_RetVal      : aliased VARIANT;
