...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.Common.DataTableMapping is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.Common.DataTableMapping";
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_MethodName  : BSTR := To_BSTR("DataSetTable");
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SourceTable");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.Data.Common.DataColumnMappingCollection.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Data.Common.DataColumnMappingCollection.Kind_Ptr := new NetFrameworkBase.System.Data.Common.DataColumnMappingCollection.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   return NetFrameworkBase.System.Data.DataColumn.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetDataColumn");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_mappingActionEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Data.MissingMappingAction.Instance;
      p_mappingActionEnum : aliased VARIANT := To_Variant (CreateEnum (p_mappingActionEnumType, mappingAction'Enum_rep));
      p_schemaActionEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Data.MissingSchemaAction.Instance;
      p_schemaActionEnum : aliased VARIANT := To_Variant (CreateEnum (p_schemaActionEnumType, schemaAction'Enum_rep));
      RetVal        : NetFrameworkBase.System.Data.DataColumn.Kind_Ptr := new NetFrameworkBase.System.Data.DataColumn.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
      ...
      ------------------------------------------------------------
      p_Index(1) := 3;
      p_Value := p_mappingActionEnum;
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 4;
      p_Value := p_schemaActionEnum;
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.System.Data.Common.DataColumnMapping.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetColumnMappingBySchemaAction");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_mappingActionEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Data.MissingMappingAction.Instance;
      p_mappingActionEnum : aliased VARIANT := To_Variant (CreateEnum (p_mappingActionEnumType, mappingAction'Enum_rep));
      RetVal        : NetFrameworkBase.System.Data.Common.DataColumnMapping.Kind_Ptr := new NetFrameworkBase.System.Data.Common.DataColumnMapping.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   return NetFrameworkBase.System.Data.DataTable.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetDataTableBySchemaAction");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_schemaActionEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Data.MissingSchemaAction.Instance;
      p_schemaActionEnum : aliased VARIANT := To_Variant (CreateEnum (p_schemaActionEnumType, schemaAction'Enum_rep));
   ...
   function Constructor return NetFrameworkBase.System.Data.Common.DataTableMapping.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Data.Common.DataTableMapping.Kind_Ptr := new NetFrameworkBase.System.Data.Common.DataTableMapping.Kind do
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(sourceTable);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(dataSetTable);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      ...
      declare
         ...
         p2_Bounds     : aliased SAFEARRAYBOUND := (columnMappings'Length , 0);
      ...
      begin
         ...
         begin
            ...
            for i in columnMappings'range loop
               p2_Index(1) := Interfaces.C.long(i) - 1;
               p2_Tmp := GetObject (columnMappings(i).m_Kind);
         ...
         -- fixme parameter type := [array] System.Data.Common.DataColumnMapping[]
