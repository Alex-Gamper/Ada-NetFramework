...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.NetworkCredential is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.NetworkCredential";
   ...
   return NetFrameworkBase.System.Security.SecureString.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SecurePassword");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   function Constructor return NetFrameworkBase.System.Net.NetworkCredential.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.NetworkCredential.Kind_Ptr := new NetFrameworkBase.System.Net.NetworkCredential.Kind do
