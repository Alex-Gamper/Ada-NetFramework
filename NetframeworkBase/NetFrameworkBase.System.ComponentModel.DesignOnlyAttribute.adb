...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.DesignOnlyAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.DesignOnlyAttribute";
   ...
   function IsDesignOnly
   (
      this : in out DesignOnlyAttribute.Kind
   )
   return NetFrameworkBase.Boolean is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsDesignOnly");
   ...
   return NetFrameworkBase.System.ComponentModel.DesignOnlyAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.DesignOnlyAttribute.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.DesignOnlyAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(isDesignOnly);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
