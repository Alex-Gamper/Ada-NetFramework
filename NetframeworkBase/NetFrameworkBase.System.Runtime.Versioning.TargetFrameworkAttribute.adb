...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Versioning.TargetFrameworkAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Versioning.TargetFrameworkAttribute";
   ...
   (
      this : in out TargetFrameworkAttribute.Kind
   )
   return NetFrameworkBase.BSTR is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("FrameworkName");
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("FrameworkDisplayName");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   procedure FrameworkDisplayName
   (
      this : in out TargetFrameworkAttribute.Kind;
   ...
   return NetFrameworkBase.System.Runtime.Versioning.TargetFrameworkAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Versioning.TargetFrameworkAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.Versioning.TargetFrameworkAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
