...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Collections.Generic.KeyNotFoundException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Collections.Generic.KeyNotFoundException";
   ...
   function Constructor return NetFrameworkBase.System.Collections.Generic.KeyNotFoundException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Collections.Generic.KeyNotFoundException.Kind_Ptr := new NetFrameworkBase.System.Collections.Generic.KeyNotFoundException.Kind do
   ...
   return NetFrameworkBase.System.Collections.Generic.KeyNotFoundException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Collections.Generic.KeyNotFoundException.Kind_Ptr := new NetFrameworkBase.System.Collections.Generic.KeyNotFoundException.Kind do
      declare
