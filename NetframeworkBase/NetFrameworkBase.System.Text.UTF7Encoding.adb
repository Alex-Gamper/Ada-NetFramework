...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Text.UTF7Encoding is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Text.UTF7Encoding";
   ...
   function Constructor return NetFrameworkBase.System.Text.UTF7Encoding.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Text.UTF7Encoding.Kind_Ptr := new NetFrameworkBase.System.Text.UTF7Encoding.Kind do
   ...
   return NetFrameworkBase.System.Text.UTF7Encoding.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Text.UTF7Encoding.Kind_Ptr := new NetFrameworkBase.System.Text.UTF7Encoding.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(allowOptionals);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
