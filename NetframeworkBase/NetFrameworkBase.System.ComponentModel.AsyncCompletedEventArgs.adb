...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.AsyncCompletedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.AsyncCompletedEventArgs";
   ...
   function Cancelled
   (
      this : in out AsyncCompletedEventArgs.Kind
   )
   return NetFrameworkBase.Boolean is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Cancelled");
   ...
   return NetFrameworkBase.System.Object.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("UserState");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   function Constructor return NetFrameworkBase.System.ComponentModel.AsyncCompletedEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.AsyncCompletedEventArgs.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.AsyncCompletedEventArgs.Kind do
   ...
   return NetFrameworkBase.System.ComponentModel.AsyncCompletedEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.AsyncCompletedEventArgs.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.AsyncCompletedEventArgs.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (error.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(cancelled);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 2;
