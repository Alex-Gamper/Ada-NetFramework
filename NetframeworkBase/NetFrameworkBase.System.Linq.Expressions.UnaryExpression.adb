...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Linq.Expressions.UnaryExpression is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Linq.Expressions.UnaryExpression";
   ...
   function Type_x
   (
      this : in out UnaryExpression.Kind
   )
   ...
   return NetFrameworkBase.System.Linq.Expressions.Expression.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Operand");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
