...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.UInt32 is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.UInt32";
   ...
   begin
      ...
      -- set out parameter [result : System.UInt32]
      p_Index(1) := 1;
   ...
   function Constructor return NetFrameworkBase.System.UInt32.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.UInt32.Kind_Ptr := new NetFrameworkBase.System.UInt32.Kind do
