...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Timers.Timer is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Timers.Timer";
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AutoReset");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.Double is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Interval");
      p_RetVal      : aliased VARIANT;
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("add_Elapsed");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("remove_Elapsed");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Timers.Timer.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Timers.Timer.Kind_Ptr := new NetFrameworkBase.System.Timers.Timer.Kind do
   ...
   return NetFrameworkBase.System.Timers.Timer.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Timers.Timer.Kind_Ptr := new NetFrameworkBase.System.Timers.Timer.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
