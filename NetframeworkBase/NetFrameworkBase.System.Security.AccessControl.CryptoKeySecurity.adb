...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.AccessControl.CryptoKeySecurity is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.AccessControl.CryptoKeySecurity";
   ...
   (
      this : in out CryptoKeySecurity.Kind;
   ...
   (
      this : in out CryptoKeySecurity.Kind;
      rule : NetFrameworkBase.System.Security.AccessControl.CryptoKeyAccessRule.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   (
      this : in out CryptoKeySecurity.Kind;
      rule : NetFrameworkBase.System.Security.AccessControl.CryptoKeyAuditRule.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   function Constructor return NetFrameworkBase.System.Security.AccessControl.CryptoKeySecurity.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.AccessControl.CryptoKeySecurity.Kind_Ptr := new NetFrameworkBase.System.Security.AccessControl.CryptoKeySecurity.Kind do
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (securityDescriptor.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
