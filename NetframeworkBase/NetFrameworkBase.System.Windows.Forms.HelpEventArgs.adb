...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.HelpEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.HelpEventArgs";
   ...
   return NetFrameworkBase.System.Windows.Forms.HelpEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.HelpEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.HelpEventArgs.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (mousePos.m_Kind); -- Parameter Type = ValueType
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
