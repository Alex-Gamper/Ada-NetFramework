...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.RuntimeTypeHandle is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.RuntimeTypeHandle";
   ...
   return NetFrameworkBase.System.ModuleHandle.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetModuleHandle");
      p_RetVal      : aliased VARIANT;
