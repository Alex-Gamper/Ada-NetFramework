...
--------------------------------------------------------------------------------
package NetFrameworkBase.System.Runtime.InteropServices.ComTypes.IEnumString is
   ...
   type Kind_Array_Ptr is access all Kind_Array;
      ...
      function Next
      (
         this : in out IEnumString.Kind;
         celt : NetFrameworkBase.Int32;
         rgelt : NetFrameworkBase.BSTR_Array;
   ...
   private
      ...
      This_TypeName     : constant Standard.Wide_String := "System.Runtime.InteropServices.ComTypes.IEnumString";
