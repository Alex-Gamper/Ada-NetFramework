...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.Design.Serialization.DefaultSerializationProviderAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.Design.Serialization.DefaultSerializationProviderAttribute";
   ...
   (
      this : in out DefaultSerializationProviderAttribute.Kind
   )
   return NetFrameworkBase.BSTR is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ProviderTypeName");
   ...
   return NetFrameworkBase.System.ComponentModel.Design.Serialization.DefaultSerializationProviderAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.Design.Serialization.DefaultSerializationProviderAttribute.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.Design.Serialization.DefaultSerializationProviderAttribute.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (providerType.m_Kind);
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(providerTypeName);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
