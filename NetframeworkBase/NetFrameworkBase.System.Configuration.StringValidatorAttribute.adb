...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.StringValidatorAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.StringValidatorAttribute";
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_MethodName  : BSTR := To_BSTR("MinLength");
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("InvalidCharacters");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.Configuration.StringValidatorAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.StringValidatorAttribute.Kind_Ptr := new NetFrameworkBase.System.Configuration.StringValidatorAttribute.Kind do
