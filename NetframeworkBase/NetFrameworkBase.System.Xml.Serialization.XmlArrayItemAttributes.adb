...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Serialization.XmlArrayItemAttributes is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Serialization.XmlArrayItemAttributes";
   ...
   function Item
   (
      this : in out XmlArrayItemAttributes.Kind;
   ...
   return NetFrameworkBase.System.Xml.Serialization.XmlArrayItemAttribute.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Xml.Serialization.XmlArrayItemAttribute.Kind_Ptr := new NetFrameworkBase.System.Xml.Serialization.XmlArrayItemAttribute.Kind;
   begin
   ...
   (
      this : in out XmlArrayItemAttributes.Kind;
      index : NetFrameworkBase.Int32; 
      value : NetFrameworkBase.System.Xml.Serialization.XmlArrayItemAttribute.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   (
      this : in out XmlArrayItemAttributes.Kind;
      attribute : NetFrameworkBase.System.Xml.Serialization.XmlArrayItemAttribute.Kind_Ptr
   )
   ...
   (
      this : in out XmlArrayItemAttributes.Kind;
      array_x : NetFrameworkBase.System.Xml.Serialization.XmlArrayItemAttribute.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Xml.Serialization.XmlArrayItemAttribute[]
   ...
   function Constructor return NetFrameworkBase.System.Xml.Serialization.XmlArrayItemAttributes.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Serialization.XmlArrayItemAttributes.Kind_Ptr := new NetFrameworkBase.System.Xml.Serialization.XmlArrayItemAttributes.Kind do
