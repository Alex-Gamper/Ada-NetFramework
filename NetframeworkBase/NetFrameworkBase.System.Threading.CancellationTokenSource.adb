...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Threading.CancellationTokenSource is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Threading.CancellationTokenSource";
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_MethodName  : BSTR := To_BSTR("IsCancellationRequested");
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := To_Variant(throwOnFirstException);
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CancelAfter");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.Threading.CancellationTokenSource.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CreateLinkedTokenSource");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Threading.CancellationTokenSource.Kind_Ptr := new NetFrameworkBase.System.Threading.CancellationTokenSource.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (token1.m_Kind); -- Parameter Type = ValueType
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := GetObject (token2.m_Kind); -- Parameter Type = ValueType
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.System.Threading.CancellationTokenSource.Kind_Ptr is
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (tokens'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in tokens'range loop
            ...
            p0_Tmp := GetObject (tokens(i).m_Kind);
      ...
      -- fixme parameter type := [array] System.Threading.CancellationToken[]
   ...
   function Constructor return NetFrameworkBase.System.Threading.CancellationTokenSource.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Threading.CancellationTokenSource.Kind_Ptr := new NetFrameworkBase.System.Threading.CancellationTokenSource.Kind do
