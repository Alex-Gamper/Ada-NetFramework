...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.SqlClient.SqlErrorCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.SqlClient.SqlErrorCollection";
   ...
   procedure CopyTo
   (
      this : in out SqlErrorCollection.Kind;
   ...
   (
      this : in out SqlErrorCollection.Kind;
      array_x : NetFrameworkBase.System.Data.SqlClient.SqlError.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Data.SqlClient.SqlError[]
   ...
   return NetFrameworkBase.System.Data.SqlClient.SqlError.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Data.SqlClient.SqlError.Kind_Ptr := new NetFrameworkBase.System.Data.SqlClient.SqlError.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
