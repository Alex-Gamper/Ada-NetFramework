...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Authentication.ExtendedProtection.Configuration.ServiceNameElement is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Authentication.ExtendedProtection.Configuration.ServiceNameElement";
   ...
   function Name
   (
      this : in out ServiceNameElement.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Security.Authentication.ExtendedProtection.Configuration.ServiceNameElement.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Authentication.ExtendedProtection.Configuration.ServiceNameElement.Kind_Ptr := new NetFrameworkBase.System.Security.Authentication.ExtendedProtection.Configuration.ServiceNameElement.Kind do
