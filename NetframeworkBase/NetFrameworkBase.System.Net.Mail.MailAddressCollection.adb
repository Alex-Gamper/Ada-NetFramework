...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Mail.MailAddressCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Mail.MailAddressCollection";
   ...
   procedure Add
   (
      this : in out MailAddressCollection.Kind;
      addresses : NetFrameworkBase.BSTR
   ) is
   ...
   function Constructor return NetFrameworkBase.System.Net.Mail.MailAddressCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Mail.MailAddressCollection.Kind_Ptr := new NetFrameworkBase.System.Net.Mail.MailAddressCollection.Kind do
