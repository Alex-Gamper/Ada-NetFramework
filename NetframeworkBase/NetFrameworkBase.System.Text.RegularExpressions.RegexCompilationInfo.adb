...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Text.RegularExpressions.RegexCompilationInfo is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Text.RegularExpressions.RegexCompilationInfo";
   ...
   function Pattern
   (
      this : in out RegexCompilationInfo.Kind
   )
   return NetFrameworkBase.BSTR is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Pattern");
   ...
   (
      this : in out RegexCompilationInfo.Kind;
      value : NetFrameworkBase.System.Text.RegularExpressions.RegexOptions.Kind
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_valueEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Text.RegularExpressions.RegexOptions.Instance;
   ...
   return NetFrameworkBase.System.Text.RegularExpressions.RegexCompilationInfo.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Text.RegularExpressions.RegexCompilationInfo.Kind_Ptr := new NetFrameworkBase.System.Text.RegularExpressions.RegexCompilationInfo.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 3;
         p_Value := To_Variant(fullnamespace);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 4;
         p_Value := To_Variant(ispublic);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
