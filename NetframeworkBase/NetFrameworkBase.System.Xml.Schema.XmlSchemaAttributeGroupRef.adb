...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.XmlSchemaAttributeGroupRef is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.XmlSchemaAttributeGroupRef";
   ...
   function RefName
   (
      this : in out XmlSchemaAttributeGroupRef.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Xml.Schema.XmlSchemaAttributeGroupRef.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Schema.XmlSchemaAttributeGroupRef.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaAttributeGroupRef.Kind do
