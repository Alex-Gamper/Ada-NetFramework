...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.MainMenu is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.MainMenu";
   ...
   return NetFrameworkBase.System.Windows.Forms.Form.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetForm");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   function Constructor return NetFrameworkBase.System.Windows.Forms.MainMenu.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.MainMenu.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.MainMenu.Kind do
