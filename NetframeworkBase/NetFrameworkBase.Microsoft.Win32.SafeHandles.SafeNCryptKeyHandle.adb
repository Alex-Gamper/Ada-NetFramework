...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.Microsoft.Win32.SafeHandles.SafeNCryptKeyHandle is
   ...
   This_TypeName     : constant Standard.Wide_String := "Microsoft.Win32.SafeHandles.SafeNCryptKeyHandle";
   ...
   function Constructor return NetFrameworkBase.Microsoft.Win32.SafeHandles.SafeNCryptKeyHandle.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.Microsoft.Win32.SafeHandles.SafeNCryptKeyHandle.Kind_Ptr := new NetFrameworkBase.Microsoft.Win32.SafeHandles.SafeNCryptKeyHandle.Kind do
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := GetObject (parentHandle.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
