...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DataGridViewCellCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DataGridViewCellCollection";
   ...
   function Add
   (
      this : in out DataGridViewCellCollection.Kind;
   ...
   (
      this : in out DataGridViewCellCollection.Kind;
      dataGridViewCells : NetFrameworkBase.System.Windows.Forms.DataGridViewCell.Kind_Array
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (dataGridViewCells'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in dataGridViewCells'range loop
            p0_Index(1) := Interfaces.C.long(i) - 1;
            p0_Tmp := GetObject (dataGridViewCells(i).m_Kind);
      ...
      -- fixme parameter type := [array] System.Windows.Forms.DataGridViewCell[]
   ...
   (
      this : in out DataGridViewCellCollection.Kind;
      cell : NetFrameworkBase.System.Windows.Forms.DataGridViewCell.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.DataGridViewCellCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.DataGridViewCellCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
