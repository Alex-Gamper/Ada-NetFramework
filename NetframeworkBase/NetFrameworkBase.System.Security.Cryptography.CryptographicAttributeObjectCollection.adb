...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.CryptographicAttributeObjectCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.CryptographicAttributeObjectCollection";
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (asnEncodedData.m_Kind);
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (attribute.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.System.Security.Cryptography.CryptographicAttributeObjectEnumerator.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.CryptographicAttributeObjectEnumerator.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.CryptographicAttributeObjectEnumerator.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Security.Cryptography.CryptographicAttributeObject[]
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.CryptographicAttributeObjectCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.CryptographicAttributeObjectCollection.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.CryptographicAttributeObjectCollection.Kind do
