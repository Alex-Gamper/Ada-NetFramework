...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Remoting.Contexts.SynchronizationAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Remoting.Contexts.SynchronizationAttribute";
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsReEntrant");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Boolean;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetPropertiesForNewContext");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      ...
      p_Value.field_1.field_1.field_1.punkVal := ctorMsg;
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.System.Runtime.Remoting.Messaging.IMessageSink.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetServerContextSink");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   begin
      ...
      p_Index(1) := 0;
      p_Value.field_1.field_1.vt := VT_UNKNOWN'Enum_rep;
      p_Value.field_1.field_1.field_1.punkVal := nextSink;
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.System.Runtime.Remoting.Messaging.IMessageSink.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetClientContextSink");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Runtime.Remoting.Messaging.IMessageSink.Kind_Ptr;
   begin
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsContextOK");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Boolean;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Runtime.Remoting.Contexts.SynchronizationAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Remoting.Contexts.SynchronizationAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.Remoting.Contexts.SynchronizationAttribute.Kind do
   ...
   return NetFrameworkBase.System.Runtime.Remoting.Contexts.SynchronizationAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Remoting.Contexts.SynchronizationAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.Remoting.Contexts.SynchronizationAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
