...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.InteropServices.ExtensibleClassFactory is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.InteropServices.ExtensibleClassFactory";
   ...
   procedure RegisterObjectCreationCallback
   (
      callback : NetFrameworkBase.System.Runtime.InteropServices.ObjectCreationDelegate.Kind_Ptr
   )
   is
      ...
      p_MethodName  : BSTR := To_BSTR("RegisterObjectCreationCallback");
