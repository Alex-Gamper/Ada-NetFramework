...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.MaskGenerationMethod is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.MaskGenerationMethod";
   ...
   (
      this : in out MaskGenerationMethod.Kind;
