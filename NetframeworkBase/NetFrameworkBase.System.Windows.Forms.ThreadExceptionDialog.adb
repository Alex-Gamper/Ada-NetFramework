...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ThreadExceptionDialog is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ThreadExceptionDialog";
   ...
   function AutoSize
   (
      this : in out ThreadExceptionDialog.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.ThreadExceptionDialog.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ThreadExceptionDialog.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ThreadExceptionDialog.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
