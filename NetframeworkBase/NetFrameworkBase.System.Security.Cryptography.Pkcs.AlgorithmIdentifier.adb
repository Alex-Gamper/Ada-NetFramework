...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Pkcs.AlgorithmIdentifier is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Pkcs.AlgorithmIdentifier";
   ...
   function Oid
   (
      this : in out AlgorithmIdentifier.Kind
   )
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("KeyLength");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.Pkcs.AlgorithmIdentifier.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Pkcs.AlgorithmIdentifier.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Pkcs.AlgorithmIdentifier.Kind do
