...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Remoting.Lifetime.ClientSponsor is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Remoting.Lifetime.ClientSponsor";
   ...
   function Renewal
   (
      this : in out ClientSponsor.Kind;
      lease : NetFrameworkBase.System.Runtime.Remoting.Lifetime.ILease.Kind_Ptr
   )
   return NetFrameworkBase.System.TimeSpan.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("Renewal");
   ...
   begin
      ...
      p_Value.field_1.field_1.field_1.punkVal := lease;
   ...
   return NetFrameworkBase.System.TimeSpan.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RenewalTime");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.TimeSpan.Kind_Ptr := new NetFrameworkBase.System.TimeSpan.Kind;
   begin
   ...
   function Constructor return NetFrameworkBase.System.Runtime.Remoting.Lifetime.ClientSponsor.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Remoting.Lifetime.ClientSponsor.Kind_Ptr := new NetFrameworkBase.System.Runtime.Remoting.Lifetime.ClientSponsor.Kind do
   ...
   return NetFrameworkBase.System.Runtime.Remoting.Lifetime.ClientSponsor.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Remoting.Lifetime.ClientSponsor.Kind_Ptr := new NetFrameworkBase.System.Runtime.Remoting.Lifetime.ClientSponsor.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (renewalTime.m_Kind); -- Parameter Type = ValueType
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
