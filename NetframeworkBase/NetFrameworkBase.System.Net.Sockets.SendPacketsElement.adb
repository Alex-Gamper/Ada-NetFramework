...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Sockets.SendPacketsElement is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Sockets.SendPacketsElement";
   ...
   function FilePath
   (
      this : in out SendPacketsElement.Kind
   )
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EndOfPacket");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Net.Sockets.SendPacketsElement.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Sockets.SendPacketsElement.Kind_Ptr := new NetFrameworkBase.System.Net.Sockets.SendPacketsElement.Kind do
      declare
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 3;
         p_Value := To_Variant(endOfPacket);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
