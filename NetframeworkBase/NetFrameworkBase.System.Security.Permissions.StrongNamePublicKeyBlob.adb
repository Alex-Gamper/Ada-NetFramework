...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.StrongNamePublicKeyBlob is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.StrongNamePublicKeyBlob";
   ...
   function Equals
   (
      this : in out StrongNamePublicKeyBlob.Kind;
   ...
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.StrongNamePublicKeyBlob.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.StrongNamePublicKeyBlob.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
