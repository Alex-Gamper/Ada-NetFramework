...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.LinkArea is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.LinkArea";
   ...
   (
      linkArea1 : NetFrameworkBase.System.Windows.Forms.LinkArea.Kind_Ptr; 
      linkArea2 : NetFrameworkBase.System.Windows.Forms.LinkArea.Kind_Ptr
   )
   return NetFrameworkBase.Boolean is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (linkArea1.m_Kind); -- Parameter Type = ValueType
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := GetObject (linkArea2.m_Kind); -- Parameter Type = ValueType
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.LinkArea.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.LinkArea.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
