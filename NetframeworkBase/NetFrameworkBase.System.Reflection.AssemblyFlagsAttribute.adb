...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Reflection.AssemblyFlagsAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Reflection.AssemblyFlagsAttribute";
   ...
   function Flags
   (
      this : in out AssemblyFlagsAttribute.Kind
   )
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AssemblyFlags");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Reflection.AssemblyFlagsAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Reflection.AssemblyFlagsAttribute.Kind_Ptr := new NetFrameworkBase.System.Reflection.AssemblyFlagsAttribute.Kind do
      declare
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(assemblyFlags);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
   ...
   begin
      ...
      declare
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_assemblyFlagsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Reflection.AssemblyNameFlags.Instance;
         p_assemblyFlagsEnum : aliased VARIANT := To_Variant (CreateEnum (p_assemblyFlagsEnumType, assemblyFlags'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := p_assemblyFlagsEnum;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
