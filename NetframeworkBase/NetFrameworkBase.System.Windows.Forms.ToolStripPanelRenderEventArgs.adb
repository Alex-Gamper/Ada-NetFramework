...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ToolStripPanelRenderEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ToolStripPanelRenderEventArgs";
   ...
   function Graphics
   (
      this : in out ToolStripPanelRenderEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.ToolStripPanelRenderEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ToolStripPanelRenderEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ToolStripPanelRenderEventArgs.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := GetObject (toolStripPanel.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
