...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Pkcs.SubjectIdentifierOrKey is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Pkcs.SubjectIdentifierOrKey";
   ...
   function Type_x
   (
      this : in out SubjectIdentifierOrKey.Kind
   )
   return NetFrameworkBase.System.Security.Cryptography.Pkcs.SubjectIdentifierOrKeyType.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Security.Cryptography.Pkcs.SubjectIdentifierOrKeyType.Kind);
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Security.Cryptography.Pkcs.SubjectIdentifierOrKeyType.Kind;
   begin
