...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.CodeDom.Compiler.TempFileCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.CodeDom.Compiler.TempFileCollection";
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_MethodName  : BSTR := To_BSTR("KeepFiles");
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := To_Variant(fileExtension);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := To_Variant(keepFile);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AddFile");
      p_RetVal      : aliased VARIANT;
   ...
   (
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (fileNames'Length , 0);
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("TempDir");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.CodeDom.Compiler.TempFileCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.CodeDom.Compiler.TempFileCollection.Kind_Ptr := new NetFrameworkBase.System.CodeDom.Compiler.TempFileCollection.Kind do
