...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Deployment.Internal.InternalApplicationIdentityHelper is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Deployment.Internal.InternalApplicationIdentityHelper";
   ...
   (
      id : NetFrameworkBase.System.ApplicationIdentity.Kind_Ptr
   )
   return NetFrameworkBase.System.Object.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("GetInternalAppId");
