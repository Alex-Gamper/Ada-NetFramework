...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.ProviderSettingsCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.ProviderSettingsCollection";
   ...
   function Item
   (
      this : in out ProviderSettingsCollection.Kind;
      key : NetFrameworkBase.BSTR
   )
   return NetFrameworkBase.System.Configuration.ProviderSettings.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Configuration.ProviderSettings.Kind_Ptr := new NetFrameworkBase.System.Configuration.ProviderSettings.Kind;
   begin
   ...
   (
      this : in out ProviderSettingsCollection.Kind;
      index : NetFrameworkBase.Int32; 
      value : NetFrameworkBase.System.Configuration.ProviderSettings.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   (
      this : in out ProviderSettingsCollection.Kind;
      provider : NetFrameworkBase.System.Configuration.ProviderSettings.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   function Constructor return NetFrameworkBase.System.Configuration.ProviderSettingsCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.ProviderSettingsCollection.Kind_Ptr := new NetFrameworkBase.System.Configuration.ProviderSettingsCollection.Kind do
