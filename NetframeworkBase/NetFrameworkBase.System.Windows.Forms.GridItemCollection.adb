...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.GridItemCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.GridItemCollection";
   ...
   function Count
   (
      this : in out GridItemCollection.Kind
   )
