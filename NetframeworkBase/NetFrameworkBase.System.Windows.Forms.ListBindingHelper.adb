...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ListBindingHelper is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ListBindingHelper";
   ...
   return NetFrameworkBase.System.Object.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("GetList");
   ...
   return NetFrameworkBase.BSTR is
      ...
      p1_Bounds     : aliased SAFEARRAYBOUND := (listAccessors'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in listAccessors'range loop
            ...
            p1_Tmp := GetObject (listAccessors(i).m_Kind);
   ...
   return NetFrameworkBase.System.ComponentModel.PropertyDescriptorCollection.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetListItemProperties");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Type_x.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetListItemType");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.ComponentModel.PropertyDescriptorCollection.Kind_Ptr is
      ...
      p2_Bounds     : aliased SAFEARRAYBOUND := (listAccessors'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in listAccessors'range loop
            ...
            p2_Tmp := GetObject (listAccessors(i).m_Kind);
