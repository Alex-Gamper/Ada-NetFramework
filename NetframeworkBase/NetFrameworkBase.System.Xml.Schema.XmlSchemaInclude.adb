...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.XmlSchemaInclude is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.XmlSchemaInclude";
   ...
   function Annotation
   (
      this : in out XmlSchemaInclude.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Xml.Schema.XmlSchemaInclude.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Schema.XmlSchemaInclude.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaInclude.Kind do
