...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Text.EncoderReplacementFallbackBuffer is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Text.EncoderReplacementFallbackBuffer";
   ...
   return NetFrameworkBase.System.Text.EncoderReplacementFallbackBuffer.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Text.EncoderReplacementFallbackBuffer.Kind_Ptr := new NetFrameworkBase.System.Text.EncoderReplacementFallbackBuffer.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
