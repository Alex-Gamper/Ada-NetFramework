...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.AxHost.ClsidAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.AxHost+ClsidAttribute";
   ...
   function Value
   (
      this : in out ClsidAttribute.Kind
   )
   ...
   (
      clsid : NetFrameworkBase.BSTR
   )
   return NetFrameworkBase.System.Windows.Forms.AxHost.ClsidAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.AxHost.ClsidAttribute.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.AxHost.ClsidAttribute.Kind do
      declare
