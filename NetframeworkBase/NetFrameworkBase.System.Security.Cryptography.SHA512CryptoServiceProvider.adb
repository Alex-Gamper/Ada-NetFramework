...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.SHA512CryptoServiceProvider is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.SHA512CryptoServiceProvider";
   ...
   (
      this : in out SHA512CryptoServiceProvider.Kind
   ) is
      Hr            : HResult := 0;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.SHA512CryptoServiceProvider.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.SHA512CryptoServiceProvider.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.SHA512CryptoServiceProvider.Kind do
