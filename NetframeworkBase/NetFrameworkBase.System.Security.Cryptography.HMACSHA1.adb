...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.HMACSHA1 is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.HMACSHA1";
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.HMACSHA1.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.HMACSHA1.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.HMACSHA1.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.HMACSHA1.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.HMACSHA1.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.HMACSHA1.Kind do
      declare
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(useManagedSha1);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy (p0_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
