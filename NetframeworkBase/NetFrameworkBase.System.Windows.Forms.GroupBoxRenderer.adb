...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.GroupBoxRenderer is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.GroupBoxRenderer";
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_RetVal      : aliased VARIANT;
      p_stateEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Windows.Forms.VisualStyles.GroupBoxState.Instance;
   ...
   is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("DrawGroupBox");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_stateEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Windows.Forms.VisualStyles.GroupBoxState.Instance;
      p_stateEnum : aliased VARIANT := To_Variant (CreateEnum (p_stateEnumType, state'Enum_rep));
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 2;
      p_Value := To_Variant(groupBoxText);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 3;
