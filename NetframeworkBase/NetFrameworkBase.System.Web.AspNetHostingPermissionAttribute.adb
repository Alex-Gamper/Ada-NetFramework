...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Web.AspNetHostingPermissionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Web.AspNetHostingPermissionAttribute";
   ...
   function Level
   (
      this : in out AspNetHostingPermissionAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Web.AspNetHostingPermissionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Web.AspNetHostingPermissionAttribute.Kind_Ptr := new NetFrameworkBase.System.Web.AspNetHostingPermissionAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
