...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Globalization.CultureNotFoundException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Globalization.CultureNotFoundException";
   ...
   function InvalidCultureName
   (
      this : in out CultureNotFoundException.Kind
   )
   return NetFrameworkBase.BSTR is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("InvalidCultureName");
   ...
   function Constructor return NetFrameworkBase.System.Globalization.CultureNotFoundException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Globalization.CultureNotFoundException.Kind_Ptr := new NetFrameworkBase.System.Globalization.CultureNotFoundException.Kind do
   ...
   return NetFrameworkBase.System.Globalization.CultureNotFoundException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Globalization.CultureNotFoundException.Kind_Ptr := new NetFrameworkBase.System.Globalization.CultureNotFoundException.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(invalidCultureId);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 2;
         p_Value := To_Variant(message);
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(invalidCultureName);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 2;
         p_Value := To_Variant(message);
