...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.CodeDom.CodeChecksumPragma is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.CodeDom.CodeChecksumPragma";
   ...
   return NetFrameworkBase.System.Guid.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ChecksumAlgorithmId");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.Byte_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ChecksumData");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.CodeDom.CodeChecksumPragma.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.CodeDom.CodeChecksumPragma.Kind_Ptr := new NetFrameworkBase.System.CodeDom.CodeChecksumPragma.Kind do
   ...
   return NetFrameworkBase.System.CodeDom.CodeChecksumPragma.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.CodeDom.CodeChecksumPragma.Kind_Ptr := new NetFrameworkBase.System.CodeDom.CodeChecksumPragma.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         ...
         p2_Bounds     : aliased SAFEARRAYBOUND := (checksumData'Length , 0);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := GetObject (checksumAlgorithmId.m_Kind); -- Parameter Type = ValueType
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 2;
         declare
         ...
         begin
            ...
            for i in checksumData'range loop
               p2_Index(1) := Interfaces.C.long(i) - 1;
               p2_Tmp := checksumData(i);
