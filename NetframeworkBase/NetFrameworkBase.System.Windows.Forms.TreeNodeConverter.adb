...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.TreeNodeConverter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.TreeNodeConverter";
   ...
   (
      this : in out TreeNodeConverter.Kind;
   ...
   function Constructor return NetFrameworkBase.System.Windows.Forms.TreeNodeConverter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.TreeNodeConverter.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.TreeNodeConverter.Kind do
