...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.SocketAddress is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.SocketAddress";
   ...
   return NetFrameworkBase.System.Net.Sockets.AddressFamily.Kind is
      ...
      p_MethodName  : BSTR := To_BSTR("Family");
   ...
   begin
      return RetVal : NetFrameworkBase.System.Net.SocketAddress.Kind_Ptr := new NetFrameworkBase.System.Net.SocketAddress.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
