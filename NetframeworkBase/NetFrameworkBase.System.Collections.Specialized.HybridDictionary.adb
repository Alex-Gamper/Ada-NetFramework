...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Collections.Specialized.HybridDictionary is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Collections.Specialized.HybridDictionary";
   ...
   function Constructor return NetFrameworkBase.System.Collections.Specialized.HybridDictionary.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Collections.Specialized.HybridDictionary.Kind_Ptr := new NetFrameworkBase.System.Collections.Specialized.HybridDictionary.Kind do
   ...
   return NetFrameworkBase.System.Collections.Specialized.HybridDictionary.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Collections.Specialized.HybridDictionary.Kind_Ptr := new NetFrameworkBase.System.Collections.Specialized.HybridDictionary.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(initialSize);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(caseInsensitive);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
