...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.EnterpriseServices.ApplicationQueuingAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.EnterpriseServices.ApplicationQueuingAttribute";
   ...
   function Enabled
   (
      this : in out ApplicationQueuingAttribute.Kind
   )
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("QueueListenerEnabled");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Boolean;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   procedure QueueListenerEnabled
   (
      this : in out ApplicationQueuingAttribute.Kind;
      value : NetFrameworkBase.Boolean
   ) is
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("MaxListenerThreads");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.EnterpriseServices.ApplicationQueuingAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.EnterpriseServices.ApplicationQueuingAttribute.Kind_Ptr := new NetFrameworkBase.System.EnterpriseServices.ApplicationQueuingAttribute.Kind do
