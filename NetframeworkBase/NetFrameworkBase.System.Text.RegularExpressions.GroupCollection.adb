...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Text.RegularExpressions.GroupCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Text.RegularExpressions.GroupCollection";
   ...
   function SyncRoot
   (
      this : in out GroupCollection.Kind
   )
   ...
   (
      this : in out GroupCollection.Kind;
      groupnum : NetFrameworkBase.Int32
   )
