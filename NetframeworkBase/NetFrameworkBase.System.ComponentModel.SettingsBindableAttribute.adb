...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.SettingsBindableAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.SettingsBindableAttribute";
   ...
   function Bindable
   (
      this : in out SettingsBindableAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.ComponentModel.SettingsBindableAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.SettingsBindableAttribute.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.SettingsBindableAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
