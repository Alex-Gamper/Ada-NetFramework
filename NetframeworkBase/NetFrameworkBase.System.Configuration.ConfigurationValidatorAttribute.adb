...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.ConfigurationValidatorAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.ConfigurationValidatorAttribute";
   ...
   (
      this : in out ConfigurationValidatorAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Type_x.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ValidatorType");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Configuration.ConfigurationValidatorAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.ConfigurationValidatorAttribute.Kind_Ptr := new NetFrameworkBase.System.Configuration.ConfigurationValidatorAttribute.Kind do
      declare
