...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.FileNotFoundException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.FileNotFoundException";
   ...
   function Message
   (
      this : in out FileNotFoundException.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("FusionLog");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.IO.FileNotFoundException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.IO.FileNotFoundException.Kind_Ptr := new NetFrameworkBase.System.IO.FileNotFoundException.Kind do
   ...
   return NetFrameworkBase.System.IO.FileNotFoundException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.IO.FileNotFoundException.Kind_Ptr := new NetFrameworkBase.System.IO.FileNotFoundException.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
