...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ConvertEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ConvertEventArgs";
   ...
   function Value
   (
      this : in out ConvertEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Type_x.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("DesiredType");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Windows.Forms.ConvertEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ConvertEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ConvertEventArgs.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
