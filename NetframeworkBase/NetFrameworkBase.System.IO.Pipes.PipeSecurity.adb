...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.Pipes.PipeSecurity is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.Pipes.PipeSecurity";
   ...
   (
      this : in out PipeSecurity.Kind;
      rule : NetFrameworkBase.System.IO.Pipes.PipeAccessRule.Kind_Ptr
   ) is
   ...
   (
      this : in out PipeSecurity.Kind;
      rule : NetFrameworkBase.System.IO.Pipes.PipeAuditRule.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   function Constructor return NetFrameworkBase.System.IO.Pipes.PipeSecurity.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.IO.Pipes.PipeSecurity.Kind_Ptr := new NetFrameworkBase.System.IO.Pipes.PipeSecurity.Kind do
