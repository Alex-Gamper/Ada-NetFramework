...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.OleDb.OleDbPermissionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.OleDb.OleDbPermissionAttribute";
   ...
   function Provider
   (
      this : in out OleDbPermissionAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Data.OleDb.OleDbPermissionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Data.OleDb.OleDbPermissionAttribute.Kind_Ptr := new NetFrameworkBase.System.Data.OleDb.OleDbPermissionAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
