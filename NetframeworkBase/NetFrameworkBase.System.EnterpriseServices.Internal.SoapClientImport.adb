...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.EnterpriseServices.Internal.SoapClientImport is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.EnterpriseServices.Internal.SoapClientImport";
   ...
   procedure ProcessClientTlbEx
   (
      this : in out SoapClientImport.Kind;
      ...
      p_MethodName  : BSTR := To_BSTR("ProcessClientTlbEx");
   ...
   function Constructor return NetFrameworkBase.System.EnterpriseServices.Internal.SoapClientImport.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.EnterpriseServices.Internal.SoapClientImport.Kind_Ptr := new NetFrameworkBase.System.EnterpriseServices.Internal.SoapClientImport.Kind do
