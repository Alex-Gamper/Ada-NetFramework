...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.KeyValueConfigurationCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.KeyValueConfigurationCollection";
   ...
   function Item
   (
      this : in out KeyValueConfigurationCollection.Kind;
      key : NetFrameworkBase.BSTR
   )
   return NetFrameworkBase.System.Configuration.KeyValueConfigurationElement.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Configuration.KeyValueConfigurationElement.Kind_Ptr := new NetFrameworkBase.System.Configuration.KeyValueConfigurationElement.Kind;
   begin
   ...
   (
      this : in out KeyValueConfigurationCollection.Kind;
      keyValue : NetFrameworkBase.System.Configuration.KeyValueConfigurationElement.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   function Constructor return NetFrameworkBase.System.Configuration.KeyValueConfigurationCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.KeyValueConfigurationCollection.Kind_Ptr := new NetFrameworkBase.System.Configuration.KeyValueConfigurationCollection.Kind do
