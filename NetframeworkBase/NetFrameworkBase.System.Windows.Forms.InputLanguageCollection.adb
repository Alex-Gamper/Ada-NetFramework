...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.InputLanguageCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.InputLanguageCollection";
   ...
   function Item
   (
      this : in out InputLanguageCollection.Kind;
   ...
   (
      this : in out InputLanguageCollection.Kind;
      array_x : NetFrameworkBase.System.Windows.Forms.InputLanguage.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Windows.Forms.InputLanguage[]
