...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ConsoleCancelEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ConsoleCancelEventArgs";
   ...
   function Cancel
   (
      this : in out ConsoleCancelEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.ConsoleSpecialKey.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.ConsoleSpecialKey.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SpecialKey");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.ConsoleSpecialKey.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
