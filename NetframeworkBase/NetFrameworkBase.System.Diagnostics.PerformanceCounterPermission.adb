...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.PerformanceCounterPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.PerformanceCounterPermission";
   ...
   (
      this : in out PerformanceCounterPermission.Kind
   )
   return NetFrameworkBase.System.Diagnostics.PerformanceCounterPermissionEntryCollection.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("PermissionEntries");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Diagnostics.PerformanceCounterPermissionEntryCollection.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.PerformanceCounterPermissionEntryCollection.Kind;
   begin
   ...
   function Constructor return NetFrameworkBase.System.Diagnostics.PerformanceCounterPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.PerformanceCounterPermission.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.PerformanceCounterPermission.Kind do
   ...
   return NetFrameworkBase.System.Diagnostics.PerformanceCounterPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.PerformanceCounterPermission.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.PerformanceCounterPermission.Kind do
      declare
   ...
   begin
      ...
      declare
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_permissionAccessEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Diagnostics.PerformanceCounterPermissionAccess.Instance;
         p_permissionAccessEnum : aliased VARIANT := To_Variant (CreateEnum (p_permissionAccessEnumType, permissionAccess'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := p_permissionAccessEnum;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
   ...
   begin
      ...
      declare
         ...
         p0_Bounds     : aliased SAFEARRAYBOUND := (permissionAccessEntries'Length , 0);
      ...
      begin
         ...
         begin
            ...
            for i in permissionAccessEntries'range loop
               p0_Index(1) := Interfaces.C.long(i) - 1;
               p0_Tmp := GetObject (permissionAccessEntries(i).m_Kind);
         ...
         -- fixme parameter type := [array] System.Diagnostics.PerformanceCounterPermissionEntry[]
