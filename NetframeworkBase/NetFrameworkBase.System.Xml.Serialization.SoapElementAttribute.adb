...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Serialization.SoapElementAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Serialization.SoapElementAttribute";
   ...
   (
      this : in out SoapElementAttribute.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Xml.Serialization.SoapElementAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Serialization.SoapElementAttribute.Kind_Ptr := new NetFrameworkBase.System.Xml.Serialization.SoapElementAttribute.Kind do
