...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Xsl.Runtime.PrecedingSiblingDocOrderIterator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Xsl.Runtime.PrecedingSiblingDocOrderIterator";
   ...
   procedure Create
   (
      this : in out PrecedingSiblingDocOrderIterator.Kind;
