...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.DefaultEventAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.DefaultEventAttribute";
   ...
   function Name
   (
      this : in out DefaultEventAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.ComponentModel.DefaultEventAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.DefaultEventAttribute.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.DefaultEventAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
