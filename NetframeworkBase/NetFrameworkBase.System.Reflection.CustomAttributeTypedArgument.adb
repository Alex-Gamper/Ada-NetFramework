...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Reflection.CustomAttributeTypedArgument is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Reflection.CustomAttributeTypedArgument";
   ...
   return NetFrameworkBase.System.Type_x.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ArgumentType");
      p_RetVal      : aliased VARIANT;
   ...
   begin
      return RetVal : NetFrameworkBase.System.Reflection.CustomAttributeTypedArgument.Kind_Ptr := new NetFrameworkBase.System.Reflection.CustomAttributeTypedArgument.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (argumentType.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
