...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionProperty is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Xml.EncryptionProperty";
   ...
   function Id
   (
      this : in out EncryptionProperty.Kind
   )
   ...
   return NetFrameworkBase.System.Xml.XmlElement.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("PropertyElement");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionProperty.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionProperty.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionProperty.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionProperty.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionProperty.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionProperty.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (elementProperty.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
