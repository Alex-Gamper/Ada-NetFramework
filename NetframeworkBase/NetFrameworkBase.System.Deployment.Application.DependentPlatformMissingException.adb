...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Deployment.Application.DependentPlatformMissingException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Deployment.Application.DependentPlatformMissingException";
   ...
   function SupportUrl
   (
      this : in out DependentPlatformMissingException.Kind
   )
   return NetFrameworkBase.System.Uri.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SupportUrl");
   ...
   function Constructor return NetFrameworkBase.System.Deployment.Application.DependentPlatformMissingException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Deployment.Application.DependentPlatformMissingException.Kind_Ptr := new NetFrameworkBase.System.Deployment.Application.DependentPlatformMissingException.Kind do
   ...
   return NetFrameworkBase.System.Deployment.Application.DependentPlatformMissingException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Deployment.Application.DependentPlatformMissingException.Kind_Ptr := new NetFrameworkBase.System.Deployment.Application.DependentPlatformMissingException.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := GetObject (supportUrl.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
