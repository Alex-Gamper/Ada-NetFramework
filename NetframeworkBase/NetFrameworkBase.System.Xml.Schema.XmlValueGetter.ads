...
--------------------------------------------------------------------------------
package NetFrameworkBase.System.Xml.Schema.XmlValueGetter is
   
   type Kind is new NetFrameworkBase.System.MulticastDelegate.Kind with null record;
   type Kind_Ptr is access all Kind;
   type Kind_Array is array(Natural range<>) of Kind_Ptr;
   type Kind_Array_Ptr is access all Kind_Array;
   type Kind_Callback is access function  return NetFrameworkBase.System.Xml.Schema.XmlValueGetter.Kind_Ptr;
