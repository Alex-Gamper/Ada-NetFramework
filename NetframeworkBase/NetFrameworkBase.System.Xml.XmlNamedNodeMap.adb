...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.XmlNamedNodeMap is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.XmlNamedNodeMap";
   ...
   (
      this : in out XmlNamedNodeMap.Kind;
   ...
   return NetFrameworkBase.System.Xml.XmlNode.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("GetNamedItem");
   ...
   return NetFrameworkBase.System.Xml.XmlNode.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RemoveNamedItem");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Xml.XmlNode.Kind_Ptr := new NetFrameworkBase.System.Xml.XmlNode.Kind;
   begin
