...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.Debug is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.Debug";
   ...
   (
      condition : NetFrameworkBase.Boolean; 
      message : NetFrameworkBase.BSTR; 
      detailMessageFormat : NetFrameworkBase.BSTR; 
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 2;
      p_Value := To_Variant(detailMessageFormat);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 3;
      declare
