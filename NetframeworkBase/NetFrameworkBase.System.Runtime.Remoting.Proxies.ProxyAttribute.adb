...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Remoting.Proxies.ProxyAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Remoting.Proxies.ProxyAttribute";
   ...
   return NetFrameworkBase.System.MarshalByRefObject.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.MarshalByRefObject.Kind_Ptr := new NetFrameworkBase.System.MarshalByRefObject.Kind;
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (serverType.m_Kind);
   ...
   return NetFrameworkBase.System.Runtime.Remoting.Proxies.RealProxy.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CreateProxy");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (objRef.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := GetObject (serverType.m_Kind);
      ...
      ------------------------------------------------------------
      p_Index(1) := 2;
      p_Value := GetObject (serverObject.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 3;
      p_Value := GetObject (serverContext.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   function Constructor return NetFrameworkBase.System.Runtime.Remoting.Proxies.ProxyAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Remoting.Proxies.ProxyAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.Remoting.Proxies.ProxyAttribute.Kind do
