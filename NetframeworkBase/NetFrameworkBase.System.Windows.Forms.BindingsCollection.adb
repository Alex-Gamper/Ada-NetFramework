...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.BindingsCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.BindingsCollection";
   ...
   function Count
   (
      this : in out BindingsCollection.Kind
   )
