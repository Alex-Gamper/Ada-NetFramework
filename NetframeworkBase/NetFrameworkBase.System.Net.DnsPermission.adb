...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.DnsPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.DnsPermission";
   ...
   return NetFrameworkBase.System.Net.DnsPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.DnsPermission.Kind_Ptr := new NetFrameworkBase.System.Net.DnsPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
