...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.RandomNumberGenerator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.RandomNumberGenerator";
   ...
   procedure Dispose
   (
      this : in out RandomNumberGenerator.Kind
   ) is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
