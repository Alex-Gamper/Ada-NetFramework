...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.Ports.SerialPinChangedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.Ports.SerialPinChangedEventArgs";
   ...
   function EventType
   (
      this : in out SerialPinChangedEventArgs.Kind
   )
   return NetFrameworkBase.System.IO.Ports.SerialPinChange.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.IO.Ports.SerialPinChange.Kind);
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.IO.Ports.SerialPinChange.Kind;
   begin
