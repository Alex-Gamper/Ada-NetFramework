...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Reflection.AssemblyAlgorithmIdAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Reflection.AssemblyAlgorithmIdAttribute";
   ...
   (
      this : in out AssemblyAlgorithmIdAttribute.Kind
   )
   return NetFrameworkBase.UInt32 is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AlgorithmId");
   ...
   return NetFrameworkBase.System.Reflection.AssemblyAlgorithmIdAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Reflection.AssemblyAlgorithmIdAttribute.Kind_Ptr := new NetFrameworkBase.System.Reflection.AssemblyAlgorithmIdAttribute.Kind do
      declare
         ...
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_algorithmIdEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Configuration.Assemblies.AssemblyHashAlgorithm.Instance;
         p_algorithmIdEnum : aliased VARIANT := To_Variant (CreateEnum (p_algorithmIdEnumType, algorithmId'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := p_algorithmIdEnum;
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(algorithmId);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
