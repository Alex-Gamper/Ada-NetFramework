...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Serialization.SerializationObjectManager is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Serialization.SerializationObjectManager";
   ...
   (
      this : in out SerializationObjectManager.Kind;
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RaiseOnSerializedEvent");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.Runtime.Serialization.SerializationObjectManager.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Serialization.SerializationObjectManager.Kind_Ptr := new NetFrameworkBase.System.Runtime.Serialization.SerializationObjectManager.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
