...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.ValidationEventHandler is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.ValidationEventHandler";
