...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.CacheVirtualItemsEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.CacheVirtualItemsEventArgs";
   ...
   function StartIndex
   (
      this : in out CacheVirtualItemsEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.CacheVirtualItemsEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.CacheVirtualItemsEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.CacheVirtualItemsEventArgs.Kind do
      declare
