...
limited with NetFrameworkBase.System.Security.AccessControl.AuthorizationRuleCollection;
--------------------------------------------------------------------------------
package NetFrameworkBase.System.Security.AccessControl.DirectoryObjectSecurity is
   
   type Kind is new NetFrameworkBase.System.Security.AccessControl.ObjectSecurity.Kind with null record;
