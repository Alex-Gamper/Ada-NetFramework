...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.AccessControl.CryptoKeyAccessRule is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.AccessControl.CryptoKeyAccessRule";
   ...
   (
      this : in out CryptoKeyAccessRule.Kind
   )
   return NetFrameworkBase.System.Security.AccessControl.CryptoKeyRights.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Security.AccessControl.CryptoKeyRights.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CryptoKeyRights");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.AccessControl.CryptoKeyRights.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.AccessControl.CryptoKeyAccessRule.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.AccessControl.CryptoKeyAccessRule.Kind_Ptr := new NetFrameworkBase.System.Security.AccessControl.CryptoKeyAccessRule.Kind do
      declare
         ...
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_cryptoKeyRightsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.AccessControl.CryptoKeyRights.Instance;
         p_cryptoKeyRightsEnum : aliased VARIANT := To_Variant (CreateEnum (p_cryptoKeyRightsEnumType, cryptoKeyRights'Enum_rep));
