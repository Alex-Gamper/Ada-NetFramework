...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.DelimitedListTraceListener is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.DelimitedListTraceListener";
   ...
   return NetFrameworkBase.System.Diagnostics.DelimitedListTraceListener.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.DelimitedListTraceListener.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.DelimitedListTraceListener.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
