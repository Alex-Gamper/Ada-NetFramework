...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Cache.RequestCachePolicy is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Cache.RequestCachePolicy";
   ...
   function Level
   (
      this : in out RequestCachePolicy.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Net.Cache.RequestCachePolicy.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Cache.RequestCachePolicy.Kind_Ptr := new NetFrameworkBase.System.Net.Cache.RequestCachePolicy.Kind do
   ...
   begin
      ...
      declare
         ...
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_levelEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Net.Cache.RequestCacheLevel.Instance;
