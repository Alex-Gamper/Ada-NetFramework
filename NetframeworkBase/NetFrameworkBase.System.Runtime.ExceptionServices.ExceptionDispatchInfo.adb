...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.ExceptionServices.ExceptionDispatchInfo is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.ExceptionServices.ExceptionDispatchInfo";
   ...
   function Capture
   (
      source : NetFrameworkBase.System.Exception_x.Kind_Ptr
   )
   return NetFrameworkBase.System.Runtime.ExceptionServices.ExceptionDispatchInfo.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Runtime.ExceptionServices.ExceptionDispatchInfo.Kind_Ptr := new NetFrameworkBase.System.Runtime.ExceptionServices.ExceptionDispatchInfo.Kind;
   begin
   ...
   (
      this : in out ExceptionDispatchInfo.Kind
   )
   return NetFrameworkBase.System.Exception_x.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SourceException");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
