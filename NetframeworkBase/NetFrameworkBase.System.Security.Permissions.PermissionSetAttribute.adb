...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.PermissionSetAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.PermissionSetAttribute";
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_MethodName  : BSTR := To_BSTR("File");
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("UnicodeEncoded");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Security.PermissionSet.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CreatePermissionSet");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Security.Permissions.PermissionSetAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.PermissionSetAttribute.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.PermissionSetAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
