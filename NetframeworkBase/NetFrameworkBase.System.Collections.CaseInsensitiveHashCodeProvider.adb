...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Collections.CaseInsensitiveHashCodeProvider is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Collections.CaseInsensitiveHashCodeProvider";
   ...
   function Default
   return NetFrameworkBase.System.Collections.CaseInsensitiveHashCodeProvider.Kind_Ptr is
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Collections.CaseInsensitiveHashCodeProvider.Kind_Ptr := new NetFrameworkBase.System.Collections.CaseInsensitiveHashCodeProvider.Kind;
   begin
   ...
   (
      this : in out CaseInsensitiveHashCodeProvider.Kind;
   ...
   function Constructor return NetFrameworkBase.System.Collections.CaseInsensitiveHashCodeProvider.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Collections.CaseInsensitiveHashCodeProvider.Kind_Ptr := new NetFrameworkBase.System.Collections.CaseInsensitiveHashCodeProvider.Kind do
