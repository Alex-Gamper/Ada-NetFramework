...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Rijndael is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Rijndael";
   ...
   return NetFrameworkBase.System.Security.Cryptography.Rijndael.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Security.Cryptography.Rijndael.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Rijndael.Kind;
   begin
