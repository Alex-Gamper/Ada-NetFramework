...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Collections.Comparer is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Collections.Comparer";
   ...
   return NetFrameworkBase.System.Collections.Comparer.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Collections.Comparer.Kind_Ptr := new NetFrameworkBase.System.Collections.Comparer.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
