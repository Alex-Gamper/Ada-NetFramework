...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DataGridTextBox is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DataGridTextBox";
   ...
   (
      this : in out DataGridTextBox.Kind;
      parentGrid : NetFrameworkBase.System.Windows.Forms.DataGrid.Kind_Ptr
   ) is
      ...
      p_MethodName  : BSTR := To_BSTR("SetDataGrid");
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (parentGrid.m_Kind);
   ...
   function IsInEditOrNavigateMode
   (
      this : in out DataGridTextBox.Kind
   )
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsInEditOrNavigateMode");
      p_RetVal      : aliased VARIANT;
   ...
   procedure IsInEditOrNavigateMode
   (
      this : in out DataGridTextBox.Kind;
   ...
   function Constructor return NetFrameworkBase.System.Windows.Forms.DataGridTextBox.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.DataGridTextBox.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.DataGridTextBox.Kind do
