...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Collections.Specialized.StringEnumerator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Collections.Specialized.StringEnumerator";
   ...
   function Current
   (
      this : in out StringEnumerator.Kind
   )
