...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Xsl.Runtime.XPathPrecedingIterator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Xsl.Runtime.XPathPrecedingIterator";
   ...
   procedure Create
   (
      this : in out XPathPrecedingIterator.Kind;
