...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.ZoneIdentityPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.ZoneIdentityPermission";
   ...
   procedure SecurityZone
   (
      this : in out ZoneIdentityPermission.Kind;
      ...
      p_MethodName  : BSTR := To_BSTR("SecurityZone");
   ...
   return NetFrameworkBase.System.Security.Permissions.ZoneIdentityPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.ZoneIdentityPermission.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.ZoneIdentityPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      declare
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_zoneEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.SecurityZone.Instance;
         p_zoneEnum : aliased VARIANT := To_Variant (CreateEnum (p_zoneEnumType, zone'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
