...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Linq.Expressions.ElementInit is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Linq.Expressions.ElementInit";
