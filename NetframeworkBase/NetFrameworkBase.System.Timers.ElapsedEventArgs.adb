...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Timers.ElapsedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Timers.ElapsedEventArgs";
   ...
   function SignalTime
   (
      this : in out ElapsedEventArgs.Kind
   )
   return NetFrameworkBase.Date is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SignalTime");
