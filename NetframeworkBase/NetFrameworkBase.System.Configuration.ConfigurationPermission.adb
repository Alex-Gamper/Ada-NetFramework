...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.ConfigurationPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.ConfigurationPermission";
   ...
   (
      this : in out ConfigurationPermission.Kind
   )
   ...
   return NetFrameworkBase.System.Configuration.ConfigurationPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.ConfigurationPermission.Kind_Ptr := new NetFrameworkBase.System.Configuration.ConfigurationPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
