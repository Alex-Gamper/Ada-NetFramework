...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.InteropServices.CriticalHandle is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.InteropServices.CriticalHandle";
   ...
   function IsClosed
   (
      this : in out CriticalHandle.Kind
   )
