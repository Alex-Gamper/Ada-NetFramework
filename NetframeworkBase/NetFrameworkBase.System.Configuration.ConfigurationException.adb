...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.ConfigurationException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.ConfigurationException";
   ...
   (
      this : in out ConfigurationException.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetXmlNodeFilename");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetXmlNodeLineNumber");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Int32;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Configuration.ConfigurationException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.ConfigurationException.Kind_Ptr := new NetFrameworkBase.System.Configuration.ConfigurationException.Kind do
   ...
   return NetFrameworkBase.System.Configuration.ConfigurationException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.ConfigurationException.Kind_Ptr := new NetFrameworkBase.System.Configuration.ConfigurationException.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
