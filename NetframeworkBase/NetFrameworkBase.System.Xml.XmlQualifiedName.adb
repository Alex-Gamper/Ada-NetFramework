...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.XmlQualifiedName is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.XmlQualifiedName";
   ...
   function Namespace
   (
      this : in out XmlQualifiedName.Kind
   )
   ...
   (
      a : NetFrameworkBase.System.Xml.XmlQualifiedName.Kind_Ptr; 
      b : NetFrameworkBase.System.Xml.XmlQualifiedName.Kind_Ptr
   )
   return NetFrameworkBase.Boolean is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   function Constructor return NetFrameworkBase.System.Xml.XmlQualifiedName.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.XmlQualifiedName.Kind_Ptr := new NetFrameworkBase.System.Xml.XmlQualifiedName.Kind do
