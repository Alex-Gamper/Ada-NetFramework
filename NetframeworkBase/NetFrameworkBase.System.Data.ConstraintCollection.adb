...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.ConstraintCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.ConstraintCollection";
   ...
   return NetFrameworkBase.System.Data.Constraint.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Data.Constraint.Kind_Ptr := new NetFrameworkBase.System.Data.Constraint.Kind;
   begin
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (constraint.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.System.Data.Constraint.Kind_Ptr is
      ...
      p1_Bounds     : aliased SAFEARRAYBOUND := (columns'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in columns'range loop
            ...
            p1_Tmp := GetObject (columns(i).m_Kind);
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := GetObject (primaryKeyColumn.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 2;
      p_Value := GetObject (foreignKeyColumn.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.System.Data.Constraint.Kind_Ptr is
      ...
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p1_Parameters : aliased LPSAFEARRAY := null;
      p1_Bounds     : aliased SAFEARRAYBOUND := (primaryKeyColumns'Length , 0);
      p1_Index      : aliased array(1..1) of aliased LONG := (others => 0);
      p1_Tmp        : aliased IUnknown_Ptr;
      p1_Tmp_Ptr    : access IUnknown_Ptr := p1_Tmp'access;
      p2_Parameters : aliased LPSAFEARRAY := null;
      p2_Bounds     : aliased SAFEARRAYBOUND := (foreignKeyColumns'Length , 0);
   ...
   begin
      ...
      begin
         p1_Parameters := SafeArrayCreate (VT_UNKNOWN'enum_rep, 1, p1_Bounds'access);
         for i in primaryKeyColumns'range loop
            p1_Index(1) := Interfaces.C.long(i) - 1;
            p1_Tmp := GetObject (primaryKeyColumns(i).m_Kind);
            Hr := SafeArrayPutElement (p1_Parameters, p1_Index (p1_Index'first)'access, Convert (p1_Tmp));
         end loop;
         p_Value := To_Variant (p1_Parameters, VT_UNKNOWN);
      end;
      ...
      begin
         ...
         for i in foreignKeyColumns'range loop
            p2_Index(1) := Interfaces.C.long(i) - 1;
            p2_Tmp := GetObject (foreignKeyColumns(i).m_Kind);
   ...
   (
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (constraints'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in constraints'range loop
            ...
            p0_Tmp := GetObject (constraints(i).m_Kind);
      ...
      -- fixme parameter type := [array] System.Data.Constraint[]
