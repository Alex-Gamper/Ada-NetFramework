...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509Certificate2Enumerator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.X509Certificates.X509Certificate2Enumerator";
   ...
   function Current
   (
      this : in out X509Certificate2Enumerator.Kind
   )
