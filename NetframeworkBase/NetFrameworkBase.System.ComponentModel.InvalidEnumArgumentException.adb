...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.InvalidEnumArgumentException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.InvalidEnumArgumentException";
   ...
   function Constructor return NetFrameworkBase.System.ComponentModel.InvalidEnumArgumentException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.InvalidEnumArgumentException.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.InvalidEnumArgumentException.Kind do
   ...
   return NetFrameworkBase.System.ComponentModel.InvalidEnumArgumentException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.InvalidEnumArgumentException.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.InvalidEnumArgumentException.Kind do
      declare
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(argumentName);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(invalidValue);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 2;
         p_Value := GetObject (enumClass.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
