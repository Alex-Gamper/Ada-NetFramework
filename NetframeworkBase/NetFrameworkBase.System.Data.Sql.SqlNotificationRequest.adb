...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.Sql.SqlNotificationRequest is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.Sql.SqlNotificationRequest";
   ...
   function Options
   (
      this : in out SqlNotificationRequest.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("UserData");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Data.Sql.SqlNotificationRequest.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Data.Sql.SqlNotificationRequest.Kind_Ptr := new NetFrameworkBase.System.Data.Sql.SqlNotificationRequest.Kind do
