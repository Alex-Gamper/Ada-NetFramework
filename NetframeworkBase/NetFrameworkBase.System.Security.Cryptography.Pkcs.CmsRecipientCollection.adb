...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Pkcs.CmsRecipientCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Pkcs.CmsRecipientCollection";
   ...
   function Item
   (
      this : in out CmsRecipientCollection.Kind;
      index : NetFrameworkBase.Int32
   )
   return NetFrameworkBase.System.Security.Cryptography.Pkcs.CmsRecipient.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Security.Cryptography.Pkcs.CmsRecipient.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Pkcs.CmsRecipient.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.Cryptography.Pkcs.CmsRecipientEnumerator.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.Pkcs.CmsRecipientEnumerator.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Pkcs.CmsRecipientEnumerator.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   (
      this : in out CmsRecipientCollection.Kind;
      array_x : NetFrameworkBase.System.Security.Cryptography.Pkcs.CmsRecipient.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Security.Cryptography.Pkcs.CmsRecipient[]
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.Pkcs.CmsRecipientCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Pkcs.CmsRecipientCollection.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Pkcs.CmsRecipientCollection.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.Pkcs.CmsRecipientCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Pkcs.CmsRecipientCollection.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Pkcs.CmsRecipientCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
