...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.NetworkInformation.GatewayIPAddressInformationCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.NetworkInformation.GatewayIPAddressInformationCollection";
   ...
   procedure CopyTo
   (
      this : in out GatewayIPAddressInformationCollection.Kind;
      array_x : NetFrameworkBase.System.Net.NetworkInformation.GatewayIPAddressInformation.Kind_Array; 
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Net.NetworkInformation.GatewayIPAddressInformation[]
   ...
   return NetFrameworkBase.System.Net.NetworkInformation.GatewayIPAddressInformation.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Net.NetworkInformation.GatewayIPAddressInformation.Kind_Ptr := new NetFrameworkBase.System.Net.NetworkInformation.GatewayIPAddressInformation.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   (
      this : in out GatewayIPAddressInformationCollection.Kind;
      address : NetFrameworkBase.System.Net.NetworkInformation.GatewayIPAddressInformation.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
