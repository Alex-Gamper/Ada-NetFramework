...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.UnmanagedMemoryStream is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.UnmanagedMemoryStream";
   ...
   return NetFrameworkBase.Byte_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("PositionPointer");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Byte_Ptr;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   begin
      return RetVal : NetFrameworkBase.System.IO.UnmanagedMemoryStream.Kind_Ptr := new NetFrameworkBase.System.IO.UnmanagedMemoryStream.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
