...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.TabControl.TabPageCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.TabControl+TabPageCollection";
   ...
   (
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (pages'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in pages'range loop
            ...
            p0_Tmp := GetObject (pages(i).m_Kind);
      ...
      -- fixme parameter type := [array] System.Windows.Forms.TabPage[]
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.TabControl.TabPageCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.TabControl.TabPageCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
