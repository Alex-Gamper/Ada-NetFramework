...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Xml.XmlLicenseTransform is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Xml.XmlLicenseTransform";
   ...
   function InputTypes
   (
      this : in out XmlLicenseTransform.Kind
   )
   ...
   return NetFrameworkBase.System.Security.Cryptography.Xml.IRelDecryptor.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Decryptor");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.Xml.IRelDecryptor.Kind_Ptr;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   (
      this : in out XmlLicenseTransform.Kind;
      value : NetFrameworkBase.System.Security.Cryptography.Xml.IRelDecryptor.Kind_Ptr
   ) is
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.Xml.XmlLicenseTransform.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Xml.XmlLicenseTransform.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Xml.XmlLicenseTransform.Kind do
