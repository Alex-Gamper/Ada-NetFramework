...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Configuration.HttpListenerTimeoutsElement is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Configuration.HttpListenerTimeoutsElement";
   ...
   function EntityBody
   (
      this : in out HttpListenerTimeoutsElement.Kind
   )
   return NetFrameworkBase.System.TimeSpan.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EntityBody");
   ...
   return NetFrameworkBase.System.TimeSpan.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("DrainEntityBody");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.TimeSpan.Kind_Ptr := new NetFrameworkBase.System.TimeSpan.Kind;
   begin
   ...
   return NetFrameworkBase.System.TimeSpan.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RequestQueue");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.TimeSpan.Kind_Ptr := new NetFrameworkBase.System.TimeSpan.Kind;
   begin
   ...
   return NetFrameworkBase.System.TimeSpan.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IdleConnection");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.TimeSpan.Kind_Ptr := new NetFrameworkBase.System.TimeSpan.Kind;
   begin
   ...
   return NetFrameworkBase.System.TimeSpan.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("HeaderWait");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.TimeSpan.Kind_Ptr := new NetFrameworkBase.System.TimeSpan.Kind;
   begin
   ...
   return NetFrameworkBase.Int64 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("MinSendBytesPerSecond");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.Net.Configuration.HttpListenerTimeoutsElement.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Configuration.HttpListenerTimeoutsElement.Kind_Ptr := new NetFrameworkBase.System.Net.Configuration.HttpListenerTimeoutsElement.Kind do
