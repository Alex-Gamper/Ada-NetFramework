...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.HtmlElementCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.HtmlElementCollection";
   ...
   function Item
   (
      this : in out HtmlElementCollection.Kind;
   ...
   return NetFrameworkBase.System.Windows.Forms.HtmlElementCollection.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetElementsByName");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
