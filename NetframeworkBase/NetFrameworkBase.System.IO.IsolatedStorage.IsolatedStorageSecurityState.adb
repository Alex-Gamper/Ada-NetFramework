...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.IsolatedStorage.IsolatedStorageSecurityState is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.IsolatedStorage.IsolatedStorageSecurityState";
   ...
   function Options
   (
      this : in out IsolatedStorageSecurityState.Kind
   )
   return NetFrameworkBase.System.IO.IsolatedStorage.IsolatedStorageSecurityOptions.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.IO.IsolatedStorage.IsolatedStorageSecurityOptions.Kind);
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.IO.IsolatedStorage.IsolatedStorageSecurityOptions.Kind;
   begin
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EnsureState");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
