...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ImeModeConversion is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ImeModeConversion";
   ...
   function IsCurrentConversionTableSupported
   return NetFrameworkBase.Boolean is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsCurrentConversionTableSupported");
