...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.IdnElement is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.IdnElement";
   ...
   function Enabled
   (
      this : in out IdnElement.Kind
   )
   return NetFrameworkBase.System.UriIdnScope.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.UriIdnScope.Kind);
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.UriIdnScope.Kind;
   begin
   ...
   (
      this : in out IdnElement.Kind;
      value : NetFrameworkBase.System.UriIdnScope.Kind
   ) is
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_valueEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.UriIdnScope.Instance;
   ...
   function Constructor return NetFrameworkBase.System.Configuration.IdnElement.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.IdnElement.Kind_Ptr := new NetFrameworkBase.System.Configuration.IdnElement.Kind do
