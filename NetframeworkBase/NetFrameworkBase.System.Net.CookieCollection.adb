...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.CookieCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.CookieCollection";
   ...
   function IsReadOnly
   (
      this : in out CookieCollection.Kind
   )
   ...
   return NetFrameworkBase.System.Net.Cookie.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Net.Cookie.Kind_Ptr := new NetFrameworkBase.System.Net.Cookie.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   (
      this : in out CookieCollection.Kind;
      array_x : NetFrameworkBase.System.Net.Cookie.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Net.Cookie[]
   ...
   function Constructor return NetFrameworkBase.System.Net.CookieCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.CookieCollection.Kind_Ptr := new NetFrameworkBase.System.Net.CookieCollection.Kind do
