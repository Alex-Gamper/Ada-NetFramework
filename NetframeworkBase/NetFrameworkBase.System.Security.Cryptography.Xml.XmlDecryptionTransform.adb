...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Xml.XmlDecryptionTransform is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Xml.XmlDecryptionTransform";
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AddExceptUri");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.Xml.XmlDecryptionTransform.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Xml.XmlDecryptionTransform.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Xml.XmlDecryptionTransform.Kind do
