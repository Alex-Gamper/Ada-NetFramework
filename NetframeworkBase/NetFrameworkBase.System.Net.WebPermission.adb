...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.WebPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.WebPermission";
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := GetObject (uriRegex.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.System.Net.WebPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.WebPermission.Kind_Ptr := new NetFrameworkBase.System.Net.WebPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   function Constructor return NetFrameworkBase.System.Net.WebPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.WebPermission.Kind_Ptr := new NetFrameworkBase.System.Net.WebPermission.Kind do
