...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Double is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Double";
   ...
   begin
      ...
      p_Value.field_1.field_1.vt := VT_R8'Enum_rep;
      -- parameter type := [out] [builtin] System.Double&
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   
      VariantInit(p_Target'access);
      p_RetVal := InvokeMethod (Instance, p_Target, p_MethodName, p_Flags, p_Parameters);
   
      -- set out parameter [result : System.Double]
      p_Index(1) := 1;
