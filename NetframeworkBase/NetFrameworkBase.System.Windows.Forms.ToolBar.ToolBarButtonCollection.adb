...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ToolBar.ToolBarButtonCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ToolBar+ToolBarButtonCollection";
   ...
   return NetFrameworkBase.System.Windows.Forms.ToolBarButton.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Windows.Forms.ToolBarButton.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ToolBarButton.Kind;
   begin
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (button.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   (
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (buttons'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in buttons'range loop
            ...
            p0_Tmp := GetObject (buttons(i).m_Kind);
      ...
      -- fixme parameter type := [array] System.Windows.Forms.ToolBarButton[]
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ToolBar.ToolBarButtonCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ToolBar.ToolBarButtonCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
