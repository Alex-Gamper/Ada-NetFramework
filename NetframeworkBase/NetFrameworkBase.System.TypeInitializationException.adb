...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.TypeInitializationException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.TypeInitializationException";
   ...
   function TypeName
   (
      this : in out TypeInitializationException.Kind
   )
   ...
   return NetFrameworkBase.System.TypeInitializationException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.TypeInitializationException.Kind_Ptr := new NetFrameworkBase.System.TypeInitializationException.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(fullTypeName);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
