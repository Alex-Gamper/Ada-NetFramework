...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Text.DecoderFallbackException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Text.DecoderFallbackException";
   ...
   function BytesUnknown
   (
      this : in out DecoderFallbackException.Kind
   )
   return NetFrameworkBase.Byte_Array is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("BytesUnknown");
   ...
   function Constructor return NetFrameworkBase.System.Text.DecoderFallbackException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Text.DecoderFallbackException.Kind_Ptr := new NetFrameworkBase.System.Text.DecoderFallbackException.Kind do
   ...
   return NetFrameworkBase.System.Text.DecoderFallbackException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Text.DecoderFallbackException.Kind_Ptr := new NetFrameworkBase.System.Text.DecoderFallbackException.Kind do
      declare
   ...
   begin
      ...
      declare
         ...
         p1_Bounds     : aliased SAFEARRAYBOUND := (bytesUnknown'Length , 0);
      ...
      begin
         ...
         begin
            ...
            for i in bytesUnknown'range loop
               p1_Index(1) := Interfaces.C.long(i) - 1;
               p1_Tmp := bytesUnknown(i);
