...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.HashAlgorithmName is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.HashAlgorithmName";
   ...
   function Name
   (
      this : in out HashAlgorithmName.Kind
   )
   ...
   (
      this : in out HashAlgorithmName.Kind;
      other : NetFrameworkBase.System.Security.Cryptography.HashAlgorithmName.Kind_Ptr
   )
   return NetFrameworkBase.Boolean is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   return NetFrameworkBase.System.Security.Cryptography.HashAlgorithmName.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.HashAlgorithmName.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.HashAlgorithmName.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
