...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ImageListStreamer is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ImageListStreamer";
   ...
   procedure Dispose
   (
      this : in out ImageListStreamer.Kind
   ) is
      Hr            : HResult := 0;
