...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.SettingsLoadedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.SettingsLoadedEventArgs";
   ...
   function Provider
   (
      this : in out SettingsLoadedEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Configuration.SettingsLoadedEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.SettingsLoadedEventArgs.Kind_Ptr := new NetFrameworkBase.System.Configuration.SettingsLoadedEventArgs.Kind do
      declare
