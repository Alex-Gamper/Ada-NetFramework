...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.CompilerServices.TupleElementNamesAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.CompilerServices.TupleElementNamesAttribute";
   ...
   return NetFrameworkBase.System.Runtime.CompilerServices.TupleElementNamesAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.CompilerServices.TupleElementNamesAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.CompilerServices.TupleElementNamesAttribute.Kind do
      declare
         ...
         p0_Bounds     : aliased SAFEARRAYBOUND := (transformNames'Length , 0);
      ...
      begin
         ...
         begin
            ...
            for i in transformNames'range loop
               p0_Index(1) := Interfaces.C.long(i) - 1;
               p0_Tmp := transformNames(i);
