...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.SaveFileDialog is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.SaveFileDialog";
   ...
   procedure Reset
   (
      this : in out SaveFileDialog.Kind
   ) is
      Hr            : HResult := 0;
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CreatePrompt");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("OverwritePrompt");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Boolean;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Windows.Forms.SaveFileDialog.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.SaveFileDialog.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.SaveFileDialog.Kind do
