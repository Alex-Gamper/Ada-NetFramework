...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.DataObjectFieldAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.DataObjectFieldAttribute";
   ...
   function IsIdentity
   (
      this : in out DataObjectFieldAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.ComponentModel.DataObjectFieldAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.DataObjectFieldAttribute.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.DataObjectFieldAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
