...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.CodeDom.CodeArrayCreateExpression is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.CodeDom.CodeArrayCreateExpression";
   ...
   function CreateType
   (
      this : in out CodeArrayCreateExpression.Kind
   )
   ...
   return NetFrameworkBase.System.CodeDom.CodeExpressionCollection.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Initializers");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.CodeDom.CodeExpression.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SizeExpression");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   function Constructor return NetFrameworkBase.System.CodeDom.CodeArrayCreateExpression.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.CodeDom.CodeArrayCreateExpression.Kind_Ptr := new NetFrameworkBase.System.CodeDom.CodeArrayCreateExpression.Kind do
   ...
   return NetFrameworkBase.System.CodeDom.CodeArrayCreateExpression.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.CodeDom.CodeArrayCreateExpression.Kind_Ptr := new NetFrameworkBase.System.CodeDom.CodeArrayCreateExpression.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (createType.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         declare
