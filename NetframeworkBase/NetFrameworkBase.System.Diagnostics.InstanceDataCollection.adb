...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.InstanceDataCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.InstanceDataCollection";
   ...
   (
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (instances'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in instances'range loop
            ...
            p0_Tmp := GetObject (instances(i).m_Kind);
      ...
      -- fixme parameter type := [array] System.Diagnostics.InstanceData[]
   ...
   return NetFrameworkBase.System.Diagnostics.InstanceData.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      p_Bounds      : aliased SAFEARRAYBOUND := (1 , 0);
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Diagnostics.InstanceData.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.InstanceData.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.InstanceDataCollection.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.InstanceDataCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
