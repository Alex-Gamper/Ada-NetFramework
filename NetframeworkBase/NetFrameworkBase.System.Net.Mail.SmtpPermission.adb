...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Mail.SmtpPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Mail.SmtpPermission";
   ...
   return NetFrameworkBase.System.Net.Mail.SmtpAccess.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Net.Mail.SmtpAccess.Kind);
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Net.Mail.SmtpAccess.Kind;
   begin
   ...
   (
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_access_xEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Net.Mail.SmtpAccess.Instance;
   ...
   return NetFrameworkBase.System.Net.Mail.SmtpPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Mail.SmtpPermission.Kind_Ptr := new NetFrameworkBase.System.Net.Mail.SmtpPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(unrestricted);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
