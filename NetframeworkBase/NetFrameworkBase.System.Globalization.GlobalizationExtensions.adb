...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Globalization.GlobalizationExtensions is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Globalization.GlobalizationExtensions";
   ...
   (
      compareInfo : NetFrameworkBase.System.Globalization.CompareInfo.Kind_Ptr; 
   ...
   return NetFrameworkBase.System.StringComparer.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("GetStringComparer");
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (compareInfo.m_Kind);
