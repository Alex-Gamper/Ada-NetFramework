...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.Odbc.OdbcErrorCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.Odbc.OdbcErrorCollection";
   ...
   function Count
   (
      this : in out OdbcErrorCollection.Kind
   )
   ...
   return NetFrameworkBase.System.Data.Odbc.OdbcError.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Data.Odbc.OdbcError.Kind_Ptr := new NetFrameworkBase.System.Data.Odbc.OdbcError.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   (
      this : in out OdbcErrorCollection.Kind;
      array_x : NetFrameworkBase.System.Data.Odbc.OdbcError.Kind_Array; 
      i : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Data.Odbc.OdbcError[]
