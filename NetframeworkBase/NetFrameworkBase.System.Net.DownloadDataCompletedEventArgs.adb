...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.DownloadDataCompletedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.DownloadDataCompletedEventArgs";
   ...
   function Result
   (
      this : in out DownloadDataCompletedEventArgs.Kind
   )
