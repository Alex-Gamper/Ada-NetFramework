...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.BooleanSwitch is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.BooleanSwitch";
   ...
   function Enabled
   (
      this : in out BooleanSwitch.Kind
   )
   ...
   return NetFrameworkBase.System.Diagnostics.BooleanSwitch.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.BooleanSwitch.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.BooleanSwitch.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
