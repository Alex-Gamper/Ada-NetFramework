...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.FileDialogPermissionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.FileDialogPermissionAttribute";
   ...
   function Open
   (
      this : in out FileDialogPermissionAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Security.Permissions.FileDialogPermissionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.FileDialogPermissionAttribute.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.FileDialogPermissionAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
