...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Linq.Expressions.MemberInitExpression is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Linq.Expressions.MemberInitExpression";
   ...
   function Type_x
   (
      this : in out MemberInitExpression.Kind
   )
