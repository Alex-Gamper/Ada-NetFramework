...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Threading.ManualResetEvent is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Threading.ManualResetEvent";
   ...
   return NetFrameworkBase.System.Threading.ManualResetEvent.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Threading.ManualResetEvent.Kind_Ptr := new NetFrameworkBase.System.Threading.ManualResetEvent.Kind do
      declare
