...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Policy.ZoneMembershipCondition is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Policy.ZoneMembershipCondition";
   ...
   (
      this : in out ZoneMembershipCondition.Kind;
   ...
   return NetFrameworkBase.System.Security.Policy.ZoneMembershipCondition.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Policy.ZoneMembershipCondition.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.ZoneMembershipCondition.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
