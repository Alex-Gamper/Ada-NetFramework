...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.RetrieveVirtualItemEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.RetrieveVirtualItemEventArgs";
   ...
   function ItemIndex
   (
      this : in out RetrieveVirtualItemEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.RetrieveVirtualItemEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.RetrieveVirtualItemEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.RetrieveVirtualItemEventArgs.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
