...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Markup.ValueSerializerAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Markup.ValueSerializerAttribute";
   ...
   function ValueSerializerType
   (
      this : in out ValueSerializerAttribute.Kind
   )
   return NetFrameworkBase.System.Type_x.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ValueSerializerType");
   ...
   function ValueSerializerTypeName
   (
      this : in out ValueSerializerAttribute.Kind
   )
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ValueSerializerTypeName");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Windows.Markup.ValueSerializerAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Markup.ValueSerializerAttribute.Kind_Ptr := new NetFrameworkBase.System.Windows.Markup.ValueSerializerAttribute.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (valueSerializerType.m_Kind);
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(valueSerializerTypeName);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
