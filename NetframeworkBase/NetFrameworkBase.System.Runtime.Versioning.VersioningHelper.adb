...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Versioning.VersioningHelper is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Versioning.VersioningHelper";
   ...
   (
      ...
      from : NetFrameworkBase.System.Runtime.Versioning.ResourceScope.Kind; 
      to : NetFrameworkBase.System.Runtime.Versioning.ResourceScope.Kind; 
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_MethodName  : BSTR := To_BSTR("MakeVersionSafeName");
      p_RetVal      : aliased VARIANT;
      p_fromEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Runtime.Versioning.ResourceScope.Instance;
      p_fromEnum : aliased VARIANT := To_Variant (CreateEnum (p_fromEnumType, from'Enum_rep));
      p_toEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Runtime.Versioning.ResourceScope.Instance;
      p_toEnum : aliased VARIANT := To_Variant (CreateEnum (p_toEnumType, to'Enum_rep));
