...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Text.RegularExpressions.Group is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Text.RegularExpressions.Group";
   ...
   function Success
   (
      this : in out Group.Kind
   )
   return NetFrameworkBase.Boolean is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Success");
   ...
   return NetFrameworkBase.System.Text.RegularExpressions.CaptureCollection.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Captures");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Text.RegularExpressions.CaptureCollection.Kind_Ptr := new NetFrameworkBase.System.Text.RegularExpressions.CaptureCollection.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   (
      inner : NetFrameworkBase.System.Text.RegularExpressions.Group.Kind_Ptr
   )
   return NetFrameworkBase.System.Text.RegularExpressions.Group.Kind_Ptr is
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Text.RegularExpressions.Group.Kind_Ptr := new NetFrameworkBase.System.Text.RegularExpressions.Group.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
