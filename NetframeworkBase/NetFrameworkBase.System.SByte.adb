...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.SByte is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.SByte";
   ...
   begin
      ...
      p_Value.field_1.field_1.vt := VT_I1'Enum_rep;
      -- parameter type := [out] [builtin] System.SByte&
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   
      VariantInit(p_Target'access);
      p_RetVal := InvokeMethod (Instance, p_Target, p_MethodName, p_Flags, p_Parameters);
   
      -- set out parameter [result : System.SByte]
      p_Index(1) := 1;
