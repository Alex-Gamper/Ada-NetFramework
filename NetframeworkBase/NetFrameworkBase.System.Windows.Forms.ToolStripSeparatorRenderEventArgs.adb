...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ToolStripSeparatorRenderEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ToolStripSeparatorRenderEventArgs";
   ...
   function Vertical
   (
      this : in out ToolStripSeparatorRenderEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.ToolStripSeparatorRenderEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ToolStripSeparatorRenderEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ToolStripSeparatorRenderEventArgs.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := GetObject (separator.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 2;
         p_Value := To_Variant(vertical);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
