...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509KeyUsageExtension is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.X509Certificates.X509KeyUsageExtension";
   ...
   function KeyUsages
   (
      this : in out X509KeyUsageExtension.Kind
   )
   return NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509KeyUsageFlags.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509KeyUsageFlags.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("KeyUsages");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509KeyUsageFlags.Kind;
   begin
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509KeyUsageExtension.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509KeyUsageExtension.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509KeyUsageExtension.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509KeyUsageExtension.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509KeyUsageExtension.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509KeyUsageExtension.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_keyUsagesEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509KeyUsageFlags.Instance;
         p_keyUsagesEnum : aliased VARIANT := To_Variant (CreateEnum (p_keyUsagesEnumType, keyUsages'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := p_keyUsagesEnum;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (encodedKeyUsage.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(critical);
