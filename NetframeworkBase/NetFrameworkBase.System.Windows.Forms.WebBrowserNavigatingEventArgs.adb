...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.WebBrowserNavigatingEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.WebBrowserNavigatingEventArgs";
   ...
   function Url
   (
      this : in out WebBrowserNavigatingEventArgs.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("TargetFrameName");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Windows.Forms.WebBrowserNavigatingEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.WebBrowserNavigatingEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.WebBrowserNavigatingEventArgs.Kind do
      declare
