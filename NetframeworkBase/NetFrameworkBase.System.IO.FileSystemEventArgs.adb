...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.FileSystemEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.FileSystemEventArgs";
   ...
   function ChangeType
   (
      this : in out FileSystemEventArgs.Kind
   )
   return NetFrameworkBase.System.IO.WatcherChangeTypes.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.IO.WatcherChangeTypes.Kind);
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.IO.WatcherChangeTypes.Kind;
   begin
   ...
   return NetFrameworkBase.System.IO.FileSystemEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.IO.FileSystemEventArgs.Kind_Ptr := new NetFrameworkBase.System.IO.FileSystemEventArgs.Kind do
      declare
