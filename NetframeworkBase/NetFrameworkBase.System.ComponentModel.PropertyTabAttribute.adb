...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.PropertyTabAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.PropertyTabAttribute";
   ...
   function TabScopes
   (
      this : in out PropertyTabAttribute.Kind
   )
   return NetFrameworkBase.System.ComponentModel.PropertyTabScope.Kind_Array is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("TabScopes");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   
      function GetArray (sa : access NetFrameworkWin32.SAFEARRAY) return NetFrameworkBase.System.ComponentModel.PropertyTabScope.Kind_Array is
      ...
      begin
         ...
         declare
            RetVal : NetFrameworkBase.System.ComponentModel.PropertyTabScope.Kind_Array(1..integer(Index));
            Value  : aliased NetFrameworkBase.System.ComponentModel.PropertyTabScope.Kind;
   ...
   (
      this : in out PropertyTabAttribute.Kind;
      other : NetFrameworkBase.System.ComponentModel.PropertyTabAttribute.Kind_Ptr
   )
   return NetFrameworkBase.Boolean is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   return NetFrameworkBase.System.Type_x.Kind_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("TabClasses");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   function Constructor return NetFrameworkBase.System.ComponentModel.PropertyTabAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.PropertyTabAttribute.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.PropertyTabAttribute.Kind do
   ...
   return NetFrameworkBase.System.ComponentModel.PropertyTabAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.PropertyTabAttribute.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.PropertyTabAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (tabClass.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(tabClassName);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
