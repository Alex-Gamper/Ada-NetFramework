...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Linq.Expressions.SwitchCase is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Linq.Expressions.SwitchCase";
