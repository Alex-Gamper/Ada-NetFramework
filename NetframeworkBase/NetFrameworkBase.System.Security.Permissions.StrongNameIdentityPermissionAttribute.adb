...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.StrongNameIdentityPermissionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.StrongNameIdentityPermissionAttribute";
   ...
   function Name
   (
      this : in out StrongNameIdentityPermissionAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Security.Permissions.StrongNameIdentityPermissionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.StrongNameIdentityPermissionAttribute.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.StrongNameIdentityPermissionAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
