...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.Contracts.ContractOptionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.Contracts.ContractOptionAttribute";
   ...
   function Category
   (
      this : in out ContractOptionAttribute.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Setting");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.Diagnostics.Contracts.ContractOptionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.Contracts.ContractOptionAttribute.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.Contracts.ContractOptionAttribute.Kind do
      declare
