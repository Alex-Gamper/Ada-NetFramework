...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Threading.AutoResetEvent is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Threading.AutoResetEvent";
   ...
   return NetFrameworkBase.System.Threading.AutoResetEvent.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Threading.AutoResetEvent.Kind_Ptr := new NetFrameworkBase.System.Threading.AutoResetEvent.Kind do
      declare
