...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Transactions.TransactionInterop is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Transactions.TransactionInterop";
   ...
   return NetFrameworkBase.Byte_Array is
      ...
      p_MethodName  : BSTR := To_BSTR("GetExportCookie");
      p_RetVal      : aliased VARIANT;
      p1_Parameters : aliased LPSAFEARRAY := null;
      p1_Bounds     : aliased SAFEARRAYBOUND := (whereabouts'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in whereabouts'range loop
            p1_Index(1) := Interfaces.C.long(i) - 1;
            p1_Tmp := whereabouts(i);
   ...
   return NetFrameworkBase.System.Transactions.Transaction.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetTransactionFromExportCookie");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p0_Parameters : aliased LPSAFEARRAY := null;
      p0_Bounds     : aliased SAFEARRAYBOUND := (cookie'Length , 0);
   ...
   return NetFrameworkBase.Byte_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetTransmitterPropagationToken");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Transactions.Transaction.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetTransactionFromTransmitterPropagationToken");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p0_Parameters : aliased LPSAFEARRAY := null;
      p0_Bounds     : aliased SAFEARRAYBOUND := (propagationToken'Length , 0);
      p0_Index      : aliased array(1..1) of aliased LONG := (others => 0);
      p0_Tmp        : aliased NetFrameworkBase.Byte;
      p0_Tmp_Ptr    : access NetFrameworkBase.Byte := p0_Tmp'access;
      RetVal        : NetFrameworkBase.System.Transactions.Transaction.Kind_Ptr := new NetFrameworkBase.System.Transactions.Transaction.Kind;
   begin
      ...
      begin
         p0_Parameters := SafeArrayCreate (VT_UI1'enum_rep, 1, p0_Bounds'access);
         for i in propagationToken'range loop
            p0_Index(1) := Interfaces.C.long(i) - 1;
            p0_Tmp := propagationToken(i);
            Hr := SafeArrayPutElement (p0_Parameters, p0_Index (p0_Index'first)'access, Convert (p0_Tmp_Ptr));
         end loop;
         p_Value := To_Variant (p0_Parameters, VT_UI1);
      end;
   ...
   return NetFrameworkBase.System.Transactions.IDtcTransaction.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      p_Bounds      : aliased SAFEARRAYBOUND := (1 , 0);
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetDtcTransaction");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Transactions.IDtcTransaction.Kind_Ptr;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Static)'Enum_rep;
   ...
   return NetFrameworkBase.System.Transactions.Transaction.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetTransactionFromDtcTransaction");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Transactions.Transaction.Kind_Ptr := new NetFrameworkBase.System.Transactions.Transaction.Kind;
   begin
      ...
      p_Value.field_1.field_1.field_1.punkVal := transactionNative;
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.Byte_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetWhereabouts");
      p_RetVal      : aliased VARIANT;
