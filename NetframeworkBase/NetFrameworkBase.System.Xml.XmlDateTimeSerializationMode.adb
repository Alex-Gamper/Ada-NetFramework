...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.XmlDateTimeSerializationMode is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.XmlDateTimeSerializationMode";
