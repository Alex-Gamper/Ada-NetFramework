...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Text.RegularExpressions.MatchCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Text.RegularExpressions.MatchCollection";
   ...
   function Count
   (
      this : in out MatchCollection.Kind
   )
