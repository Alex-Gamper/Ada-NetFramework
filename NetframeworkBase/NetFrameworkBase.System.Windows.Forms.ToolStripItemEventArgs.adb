...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ToolStripItemEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ToolStripItemEventArgs";
   ...
   function Item
   (
      this : in out ToolStripItemEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.ToolStripItemEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ToolStripItemEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ToolStripItemEventArgs.Kind do
      declare
