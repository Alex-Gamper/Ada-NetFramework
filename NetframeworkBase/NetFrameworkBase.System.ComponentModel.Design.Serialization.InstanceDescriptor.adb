...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.Design.Serialization.InstanceDescriptor is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.Design.Serialization.InstanceDescriptor";
   ...
   function Arguments
   (
      this : in out InstanceDescriptor.Kind
   )
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsComplete");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.ComponentModel.Design.Serialization.InstanceDescriptor.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.Design.Serialization.InstanceDescriptor.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.Design.Serialization.InstanceDescriptor.Kind do
      declare
      ...
      begin
         ...
         p_Value.field_1.field_1.field_1.punkVal := arguments;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
