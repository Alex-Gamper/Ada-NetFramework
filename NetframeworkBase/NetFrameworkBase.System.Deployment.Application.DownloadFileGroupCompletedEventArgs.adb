...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Deployment.Application.DownloadFileGroupCompletedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Deployment.Application.DownloadFileGroupCompletedEventArgs";
   ...
   function Group
   (
      this : in out DownloadFileGroupCompletedEventArgs.Kind
   )
