...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Serialization.XmlIncludeAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Serialization.XmlIncludeAttribute";
   ...
   function Type_x
   (
      this : in out XmlIncludeAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Xml.Serialization.XmlIncludeAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Serialization.XmlIncludeAttribute.Kind_Ptr := new NetFrameworkBase.System.Xml.Serialization.XmlIncludeAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
