...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ListView.SelectedIndexCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ListView+SelectedIndexCollection";
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ListView.SelectedIndexCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ListView.SelectedIndexCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
