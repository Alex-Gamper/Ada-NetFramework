...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.XmlSchemaAnnotation is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.XmlSchemaAnnotation";
   ...
   function Id
   (
      this : in out XmlSchemaAnnotation.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Xml.Schema.XmlSchemaAnnotation.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Schema.XmlSchemaAnnotation.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaAnnotation.Kind do
