...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Resources.ResXFileRef is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Resources.ResXFileRef";
   ...
   return NetFrameworkBase.System.Text.Encoding.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("TextFileEncoding");
      p_RetVal      : aliased VARIANT;
   ...
   begin
      return RetVal : NetFrameworkBase.System.Resources.ResXFileRef.Kind_Ptr := new NetFrameworkBase.System.Resources.ResXFileRef.Kind do
      declare
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 2;
         p_Value := GetObject (textFileEncoding.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
