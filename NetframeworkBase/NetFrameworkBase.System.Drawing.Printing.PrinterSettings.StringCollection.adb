...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Drawing.Printing.PrinterSettings.StringCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Drawing.Printing.PrinterSettings+StringCollection";
   ...
   (
      this : in out StringCollection.Kind;
      strings : NetFrameworkBase.BSTR_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (strings'Length , 0);
   ...
   begin
      return RetVal : NetFrameworkBase.System.Drawing.Printing.PrinterSettings.StringCollection.Kind_Ptr := new NetFrameworkBase.System.Drawing.Printing.PrinterSettings.StringCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
