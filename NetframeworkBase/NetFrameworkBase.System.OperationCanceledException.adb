...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.OperationCanceledException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.OperationCanceledException";
   ...
   (
      this : in out OperationCanceledException.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.OperationCanceledException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.OperationCanceledException.Kind_Ptr := new NetFrameworkBase.System.OperationCanceledException.Kind do
   ...
   return NetFrameworkBase.System.OperationCanceledException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.OperationCanceledException.Kind_Ptr := new NetFrameworkBase.System.OperationCanceledException.Kind do
      declare
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (token.m_Kind); -- Parameter Type = ValueType
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
