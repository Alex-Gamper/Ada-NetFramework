...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.KeyedHashAlgorithm is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.KeyedHashAlgorithm";
   ...
   function Key
   (
      this : in out KeyedHashAlgorithm.Kind
   )
   ...
   return NetFrameworkBase.System.Security.Cryptography.KeyedHashAlgorithm.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      p_Bounds      : aliased SAFEARRAYBOUND := (1 , 0);
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.KeyedHashAlgorithm.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.KeyedHashAlgorithm.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
