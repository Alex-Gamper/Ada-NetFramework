...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Policy.Hash is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Policy.Hash";
   ...
   return NetFrameworkBase.System.Security.Policy.Hash.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("CreateSHA1");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p0_Parameters : aliased LPSAFEARRAY := null;
      p0_Bounds     : aliased SAFEARRAYBOUND := (sha1'Length , 0);
      ...
      RetVal        : NetFrameworkBase.System.Security.Policy.Hash.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.Hash.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.Policy.Hash.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CreateSHA256");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p0_Parameters : aliased LPSAFEARRAY := null;
      p0_Bounds     : aliased SAFEARRAYBOUND := (sha256'Length , 0);
      p0_Index      : aliased array(1..1) of aliased LONG := (others => 0);
      p0_Tmp        : aliased NetFrameworkBase.Byte;
      p0_Tmp_Ptr    : access NetFrameworkBase.Byte := p0_Tmp'access;
      RetVal        : NetFrameworkBase.System.Security.Policy.Hash.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.Hash.Kind;
   ...
   return NetFrameworkBase.System.Security.Policy.Hash.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CreateMD5");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p0_Parameters : aliased LPSAFEARRAY := null;
      p0_Bounds     : aliased SAFEARRAYBOUND := (md5'Length , 0);
      p0_Index      : aliased array(1..1) of aliased LONG := (others => 0);
      p0_Tmp        : aliased NetFrameworkBase.Byte;
      p0_Tmp_Ptr    : access NetFrameworkBase.Byte := p0_Tmp'access;
      RetVal        : NetFrameworkBase.System.Security.Policy.Hash.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.Hash.Kind;
   ...
   return NetFrameworkBase.Byte_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GenerateHash");
      p_RetVal      : aliased VARIANT;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (hashAlg.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.System.Security.Policy.Hash.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Policy.Hash.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.Hash.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
