...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ButtonBase.ButtonBaseAccessibleObject is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ButtonBase+ButtonBaseAccessibleObject";
   ...
   (
      this : in out ButtonBaseAccessibleObject.Kind
   ) is
      Hr            : HResult := 0;
   ...
   return NetFrameworkBase.System.Windows.Forms.ButtonBase.ButtonBaseAccessibleObject.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ButtonBase.ButtonBaseAccessibleObject.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ButtonBase.ButtonBaseAccessibleObject.Kind do
      declare
