...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Management.Instrumentation.ManagementMemberAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Management.Instrumentation.ManagementMemberAttribute";
   ...
   function Name
   (
      this : in out ManagementMemberAttribute.Kind
   )
