...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Collections.Specialized.NameObjectCollectionBase.KeysCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Collections.Specialized.NameObjectCollectionBase+KeysCollection";
   ...
   function Get
   (
      this : in out KeysCollection.Kind;
