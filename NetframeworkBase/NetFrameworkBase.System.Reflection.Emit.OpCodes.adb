...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Reflection.Emit.OpCodes is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Reflection.Emit.OpCodes";
   ...
   (
      inst : NetFrameworkBase.System.Reflection.Emit.OpCode.Kind_Ptr
   )
   return NetFrameworkBase.Boolean is
      ...
      p_MethodName  : BSTR := To_BSTR("TakesSingleByteArgument");
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (inst.m_Kind); -- Parameter Type = ValueType
