...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.SocketPermissionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.SocketPermissionAttribute";
   ...
   function Access_x
   (
      this : in out SocketPermissionAttribute.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Transport");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.Net.SocketPermissionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.SocketPermissionAttribute.Kind_Ptr := new NetFrameworkBase.System.Net.SocketPermissionAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
