...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.EnterpriseServices.SecurityCallers is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.EnterpriseServices.SecurityCallers";
   ...
   function Count
   (
      this : in out SecurityCallers.Kind
   )
