...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.SqlClient.SqlAuthenticationToken is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.SqlClient.SqlAuthenticationToken";
   ...
   function ExpiresOn
   (
      this : in out SqlAuthenticationToken.Kind
   )
   return NetFrameworkBase.System.DateTimeOffset.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ExpiresOn");
   ...
   return NetFrameworkBase.System.Data.SqlClient.SqlAuthenticationToken.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Data.SqlClient.SqlAuthenticationToken.Kind_Ptr := new NetFrameworkBase.System.Data.SqlClient.SqlAuthenticationToken.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(accessToken);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := GetObject (expiresOn.m_Kind); -- Parameter Type = ValueType
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
