...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Policy.ApplicationTrustEnumerator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Policy.ApplicationTrustEnumerator";
   ...
   function Current
   (
      this : in out ApplicationTrustEnumerator.Kind
   )
