...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Serialization.Configuration.SchemaImporterExtensionElement is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Serialization.Configuration.SchemaImporterExtensionElement";
   ...
   function Name
   (
      this : in out SchemaImporterExtensionElement.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Xml.Serialization.Configuration.SchemaImporterExtensionElement.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Serialization.Configuration.SchemaImporterExtensionElement.Kind_Ptr := new NetFrameworkBase.System.Xml.Serialization.Configuration.SchemaImporterExtensionElement.Kind do
