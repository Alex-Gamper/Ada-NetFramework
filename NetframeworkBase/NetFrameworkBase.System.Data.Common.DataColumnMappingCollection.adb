...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.Common.DataColumnMappingCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.Common.DataColumnMappingCollection";
   ...
   function Count
   (
      this : in out DataColumnMappingCollection.Kind
   )
   ...
   (
      columnMappings : NetFrameworkBase.System.Data.Common.DataColumnMappingCollection.Kind_Ptr; 
      sourceColumn : NetFrameworkBase.BSTR; 
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (columnMappings.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := To_Variant(sourceColumn);
   ...
   (
      this : in out DataColumnMappingCollection.Kind;
      index : NetFrameworkBase.Int32; 
      value : NetFrameworkBase.System.Data.Common.DataColumnMapping.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := To_Variant(dataSetColumn);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   (
      this : in out DataColumnMappingCollection.Kind;
      values : NetFrameworkBase.System.Data.Common.DataColumnMapping.Kind_Array
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   (
      this : in out DataColumnMappingCollection.Kind;
      array_x : NetFrameworkBase.System.Data.Common.DataColumnMapping.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   return NetFrameworkBase.System.Data.Common.DataColumnMapping.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetByDataSetColumn");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Data.Common.DataColumnMapping.Kind_Ptr := new NetFrameworkBase.System.Data.Common.DataColumnMapping.Kind;
   begin
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IndexOfDataSetColumn");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Int32;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Data.Common.DataColumnMappingCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Data.Common.DataColumnMappingCollection.Kind_Ptr := new NetFrameworkBase.System.Data.Common.DataColumnMappingCollection.Kind do
