...
--------------------------------------------------------------------------------
package NetFrameworkBase.System.Runtime.Remoting.Contexts.IDynamicMessageSink is
   ...
   type Kind_Array_Ptr is access all Kind_Array;
      ...
      (
         this : in out IDynamicMessageSink.Kind;
         reqMsg : NetFrameworkBase.System.Runtime.Remoting.Messaging.IMessage.Kind_Ptr;
         bCliSide : NetFrameworkBase.Boolean;
         bAsync : NetFrameworkBase.Boolean
      ) return HResult is abstract;
      
      function ProcessMessageFinish
      (
         this : in out IDynamicMessageSink.Kind;
         replyMsg : NetFrameworkBase.System.Runtime.Remoting.Messaging.IMessage.Kind_Ptr;
         bCliSide : NetFrameworkBase.Boolean;
         bAsync : NetFrameworkBase.Boolean
      ) return HResult is abstract;
   ...
   private
      ...
      This_TypeName     : constant Standard.Wide_String := "System.Runtime.Remoting.Contexts.IDynamicMessageSink";
