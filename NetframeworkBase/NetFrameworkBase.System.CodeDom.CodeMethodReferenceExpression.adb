...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.CodeDom.CodeMethodReferenceExpression is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.CodeDom.CodeMethodReferenceExpression";
   ...
   return NetFrameworkBase.System.CodeDom.CodeExpression.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("TargetObject");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   function Constructor return NetFrameworkBase.System.CodeDom.CodeMethodReferenceExpression.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.CodeDom.CodeMethodReferenceExpression.Kind_Ptr := new NetFrameworkBase.System.CodeDom.CodeMethodReferenceExpression.Kind do
   ...
   begin
      ...
      declare
         ...
         p2_Bounds     : aliased SAFEARRAYBOUND := (typeParameters'Length , 0);
      ...
      begin
         ...
         begin
            ...
            for i in typeParameters'range loop
               p2_Index(1) := Interfaces.C.long(i) - 1;
               p2_Tmp := GetObject (typeParameters(i).m_Kind);
