...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.LicFileLicenseProvider is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.LicFileLicenseProvider";
   ...
   function GetLicense
   (
      this : in out LicFileLicenseProvider.Kind;
   ...
   return NetFrameworkBase.System.ComponentModel.License.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("GetLicense");
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 3;
      p_Value := To_Variant(allowExceptions);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   function Constructor return NetFrameworkBase.System.ComponentModel.LicFileLicenseProvider.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.LicFileLicenseProvider.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.LicFileLicenseProvider.Kind do
