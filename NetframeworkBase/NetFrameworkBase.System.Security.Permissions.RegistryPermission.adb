...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.RegistryPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.RegistryPermission";
   ...
   (
      ...
      p_access_xEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Permissions.RegistryPermissionAccess.Instance;
   ...
   return NetFrameworkBase.System.Security.Permissions.RegistryPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.RegistryPermission.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.RegistryPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
