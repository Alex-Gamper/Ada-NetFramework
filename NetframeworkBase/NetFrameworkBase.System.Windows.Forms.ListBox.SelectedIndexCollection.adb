...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ListBox.SelectedIndexCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ListBox+SelectedIndexCollection";
   ...
   function Count
   (
      this : in out SelectedIndexCollection.Kind
   )
   ...
   (
      this : in out SelectedIndexCollection.Kind;
      selectedIndex : NetFrameworkBase.Int32
   )
   return NetFrameworkBase.Boolean is
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := To_Variant(selectedIndex);
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ListBox.SelectedIndexCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ListBox.SelectedIndexCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
