...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.RSAPKCS1KeyExchangeFormatter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.RSAPKCS1KeyExchangeFormatter";
   ...
   function Rng
   (
      this : in out RSAPKCS1KeyExchangeFormatter.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.RSAPKCS1KeyExchangeFormatter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.RSAPKCS1KeyExchangeFormatter.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.RSAPKCS1KeyExchangeFormatter.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.RSAPKCS1KeyExchangeFormatter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.RSAPKCS1KeyExchangeFormatter.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.RSAPKCS1KeyExchangeFormatter.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
