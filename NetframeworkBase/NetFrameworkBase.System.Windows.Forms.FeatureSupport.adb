...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.FeatureSupport is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.FeatureSupport";
   ...
   function IsPresent
   (
      featureClassName : NetFrameworkBase.BSTR; 
      featureConstName : NetFrameworkBase.BSTR
   )
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := To_Variant(featureClassName);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := To_Variant(featureConstName);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   (
      featureClassName : NetFrameworkBase.BSTR; 
      featureConstName : NetFrameworkBase.BSTR; 
      minimumVersion : NetFrameworkBase.System.Version.Kind_Ptr
   )
   return NetFrameworkBase.Boolean is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 2;
      p_Value := GetObject (minimumVersion.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   function IsPresent
   (
      this : in out FeatureSupport.Kind;
