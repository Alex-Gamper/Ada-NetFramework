...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.RIPEMD160Managed is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.RIPEMD160Managed";
   ...
   (
      this : in out RIPEMD160Managed.Kind
   ) is
      Hr            : HResult := 0;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.RIPEMD160Managed.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.RIPEMD160Managed.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.RIPEMD160Managed.Kind do
