...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.DesignerServices.WindowsRuntimeDesignerContext is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.DesignerServices.WindowsRuntimeDesignerContext";
   ...
   procedure SetIterationContext
   (
      context : NetFrameworkBase.System.Runtime.DesignerServices.WindowsRuntimeDesignerContext.Kind_Ptr
   )
   is
      ...
      p_MethodName  : BSTR := To_BSTR("SetIterationContext");
   ...
   (
      this : in out WindowsRuntimeDesignerContext.Kind;
