...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.ZoneIdentityPermissionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.ZoneIdentityPermissionAttribute";
   ...
   function Zone
   (
      this : in out ZoneIdentityPermissionAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Security.Permissions.ZoneIdentityPermissionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.ZoneIdentityPermissionAttribute.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.ZoneIdentityPermissionAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
