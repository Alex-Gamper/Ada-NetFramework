...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DateRangeEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DateRangeEventArgs";
   ...
   function Start
   (
      this : in out DateRangeEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.DateRangeEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.DateRangeEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.DateRangeEventArgs.Kind do
      declare
