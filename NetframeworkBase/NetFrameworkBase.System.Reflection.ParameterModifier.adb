...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Reflection.ParameterModifier is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Reflection.ParameterModifier";
   ...
   return NetFrameworkBase.System.Reflection.ParameterModifier.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Reflection.ParameterModifier.Kind_Ptr := new NetFrameworkBase.System.Reflection.ParameterModifier.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(parameterCount);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
