...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.DataSetSchemaImporterExtension is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.DataSetSchemaImporterExtension";
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := To_Variant(schemaNamespace);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 2;
   ...
   function Constructor return NetFrameworkBase.System.Data.DataSetSchemaImporterExtension.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Data.DataSetSchemaImporterExtension.Kind_Ptr := new NetFrameworkBase.System.Data.DataSetSchemaImporterExtension.Kind do
