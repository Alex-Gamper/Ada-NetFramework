...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleType is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.XmlSchemaSimpleType";
   ...
   function Content
   (
      this : in out XmlSchemaSimpleType.Kind
   )
   return NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleTypeContent.Kind_Ptr is
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleTypeContent.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleTypeContent.Kind;
   begin
   ...
   (
      this : in out XmlSchemaSimpleType.Kind;
      value : NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleTypeContent.Kind_Ptr
   ) is
   ...
   function Constructor return NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleType.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleType.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleType.Kind do
