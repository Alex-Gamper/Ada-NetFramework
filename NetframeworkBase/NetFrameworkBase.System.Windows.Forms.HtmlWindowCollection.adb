...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.HtmlWindowCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.HtmlWindowCollection";
   ...
   function Count
   (
      this : in out HtmlWindowCollection.Kind
   )
   ...
   (
      this : in out HtmlWindowCollection.Kind;
      windowId : NetFrameworkBase.BSTR
   )
   return NetFrameworkBase.System.Windows.Forms.HtmlWindow.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
