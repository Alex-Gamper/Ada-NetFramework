...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DataGridViewRowsRemovedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DataGridViewRowsRemovedEventArgs";
   ...
   function RowIndex
   (
      this : in out DataGridViewRowsRemovedEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.DataGridViewRowsRemovedEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.DataGridViewRowsRemovedEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.DataGridViewRowsRemovedEventArgs.Kind do
      declare
