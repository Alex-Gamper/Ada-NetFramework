...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.LinkLabel.LinkCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.LinkLabel+LinkCollection";
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("LinksAdded");
      p_RetVal      : aliased VARIANT;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 2;
      p_Value := GetObject (linkData.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.LinkLabel.LinkCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.LinkLabel.LinkCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
