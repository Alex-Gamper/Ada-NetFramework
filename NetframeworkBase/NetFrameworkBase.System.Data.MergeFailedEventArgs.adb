...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.MergeFailedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.MergeFailedEventArgs";
   ...
   function Table
   (
      this : in out MergeFailedEventArgs.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Conflict");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Data.MergeFailedEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Data.MergeFailedEventArgs.Kind_Ptr := new NetFrameworkBase.System.Data.MergeFailedEventArgs.Kind do
      declare
