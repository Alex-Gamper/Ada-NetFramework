...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.WebBrowserNavigatedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.WebBrowserNavigatedEventArgs";
   ...
   function Url
   (
      this : in out WebBrowserNavigatedEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.WebBrowserNavigatedEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.WebBrowserNavigatedEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.WebBrowserNavigatedEventArgs.Kind do
      declare
