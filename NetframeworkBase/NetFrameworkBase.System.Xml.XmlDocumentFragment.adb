...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.XmlDocumentFragment is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.XmlDocumentFragment";
   ...
   function Name
   (
      this : in out XmlDocumentFragment.Kind
   )
