...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.Eventing.Reader.EventRecordWrittenEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.Eventing.Reader.EventRecordWrittenEventArgs";
   ...
   return NetFrameworkBase.System.Exception_x.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EventException");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
