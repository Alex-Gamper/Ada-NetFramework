...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.ComponentEditor is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.ComponentEditor";
   ...
   (
      this : in out ComponentEditor.Kind;
