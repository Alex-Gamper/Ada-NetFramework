...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.HttpListenerBasicIdentity is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.HttpListenerBasicIdentity";
   ...
   function Password
   (
      this : in out HttpListenerBasicIdentity.Kind
   )
   ...
   return NetFrameworkBase.System.Net.HttpListenerBasicIdentity.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.HttpListenerBasicIdentity.Kind_Ptr := new NetFrameworkBase.System.Net.HttpListenerBasicIdentity.Kind do
      declare
