...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.SubclassTypeValidator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.SubclassTypeValidator";
   ...
   procedure Validate
   (
      this : in out SubclassTypeValidator.Kind;
   ...
   return NetFrameworkBase.System.Configuration.SubclassTypeValidator.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.SubclassTypeValidator.Kind_Ptr := new NetFrameworkBase.System.Configuration.SubclassTypeValidator.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
