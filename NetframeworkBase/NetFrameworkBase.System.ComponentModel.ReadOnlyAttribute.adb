...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.ReadOnlyAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.ReadOnlyAttribute";
   ...
   function IsReadOnly
   (
      this : in out ReadOnlyAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.ComponentModel.ReadOnlyAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.ReadOnlyAttribute.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.ReadOnlyAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
