...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Remoting.Lifetime.LifetimeServices is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Remoting.Lifetime.LifetimeServices";
   ...
   return NetFrameworkBase.System.TimeSpan.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("LeaseTime");
   ...
   function RenewOnCallTime
   return NetFrameworkBase.System.TimeSpan.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RenewOnCallTime");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.TimeSpan.Kind_Ptr := new NetFrameworkBase.System.TimeSpan.Kind;
   begin
   ...
   function SponsorshipTimeout
   return NetFrameworkBase.System.TimeSpan.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SponsorshipTimeout");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.TimeSpan.Kind_Ptr := new NetFrameworkBase.System.TimeSpan.Kind;
   begin
   ...
   function LeaseManagerPollTime
   return NetFrameworkBase.System.TimeSpan.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("LeaseManagerPollTime");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.TimeSpan.Kind_Ptr := new NetFrameworkBase.System.TimeSpan.Kind;
   begin
   ...
   procedure LeaseManagerPollTime
   (
      value : NetFrameworkBase.System.TimeSpan.Kind_Ptr
   )
   is
   ...
   function Constructor return NetFrameworkBase.System.Runtime.Remoting.Lifetime.LifetimeServices.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Remoting.Lifetime.LifetimeServices.Kind_Ptr := new NetFrameworkBase.System.Runtime.Remoting.Lifetime.LifetimeServices.Kind do
