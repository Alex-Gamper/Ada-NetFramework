...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.ConfigurationValidatorBase is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.ConfigurationValidatorBase";
   ...
   (
      this : in out ConfigurationValidatorBase.Kind;
