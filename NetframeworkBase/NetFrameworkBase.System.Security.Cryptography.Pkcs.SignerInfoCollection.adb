...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Pkcs.SignerInfoCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Pkcs.SignerInfoCollection";
   ...
   function Item
   (
      this : in out SignerInfoCollection.Kind;
      index : NetFrameworkBase.Int32
   )
   return NetFrameworkBase.System.Security.Cryptography.Pkcs.SignerInfo.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Security.Cryptography.Pkcs.SignerInfo.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Pkcs.SignerInfo.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.Cryptography.Pkcs.SignerInfoEnumerator.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.Pkcs.SignerInfoEnumerator.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Pkcs.SignerInfoEnumerator.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   (
      this : in out SignerInfoCollection.Kind;
      array_x : NetFrameworkBase.System.Security.Cryptography.Pkcs.SignerInfo.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Security.Cryptography.Pkcs.SignerInfo[]
