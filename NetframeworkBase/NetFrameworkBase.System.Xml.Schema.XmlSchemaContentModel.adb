...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.XmlSchemaContentModel is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.XmlSchemaContentModel";
   ...
   function Content
   (
      this : in out XmlSchemaContentModel.Kind
   )
