...
--------------------------------------------------------------------------------
package NetFrameworkBase.System.Windows.Forms.PropertyGridInternal.IRootGridEntry is
   ...
   type Kind_Array_Ptr is access all Kind_Array;
      ...
      (
         this : in out IRootGridEntry.Kind;
         showCategories : NetFrameworkBase.Boolean
      ) return HResult is abstract;
   ...
   private
      ...
      This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.PropertyGridInternal.IRootGridEntry";
