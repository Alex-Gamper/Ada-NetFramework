...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Remoting.Channels.ClientChannelSinkStack is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Remoting.Channels.ClientChannelSinkStack";
   ...
   procedure Push
   (
      this : in out ClientChannelSinkStack.Kind;
      sink : NetFrameworkBase.System.Runtime.Remoting.Channels.IClientChannelSink.Kind_Ptr; 
      ...
      p_MethodName  : BSTR := To_BSTR("Push");
   ...
   begin
      ...
      p_Value.field_1.field_1.field_1.punkVal := sink;
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AsyncProcessResponse");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      ...
      p_Index(1) := 0;
      p_Value.field_1.field_1.vt := VT_UNKNOWN'Enum_rep;
      p_Value.field_1.field_1.field_1.punkVal := headers;
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 1;
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("DispatchReplyMessage");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("DispatchException");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Runtime.Remoting.Channels.ClientChannelSinkStack.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Remoting.Channels.ClientChannelSinkStack.Kind_Ptr := new NetFrameworkBase.System.Runtime.Remoting.Channels.ClientChannelSinkStack.Kind do
   ...
   return NetFrameworkBase.System.Runtime.Remoting.Channels.ClientChannelSinkStack.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Remoting.Channels.ClientChannelSinkStack.Kind_Ptr := new NetFrameworkBase.System.Runtime.Remoting.Channels.ClientChannelSinkStack.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
