...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.AttributeCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.AttributeCollection";
   ...
   return NetFrameworkBase.System.Attribute.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Attribute.Kind_Ptr := new NetFrameworkBase.System.Attribute.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   return NetFrameworkBase.System.ComponentModel.AttributeCollection.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("FromExisting");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p1_Parameters : aliased LPSAFEARRAY := null;
      p1_Bounds     : aliased SAFEARRAYBOUND := (newAttributes'Length , 0);
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (existing.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 1;
      declare
      ...
      begin
         ...
         for i in newAttributes'range loop
            p1_Index(1) := Interfaces.C.long(i) - 1;
            p1_Tmp := GetObject (newAttributes(i).m_Kind);
   ...
   return NetFrameworkBase.System.ComponentModel.AttributeCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.AttributeCollection.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.AttributeCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
