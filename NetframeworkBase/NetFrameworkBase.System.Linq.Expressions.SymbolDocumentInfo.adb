...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Linq.Expressions.SymbolDocumentInfo is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Linq.Expressions.SymbolDocumentInfo";
   ...
   function FileName
   (
      this : in out SymbolDocumentInfo.Kind
   )
   ...
   return NetFrameworkBase.System.Guid.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("LanguageVendor");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Guid.Kind_Ptr := new NetFrameworkBase.System.Guid.Kind;
   begin
