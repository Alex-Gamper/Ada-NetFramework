...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Collections.ReadOnlyCollectionBase is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Collections.ReadOnlyCollectionBase";
   ...
   function Count
   (
      this : in out ReadOnlyCollectionBase.Kind
   )
