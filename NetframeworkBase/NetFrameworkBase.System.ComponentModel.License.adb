...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.License is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.License";
   ...
   function LicenseKey
   (
      this : in out License.Kind
   )
   return NetFrameworkBase.BSTR is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("LicenseKey");
