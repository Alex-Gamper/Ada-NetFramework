...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ControlEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ControlEventArgs";
   ...
   function Control
   (
      this : in out ControlEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.ControlEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ControlEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ControlEventArgs.Kind do
      declare
