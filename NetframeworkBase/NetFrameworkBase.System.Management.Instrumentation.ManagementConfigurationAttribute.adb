...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Management.Instrumentation.ManagementConfigurationAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Management.Instrumentation.ManagementConfigurationAttribute";
   ...
   function Mode
   (
      this : in out ManagementConfigurationAttribute.Kind
   )
   return NetFrameworkBase.System.Management.Instrumentation.ManagementConfigurationType.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Management.Instrumentation.ManagementConfigurationType.Kind);
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Management.Instrumentation.ManagementConfigurationType.Kind;
   begin
   ...
   (
      this : in out ManagementConfigurationAttribute.Kind;
      value : NetFrameworkBase.System.Management.Instrumentation.ManagementConfigurationType.Kind
   ) is
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_valueEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Management.Instrumentation.ManagementConfigurationType.Instance;
   ...
   return NetFrameworkBase.System.Type_x.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Schema");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   function Constructor return NetFrameworkBase.System.Management.Instrumentation.ManagementConfigurationAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Management.Instrumentation.ManagementConfigurationAttribute.Kind_Ptr := new NetFrameworkBase.System.Management.Instrumentation.ManagementConfigurationAttribute.Kind do
