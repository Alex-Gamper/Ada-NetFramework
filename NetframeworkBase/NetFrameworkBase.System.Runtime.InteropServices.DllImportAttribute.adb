...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.InteropServices.DllImportAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.InteropServices.DllImportAttribute";
   ...
   function Value
   (
      this : in out DllImportAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Runtime.InteropServices.DllImportAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.InteropServices.DllImportAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.InteropServices.DllImportAttribute.Kind do
      declare
