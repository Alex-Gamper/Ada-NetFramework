...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.Ports.SerialDataReceivedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.Ports.SerialDataReceivedEventArgs";
   ...
   function EventType
   (
      this : in out SerialDataReceivedEventArgs.Kind
   )
   return NetFrameworkBase.System.IO.Ports.SerialData.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.IO.Ports.SerialData.Kind);
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.IO.Ports.SerialData.Kind;
   begin
