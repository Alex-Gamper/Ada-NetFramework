...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.EnterpriseServices.ExceptionClassAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.EnterpriseServices.ExceptionClassAttribute";
   ...
   function Value
   (
      this : in out ExceptionClassAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.EnterpriseServices.ExceptionClassAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.EnterpriseServices.ExceptionClassAttribute.Kind_Ptr := new NetFrameworkBase.System.EnterpriseServices.ExceptionClassAttribute.Kind do
      declare
