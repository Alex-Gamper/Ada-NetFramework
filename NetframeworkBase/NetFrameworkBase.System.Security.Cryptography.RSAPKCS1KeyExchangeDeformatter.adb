...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.RSAPKCS1KeyExchangeDeformatter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.RSAPKCS1KeyExchangeDeformatter";
   ...
   return NetFrameworkBase.Byte_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("DecryptKeyExchange");
      p_RetVal      : aliased VARIANT;
      p0_Parameters : aliased LPSAFEARRAY := null;
      p0_Bounds     : aliased SAFEARRAYBOUND := (rgbIn'Length , 0);
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.RSAPKCS1KeyExchangeDeformatter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.RSAPKCS1KeyExchangeDeformatter.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.RSAPKCS1KeyExchangeDeformatter.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.RSAPKCS1KeyExchangeDeformatter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.RSAPKCS1KeyExchangeDeformatter.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.RSAPKCS1KeyExchangeDeformatter.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
