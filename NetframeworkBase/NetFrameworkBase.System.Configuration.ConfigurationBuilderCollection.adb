...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.ConfigurationBuilderCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.ConfigurationBuilderCollection";
   ...
   function Item
   (
      this : in out ConfigurationBuilderCollection.Kind;
   ...
   (
      this : in out ConfigurationBuilderCollection.Kind;
      builder : NetFrameworkBase.System.Configuration.Provider.ProviderBase.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   function Constructor return NetFrameworkBase.System.Configuration.ConfigurationBuilderCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.ConfigurationBuilderCollection.Kind_Ptr := new NetFrameworkBase.System.Configuration.ConfigurationBuilderCollection.Kind do
