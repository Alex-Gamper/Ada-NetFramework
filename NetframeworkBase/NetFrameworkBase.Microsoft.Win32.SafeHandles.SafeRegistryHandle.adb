...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.Microsoft.Win32.SafeHandles.SafeRegistryHandle is
   ...
   This_TypeName     : constant Standard.Wide_String := "Microsoft.Win32.SafeHandles.SafeRegistryHandle";
   ...
   begin
      return RetVal : NetFrameworkBase.Microsoft.Win32.SafeHandles.SafeRegistryHandle.Kind_Ptr := new NetFrameworkBase.Microsoft.Win32.SafeHandles.SafeRegistryHandle.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(preexistingHandle);
