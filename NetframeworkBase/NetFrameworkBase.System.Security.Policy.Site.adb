...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Policy.Site is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Policy.Site";
   ...
   return NetFrameworkBase.System.Security.Policy.Site.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Security.Policy.Site.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.Site.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.Policy.Site.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Policy.Site.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.Site.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
