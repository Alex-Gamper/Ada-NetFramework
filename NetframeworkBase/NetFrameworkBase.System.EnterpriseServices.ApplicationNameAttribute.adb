...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.EnterpriseServices.ApplicationNameAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.EnterpriseServices.ApplicationNameAttribute";
   ...
   function Value
   (
      this : in out ApplicationNameAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.EnterpriseServices.ApplicationNameAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.EnterpriseServices.ApplicationNameAttribute.Kind_Ptr := new NetFrameworkBase.System.EnterpriseServices.ApplicationNameAttribute.Kind do
      declare
