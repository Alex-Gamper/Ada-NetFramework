...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.TripleDESCryptoServiceProvider is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.TripleDESCryptoServiceProvider";
   ...
   (
      this : in out TripleDESCryptoServiceProvider.Kind;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.TripleDESCryptoServiceProvider.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.TripleDESCryptoServiceProvider.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.TripleDESCryptoServiceProvider.Kind do
