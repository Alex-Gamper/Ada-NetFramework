...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Threading.RegisteredWaitHandle is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Threading.RegisteredWaitHandle";
   ...
   function Unregister
   (
      this : in out RegisteredWaitHandle.Kind;
