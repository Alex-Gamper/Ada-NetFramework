...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Serialization.SerializationBinder is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Serialization.SerializationBinder";
   ...
   procedure BindToName
   (
      this : in out SerializationBinder.Kind;
      serializedType : NetFrameworkBase.System.Type_x.Kind_Ptr; 
      ...
      p_MethodName  : BSTR := To_BSTR("BindToName");
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (serializedType.m_Kind);
   ...
   return NetFrameworkBase.System.Type_x.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("BindToType");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
