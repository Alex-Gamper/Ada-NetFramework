...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.IntegerValidator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.IntegerValidator";
   ...
   (
      this : in out IntegerValidator.Kind;
   ...
   return NetFrameworkBase.System.Configuration.IntegerValidator.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.IntegerValidator.Kind_Ptr := new NetFrameworkBase.System.Configuration.IntegerValidator.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
