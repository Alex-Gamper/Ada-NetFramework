...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.GenericUriParser is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.GenericUriParser";
   ...
   return NetFrameworkBase.System.GenericUriParser.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.GenericUriParser.Kind_Ptr := new NetFrameworkBase.System.GenericUriParser.Kind do
      declare
         ...
         p_optionsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.GenericUriParserOptions.Instance;
