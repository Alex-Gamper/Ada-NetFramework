...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DataGridViewLinkColumn is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DataGridViewLinkColumn";
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("TrackVisitedState");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("UseColumnTextForLinkValue");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Boolean;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Windows.Forms.DataGridViewLinkColumn.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.DataGridViewLinkColumn.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.DataGridViewLinkColumn.Kind do
