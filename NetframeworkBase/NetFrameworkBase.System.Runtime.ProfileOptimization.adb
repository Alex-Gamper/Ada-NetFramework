...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.ProfileOptimization is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.ProfileOptimization";
   ...
   procedure SetProfileRoot
   (
      directoryPath : NetFrameworkBase.BSTR
   )
   is
      ...
      p_MethodName  : BSTR := To_BSTR("SetProfileRoot");
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := To_Variant(directoryPath);
   ...
   is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("StartProfile");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
