...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.Pipes.NamedPipeClientStream is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.Pipes.NamedPipeClientStream";
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("NumberOfServerInstances");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.IO.Pipes.NamedPipeClientStream.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.IO.Pipes.NamedPipeClientStream.Kind_Ptr := new NetFrameworkBase.System.IO.Pipes.NamedPipeClientStream.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      declare
         ...
         p_optionsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.IO.Pipes.PipeOptions.Instance;
         p_optionsEnum : aliased VARIANT := To_Variant (CreateEnum (p_optionsEnumType, options'Enum_rep));
         p_impersonationLevelEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Principal.TokenImpersonationLevel.Instance;
         p_impersonationLevelEnum : aliased VARIANT := To_Variant (CreateEnum (p_impersonationLevelEnumType, impersonationLevel'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
         ...
         ------------------------------------------------------------
         p_Index(1) := 4;
         p_Value := p_impersonationLevelEnum;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
   ...
   begin
      ...
      declare
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_desiredAccessRightsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.IO.Pipes.PipeAccessRights.Instance;
