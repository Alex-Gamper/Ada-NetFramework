...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.AccessControl.SemaphoreAuditRule is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.AccessControl.SemaphoreAuditRule";
   ...
   (
      this : in out SemaphoreAuditRule.Kind
   )
   ...
   return NetFrameworkBase.System.Security.AccessControl.SemaphoreAuditRule.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.AccessControl.SemaphoreAuditRule.Kind_Ptr := new NetFrameworkBase.System.Security.AccessControl.SemaphoreAuditRule.Kind do
      declare
