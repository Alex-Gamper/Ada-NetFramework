...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.NameTable is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.NameTable";
   ...
   (
      this : in out NameTable.Kind;
      key : NetFrameworkBase.Wide_Char_Array; 
   ...
   function Constructor return NetFrameworkBase.System.Xml.NameTable.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.NameTable.Kind_Ptr := new NetFrameworkBase.System.Xml.NameTable.Kind do
