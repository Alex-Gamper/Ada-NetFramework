...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.Compression.GZipStream is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.Compression.GZipStream";
   ...
   return NetFrameworkBase.System.IO.Compression.GZipStream.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.IO.Compression.GZipStream.Kind_Ptr := new NetFrameworkBase.System.IO.Compression.GZipStream.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
