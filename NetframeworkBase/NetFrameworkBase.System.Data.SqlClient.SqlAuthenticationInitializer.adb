...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.SqlClient.SqlAuthenticationInitializer is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.SqlClient.SqlAuthenticationInitializer";
   ...
   (
      this : in out SqlAuthenticationInitializer.Kind
   ) is
      Hr            : HResult := 0;
