...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.TextBoxRenderer is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.TextBoxRenderer";
   ...
   (
      ...
      state : NetFrameworkBase.System.Windows.Forms.VisualStyles.TextBoxState.Kind
   )
   is
      ...
      p_stateEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Windows.Forms.VisualStyles.TextBoxState.Instance;
   ...
   (
      g : NetFrameworkBase.System.Drawing.Graphics.Kind_Ptr; 
      bounds : NetFrameworkBase.System.Drawing.Rectangle.Kind_Ptr; 
      textBoxText : NetFrameworkBase.BSTR; 
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 2;
      p_Value := To_Variant(textBoxText);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 3;
