...
--------------------------------------------------------------------------------
package NetFrameworkBase.System.Net.WebSockets.HttpListenerWebSocketContext is
   
   type Kind is new NetFrameworkBase.System.Net.WebSockets.WebSocketContext.Kind with null record;
