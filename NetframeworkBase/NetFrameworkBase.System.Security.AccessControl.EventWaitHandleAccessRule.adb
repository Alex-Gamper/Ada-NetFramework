...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.AccessControl.EventWaitHandleAccessRule is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.AccessControl.EventWaitHandleAccessRule";
   ...
   (
      this : in out EventWaitHandleAccessRule.Kind
   )
   return NetFrameworkBase.System.Security.AccessControl.EventWaitHandleRights.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Security.AccessControl.EventWaitHandleRights.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EventWaitHandleRights");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.AccessControl.EventWaitHandleRights.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.AccessControl.EventWaitHandleAccessRule.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.AccessControl.EventWaitHandleAccessRule.Kind_Ptr := new NetFrameworkBase.System.Security.AccessControl.EventWaitHandleAccessRule.Kind do
      declare
         ...
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_eventRightsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.AccessControl.EventWaitHandleRights.Instance;
