...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Transactions.TransactionOptions is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Transactions.TransactionOptions";
   ...
   (
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_valueEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Transactions.IsolationLevel.Instance;
