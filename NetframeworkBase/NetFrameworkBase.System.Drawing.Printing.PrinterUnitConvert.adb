...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Drawing.Printing.PrinterUnitConvert is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Drawing.Printing.PrinterUnitConvert";
   ...
   (
      ...
      fromUnit : NetFrameworkBase.System.Drawing.Printing.PrinterUnit.Kind; 
      toUnit : NetFrameworkBase.System.Drawing.Printing.PrinterUnit.Kind
   )
   return NetFrameworkBase.Double is
      ...
      p_fromUnitEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Drawing.Printing.PrinterUnit.Instance;
      p_fromUnitEnum : aliased VARIANT := To_Variant (CreateEnum (p_fromUnitEnumType, fromUnit'Enum_rep));
      p_toUnitEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Drawing.Printing.PrinterUnit.Instance;
      p_toUnitEnum : aliased VARIANT := To_Variant (CreateEnum (p_toUnitEnumType, toUnit'Enum_rep));
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := p_fromUnitEnum;
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 2;
      p_Value := p_toUnitEnum;
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
