...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.RSAPKCS1SignatureFormatter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.RSAPKCS1SignatureFormatter";
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.RSAPKCS1SignatureFormatter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.RSAPKCS1SignatureFormatter.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.RSAPKCS1SignatureFormatter.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.RSAPKCS1SignatureFormatter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.RSAPKCS1SignatureFormatter.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.RSAPKCS1SignatureFormatter.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
