...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.XPath.XPathDocument is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.XPath.XPathDocument";
   ...
   return NetFrameworkBase.System.Xml.XPath.XPathDocument.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.XPath.XPathDocument.Kind_Ptr := new NetFrameworkBase.System.Xml.XPath.XPathDocument.Kind do
      declare
   ...
   begin
      ...
      declare
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_spaceEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Xml.XmlSpace.Instance;
         p_spaceEnum : aliased VARIANT := To_Variant (CreateEnum (p_spaceEnumType, space'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
