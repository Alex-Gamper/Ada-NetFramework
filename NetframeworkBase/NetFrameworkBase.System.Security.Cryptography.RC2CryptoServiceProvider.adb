...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.RC2CryptoServiceProvider is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.RC2CryptoServiceProvider";
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_MethodName  : BSTR := To_BSTR("EffectiveKeySize");
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("UseSalt");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.RC2CryptoServiceProvider.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.RC2CryptoServiceProvider.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.RC2CryptoServiceProvider.Kind do
