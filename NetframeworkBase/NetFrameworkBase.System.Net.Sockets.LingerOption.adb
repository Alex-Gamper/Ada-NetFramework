...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Sockets.LingerOption is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Sockets.LingerOption";
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("LingerTime");
      p_RetVal      : aliased VARIANT;
   ...
   begin
      return RetVal : NetFrameworkBase.System.Net.Sockets.LingerOption.Kind_Ptr := new NetFrameworkBase.System.Net.Sockets.LingerOption.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
