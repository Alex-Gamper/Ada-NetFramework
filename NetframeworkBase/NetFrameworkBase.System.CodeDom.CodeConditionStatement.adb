...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.CodeDom.CodeConditionStatement is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.CodeDom.CodeConditionStatement";
   ...
   return NetFrameworkBase.System.CodeDom.CodeStatementCollection.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("TrueStatements");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.CodeDom.CodeStatementCollection.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("FalseStatements");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.CodeDom.CodeStatementCollection.Kind_Ptr := new NetFrameworkBase.System.CodeDom.CodeStatementCollection.Kind;
   begin
   ...
   function Constructor return NetFrameworkBase.System.CodeDom.CodeConditionStatement.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.CodeDom.CodeConditionStatement.Kind_Ptr := new NetFrameworkBase.System.CodeDom.CodeConditionStatement.Kind do
   ...
   return NetFrameworkBase.System.CodeDom.CodeConditionStatement.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.CodeDom.CodeConditionStatement.Kind_Ptr := new NetFrameworkBase.System.CodeDom.CodeConditionStatement.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         ...
         p1_Bounds     : aliased SAFEARRAYBOUND := (trueStatements'Length , 0);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (condition.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         declare
         ...
         begin
            ...
            for i in trueStatements'range loop
               p1_Index(1) := Interfaces.C.long(i) - 1;
               p1_Tmp := GetObject (trueStatements(i).m_Kind);
   ...
   begin
      ...
      declare
         ...
         p2_Bounds     : aliased SAFEARRAYBOUND := (falseStatements'Length , 0);
      ...
      begin
         ...
         begin
            ...
            for i in falseStatements'range loop
               p2_Index(1) := Interfaces.C.long(i) - 1;
               p2_Tmp := GetObject (falseStatements(i).m_Kind);
