...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Reflection.AssemblyInformationalVersionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Reflection.AssemblyInformationalVersionAttribute";
   ...
   function InformationalVersion
   (
      this : in out AssemblyInformationalVersionAttribute.Kind
   )
   return NetFrameworkBase.BSTR is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("InformationalVersion");
   ...
   return NetFrameworkBase.System.Reflection.AssemblyInformationalVersionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Reflection.AssemblyInformationalVersionAttribute.Kind_Ptr := new NetFrameworkBase.System.Reflection.AssemblyInformationalVersionAttribute.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(informationalVersion);
