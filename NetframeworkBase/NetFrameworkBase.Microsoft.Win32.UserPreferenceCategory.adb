...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.Microsoft.Win32.UserPreferenceCategory is
   ...
   This_TypeName     : constant Standard.Wide_String := "Microsoft.Win32.UserPreferenceCategory";
