...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ColumnStyle is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ColumnStyle";
   ...
   function Constructor return NetFrameworkBase.System.Windows.Forms.ColumnStyle.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ColumnStyle.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ColumnStyle.Kind do
   ...
   return NetFrameworkBase.System.Windows.Forms.ColumnStyle.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ColumnStyle.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ColumnStyle.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_sizeTypeEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Windows.Forms.SizeType.Instance;
         p_sizeTypeEnum : aliased VARIANT := To_Variant (CreateEnum (p_sizeTypeEnumType, sizeType'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := p_sizeTypeEnum;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
