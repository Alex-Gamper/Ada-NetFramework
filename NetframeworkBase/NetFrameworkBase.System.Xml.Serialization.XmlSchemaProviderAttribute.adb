...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Serialization.XmlSchemaProviderAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Serialization.XmlSchemaProviderAttribute";
   ...
   function MethodName
   (
      this : in out XmlSchemaProviderAttribute.Kind
   )
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsAny");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Xml.Serialization.XmlSchemaProviderAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Serialization.XmlSchemaProviderAttribute.Kind_Ptr := new NetFrameworkBase.System.Xml.Serialization.XmlSchemaProviderAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
