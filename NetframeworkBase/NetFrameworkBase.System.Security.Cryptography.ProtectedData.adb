...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.ProtectedData is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.ProtectedData";
   ...
   (
      ...
      optionalEntropy : NetFrameworkBase.Byte_Array; 
      scope : NetFrameworkBase.System.Security.Cryptography.DataProtectionScope.Kind
   )
   return NetFrameworkBase.Byte_Array is
      ...
      p1_Bounds     : aliased SAFEARRAYBOUND := (optionalEntropy'Length , 0);
      ...
      p_scopeEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Cryptography.DataProtectionScope.Instance;
   ...
   begin
      ...
      begin
         ...
         for i in optionalEntropy'range loop
            p1_Index(1) := Interfaces.C.long(i) - 1;
            p1_Tmp := optionalEntropy(i);
