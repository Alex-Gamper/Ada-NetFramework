...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.ECDsa is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.ECDsa";
   ...
   function Create
   return NetFrameworkBase.System.Security.Cryptography.ECDsa.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      RetVal        : NetFrameworkBase.System.Security.Cryptography.ECDsa.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.ECDsa.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
