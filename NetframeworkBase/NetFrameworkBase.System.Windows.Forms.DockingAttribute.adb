...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DockingAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DockingAttribute";
   ...
   function DockingBehavior
   (
      this : in out DockingAttribute.Kind
   )
   return NetFrameworkBase.System.Windows.Forms.DockingBehavior.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Windows.Forms.DockingBehavior.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("DockingBehavior");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Windows.Forms.DockingBehavior.Kind;
   begin
   ...
   function Constructor return NetFrameworkBase.System.Windows.Forms.DockingAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.DockingAttribute.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.DockingAttribute.Kind do
   ...
   return NetFrameworkBase.System.Windows.Forms.DockingAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.DockingAttribute.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.DockingAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_dockingBehaviorEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Windows.Forms.DockingBehavior.Instance;
         p_dockingBehaviorEnum : aliased VARIANT := To_Variant (CreateEnum (p_dockingBehaviorEnumType, dockingBehavior'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := p_dockingBehaviorEnum;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
