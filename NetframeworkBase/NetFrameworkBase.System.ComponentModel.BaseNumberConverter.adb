...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.BaseNumberConverter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.BaseNumberConverter";
   ...
   (
      this : in out BaseNumberConverter.Kind;
