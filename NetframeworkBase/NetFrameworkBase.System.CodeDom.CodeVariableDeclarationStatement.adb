...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.CodeDom.CodeVariableDeclarationStatement is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.CodeDom.CodeVariableDeclarationStatement";
   ...
   return NetFrameworkBase.System.CodeDom.CodeExpression.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("InitExpression");
   ...
   function Constructor return NetFrameworkBase.System.CodeDom.CodeVariableDeclarationStatement.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.CodeDom.CodeVariableDeclarationStatement.Kind_Ptr := new NetFrameworkBase.System.CodeDom.CodeVariableDeclarationStatement.Kind do
   ...
   return NetFrameworkBase.System.CodeDom.CodeVariableDeclarationStatement.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.CodeDom.CodeVariableDeclarationStatement.Kind_Ptr := new NetFrameworkBase.System.CodeDom.CodeVariableDeclarationStatement.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 2;
         p_Value := GetObject (initExpression.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
