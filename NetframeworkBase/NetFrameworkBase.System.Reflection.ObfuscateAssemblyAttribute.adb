...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Reflection.ObfuscateAssemblyAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Reflection.ObfuscateAssemblyAttribute";
   ...
   (
      this : in out ObfuscateAssemblyAttribute.Kind
   )
   return NetFrameworkBase.Boolean is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AssemblyIsPrivate");
   ...
   return NetFrameworkBase.System.Reflection.ObfuscateAssemblyAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Reflection.ObfuscateAssemblyAttribute.Kind_Ptr := new NetFrameworkBase.System.Reflection.ObfuscateAssemblyAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(assemblyIsPrivate);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
