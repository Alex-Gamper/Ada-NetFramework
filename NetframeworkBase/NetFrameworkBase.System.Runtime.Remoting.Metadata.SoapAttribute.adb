...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Remoting.Metadata.SoapAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Remoting.Metadata.SoapAttribute";
   ...
   (
      this : in out SoapAttribute.Kind
   )
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Embedded");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Boolean;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Runtime.Remoting.Metadata.SoapAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Remoting.Metadata.SoapAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.Remoting.Metadata.SoapAttribute.Kind do
