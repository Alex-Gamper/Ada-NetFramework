...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Policy.ApplicationTrustCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Policy.ApplicationTrustCollection";
   ...
   function Count
   (
      this : in out ApplicationTrustCollection.Kind
   )
   ...
   (
      this : in out ApplicationTrustCollection.Kind;
      appFullName : NetFrameworkBase.BSTR
   )
   return NetFrameworkBase.System.Security.Policy.ApplicationTrust.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := To_Variant(appFullName);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   (
      this : in out ApplicationTrustCollection.Kind;
      trust : NetFrameworkBase.System.Security.Policy.ApplicationTrust.Kind_Ptr
   )
   return NetFrameworkBase.Int32 is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (trust.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   (
      this : in out ApplicationTrustCollection.Kind;
      trusts : NetFrameworkBase.System.Security.Policy.ApplicationTrust.Kind_Array
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (trusts'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in trusts'range loop
            p0_Index(1) := Interfaces.C.long(i) - 1;
            p0_Tmp := GetObject (trusts(i).m_Kind);
      ...
      -- fixme parameter type := [array] System.Security.Policy.ApplicationTrust[]
   ...
   (
      this : in out ApplicationTrustCollection.Kind;
      trusts : NetFrameworkBase.System.Security.Policy.ApplicationTrustCollection.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (trusts.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   (
      ...
      versionMatch : NetFrameworkBase.System.Security.Policy.ApplicationVersionMatch.Kind
   )
   return NetFrameworkBase.System.Security.Policy.ApplicationTrustCollection.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_versionMatchEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Policy.ApplicationVersionMatch.Instance;
      p_versionMatchEnum : aliased VARIANT := To_Variant (CreateEnum (p_versionMatchEnumType, versionMatch'Enum_rep));
      RetVal        : NetFrameworkBase.System.Security.Policy.ApplicationTrustCollection.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.ApplicationTrustCollection.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   return NetFrameworkBase.System.Security.Policy.ApplicationTrustEnumerator.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Policy.ApplicationTrustEnumerator.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.ApplicationTrustEnumerator.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   (
      this : in out ApplicationTrustCollection.Kind;
      array_x : NetFrameworkBase.System.Security.Policy.ApplicationTrust.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
