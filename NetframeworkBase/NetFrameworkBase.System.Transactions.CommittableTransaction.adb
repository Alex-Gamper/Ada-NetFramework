...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Transactions.CommittableTransaction is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Transactions.CommittableTransaction";
   ...
   function Constructor return NetFrameworkBase.System.Transactions.CommittableTransaction.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Transactions.CommittableTransaction.Kind_Ptr := new NetFrameworkBase.System.Transactions.CommittableTransaction.Kind do
   ...
   return NetFrameworkBase.System.Transactions.CommittableTransaction.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Transactions.CommittableTransaction.Kind_Ptr := new NetFrameworkBase.System.Transactions.CommittableTransaction.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
