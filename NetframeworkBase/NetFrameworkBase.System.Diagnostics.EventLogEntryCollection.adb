...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.EventLogEntryCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.EventLogEntryCollection";
   ...
   function Count
   (
      this : in out EventLogEntryCollection.Kind
   )
   ...
   (
      this : in out EventLogEntryCollection.Kind;
      entries : NetFrameworkBase.System.Diagnostics.EventLogEntry.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (entries'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in entries'range loop
            ...
            p0_Tmp := GetObject (entries(i).m_Kind);
      ...
      -- fixme parameter type := [array] System.Diagnostics.EventLogEntry[]
