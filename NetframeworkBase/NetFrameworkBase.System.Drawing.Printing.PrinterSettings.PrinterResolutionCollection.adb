...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Drawing.Printing.PrinterSettings.PrinterResolutionCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Drawing.Printing.PrinterSettings+PrinterResolutionCollection";
   ...
   function Count
   (
      this : in out PrinterResolutionCollection.Kind
   )
   ...
   (
      this : in out PrinterResolutionCollection.Kind;
      printerResolutions : NetFrameworkBase.System.Drawing.Printing.PrinterResolution.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (printerResolutions'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in printerResolutions'range loop
            p0_Index(1) := Interfaces.C.long(i) - 1;
            p0_Tmp := GetObject (printerResolutions(i).m_Kind);
      ...
      -- fixme parameter type := [array] System.Drawing.Printing.PrinterResolution[]
   ...
   (
      this : in out PrinterResolutionCollection.Kind;
      printerResolution : NetFrameworkBase.System.Drawing.Printing.PrinterResolution.Kind_Ptr
   )
   return NetFrameworkBase.Int32 is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (printerResolution.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   (
      array_x : NetFrameworkBase.System.Drawing.Printing.PrinterResolution.Kind_Array
   )
   return NetFrameworkBase.System.Drawing.Printing.PrinterSettings.PrinterResolutionCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Drawing.Printing.PrinterSettings.PrinterResolutionCollection.Kind_Ptr := new NetFrameworkBase.System.Drawing.Printing.PrinterSettings.PrinterResolutionCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
