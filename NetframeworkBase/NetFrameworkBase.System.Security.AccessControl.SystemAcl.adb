...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.AccessControl.SystemAcl is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.AccessControl.SystemAcl";
   ...
   (
      ...
      p_MethodName  : BSTR := To_BSTR("AddAudit");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_auditFlagsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.AccessControl.AuditFlags.Instance;
      p_auditFlagsEnum : aliased VARIANT := To_Variant (CreateEnum (p_auditFlagsEnumType, auditFlags'Enum_rep));
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SetAudit");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_auditFlagsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.AccessControl.AuditFlags.Instance;
      p_auditFlagsEnum : aliased VARIANT := To_Variant (CreateEnum (p_auditFlagsEnumType, auditFlags'Enum_rep));
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RemoveAudit");
      p_RetVal      : aliased VARIANT;
      p_auditFlagsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.AccessControl.AuditFlags.Instance;
      p_auditFlagsEnum : aliased VARIANT := To_Variant (CreateEnum (p_auditFlagsEnumType, auditFlags'Enum_rep));
      p_inheritanceFlagsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.AccessControl.InheritanceFlags.Instance;
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RemoveAuditSpecific");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_auditFlagsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.AccessControl.AuditFlags.Instance;
      p_auditFlagsEnum : aliased VARIANT := To_Variant (CreateEnum (p_auditFlagsEnumType, auditFlags'Enum_rep));
   ...
   begin
      return RetVal : NetFrameworkBase.System.Security.AccessControl.SystemAcl.Kind_Ptr := new NetFrameworkBase.System.Security.AccessControl.SystemAcl.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
