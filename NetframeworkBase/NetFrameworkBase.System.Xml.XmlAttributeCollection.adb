...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.XmlAttributeCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.XmlAttributeCollection";
   ...
   return NetFrameworkBase.System.Xml.XmlAttribute.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("ItemOf");
   ...
   return NetFrameworkBase.System.Xml.XmlNode.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SetNamedItem");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Xml.XmlAttribute.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Prepend");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Xml.XmlAttribute.Kind_Ptr := new NetFrameworkBase.System.Xml.XmlAttribute.Kind;
   begin
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := GetObject (refNode.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
