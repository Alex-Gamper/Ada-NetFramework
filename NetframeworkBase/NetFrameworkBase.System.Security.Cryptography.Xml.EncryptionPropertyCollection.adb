...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionPropertyCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Xml.EncryptionPropertyCollection";
   ...
   return NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionProperty.Kind_Ptr is
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionProperty.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionProperty.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Security.Cryptography.Xml.EncryptionProperty[]
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionPropertyCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionPropertyCollection.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionPropertyCollection.Kind do
