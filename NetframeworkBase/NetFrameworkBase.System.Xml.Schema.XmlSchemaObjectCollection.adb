...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.XmlSchemaObjectCollection";
   ...
   return NetFrameworkBase.System.Xml.Schema.XmlSchemaObject.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Xml.Schema.XmlSchemaObject.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaObject.Kind;
   begin
   ...
   return NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectEnumerator.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectEnumerator.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectEnumerator.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Xml.Schema.XmlSchemaObject[]
   ...
   function Constructor return NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectCollection.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectCollection.Kind do
