...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.AccessControl.FileSystemAccessRule is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.AccessControl.FileSystemAccessRule";
   ...
   (
      this : in out FileSystemAccessRule.Kind
   )
   return NetFrameworkBase.System.Security.AccessControl.FileSystemRights.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Security.AccessControl.FileSystemRights.Kind);
      Hr            : HResult := 0;
   ...
   return NetFrameworkBase.System.Security.AccessControl.FileSystemAccessRule.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.AccessControl.FileSystemAccessRule.Kind_Ptr := new NetFrameworkBase.System.Security.AccessControl.FileSystemAccessRule.Kind do
      declare
