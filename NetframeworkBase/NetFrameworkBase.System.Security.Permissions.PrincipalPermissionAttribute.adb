...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.PrincipalPermissionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.PrincipalPermissionAttribute";
   ...
   function Name
   (
      this : in out PrincipalPermissionAttribute.Kind
   )
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Authenticated");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Security.Permissions.PrincipalPermissionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.PrincipalPermissionAttribute.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.PrincipalPermissionAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
