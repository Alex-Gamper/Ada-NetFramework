...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.PrincipalPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.PrincipalPermission";
   ...
   return NetFrameworkBase.System.Security.Permissions.PrincipalPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.PrincipalPermission.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.PrincipalPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
