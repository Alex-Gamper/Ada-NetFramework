...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Xsl.XsltMessageEncounteredEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Xsl.XsltMessageEncounteredEventArgs";
   ...
   function Message
   (
      this : in out XsltMessageEncounteredEventArgs.Kind
   )
