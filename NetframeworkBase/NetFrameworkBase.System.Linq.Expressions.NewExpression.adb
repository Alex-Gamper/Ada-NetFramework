...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Linq.Expressions.NewExpression is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Linq.Expressions.NewExpression";
   ...
   function Type_x
   (
      this : in out NewExpression.Kind
   )
