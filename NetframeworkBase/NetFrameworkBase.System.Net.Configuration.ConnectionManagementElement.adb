...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Configuration.ConnectionManagementElement is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Configuration.ConnectionManagementElement";
   ...
   function Address
   (
      this : in out ConnectionManagementElement.Kind
   )
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("MaxConnection");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.Net.Configuration.ConnectionManagementElement.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Configuration.ConnectionManagementElement.Kind_Ptr := new NetFrameworkBase.System.Net.Configuration.ConnectionManagementElement.Kind do
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(maxConnection);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
