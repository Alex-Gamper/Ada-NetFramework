...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DataGridViewCellValueEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DataGridViewCellValueEventArgs";
   ...
   (
      this : in out DataGridViewCellValueEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.DataGridViewCellValueEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.DataGridViewCellValueEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.DataGridViewCellValueEventArgs.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
