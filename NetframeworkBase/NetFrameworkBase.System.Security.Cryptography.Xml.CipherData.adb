...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Xml.CipherData is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Xml.CipherData";
   ...
   (
      this : in out CipherData.Kind
   )
   return NetFrameworkBase.System.Security.Cryptography.Xml.CipherReference.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CipherReference");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.Xml.CipherReference.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Xml.CipherReference.Kind;
   begin
   ...
   procedure CipherReference
   (
      this : in out CipherData.Kind;
      value : NetFrameworkBase.System.Security.Cryptography.Xml.CipherReference.Kind_Ptr
   ) is
   ...
   return NetFrameworkBase.Byte_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CipherValue");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.Xml.CipherData.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Xml.CipherData.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Xml.CipherData.Kind do
   ...
   begin
      ...
      declare
         ...
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p0_Parameters : aliased LPSAFEARRAY := null;
         p0_Bounds     : aliased SAFEARRAYBOUND := (cipherValue'Length , 0);
         p0_Index      : aliased array(1..1) of aliased LONG := (others => 0);
         p0_Tmp        : aliased NetFrameworkBase.Byte;
         p0_Tmp_Ptr    : access NetFrameworkBase.Byte := p0_Tmp'access;
      begin
         ...
         begin
            p0_Parameters := SafeArrayCreate (VT_UI1'enum_rep, 1, p0_Bounds'access);
            for i in cipherValue'range loop
               p0_Index(1) := Interfaces.C.long(i) - 1;
               p0_Tmp := cipherValue(i);
               Hr := SafeArrayPutElement (p0_Parameters, p0_Index (p0_Index'first)'access, Convert (p0_Tmp_Ptr));
            end loop;
            p_Value := To_Variant (p0_Parameters, VT_UI1);
         end;
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (cipherReference.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
