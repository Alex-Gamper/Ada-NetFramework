...
--------------------------------------------------------------------------------
package NetFrameworkBase.System.Configuration.Internal.IInternalConfigRecord is
   ...
   type Kind_Array_Ptr is access all Kind_Array;
      ...
      (
         this : in out IInternalConfigRecord.Kind;
         RetVal : access NetFrameworkBase.BSTR
      ) return HResult is abstract;
      
      function get_StreamName
      (
         this : in out IInternalConfigRecord.Kind;
         RetVal : access NetFrameworkBase.BSTR
      ) return HResult is abstract;
      
      function get_HasInitErrors
      (
         this : in out IInternalConfigRecord.Kind;
         RetVal : access NetFrameworkBase.Boolean
      ) return HResult is abstract;
      
      function ThrowIfInitErrors
      (
         this : in out IInternalConfigRecord.Kind
      ) return HResult is abstract;
      ...
      (
         this : in out IInternalConfigRecord.Kind;
         configKey : NetFrameworkBase.BSTR;
         RetVal : access NetFrameworkBase.System.Object.Kind_Ptr
      ) return HResult is abstract;
      
      function GetLkgSection
      (
         this : in out IInternalConfigRecord.Kind;
         configKey : NetFrameworkBase.BSTR;
         RetVal : access NetFrameworkBase.System.Object.Kind_Ptr
   ...
   private
      ...
      This_TypeName     : constant Standard.Wide_String := "System.Configuration.Internal.IInternalConfigRecord";
