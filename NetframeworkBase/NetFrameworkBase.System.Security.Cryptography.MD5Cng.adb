...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.MD5Cng is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.MD5Cng";
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.MD5Cng.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.MD5Cng.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.MD5Cng.Kind do
