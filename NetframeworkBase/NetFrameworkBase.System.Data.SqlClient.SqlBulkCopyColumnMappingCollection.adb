...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.SqlClient.SqlBulkCopyColumnMappingCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.SqlClient.SqlBulkCopyColumnMappingCollection";
   ...
   return NetFrameworkBase.System.Data.SqlClient.SqlBulkCopyColumnMapping.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Data.SqlClient.SqlBulkCopyColumnMapping.Kind_Ptr := new NetFrameworkBase.System.Data.SqlClient.SqlBulkCopyColumnMapping.Kind;
   begin
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Data.SqlClient.SqlBulkCopyColumnMapping[]
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (bulkCopyColumnMapping.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := To_Variant(destinationColumn);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := To_Variant(sourceColumnIndex);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := To_Variant(destinationColumn);
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := To_Variant(destinationColumnIndex);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
