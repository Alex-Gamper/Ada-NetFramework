...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.XmlSchemaDocumentation is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.XmlSchemaDocumentation";
   ...
   function Source
   (
      this : in out XmlSchemaDocumentation.Kind
   )
   ...
   return NetFrameworkBase.System.Xml.XmlNode.Kind_Array is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Markup");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   
      function GetArray (sa : access NetFrameworkWin32.SAFEARRAY) return NetFrameworkBase.System.Xml.XmlNode.Kind_Array is
      ...
      begin
         ...
         declare
            RetVal : NetFrameworkBase.System.Xml.XmlNode.Kind_Array(1..integer(Index));
            Value  : NetFrameworkBase.System.Xml.XmlNode.Kind_Ptr;
            Var    : aliased VARIANT;
            Item   : PVOID;
         ...
         begin
            ...
            for I in RetVal'range loop
               ...
               Value := new NetFrameworkBase.System.Xml.XmlNode.Kind;
   ...
   (
      this : in out XmlSchemaDocumentation.Kind;
      value : NetFrameworkBase.System.Xml.XmlNode.Kind_Array
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Xml.XmlNode[]
   ...
   function Constructor return NetFrameworkBase.System.Xml.Schema.XmlSchemaDocumentation.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Schema.XmlSchemaDocumentation.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaDocumentation.Kind do
