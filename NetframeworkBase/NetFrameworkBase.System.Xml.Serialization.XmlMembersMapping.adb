...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Serialization.XmlMembersMapping is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Serialization.XmlMembersMapping";
   ...
   function TypeName
   (
      this : in out XmlMembersMapping.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("TypeNamespace");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.Xml.Serialization.XmlMemberMapping.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Xml.Serialization.XmlMemberMapping.Kind_Ptr := new NetFrameworkBase.System.Xml.Serialization.XmlMemberMapping.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
