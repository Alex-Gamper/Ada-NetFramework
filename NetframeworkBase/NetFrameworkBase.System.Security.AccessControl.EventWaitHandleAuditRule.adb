...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.AccessControl.EventWaitHandleAuditRule is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.AccessControl.EventWaitHandleAuditRule";
   ...
   (
      this : in out EventWaitHandleAuditRule.Kind
   )
   ...
   return NetFrameworkBase.System.Security.AccessControl.EventWaitHandleAuditRule.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.AccessControl.EventWaitHandleAuditRule.Kind_Ptr := new NetFrameworkBase.System.Security.AccessControl.EventWaitHandleAuditRule.Kind do
      declare
