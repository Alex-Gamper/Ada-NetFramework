...
--------------------------------------------------------------------------------
package NetFrameworkBase.System.Xml.Serialization.IXmlSerializable is
   ...
   type Kind_Array_Ptr is access all Kind_Array;
      ...
      function GetSchema
      (
         this : in out IXmlSerializable.Kind;
         RetVal : access NetFrameworkBase.System.Xml.Schema.XmlSchema.Kind_Ptr
   ...
   private
      ...
      This_TypeName     : constant Standard.Wide_String := "System.Xml.Serialization.IXmlSerializable";
