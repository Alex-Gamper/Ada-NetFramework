...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.UInt64 is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.UInt64";
   ...
   begin
      ...
      p_Value.field_1.field_1.vt := VT_UI8'Enum_rep;
      -- parameter type := [out] [builtin] System.UInt64&
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   
      VariantInit(p_Target'access);
      p_RetVal := InvokeMethod (Instance, p_Target, p_MethodName, p_Flags, p_Parameters);
   
      -- set out parameter [result : System.UInt64]
      p_Index(1) := 1;
   ...
   function Constructor return NetFrameworkBase.System.UInt64.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.UInt64.Kind_Ptr := new NetFrameworkBase.System.UInt64.Kind do
