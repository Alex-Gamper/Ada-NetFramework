...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Xml.TransformChain is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Xml.TransformChain";
   ...
   procedure Add
   (
      this : in out TransformChain.Kind;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.Xml.TransformChain.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Xml.TransformChain.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Xml.TransformChain.Kind do
