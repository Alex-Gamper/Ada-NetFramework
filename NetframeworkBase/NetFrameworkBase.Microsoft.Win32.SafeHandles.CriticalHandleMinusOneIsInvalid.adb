...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.Microsoft.Win32.SafeHandles.CriticalHandleMinusOneIsInvalid is
   ...
   This_TypeName     : constant Standard.Wide_String := "Microsoft.Win32.SafeHandles.CriticalHandleMinusOneIsInvalid";
   ...
   function IsInvalid
   (
      this : in out CriticalHandleMinusOneIsInvalid.Kind
   )
