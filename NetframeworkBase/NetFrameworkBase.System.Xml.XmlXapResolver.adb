...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.XmlXapResolver is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.XmlXapResolver";
   ...
   function GetEntity
   (
      this : in out XmlXapResolver.Kind;
   ...
   procedure RegisterApplicationResourceStreamResolver
   (
      appStreamResolver : NetFrameworkBase.System.Xml.IApplicationResourceStreamResolver.Kind_Ptr
   )
   is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RegisterApplicationResourceStreamResolver");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      ...
      p_Value.field_1.field_1.field_1.punkVal := appStreamResolver;
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   function Constructor return NetFrameworkBase.System.Xml.XmlXapResolver.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.XmlXapResolver.Kind_Ptr := new NetFrameworkBase.System.Xml.XmlXapResolver.Kind do
