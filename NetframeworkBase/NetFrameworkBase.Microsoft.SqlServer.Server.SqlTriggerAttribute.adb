...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.Microsoft.SqlServer.Server.SqlTriggerAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "Microsoft.SqlServer.Server.SqlTriggerAttribute";
   ...
   function Name
   (
      this : in out SqlTriggerAttribute.Kind
   )
   ...
   function Constructor return NetFrameworkBase.Microsoft.SqlServer.Server.SqlTriggerAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.Microsoft.SqlServer.Server.SqlTriggerAttribute.Kind_Ptr := new NetFrameworkBase.Microsoft.SqlServer.Server.SqlTriggerAttribute.Kind do
