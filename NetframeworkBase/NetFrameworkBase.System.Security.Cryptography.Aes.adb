...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Aes is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Aes";
   ...
   return NetFrameworkBase.System.Security.Cryptography.Aes.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Security.Cryptography.Aes.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Aes.Kind;
   begin
