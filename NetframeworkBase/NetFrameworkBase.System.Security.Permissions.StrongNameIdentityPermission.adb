...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.StrongNameIdentityPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.StrongNameIdentityPermission";
   ...
   return NetFrameworkBase.System.Security.Permissions.StrongNamePublicKeyBlob.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("PublicKey");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Permissions.StrongNamePublicKeyBlob.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.StrongNamePublicKeyBlob.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   return NetFrameworkBase.System.Security.Permissions.StrongNameIdentityPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.StrongNameIdentityPermission.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.StrongNameIdentityPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
