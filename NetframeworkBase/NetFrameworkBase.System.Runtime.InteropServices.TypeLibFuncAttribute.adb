...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.InteropServices.TypeLibFuncAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.InteropServices.TypeLibFuncAttribute";
   ...
   function Value
   (
      this : in out TypeLibFuncAttribute.Kind
   )
   return NetFrameworkBase.System.Runtime.InteropServices.TypeLibFuncFlags.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Runtime.InteropServices.TypeLibFuncFlags.Kind);
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Runtime.InteropServices.TypeLibFuncFlags.Kind;
   begin
   ...
   return NetFrameworkBase.System.Runtime.InteropServices.TypeLibFuncAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.InteropServices.TypeLibFuncAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.InteropServices.TypeLibFuncAttribute.Kind do
      declare
         ...
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_flagsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Runtime.InteropServices.TypeLibFuncFlags.Instance;
