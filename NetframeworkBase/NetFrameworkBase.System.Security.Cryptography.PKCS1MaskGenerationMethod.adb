...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.PKCS1MaskGenerationMethod is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.PKCS1MaskGenerationMethod";
   ...
   function HashName
   (
      this : in out PKCS1MaskGenerationMethod.Kind
   )
   ...
   (
      this : in out PKCS1MaskGenerationMethod.Kind;
      rgbSeed : NetFrameworkBase.Byte_Array; 
      cbReturn : NetFrameworkBase.Int32
   )
   return NetFrameworkBase.Byte_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GenerateMask");
      p_RetVal      : aliased VARIANT;
      p0_Parameters : aliased LPSAFEARRAY := null;
      p0_Bounds     : aliased SAFEARRAYBOUND := (rgbSeed'Length , 0);
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.PKCS1MaskGenerationMethod.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.PKCS1MaskGenerationMethod.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.PKCS1MaskGenerationMethod.Kind do
