...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Drawing.Printing.PrinterSettings.PaperSourceCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Drawing.Printing.PrinterSettings+PaperSourceCollection";
   ...
   function Count
   (
      this : in out PaperSourceCollection.Kind
   )
   ...
   (
      this : in out PaperSourceCollection.Kind;
      paperSources : NetFrameworkBase.System.Drawing.Printing.PaperSource.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (paperSources'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in paperSources'range loop
            p0_Index(1) := Interfaces.C.long(i) - 1;
            p0_Tmp := GetObject (paperSources(i).m_Kind);
      ...
      -- fixme parameter type := [array] System.Drawing.Printing.PaperSource[]
   ...
   (
      this : in out PaperSourceCollection.Kind;
      paperSource : NetFrameworkBase.System.Drawing.Printing.PaperSource.Kind_Ptr
   )
   return NetFrameworkBase.Int32 is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (paperSource.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   (
      array_x : NetFrameworkBase.System.Drawing.Printing.PaperSource.Kind_Array
   )
   return NetFrameworkBase.System.Drawing.Printing.PrinterSettings.PaperSourceCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Drawing.Printing.PrinterSettings.PaperSourceCollection.Kind_Ptr := new NetFrameworkBase.System.Drawing.Printing.PrinterSettings.PaperSourceCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
