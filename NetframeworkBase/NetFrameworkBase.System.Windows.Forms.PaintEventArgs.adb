...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.PaintEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.PaintEventArgs";
   ...
   function Graphics
   (
      this : in out PaintEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Drawing.Rectangle.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ClipRectangle");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Windows.Forms.PaintEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.PaintEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.PaintEventArgs.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := GetObject (clipRect.m_Kind); -- Parameter Type = ValueType
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
