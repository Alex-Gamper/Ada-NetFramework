...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.XmlSchemaAppInfo is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.XmlSchemaAppInfo";
   ...
   function Source
   (
      this : in out XmlSchemaAppInfo.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Xml.Schema.XmlSchemaAppInfo.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Schema.XmlSchemaAppInfo.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaAppInfo.Kind do
