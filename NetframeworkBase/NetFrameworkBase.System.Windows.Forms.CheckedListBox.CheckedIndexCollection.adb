...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.CheckedListBox.CheckedIndexCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.CheckedListBox+CheckedIndexCollection";
