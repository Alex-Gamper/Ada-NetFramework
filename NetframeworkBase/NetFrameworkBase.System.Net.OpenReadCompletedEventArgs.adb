...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.OpenReadCompletedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.OpenReadCompletedEventArgs";
   ...
   function Result
   (
      this : in out OpenReadCompletedEventArgs.Kind
   )
