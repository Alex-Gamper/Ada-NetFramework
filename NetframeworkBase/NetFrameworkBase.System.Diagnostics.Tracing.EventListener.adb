...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.Tracing.EventListener is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.Tracing.EventListener";
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EnableEvents");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (eventSource.m_Kind);
   ...
   (
      ...
      p_levelEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Diagnostics.Tracing.EventLevel.Instance;
      p_levelEnum : aliased VARIANT := To_Variant (CreateEnum (p_levelEnumType, level'Enum_rep));
      p_matchAnyKeywordEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Diagnostics.Tracing.EventKeywords.Instance;
      p_matchAnyKeywordEnum : aliased VARIANT := To_Variant (CreateEnum (p_matchAnyKeywordEnumType, matchAnyKeyword'Enum_rep));
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("DisableEvents");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EventSourceIndex");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.Diagnostics.Tracing.EventListener.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.Tracing.EventListener.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.Tracing.EventListener.Kind do
