...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.DefaultPropertyAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.DefaultPropertyAttribute";
   ...
   function Name
   (
      this : in out DefaultPropertyAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.ComponentModel.DefaultPropertyAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.DefaultPropertyAttribute.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.DefaultPropertyAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
