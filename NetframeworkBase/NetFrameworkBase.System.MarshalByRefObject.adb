...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.MarshalByRefObject is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.MarshalByRefObject";
   ...
   (
      this : in out MarshalByRefObject.Kind
   )
