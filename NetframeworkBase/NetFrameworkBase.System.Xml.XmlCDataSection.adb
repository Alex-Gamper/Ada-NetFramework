...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.XmlCDataSection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.XmlCDataSection";
   ...
   function Name
   (
      this : in out XmlCDataSection.Kind
   )
