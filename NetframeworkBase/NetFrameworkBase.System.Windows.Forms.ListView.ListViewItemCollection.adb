...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ListView.ListViewItemCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ListView+ListViewItemCollection";
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Windows.Forms.ListViewItem[]
   ...
   return NetFrameworkBase.System.Windows.Forms.ListViewItem.Kind_Array is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      p_Bounds      : aliased SAFEARRAYBOUND := (2 , 0);
      ...
      function GetArray (sa : access NetFrameworkWin32.SAFEARRAY) return NetFrameworkBase.System.Windows.Forms.ListViewItem.Kind_Array is
      ...
      begin
         ...
         declare
            RetVal : NetFrameworkBase.System.Windows.Forms.ListViewItem.Kind_Array(1..integer(Index));
            Value  : NetFrameworkBase.System.Windows.Forms.ListViewItem.Kind_Ptr;
            Var    : aliased VARIANT;
            Item   : PVOID;
         ...
         begin
            ...
            for I in RetVal'range loop
               ...
               Value := new NetFrameworkBase.System.Windows.Forms.ListViewItem.Kind;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := To_Variant(searchAllSubItems);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ListView.ListViewItemCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ListView.ListViewItemCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
