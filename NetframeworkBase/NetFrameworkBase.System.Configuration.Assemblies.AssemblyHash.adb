...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.Assemblies.AssemblyHash is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.Assemblies.AssemblyHash";
   ...
   return NetFrameworkBase.System.Configuration.Assemblies.AssemblyHash.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.Assemblies.AssemblyHash.Kind_Ptr := new NetFrameworkBase.System.Configuration.Assemblies.AssemblyHash.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      declare
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_algorithmEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Configuration.Assemblies.AssemblyHashAlgorithm.Instance;
