...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.InstanceDataCollectionCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.InstanceDataCollectionCollection";
   ...
   function Item
   (
      this : in out InstanceDataCollectionCollection.Kind;
      counterName : NetFrameworkBase.BSTR
   )
   return NetFrameworkBase.System.Diagnostics.InstanceDataCollection.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Diagnostics.InstanceDataCollection.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.InstanceDataCollection.Kind;
   begin
   ...
   (
      this : in out InstanceDataCollectionCollection.Kind;
      counters : NetFrameworkBase.System.Diagnostics.InstanceDataCollection.Kind_Array; 
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (counters'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in counters'range loop
            ...
            p0_Tmp := GetObject (counters(i).m_Kind);
      ...
      -- fixme parameter type := [array] System.Diagnostics.InstanceDataCollection[]
   ...
   function Constructor return NetFrameworkBase.System.Diagnostics.InstanceDataCollectionCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.InstanceDataCollectionCollection.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.InstanceDataCollectionCollection.Kind do
