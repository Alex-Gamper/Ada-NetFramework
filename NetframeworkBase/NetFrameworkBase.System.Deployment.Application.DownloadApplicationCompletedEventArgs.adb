...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Deployment.Application.DownloadApplicationCompletedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Deployment.Application.DownloadApplicationCompletedEventArgs";
   ...
   (
      this : in out DownloadApplicationCompletedEventArgs.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ShortcutAppId");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
