...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Deployment.Application.CheckForUpdateCompletedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Deployment.Application.CheckForUpdateCompletedEventArgs";
   ...
   (
      this : in out CheckForUpdateCompletedEventArgs.Kind
   )
   return NetFrameworkBase.Boolean is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("UpdateAvailable");
   ...
   return NetFrameworkBase.System.Version.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AvailableVersion");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsUpdateRequired");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Boolean;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function MinimumRequiredVersion
   (
      this : in out CheckForUpdateCompletedEventArgs.Kind
   )
   return NetFrameworkBase.System.Version.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("MinimumRequiredVersion");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Version.Kind_Ptr := new NetFrameworkBase.System.Version.Kind;
   begin
   ...
   return NetFrameworkBase.Int64 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("UpdateSizeBytes");
      p_RetVal      : aliased VARIANT;
