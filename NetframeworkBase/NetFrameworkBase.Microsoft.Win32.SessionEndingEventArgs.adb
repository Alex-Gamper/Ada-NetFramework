...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.Microsoft.Win32.SessionEndingEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "Microsoft.Win32.SessionEndingEventArgs";
   ...
   function Cancel
   (
      this : in out SessionEndingEventArgs.Kind
   )
   ...
   return NetFrameworkBase.Microsoft.Win32.SessionEndReasons.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.Microsoft.Win32.SessionEndReasons.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Reason");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.Microsoft.Win32.SessionEndReasons.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   return NetFrameworkBase.Microsoft.Win32.SessionEndingEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.Microsoft.Win32.SessionEndingEventArgs.Kind_Ptr := new NetFrameworkBase.Microsoft.Win32.SessionEndingEventArgs.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_reasonEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.Microsoft.Win32.SessionEndReasons.Instance;
