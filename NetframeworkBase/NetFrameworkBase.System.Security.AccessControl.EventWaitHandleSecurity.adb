...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.AccessControl.EventWaitHandleSecurity is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.AccessControl.EventWaitHandleSecurity";
   ...
   (
      this : in out EventWaitHandleSecurity.Kind;
   ...
   (
      this : in out EventWaitHandleSecurity.Kind;
      rule : NetFrameworkBase.System.Security.AccessControl.EventWaitHandleAccessRule.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   (
      this : in out EventWaitHandleSecurity.Kind;
      rule : NetFrameworkBase.System.Security.AccessControl.EventWaitHandleAuditRule.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   function Constructor return NetFrameworkBase.System.Security.AccessControl.EventWaitHandleSecurity.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.AccessControl.EventWaitHandleSecurity.Kind_Ptr := new NetFrameworkBase.System.Security.AccessControl.EventWaitHandleSecurity.Kind do
