...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.HostProtectionException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.HostProtectionException";
   ...
   (
      this : in out HostProtectionException.Kind
   )
   return NetFrameworkBase.System.Security.Permissions.HostProtectionResource.Kind is
      ...
      p_MethodName  : BSTR := To_BSTR("ProtectedResources");
   ...
   return NetFrameworkBase.System.Security.Permissions.HostProtectionResource.Kind is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("DemandedResources");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Permissions.HostProtectionResource.Kind;
   begin
   ...
   function Constructor return NetFrameworkBase.System.Security.HostProtectionException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.HostProtectionException.Kind_Ptr := new NetFrameworkBase.System.Security.HostProtectionException.Kind do
   ...
   return NetFrameworkBase.System.Security.HostProtectionException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.HostProtectionException.Kind_Ptr := new NetFrameworkBase.System.Security.HostProtectionException.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
   ...
   begin
      ...
      declare
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_protectedResourcesEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Permissions.HostProtectionResource.Instance;
         p_protectedResourcesEnum : aliased VARIANT := To_Variant (CreateEnum (p_protectedResourcesEnumType, protectedResources'Enum_rep));
         p_demandedResourcesEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Permissions.HostProtectionResource.Instance;
         p_demandedResourcesEnum : aliased VARIANT := To_Variant (CreateEnum (p_demandedResourcesEnumType, demandedResources'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := p_protectedResourcesEnum;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 2;
         p_Value := p_demandedResourcesEnum;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
