...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.WebSockets.WebSocketException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.WebSockets.WebSocketException";
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_MethodName  : BSTR := To_BSTR("ErrorCode");
   ...
   return NetFrameworkBase.System.Net.WebSockets.WebSocketError.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Net.WebSockets.WebSocketError.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("WebSocketErrorCode");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Net.WebSockets.WebSocketError.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Net.WebSockets.WebSocketException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.WebSockets.WebSocketException.Kind_Ptr := new NetFrameworkBase.System.Net.WebSockets.WebSocketException.Kind do
   ...
   return NetFrameworkBase.System.Net.WebSockets.WebSocketException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.WebSockets.WebSocketException.Kind_Ptr := new NetFrameworkBase.System.Net.WebSockets.WebSocketException.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_errorEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Net.WebSockets.WebSocketError.Instance;
         p_errorEnum : aliased VARIANT := To_Variant (CreateEnum (p_errorEnumType, error'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(nativeError);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
