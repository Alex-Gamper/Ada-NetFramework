...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Xml.XmlDsigExcC14NTransform is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Xml.XmlDsigExcC14NTransform";
   ...
   function InclusiveNamespacesPrefixList
   (
      this : in out XmlDsigExcC14NTransform.Kind
   )
   return NetFrameworkBase.BSTR is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("InclusiveNamespacesPrefixList");
   ...
   procedure InclusiveNamespacesPrefixList
   (
      this : in out XmlDsigExcC14NTransform.Kind;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.Xml.XmlDsigExcC14NTransform.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Xml.XmlDsigExcC14NTransform.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Xml.XmlDsigExcC14NTransform.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.Xml.XmlDsigExcC14NTransform.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Xml.XmlDsigExcC14NTransform.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Xml.XmlDsigExcC14NTransform.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(includeComments);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(inclusiveNamespacesPrefixList);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
