...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Dynamic.CallInfo is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Dynamic.CallInfo";
   ...
   (
      this : in out CallInfo.Kind
   )
   return NetFrameworkBase.Int32 is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ArgumentCount");
   ...
   begin
      return RetVal : NetFrameworkBase.System.Dynamic.CallInfo.Kind_Ptr := new NetFrameworkBase.System.Dynamic.CallInfo.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
         ...
         p1_Bounds     : aliased SAFEARRAYBOUND := (argNames'Length , 0);
