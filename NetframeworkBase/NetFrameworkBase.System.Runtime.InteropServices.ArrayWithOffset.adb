...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.InteropServices.ArrayWithOffset is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.InteropServices.ArrayWithOffset";
   ...
   function GetArray
   (
      this : in out ArrayWithOffset.Kind
   )
   return NetFrameworkBase.System.Object.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetArray");
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetOffset");
      p_RetVal      : aliased VARIANT;
   ...
   (
      this : in out ArrayWithOffset.Kind;
      obj : NetFrameworkBase.System.Runtime.InteropServices.ArrayWithOffset.Kind_Ptr
   )
   return NetFrameworkBase.Boolean is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   (
      a : NetFrameworkBase.System.Runtime.InteropServices.ArrayWithOffset.Kind_Ptr; 
      b : NetFrameworkBase.System.Runtime.InteropServices.ArrayWithOffset.Kind_Ptr
   )
   return NetFrameworkBase.Boolean is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   return NetFrameworkBase.System.Runtime.InteropServices.ArrayWithOffset.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.InteropServices.ArrayWithOffset.Kind_Ptr := new NetFrameworkBase.System.Runtime.InteropServices.ArrayWithOffset.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
