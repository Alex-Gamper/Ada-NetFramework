...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.ECCurve.ECCurveType is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.ECCurve+ECCurveType";
