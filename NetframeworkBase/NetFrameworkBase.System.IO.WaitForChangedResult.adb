...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.WaitForChangedResult is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.WaitForChangedResult";
   ...
   function ChangeType
   (
      this : in out WaitForChangedResult.Kind
   )
   ...
   (
      this : in out WaitForChangedResult.Kind;
      value : NetFrameworkBase.System.IO.WatcherChangeTypes.Kind
   ) is
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_valueEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.IO.WatcherChangeTypes.Instance;
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("TimedOut");
      p_RetVal      : aliased VARIANT;
