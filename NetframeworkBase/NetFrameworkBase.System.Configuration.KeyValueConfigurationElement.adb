...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.KeyValueConfigurationElement is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.KeyValueConfigurationElement";
   ...
   function Key
   (
      this : in out KeyValueConfigurationElement.Kind
   )
   ...
   begin
      return RetVal : NetFrameworkBase.System.Configuration.KeyValueConfigurationElement.Kind_Ptr := new NetFrameworkBase.System.Configuration.KeyValueConfigurationElement.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
