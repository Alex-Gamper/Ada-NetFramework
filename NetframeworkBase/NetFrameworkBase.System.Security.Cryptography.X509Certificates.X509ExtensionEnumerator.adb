...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509ExtensionEnumerator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.X509Certificates.X509ExtensionEnumerator";
   ...
   function Current
   (
      this : in out X509ExtensionEnumerator.Kind
   )
