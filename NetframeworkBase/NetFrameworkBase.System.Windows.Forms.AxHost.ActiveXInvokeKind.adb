...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.AxHost.ActiveXInvokeKind is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.AxHost+ActiveXInvokeKind";
