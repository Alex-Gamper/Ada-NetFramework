...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.CryptoStream is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.CryptoStream";
   ...
   (
      ...
      p_MethodName  : BSTR := To_BSTR("FlushFinalBlock");
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("HasFlushedFinalBlock");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Boolean;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.Security.Cryptography.CryptoStream.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.CryptoStream.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.CryptoStream.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_modeEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Cryptography.CryptoStreamMode.Instance;
      ...
      begin
         ...
         p_Value.field_1.field_1.field_1.punkVal := transform;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 2;
         p_Value := p_modeEnum;
