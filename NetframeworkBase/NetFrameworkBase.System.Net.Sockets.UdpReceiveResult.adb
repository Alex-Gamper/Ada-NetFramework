...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Sockets.UdpReceiveResult is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Sockets.UdpReceiveResult";
   ...
   return NetFrameworkBase.System.Net.Sockets.UdpReceiveResult.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Sockets.UdpReceiveResult.Kind_Ptr := new NetFrameworkBase.System.Net.Sockets.UdpReceiveResult.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := GetObject (remoteEndPoint.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
