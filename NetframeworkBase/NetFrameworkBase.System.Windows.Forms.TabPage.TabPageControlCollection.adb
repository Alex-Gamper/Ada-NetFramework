...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.TabPage.TabPageControlCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.TabPage+TabPageControlCollection";
   ...
   procedure Add
   (
      this : in out TabPageControlCollection.Kind;
   ...
   (
      owner : NetFrameworkBase.System.Windows.Forms.TabPage.Kind_Ptr
   )
   return NetFrameworkBase.System.Windows.Forms.TabPage.TabPageControlCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.TabPage.TabPageControlCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.TabPage.TabPageControlCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
