...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.SelectionRange is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.SelectionRange";
   ...
   function End_x
   (
      this : in out SelectionRange.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Windows.Forms.SelectionRange.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.SelectionRange.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.SelectionRange.Kind do
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(lower);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(upper);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (range_x.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
