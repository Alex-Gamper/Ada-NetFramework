...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ListBox.ObjectCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ListBox+ObjectCollection";
   ...
   (
      this : in out ObjectCollection.Kind;
      value : NetFrameworkBase.System.Windows.Forms.ListBox.ObjectCollection.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ListBox.ObjectCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ListBox.ObjectCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
