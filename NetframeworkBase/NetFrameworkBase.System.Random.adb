...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Random is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Random";
   ...
   function Next
   (
      this : in out Random.Kind
   )
   return NetFrameworkBase.Int32 is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Next");
   ...
   return NetFrameworkBase.Double is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("NextDouble");
      p_RetVal      : aliased VARIANT;
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("NextBytes");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.Random.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Random.Kind_Ptr := new NetFrameworkBase.System.Random.Kind do
   ...
   return NetFrameworkBase.System.Random.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Random.Kind_Ptr := new NetFrameworkBase.System.Random.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
