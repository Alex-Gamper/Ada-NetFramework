...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ListView.CheckedIndexCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ListView+CheckedIndexCollection";
   ...
   function Count
   (
      this : in out CheckedIndexCollection.Kind
   )
   ...
   (
      this : in out CheckedIndexCollection.Kind;
      checkedIndex : NetFrameworkBase.Int32
   )
   return NetFrameworkBase.Boolean is
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := To_Variant(checkedIndex);
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ListView.CheckedIndexCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ListView.CheckedIndexCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
