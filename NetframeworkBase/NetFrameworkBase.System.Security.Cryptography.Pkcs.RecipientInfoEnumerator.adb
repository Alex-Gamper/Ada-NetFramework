...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Pkcs.RecipientInfoEnumerator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Pkcs.RecipientInfoEnumerator";
   ...
   function Current
   (
      this : in out RecipientInfoEnumerator.Kind
   )
