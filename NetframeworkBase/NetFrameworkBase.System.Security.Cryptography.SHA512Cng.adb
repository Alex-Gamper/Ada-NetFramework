...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.SHA512Cng is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.SHA512Cng";
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.SHA512Cng.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.SHA512Cng.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.SHA512Cng.Kind do
