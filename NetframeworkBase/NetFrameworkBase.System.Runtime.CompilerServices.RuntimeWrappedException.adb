...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.CompilerServices.RuntimeWrappedException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.CompilerServices.RuntimeWrappedException";
   ...
   function WrappedException
   (
      this : in out RuntimeWrappedException.Kind
   )
   return NetFrameworkBase.System.Object.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("WrappedException");
