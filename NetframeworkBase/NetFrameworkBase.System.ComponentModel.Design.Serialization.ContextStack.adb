...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.Design.Serialization.ContextStack is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.Design.Serialization.ContextStack";
   ...
   (
      this : in out ContextStack.Kind;
      context : NetFrameworkBase.System.Object.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   function Constructor return NetFrameworkBase.System.ComponentModel.Design.Serialization.ContextStack.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.Design.Serialization.ContextStack.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.Design.Serialization.ContextStack.Kind do
