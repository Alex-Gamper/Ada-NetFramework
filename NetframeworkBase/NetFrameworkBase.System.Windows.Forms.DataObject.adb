...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DataObject is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DataObject";
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := To_Variant(autoConvert);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetDataPresent");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.BSTR_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetFormats");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.Windows.Forms.DataObject.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.DataObject.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.DataObject.Kind do
