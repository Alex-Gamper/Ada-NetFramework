...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ListViewGroupCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ListViewGroupCollection";
   ...
   function Count
   (
      this : in out ListViewGroupCollection.Kind
   )
   ...
   (
      this : in out ListViewGroupCollection.Kind;
      groups : NetFrameworkBase.System.Windows.Forms.ListViewGroup.Kind_Array
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (groups'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in groups'range loop
            ...
            p0_Tmp := GetObject (groups(i).m_Kind);
      ...
      -- fixme parameter type := [array] System.Windows.Forms.ListViewGroup[]
   ...
   (
      this : in out ListViewGroupCollection.Kind;
      groups : NetFrameworkBase.System.Windows.Forms.ListViewGroupCollection.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (groups.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
