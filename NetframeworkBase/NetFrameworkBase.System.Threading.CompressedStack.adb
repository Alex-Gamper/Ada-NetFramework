...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Threading.CompressedStack is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Threading.CompressedStack";
   ...
   procedure Run
   (
      compressedStack : NetFrameworkBase.System.Threading.CompressedStack.Kind_Ptr; 
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (compressedStack.m_Kind);
   ...
   function CreateCopy
   (
      this : in out CompressedStack.Kind
   )
   return NetFrameworkBase.System.Threading.CompressedStack.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
