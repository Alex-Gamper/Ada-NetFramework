...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.XmlSchemaCollectionEnumerator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.XmlSchemaCollectionEnumerator";
   ...
   function MoveNext
   (
      this : in out XmlSchemaCollectionEnumerator.Kind
   )
