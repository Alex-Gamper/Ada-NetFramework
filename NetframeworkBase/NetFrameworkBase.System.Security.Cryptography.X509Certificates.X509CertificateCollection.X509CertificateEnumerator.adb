...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509CertificateCollection.X509CertificateEnumerator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.X509Certificates.X509CertificateCollection+X509CertificateEnumerator";
   ...
   function Current
   (
      this : in out X509CertificateEnumerator.Kind
   )
   ...
   (
      mappings : NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509CertificateCollection.Kind_Ptr
   )
   ...
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509CertificateCollection.X509CertificateEnumerator.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509CertificateCollection.X509CertificateEnumerator.Kind do
      declare
