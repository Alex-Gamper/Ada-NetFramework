...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.WindowsFormsSection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.WindowsFormsSection";
   ...
   procedure JitDebugging
   (
      this : in out WindowsFormsSection.Kind;
      ...
      p_MethodName  : BSTR := To_BSTR("JitDebugging");
   ...
   function Constructor return NetFrameworkBase.System.Windows.Forms.WindowsFormsSection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.WindowsFormsSection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.WindowsFormsSection.Kind do
