...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Dynamic.GetMemberBinder is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Dynamic.GetMemberBinder";
   ...
   function ReturnType
   (
      this : in out GetMemberBinder.Kind
   )
   ...
   return NetFrameworkBase.System.Dynamic.DynamicMetaObject.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("FallbackGetMember");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
