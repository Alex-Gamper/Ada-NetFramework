...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.XmlSchemaComplexContent is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.XmlSchemaComplexContent";
   ...
   function IsMixed
   (
      this : in out XmlSchemaComplexContent.Kind
   )
   ...
   return NetFrameworkBase.System.Xml.Schema.XmlSchemaContent.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Xml.Schema.XmlSchemaContent.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaContent.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   (
      this : in out XmlSchemaComplexContent.Kind;
      value : NetFrameworkBase.System.Xml.Schema.XmlSchemaContent.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   function Constructor return NetFrameworkBase.System.Xml.Schema.XmlSchemaComplexContent.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Schema.XmlSchemaComplexContent.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaComplexContent.Kind do
