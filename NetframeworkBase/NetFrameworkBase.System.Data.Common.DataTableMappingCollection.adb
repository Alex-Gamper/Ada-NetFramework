...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.Common.DataTableMappingCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.Common.DataTableMappingCollection";
   ...
   return NetFrameworkBase.System.Data.Common.DataTableMapping.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetTableMappingBySchemaAction");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (tableMappings.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := To_Variant(sourceTable);
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Data.Common.DataTableMapping[]
   ...
   return NetFrameworkBase.System.Data.Common.DataTableMapping.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetByDataSetTable");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Data.Common.DataTableMapping.Kind_Ptr := new NetFrameworkBase.System.Data.Common.DataTableMapping.Kind;
   begin
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IndexOfDataSetTable");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Int32;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Data.Common.DataTableMappingCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Data.Common.DataTableMappingCollection.Kind_Ptr := new NetFrameworkBase.System.Data.Common.DataTableMappingCollection.Kind do
