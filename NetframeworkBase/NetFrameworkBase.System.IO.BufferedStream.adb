...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.BufferedStream is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.BufferedStream";
   ...
   return NetFrameworkBase.System.IO.BufferedStream.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.IO.BufferedStream.Kind_Ptr := new NetFrameworkBase.System.IO.BufferedStream.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
