...
--------------------------------------------------------------------------------
package NetFrameworkBase.System.ComponentModel.Design.Serialization.IDesignerLoaderService is
   ...
   type Kind_Array_Ptr is access all Kind_Array;
      ...
      function AddLoadDependency
      (
         this : in out IDesignerLoaderService.Kind
      ) return HResult is abstract;
      
      function DependentLoadComplete
      (
         this : in out IDesignerLoaderService.Kind;
         successful : NetFrameworkBase.Boolean;
         errorCollection : NetFrameworkBase.System.Collections.ICollection.Kind_Ptr
      ) return HResult is abstract;
   ...
   private
      ...
      This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.Design.Serialization.IDesignerLoaderService";
