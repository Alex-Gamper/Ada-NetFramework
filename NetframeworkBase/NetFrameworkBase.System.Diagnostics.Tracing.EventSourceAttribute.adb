...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.Tracing.EventSourceAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.Tracing.EventSourceAttribute";
   ...
   function Name
   (
      this : in out EventSourceAttribute.Kind
   )
   ...
   function LocalizationResources
   (
      this : in out EventSourceAttribute.Kind
   )
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("LocalizationResources");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   procedure LocalizationResources
   (
      this : in out EventSourceAttribute.Kind;
      value : NetFrameworkBase.BSTR
   ) is
   ...
   function Constructor return NetFrameworkBase.System.Diagnostics.Tracing.EventSourceAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.Tracing.EventSourceAttribute.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.Tracing.EventSourceAttribute.Kind do
