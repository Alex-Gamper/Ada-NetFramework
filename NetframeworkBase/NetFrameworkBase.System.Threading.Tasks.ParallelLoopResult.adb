...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Threading.Tasks.ParallelLoopResult is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Threading.Tasks.ParallelLoopResult";
   ...
   (
      this : in out ParallelLoopResult.Kind
   )
