...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DataGrid.HitTestType is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DataGrid+HitTestType";
