...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Collections.DictionaryEntry is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Collections.DictionaryEntry";
   ...
   function Key
   (
      this : in out DictionaryEntry.Kind
   )
   ...
   return NetFrameworkBase.System.Collections.DictionaryEntry.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Collections.DictionaryEntry.Kind_Ptr := new NetFrameworkBase.System.Collections.DictionaryEntry.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
