...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.Common.DbEnumerator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.Common.DbEnumerator";
   ...
   return NetFrameworkBase.System.Data.Common.DbEnumerator.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Data.Common.DbEnumerator.Kind_Ptr := new NetFrameworkBase.System.Data.Common.DbEnumerator.Kind do
      declare
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(closeReader);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
