...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Principal.WindowsImpersonationContext is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Principal.WindowsImpersonationContext";
   ...
   procedure Undo
   (
      this : in out WindowsImpersonationContext.Kind
   ) is
      Hr            : HResult := 0;
