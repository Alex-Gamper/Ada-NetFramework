...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.NotFiniteNumberException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.NotFiniteNumberException";
   ...
   function OffendingNumber
   (
      this : in out NotFiniteNumberException.Kind
   )
   return NetFrameworkBase.Double is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("OffendingNumber");
   ...
   function Constructor return NetFrameworkBase.System.NotFiniteNumberException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.NotFiniteNumberException.Kind_Ptr := new NetFrameworkBase.System.NotFiniteNumberException.Kind do
   ...
   return NetFrameworkBase.System.NotFiniteNumberException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.NotFiniteNumberException.Kind_Ptr := new NetFrameworkBase.System.NotFiniteNumberException.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(offendingNumber);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
