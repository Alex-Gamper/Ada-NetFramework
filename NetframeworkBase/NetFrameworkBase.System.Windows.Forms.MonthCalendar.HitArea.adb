...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.MonthCalendar.HitArea is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.MonthCalendar+HitArea";
