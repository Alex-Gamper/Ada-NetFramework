...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Threading.Semaphore is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Threading.Semaphore";
   ...
   return NetFrameworkBase.System.Threading.Semaphore.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Threading.Semaphore.Kind_Ptr := new NetFrameworkBase.System.Threading.Semaphore.Kind;
   begin
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_MethodName  : BSTR := To_BSTR("TryOpenExisting");
      p_RetVal      : aliased VARIANT;
      p_rightsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.AccessControl.SemaphoreRights.Instance;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := To_Variant(releaseCount);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.System.Security.AccessControl.SemaphoreSecurity.Kind_Ptr is
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.AccessControl.SemaphoreSecurity.Kind_Ptr := new NetFrameworkBase.System.Security.AccessControl.SemaphoreSecurity.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (semaphoreSecurity.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.System.Threading.Semaphore.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Threading.Semaphore.Kind_Ptr := new NetFrameworkBase.System.Threading.Semaphore.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(initialCount);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(maximumCount);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
