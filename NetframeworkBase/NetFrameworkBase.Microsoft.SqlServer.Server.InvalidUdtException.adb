...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.Microsoft.SqlServer.Server.InvalidUdtException is
   ...
   This_TypeName     : constant Standard.Wide_String := "Microsoft.SqlServer.Server.InvalidUdtException";
   ...
   (
      this : in out InvalidUdtException.Kind;
