...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Text.EncoderFallback is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Text.EncoderFallback";
   ...
   (
      this : in out EncoderFallback.Kind
   )
