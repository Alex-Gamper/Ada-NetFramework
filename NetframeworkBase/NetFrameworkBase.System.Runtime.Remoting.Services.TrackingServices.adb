...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Remoting.Services.TrackingServices is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Remoting.Services.TrackingServices";
   ...
   (
      handler : NetFrameworkBase.System.Runtime.Remoting.Services.ITrackingHandler.Kind_Ptr
   )
   is
      ...
      p_MethodName  : BSTR := To_BSTR("RegisterTrackingHandler");
   ...
   begin
      ...
      p_Value.field_1.field_1.field_1.punkVal := handler;
   ...
   is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("UnregisterTrackingHandler");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.Runtime.Remoting.Services.ITrackingHandler.Kind_Array is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RegisteredHandlers");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   
      function GetArray (sa : access NetFrameworkWin32.SAFEARRAY) return NetFrameworkBase.System.Runtime.Remoting.Services.ITrackingHandler.Kind_Array is
      ...
      begin
         ...
         declare
            RetVal : NetFrameworkBase.System.Runtime.Remoting.Services.ITrackingHandler.Kind_Array(1..integer(Index));
            Value  : aliased NetFrameworkBase.System.Runtime.Remoting.Services.ITrackingHandler.Kind_Ptr;
   ...
   function Constructor return NetFrameworkBase.System.Runtime.Remoting.Services.TrackingServices.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Remoting.Services.TrackingServices.Kind_Ptr := new NetFrameworkBase.System.Runtime.Remoting.Services.TrackingServices.Kind do
