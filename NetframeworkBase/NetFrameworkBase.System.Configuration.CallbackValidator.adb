...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.CallbackValidator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.CallbackValidator";
   ...
   (
      this : in out CallbackValidator.Kind;
   ...
   return NetFrameworkBase.System.Configuration.CallbackValidator.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.CallbackValidator.Kind_Ptr := new NetFrameworkBase.System.Configuration.CallbackValidator.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
