...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.ProcessModuleCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.ProcessModuleCollection";
   ...
   function Item
   (
      this : in out ProcessModuleCollection.Kind;
   ...
   (
      this : in out ProcessModuleCollection.Kind;
      module : NetFrameworkBase.System.Diagnostics.ProcessModule.Kind_Ptr
   )
   ...
   (
      this : in out ProcessModuleCollection.Kind;
      array_x : NetFrameworkBase.System.Diagnostics.ProcessModule.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Diagnostics.ProcessModule[]
   ...
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.ProcessModuleCollection.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.ProcessModuleCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
         ...
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p0_Parameters : aliased LPSAFEARRAY := null;
         p0_Bounds     : aliased SAFEARRAYBOUND := (processModules'Length , 0);
         p0_Index      : aliased array(1..1) of aliased LONG := (others => 0);
         p0_Tmp        : aliased IUnknown_Ptr;
         p0_Tmp_Ptr    : access IUnknown_Ptr := p0_Tmp'access;
      begin
         ...
         begin
            p0_Parameters := SafeArrayCreate (VT_UNKNOWN'enum_rep, 1, p0_Bounds'access);
            for i in processModules'range loop
               p0_Index(1) := Interfaces.C.long(i) - 1;
               p0_Tmp := GetObject (processModules(i).m_Kind);
               Hr := SafeArrayPutElement (p0_Parameters, p0_Index (p0_Index'first)'access, Convert (p0_Tmp));
            end loop;
            p_Value := To_Variant (p0_Parameters, VT_UNKNOWN);
         end;
