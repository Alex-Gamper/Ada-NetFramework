...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DrawListViewColumnHeaderEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DrawListViewColumnHeaderEventArgs";
   ...
   (
      this : in out DrawListViewColumnHeaderEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.DrawListViewColumnHeaderEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.DrawListViewColumnHeaderEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.DrawListViewColumnHeaderEventArgs.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_stateEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Windows.Forms.ListViewItemStates.Instance;
