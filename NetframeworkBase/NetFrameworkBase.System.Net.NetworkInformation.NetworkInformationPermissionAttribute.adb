...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.NetworkInformation.NetworkInformationPermissionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.NetworkInformation.NetworkInformationPermissionAttribute";
   ...
   function Access_x
   (
      this : in out NetworkInformationPermissionAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Net.NetworkInformation.NetworkInformationPermissionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.NetworkInformation.NetworkInformationPermissionAttribute.Kind_Ptr := new NetFrameworkBase.System.Net.NetworkInformation.NetworkInformationPermissionAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
