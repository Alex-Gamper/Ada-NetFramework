...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.Microsoft.SqlServer.Server.SqlProcedureAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "Microsoft.SqlServer.Server.SqlProcedureAttribute";
   ...
   function Name
   (
      this : in out SqlProcedureAttribute.Kind
   )
   ...
   function Constructor return NetFrameworkBase.Microsoft.SqlServer.Server.SqlProcedureAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.Microsoft.SqlServer.Server.SqlProcedureAttribute.Kind_Ptr := new NetFrameworkBase.Microsoft.SqlServer.Server.SqlProcedureAttribute.Kind do
