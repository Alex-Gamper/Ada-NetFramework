...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.TypeDescriptorPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.TypeDescriptorPermission";
   ...
   procedure Flags
   (
      this : in out TypeDescriptorPermission.Kind;
   ...
   return NetFrameworkBase.System.Security.Permissions.TypeDescriptorPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.TypeDescriptorPermission.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.TypeDescriptorPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      declare
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_flagEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Permissions.TypeDescriptorPermissionFlags.Instance;
