...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Drawing.BufferedGraphicsContext is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Drawing.BufferedGraphicsContext";
   ...
   return NetFrameworkBase.System.Drawing.Size.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("MaximumBuffer");
   ...
   return NetFrameworkBase.System.Drawing.BufferedGraphics.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Allocate");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Drawing.BufferedGraphics.Kind_Ptr := new NetFrameworkBase.System.Drawing.BufferedGraphics.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (targetGraphics.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := GetObject (targetRectangle.m_Kind); -- Parameter Type = ValueType
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   function Constructor return NetFrameworkBase.System.Drawing.BufferedGraphicsContext.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Drawing.BufferedGraphicsContext.Kind_Ptr := new NetFrameworkBase.System.Drawing.BufferedGraphicsContext.Kind do
