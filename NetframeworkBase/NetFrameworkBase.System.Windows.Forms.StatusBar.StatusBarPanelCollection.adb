...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.StatusBar.StatusBarPanelCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.StatusBar+StatusBarPanelCollection";
   ...
   (
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (panels'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in panels'range loop
            ...
            p0_Tmp := GetObject (panels(i).m_Kind);
      ...
      -- fixme parameter type := [array] System.Windows.Forms.StatusBarPanel[]
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.StatusBar.StatusBarPanelCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.StatusBar.StatusBarPanelCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
