...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Xsl.Runtime.PrecedingSiblingIterator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Xsl.Runtime.PrecedingSiblingIterator";
   ...
   procedure Create
   (
      this : in out PrecedingSiblingIterator.Kind;
