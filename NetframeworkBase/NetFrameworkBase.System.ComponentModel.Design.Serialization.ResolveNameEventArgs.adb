...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.Design.Serialization.ResolveNameEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.Design.Serialization.ResolveNameEventArgs";
   ...
   function Name
   (
      this : in out ResolveNameEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.ComponentModel.Design.Serialization.ResolveNameEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.Design.Serialization.ResolveNameEventArgs.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.Design.Serialization.ResolveNameEventArgs.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
