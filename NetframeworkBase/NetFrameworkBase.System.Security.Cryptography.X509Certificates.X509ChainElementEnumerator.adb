...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509ChainElementEnumerator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.X509Certificates.X509ChainElementEnumerator";
   ...
   function Current
   (
      this : in out X509ChainElementEnumerator.Kind
   )
