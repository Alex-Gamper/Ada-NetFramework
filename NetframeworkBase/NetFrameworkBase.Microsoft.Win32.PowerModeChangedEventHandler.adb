...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.Microsoft.Win32.PowerModeChangedEventHandler is
   ...
   This_TypeName     : constant Standard.Wide_String := "Microsoft.Win32.PowerModeChangedEventHandler";
