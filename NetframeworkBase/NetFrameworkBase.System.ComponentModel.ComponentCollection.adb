...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.ComponentCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.ComponentCollection";
   ...
   function Item
   (
      this : in out ComponentCollection.Kind;
   ...
   (
      this : in out ComponentCollection.Kind;
      array_x : NetFrameworkBase.System.ComponentModel.IComponent.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   --         p0_Tmp := GetObject (array_x(i).m_Kind); -- fixme [interface]
   ...
   return NetFrameworkBase.System.ComponentModel.ComponentCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.ComponentCollection.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.ComponentCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
