...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.Design.ComponentRenameEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.Design.ComponentRenameEventArgs";
   ...
   function Component
   (
      this : in out ComponentRenameEventArgs.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("NewName");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.ComponentModel.Design.ComponentRenameEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.Design.ComponentRenameEventArgs.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.Design.ComponentRenameEventArgs.Kind do
      declare
