...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.SecurityState is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.SecurityState";
   ...
   (
      this : in out SecurityState.Kind
   )
   return NetFrameworkBase.Boolean is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsStateAvailable");
