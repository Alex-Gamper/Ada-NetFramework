...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Policy.UrlMembershipCondition is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Policy.UrlMembershipCondition";
   ...
   procedure FromXml
   (
      this : in out UrlMembershipCondition.Kind;
   ...
   return NetFrameworkBase.System.Security.Policy.UrlMembershipCondition.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Policy.UrlMembershipCondition.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.UrlMembershipCondition.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
