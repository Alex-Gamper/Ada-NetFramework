...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.LabelEditEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.LabelEditEventArgs";
   ...
   function Label
   (
      this : in out LabelEditEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.LabelEditEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.LabelEditEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.LabelEditEventArgs.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
