...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.NetworkInformation.MulticastIPAddressInformationCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.NetworkInformation.MulticastIPAddressInformationCollection";
   ...
   procedure CopyTo
   (
      this : in out MulticastIPAddressInformationCollection.Kind;
      array_x : NetFrameworkBase.System.Net.NetworkInformation.MulticastIPAddressInformation.Kind_Array; 
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Net.NetworkInformation.MulticastIPAddressInformation[]
   ...
   (
      this : in out MulticastIPAddressInformationCollection.Kind;
      address : NetFrameworkBase.System.Net.NetworkInformation.MulticastIPAddressInformation.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   return NetFrameworkBase.System.Net.NetworkInformation.MulticastIPAddressInformation.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      p_Bounds      : aliased SAFEARRAYBOUND := (1 , 0);
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Net.NetworkInformation.MulticastIPAddressInformation.Kind_Ptr := new NetFrameworkBase.System.Net.NetworkInformation.MulticastIPAddressInformation.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
