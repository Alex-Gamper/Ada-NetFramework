...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Drawing.Printing.PrinterSettings.PaperSizeCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Drawing.Printing.PrinterSettings+PaperSizeCollection";
   ...
   function Count
   (
      this : in out PaperSizeCollection.Kind
   )
   ...
   (
      this : in out PaperSizeCollection.Kind;
      paperSizes : NetFrameworkBase.System.Drawing.Printing.PaperSize.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (paperSizes'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in paperSizes'range loop
            p0_Index(1) := Interfaces.C.long(i) - 1;
            p0_Tmp := GetObject (paperSizes(i).m_Kind);
      ...
      -- fixme parameter type := [array] System.Drawing.Printing.PaperSize[]
   ...
   (
      this : in out PaperSizeCollection.Kind;
      paperSize : NetFrameworkBase.System.Drawing.Printing.PaperSize.Kind_Ptr
   )
   return NetFrameworkBase.Int32 is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (paperSize.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   (
      array_x : NetFrameworkBase.System.Drawing.Printing.PaperSize.Kind_Array
   )
   return NetFrameworkBase.System.Drawing.Printing.PrinterSettings.PaperSizeCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Drawing.Printing.PrinterSettings.PaperSizeCollection.Kind_Ptr := new NetFrameworkBase.System.Drawing.Printing.PrinterSettings.PaperSizeCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
