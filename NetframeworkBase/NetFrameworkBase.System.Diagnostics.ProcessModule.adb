...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.ProcessModule is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.ProcessModule";
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_MethodName  : BSTR := To_BSTR("ModuleName");
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ModuleMemorySize");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.IntPtr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EntryPointAddress");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.IntPtr;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.Diagnostics.FileVersionInfo.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("FileVersionInfo");
      p_RetVal      : aliased VARIANT;
