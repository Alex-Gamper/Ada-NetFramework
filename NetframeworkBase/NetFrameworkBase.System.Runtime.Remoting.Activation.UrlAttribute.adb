...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Remoting.Activation.UrlAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Remoting.Activation.UrlAttribute";
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("UrlValue");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Runtime.Remoting.Activation.UrlAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Remoting.Activation.UrlAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.Remoting.Activation.UrlAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(callsiteURL);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
