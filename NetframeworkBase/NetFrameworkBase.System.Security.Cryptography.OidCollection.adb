...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.OidCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.OidCollection";
   ...
   function Add
   (
      this : in out OidCollection.Kind;
   ...
   return NetFrameworkBase.System.Security.Cryptography.OidEnumerator.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.OidEnumerator.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.OidEnumerator.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   (
      this : in out OidCollection.Kind;
      array_x : NetFrameworkBase.System.Security.Cryptography.Oid.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Security.Cryptography.Oid[]
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.OidCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.OidCollection.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.OidCollection.Kind do
