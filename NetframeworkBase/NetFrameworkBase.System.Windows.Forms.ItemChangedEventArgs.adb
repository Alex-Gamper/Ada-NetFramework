...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ItemChangedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ItemChangedEventArgs";
   ...
   function Index
   (
      this : in out ItemChangedEventArgs.Kind
   )
