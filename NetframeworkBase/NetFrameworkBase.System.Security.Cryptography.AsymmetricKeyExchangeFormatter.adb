...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.AsymmetricKeyExchangeFormatter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.AsymmetricKeyExchangeFormatter";
   ...
   function Parameters
   (
      this : in out AsymmetricKeyExchangeFormatter.Kind
   )
