...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.CngKeyBlobFormat";
   ...
   return NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EccPrivateBlob");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EccPublicBlob");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EccFullPrivateBlob");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EccFullPublicBlob");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GenericPrivateBlob");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GenericPublicBlob");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("OpaqueTransportBlob");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Pkcs8PrivateBlob");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
