...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.CheckedListBox.CheckedItemCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.CheckedListBox+CheckedItemCollection";
   ...
   function Count
   (
      this : in out CheckedItemCollection.Kind
   )
