...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.TreeNodeCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.TreeNodeCollection";
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 3;
      p_Value := To_Variant(selectedImageKey);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   (
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (nodes'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in nodes'range loop
            ...
            p0_Tmp := GetObject (nodes(i).m_Kind);
   ...
   return NetFrameworkBase.System.Windows.Forms.TreeNode.Kind_Array is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      p_Bounds      : aliased SAFEARRAYBOUND := (2 , 0);
      ...
      function GetArray (sa : access NetFrameworkWin32.SAFEARRAY) return NetFrameworkBase.System.Windows.Forms.TreeNode.Kind_Array is
      ...
      begin
         ...
         declare
            RetVal : NetFrameworkBase.System.Windows.Forms.TreeNode.Kind_Array(1..integer(Index));
            Value  : NetFrameworkBase.System.Windows.Forms.TreeNode.Kind_Ptr;
            Var    : aliased VARIANT;
            Item   : PVOID;
         ...
         begin
            ...
            for I in RetVal'range loop
               ...
               Value := new NetFrameworkBase.System.Windows.Forms.TreeNode.Kind;
