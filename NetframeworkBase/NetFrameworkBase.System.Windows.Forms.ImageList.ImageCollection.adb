...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ImageList.ImageCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ImageList+ImageCollection";
   ...
   (
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (images'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in images'range loop
            ...
            p0_Tmp := GetObject (images(i).m_Kind);
      ...
      -- fixme parameter type := [array] System.Drawing.Image[]
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SetKeyName");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AddStrip");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Int32;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
