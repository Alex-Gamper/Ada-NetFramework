...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.ECDiffieHellmanCngPublicKey is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.ECDiffieHellmanCngPublicKey";
   ...
   function BlobFormat
   (
      this : in out ECDiffieHellmanCngPublicKey.Kind
   )
   return NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("BlobFormat");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.CngKeyBlobFormat.Kind;
   begin
   ...
   (
      publicKeyBlob : NetFrameworkBase.Byte_Array; 
   ...
   return NetFrameworkBase.System.Security.Cryptography.ECDiffieHellmanPublicKey.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("FromByteArray");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p0_Parameters : aliased LPSAFEARRAY := null;
      p0_Bounds     : aliased SAFEARRAYBOUND := (publicKeyBlob'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in publicKeyBlob'range loop
            p0_Index(1) := Interfaces.C.long(i) - 1;
            p0_Tmp := publicKeyBlob(i);
   ...
   return NetFrameworkBase.System.Security.Cryptography.ECDiffieHellmanCngPublicKey.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.ECDiffieHellmanCngPublicKey.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.ECDiffieHellmanCngPublicKey.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Static)'Enum_rep;
