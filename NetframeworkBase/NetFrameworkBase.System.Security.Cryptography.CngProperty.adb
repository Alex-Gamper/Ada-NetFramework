...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.CngProperty is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.CngProperty";
   ...
   return NetFrameworkBase.System.Security.Cryptography.CngPropertyOptions.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Security.Cryptography.CngPropertyOptions.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      RetVal        : NetFrameworkBase.System.Security.Cryptography.CngPropertyOptions.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   (
      left : NetFrameworkBase.System.Security.Cryptography.CngProperty.Kind_Ptr; 
      right : NetFrameworkBase.System.Security.Cryptography.CngProperty.Kind_Ptr
   )
   ...
   (
      this : in out CngProperty.Kind;
      other : NetFrameworkBase.System.Security.Cryptography.CngProperty.Kind_Ptr
   )
   return NetFrameworkBase.Boolean is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.CngProperty.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.CngProperty.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
