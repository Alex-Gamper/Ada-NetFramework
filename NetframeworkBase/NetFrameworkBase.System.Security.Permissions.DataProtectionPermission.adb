...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.DataProtectionPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.DataProtectionPermission";
   ...
   procedure Flags
   (
      this : in out DataProtectionPermission.Kind;
      value : NetFrameworkBase.System.Security.Permissions.DataProtectionPermissionFlags.Kind
   ) is
      ...
      p_valueEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Permissions.DataProtectionPermissionFlags.Instance;
   ...
   return NetFrameworkBase.System.Security.Permissions.DataProtectionPermissionFlags.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Security.Permissions.DataProtectionPermissionFlags.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Flags");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Permissions.DataProtectionPermissionFlags.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.Security.Permissions.DataProtectionPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.DataProtectionPermission.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.DataProtectionPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      declare
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_flagEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Permissions.DataProtectionPermissionFlags.Instance;
         p_flagEnum : aliased VARIANT := To_Variant (CreateEnum (p_flagEnumType, flag'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
