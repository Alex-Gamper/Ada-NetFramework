...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.Microsoft.SqlServer.Server.SqlMethodAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "Microsoft.SqlServer.Server.SqlMethodAttribute";
   ...
   function OnNullCall
   (
      this : in out SqlMethodAttribute.Kind
   )
   return NetFrameworkBase.Boolean is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("OnNullCall");
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsMutator");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Boolean;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function InvokeIfReceiverIsNull
   (
      this : in out SqlMethodAttribute.Kind
   )
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("InvokeIfReceiverIsNull");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Boolean;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   procedure InvokeIfReceiverIsNull
   (
      this : in out SqlMethodAttribute.Kind;
      value : NetFrameworkBase.Boolean
   ) is
   ...
   function Constructor return NetFrameworkBase.Microsoft.SqlServer.Server.SqlMethodAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.Microsoft.SqlServer.Server.SqlMethodAttribute.Kind_Ptr := new NetFrameworkBase.Microsoft.SqlServer.Server.SqlMethodAttribute.Kind do
