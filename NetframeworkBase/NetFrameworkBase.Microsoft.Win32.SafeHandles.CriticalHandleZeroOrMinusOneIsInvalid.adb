...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.Microsoft.Win32.SafeHandles.CriticalHandleZeroOrMinusOneIsInvalid is
   ...
   This_TypeName     : constant Standard.Wide_String := "Microsoft.Win32.SafeHandles.CriticalHandleZeroOrMinusOneIsInvalid";
   ...
   function IsInvalid
   (
      this : in out CriticalHandleZeroOrMinusOneIsInvalid.Kind
   )
