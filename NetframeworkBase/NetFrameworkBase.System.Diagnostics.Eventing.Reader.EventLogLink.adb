...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.Eventing.Reader.EventLogLink is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.Eventing.Reader.EventLogLink";
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsImported");
      p_RetVal      : aliased VARIANT;
