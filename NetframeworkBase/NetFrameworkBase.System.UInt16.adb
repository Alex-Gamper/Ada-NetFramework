...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.UInt16 is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.UInt16";
   ...
   (
      s : NetFrameworkBase.BSTR; 
      result : out NetFrameworkBase.UInt16
   )
   return NetFrameworkBase.Boolean is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      -- parameter type := [out] [builtin] System.UInt16&
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   
      VariantInit(p_Target'access);
      p_RetVal := InvokeMethod (Instance, p_Target, p_MethodName, p_Flags, p_Parameters);
   
      -- set out parameter [result : System.UInt16]
      p_Index(1) := 1;
   ...
   function Constructor return NetFrameworkBase.System.UInt16.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.UInt16.Kind_Ptr := new NetFrameworkBase.System.UInt16.Kind do
