...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.NamedPermissionSet is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.NamedPermissionSet";
   ...
   return NetFrameworkBase.System.Security.NamedPermissionSet.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.NamedPermissionSet.Kind_Ptr := new NetFrameworkBase.System.Security.NamedPermissionSet.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
