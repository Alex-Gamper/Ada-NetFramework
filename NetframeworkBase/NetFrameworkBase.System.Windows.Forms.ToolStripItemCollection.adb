...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ToolStripItemCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ToolStripItemCollection";
   ...
   (
      ...
      p0_Bounds     : aliased SAFEARRAYBOUND := (toolStripItems'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in toolStripItems'range loop
            p0_Index(1) := Interfaces.C.long(i) - 1;
            p0_Tmp := GetObject (toolStripItems(i).m_Kind);
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (toolStripItems.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.System.Windows.Forms.ToolStripItem.Kind_Array is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      p_Bounds      : aliased SAFEARRAYBOUND := (2 , 0);
      ...
      function GetArray (sa : access NetFrameworkWin32.SAFEARRAY) return NetFrameworkBase.System.Windows.Forms.ToolStripItem.Kind_Array is
      ...
      begin
         ...
         declare
            RetVal : NetFrameworkBase.System.Windows.Forms.ToolStripItem.Kind_Array(1..integer(Index));
            Value  : NetFrameworkBase.System.Windows.Forms.ToolStripItem.Kind_Ptr;
            Var    : aliased VARIANT;
            Item   : PVOID;
         ...
         begin
            ...
            for I in RetVal'range loop
               ...
               Value := new NetFrameworkBase.System.Windows.Forms.ToolStripItem.Kind;
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ToolStripItemCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ToolStripItemCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         begin
            ...
            for i in value'range loop
               ...
               p1_Tmp := GetObject (value(i).m_Kind);
