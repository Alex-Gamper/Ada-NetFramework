...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.TabControl.ControlCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.TabControl+ControlCollection";
   ...
   return NetFrameworkBase.System.Windows.Forms.TabControl.ControlCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.TabControl.ControlCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.TabControl.ControlCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
