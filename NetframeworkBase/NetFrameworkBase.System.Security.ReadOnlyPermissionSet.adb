...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.ReadOnlyPermissionSet is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.ReadOnlyPermissionSet";
   ...
   function IsReadOnly
   (
      this : in out ReadOnlyPermissionSet.Kind
   )
   ...
   return NetFrameworkBase.System.Security.ReadOnlyPermissionSet.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.ReadOnlyPermissionSet.Kind_Ptr := new NetFrameworkBase.System.Security.ReadOnlyPermissionSet.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (permissionSetXml.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
