...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.ConfigurationSectionCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.ConfigurationSectionCollection";
   ...
   (
      this : in out ConfigurationSectionCollection.Kind;
   ...
   (
      this : in out ConfigurationSectionCollection.Kind;
      name : NetFrameworkBase.BSTR; 
      section : NetFrameworkBase.System.Configuration.ConfigurationSection.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := GetObject (section.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   (
      this : in out ConfigurationSectionCollection.Kind;
      array_x : NetFrameworkBase.System.Configuration.ConfigurationSection.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Configuration.ConfigurationSection[]
