...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Drawing.Point is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Drawing.Point";
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := GetObject (sz.m_Kind); -- Parameter Type = ValueType
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.System.Drawing.Point.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Drawing.Point.Kind_Ptr := new NetFrameworkBase.System.Drawing.Point.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
