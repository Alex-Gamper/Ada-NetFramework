...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.ConditionalAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.ConditionalAttribute";
   ...
   (
      this : in out ConditionalAttribute.Kind
   )
   return NetFrameworkBase.BSTR is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ConditionString");
   ...
   return NetFrameworkBase.System.Diagnostics.ConditionalAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.ConditionalAttribute.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.ConditionalAttribute.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(conditionString);
