...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.Provider.ProviderBase is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.Provider.ProviderBase";
   ...
   (
      ...
      config : NetFrameworkBase.System.Collections.Specialized.NameValueCollection.Kind_Ptr
   ) is
