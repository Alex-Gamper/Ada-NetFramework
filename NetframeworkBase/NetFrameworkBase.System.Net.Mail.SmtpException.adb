...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Mail.SmtpException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Mail.SmtpException";
   ...
   function StatusCode
   (
      this : in out SmtpException.Kind
   )
   return NetFrameworkBase.System.Net.Mail.SmtpStatusCode.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Net.Mail.SmtpStatusCode.Kind);
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Net.Mail.SmtpStatusCode.Kind;
   begin
   ...
   (
      this : in out SmtpException.Kind;
      value : NetFrameworkBase.System.Net.Mail.SmtpStatusCode.Kind
   ) is
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_valueEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Net.Mail.SmtpStatusCode.Instance;
   ...
   return NetFrameworkBase.System.Net.Mail.SmtpException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Mail.SmtpException.Kind_Ptr := new NetFrameworkBase.System.Net.Mail.SmtpException.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_statusCodeEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Net.Mail.SmtpStatusCode.Instance;
         p_statusCodeEnum : aliased VARIANT := To_Variant (CreateEnum (p_statusCodeEnumType, statusCode'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := p_statusCodeEnum;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   function Constructor return NetFrameworkBase.System.Net.Mail.SmtpException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Mail.SmtpException.Kind_Ptr := new NetFrameworkBase.System.Net.Mail.SmtpException.Kind do
