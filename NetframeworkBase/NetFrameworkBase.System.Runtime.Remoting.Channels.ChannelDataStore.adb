...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Remoting.Channels.ChannelDataStore is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Remoting.Channels.ChannelDataStore";
   ...
   function ChannelUris
   (
      this : in out ChannelDataStore.Kind
   )
   return NetFrameworkBase.BSTR_Array is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ChannelUris");
   ...
   return NetFrameworkBase.System.Runtime.Remoting.Channels.ChannelDataStore.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.Remoting.Channels.ChannelDataStore.Kind_Ptr := new NetFrameworkBase.System.Runtime.Remoting.Channels.ChannelDataStore.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
         ...
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p0_Parameters : aliased LPSAFEARRAY := null;
         p0_Bounds     : aliased SAFEARRAYBOUND := (channelURIs'Length , 0);
         p0_Index      : aliased array(1..1) of aliased LONG := (others => 0);
         p0_Tmp        : aliased NetFrameworkBase.BSTR;
         p0_Tmp_Ptr    : access NetFrameworkBase.BSTR := p0_Tmp'access;
      begin
         ...
         begin
            p0_Parameters := SafeArrayCreate (VT_BSTR'enum_rep, 1, p0_Bounds'access);
            for i in channelURIs'range loop
               p0_Index(1) := Interfaces.C.long(i) - 1;
               p0_Tmp := channelURIs(i);
               Hr := SafeArrayPutElement (p0_Parameters, p0_Index (p0_Index'first)'access, Convert (p0_Tmp_Ptr));
            end loop;
            p_Value := To_Variant (p0_Parameters, VT_BSTR);
         end;
