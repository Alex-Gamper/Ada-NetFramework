...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.TableLayoutControlCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.TableLayoutControlCollection";
   ...
   return NetFrameworkBase.System.Windows.Forms.TableLayoutPanel.Kind_Ptr is
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Windows.Forms.TableLayoutPanel.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.TableLayoutPanel.Kind;
   begin
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.TableLayoutControlCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.TableLayoutControlCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
