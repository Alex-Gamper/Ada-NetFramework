...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.ECDiffieHellman is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.ECDiffieHellman";
   ...
   function Create
   return NetFrameworkBase.System.Security.Cryptography.ECDiffieHellman.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      RetVal        : NetFrameworkBase.System.Security.Cryptography.ECDiffieHellman.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.ECDiffieHellman.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
