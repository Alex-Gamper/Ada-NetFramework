...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.Design.DesignerCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.Design.DesignerCollection";
   ...
   return NetFrameworkBase.System.ComponentModel.Design.IDesignerHost.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.ComponentModel.Design.IDesignerHost.Kind_Ptr;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   return NetFrameworkBase.System.ComponentModel.Design.DesignerCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.Design.DesignerCollection.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.Design.DesignerCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
         ...
         p0_Bounds     : aliased SAFEARRAYBOUND := (designers'Length , 0);
      ...
      begin
         ...
         begin
            ...
            for i in designers'range loop
               p0_Index(1) := Interfaces.C.long(i) - 1;
      --         p0_Tmp := GetObject (designers(i).m_Kind); -- fixme [interface]
         ...
         -- fixme parameter type := [array] System.ComponentModel.Design.IDesignerHost[]
   ...
   begin
      ...
      begin
         ...
         p_Value.field_1.field_1.field_1.punkVal := designers;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
