...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Transactions.DistributedTransactionPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Transactions.DistributedTransactionPermission";
   ...
   (
      this : in out DistributedTransactionPermission.Kind
   )
   ...
   return NetFrameworkBase.System.Transactions.DistributedTransactionPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Transactions.DistributedTransactionPermission.Kind_Ptr := new NetFrameworkBase.System.Transactions.DistributedTransactionPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
