...
--------------------------------------------------------------------------------
package NetFrameworkBase.System.EnterpriseServices.IProcessInitControl is
   ...
   type Kind_Array_Ptr is access all Kind_Array;
      ...
      (
         this : in out IProcessInitControl.Kind;
         dwSecondsRemaining : NetFrameworkBase.Int32
   ...
   private
      ...
      This_TypeName     : constant Standard.Wide_String := "System.EnterpriseServices.IProcessInitControl";
