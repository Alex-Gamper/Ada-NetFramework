...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.SqlClient.SqlCredential is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.SqlClient.SqlCredential";
   ...
   function UserId
   (
      this : in out SqlCredential.Kind
   )
   ...
   begin
      return RetVal : NetFrameworkBase.System.Data.SqlClient.SqlCredential.Kind_Ptr := new NetFrameworkBase.System.Data.SqlClient.SqlCredential.Kind do
      declare
