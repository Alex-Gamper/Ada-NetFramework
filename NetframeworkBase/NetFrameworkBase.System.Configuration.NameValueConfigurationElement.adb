...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.NameValueConfigurationElement is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.NameValueConfigurationElement";
   ...
   function Name
   (
      this : in out NameValueConfigurationElement.Kind
   )
   ...
   begin
      return RetVal : NetFrameworkBase.System.Configuration.NameValueConfigurationElement.Kind_Ptr := new NetFrameworkBase.System.Configuration.NameValueConfigurationElement.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
