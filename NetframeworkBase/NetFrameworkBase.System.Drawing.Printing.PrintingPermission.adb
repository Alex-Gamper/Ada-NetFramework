...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Drawing.Printing.PrintingPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Drawing.Printing.PrintingPermission";
   ...
   return NetFrameworkBase.System.Drawing.Printing.PrintingPermissionLevel.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Drawing.Printing.PrintingPermissionLevel.Kind);
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Drawing.Printing.PrintingPermissionLevel.Kind;
   begin
   ...
   (
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_valueEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Drawing.Printing.PrintingPermissionLevel.Instance;
   ...
   return NetFrameworkBase.System.Drawing.Printing.PrintingPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Drawing.Printing.PrintingPermission.Kind_Ptr := new NetFrameworkBase.System.Drawing.Printing.PrintingPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      declare
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_printingLevelEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Drawing.Printing.PrintingPermissionLevel.Instance;
         p_printingLevelEnum : aliased VARIANT := To_Variant (CreateEnum (p_printingLevelEnumType, printingLevel'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := p_printingLevelEnum;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
