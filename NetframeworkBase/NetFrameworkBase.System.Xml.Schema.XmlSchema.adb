...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.XmlSchema is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.XmlSchema";
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := GetObject (namespaceManager.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.System.Xml.Schema.XmlSchemaForm.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Xml.Schema.XmlSchemaForm.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AttributeFormDefault");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Xml.Schema.XmlSchemaForm.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   (
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_valueEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Xml.Schema.XmlSchemaForm.Instance;
   ...
   return NetFrameworkBase.System.Xml.Schema.XmlSchemaDerivationMethod.Kind is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("BlockDefault");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Xml.Schema.XmlSchemaDerivationMethod.Kind is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("FinalDefault");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Xml.Schema.XmlSchemaDerivationMethod.Kind;
   begin
   ...
   return NetFrameworkBase.System.Xml.Schema.XmlSchemaForm.Kind is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ElementFormDefault");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Xml.Schema.XmlSchemaForm.Kind;
   begin
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("TargetNamespace");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectCollection.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Includes");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectCollection.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectCollection.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   return NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectTable.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AttributeGroups");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectTable.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectTable.Kind;
   begin
   ...
   return NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectTable.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SchemaTypes");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectTable.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectTable.Kind;
   begin
   ...
   return NetFrameworkBase.System.Xml.XmlAttribute.Kind_Array is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("UnhandledAttributes");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   
      function GetArray (sa : access NetFrameworkWin32.SAFEARRAY) return NetFrameworkBase.System.Xml.XmlAttribute.Kind_Array is
      ...
      begin
         ...
         declare
            RetVal : NetFrameworkBase.System.Xml.XmlAttribute.Kind_Array(1..integer(Index));
            Value  : NetFrameworkBase.System.Xml.XmlAttribute.Kind_Ptr;
            Var    : aliased VARIANT;
            Item   : PVOID;
         ...
         begin
            ...
            for I in RetVal'range loop
               ...
               Value := new NetFrameworkBase.System.Xml.XmlAttribute.Kind;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Xml.XmlAttribute[]
   ...
   return NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectTable.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Notations");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectTable.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaObjectTable.Kind;
   begin
   ...
   function Constructor return NetFrameworkBase.System.Xml.Schema.XmlSchema.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Schema.XmlSchema.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchema.Kind do
