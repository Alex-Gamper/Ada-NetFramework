...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.Design.Serialization.MemberRelationship is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.Design.Serialization.MemberRelationship";
   ...
   function IsEmpty
   (
      this : in out MemberRelationship.Kind
   )
   ...
   return NetFrameworkBase.System.ComponentModel.MemberDescriptor.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      RetVal        : NetFrameworkBase.System.ComponentModel.MemberDescriptor.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.MemberDescriptor.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   (
      left : NetFrameworkBase.System.ComponentModel.Design.Serialization.MemberRelationship.Kind_Ptr; 
      right : NetFrameworkBase.System.ComponentModel.Design.Serialization.MemberRelationship.Kind_Ptr
   )
   return NetFrameworkBase.Boolean is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.Design.Serialization.MemberRelationship.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.Design.Serialization.MemberRelationship.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
