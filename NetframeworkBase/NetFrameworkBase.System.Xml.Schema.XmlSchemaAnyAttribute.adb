...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.XmlSchemaAnyAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.XmlSchemaAnyAttribute";
   ...
   function Namespace
   (
      this : in out XmlSchemaAnyAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Xml.Schema.XmlSchemaContentProcessing.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Xml.Schema.XmlSchemaContentProcessing.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ProcessContents");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Xml.Schema.XmlSchemaContentProcessing.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   (
      this : in out XmlSchemaAnyAttribute.Kind;
      value : NetFrameworkBase.System.Xml.Schema.XmlSchemaContentProcessing.Kind
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_valueEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Xml.Schema.XmlSchemaContentProcessing.Instance;
   ...
   function Constructor return NetFrameworkBase.System.Xml.Schema.XmlSchemaAnyAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Schema.XmlSchemaAnyAttribute.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaAnyAttribute.Kind do
