...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.Versioning.CompatibilitySwitch is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.Versioning.CompatibilitySwitch";
   ...
   function IsEnabled
   (
      compatibilitySwitchName : NetFrameworkBase.BSTR
   )
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := To_Variant(compatibilitySwitchName);
