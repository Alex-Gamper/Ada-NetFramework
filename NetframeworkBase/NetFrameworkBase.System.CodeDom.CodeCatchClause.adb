...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.CodeDom.CodeCatchClause is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.CodeDom.CodeCatchClause";
   ...
   function LocalName
   (
      this : in out CodeCatchClause.Kind
   )
   ...
   return NetFrameworkBase.System.CodeDom.CodeTypeReference.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CatchExceptionType");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   function Constructor return NetFrameworkBase.System.CodeDom.CodeCatchClause.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.CodeDom.CodeCatchClause.Kind_Ptr := new NetFrameworkBase.System.CodeDom.CodeCatchClause.Kind do
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := GetObject (catchExceptionType.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
   ...
   begin
      ...
      declare
         ...
         p2_Bounds     : aliased SAFEARRAYBOUND := (statements'Length , 0);
      ...
      begin
         ...
         begin
            ...
            for i in statements'range loop
               ...
               p2_Tmp := GetObject (statements(i).m_Kind);
