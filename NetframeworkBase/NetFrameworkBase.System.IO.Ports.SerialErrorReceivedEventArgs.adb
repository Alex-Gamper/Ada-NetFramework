...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.Ports.SerialErrorReceivedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.Ports.SerialErrorReceivedEventArgs";
   ...
   function EventType
   (
      this : in out SerialErrorReceivedEventArgs.Kind
   )
   return NetFrameworkBase.System.IO.Ports.SerialError.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.IO.Ports.SerialError.Kind);
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.IO.Ports.SerialError.Kind;
   begin
