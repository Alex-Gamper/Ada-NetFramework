...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.EventLogPermissionEntryCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.EventLogPermissionEntryCollection";
   ...
   function Item
   (
      this : in out EventLogPermissionEntryCollection.Kind;
   ...
   return NetFrameworkBase.System.Diagnostics.EventLogPermissionEntry.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Diagnostics.EventLogPermissionEntry.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.EventLogPermissionEntry.Kind;
   begin
   ...
   (
      this : in out EventLogPermissionEntryCollection.Kind;
      index : NetFrameworkBase.Int32; 
      value : NetFrameworkBase.System.Diagnostics.EventLogPermissionEntry.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   (
      this : in out EventLogPermissionEntryCollection.Kind;
      value : NetFrameworkBase.System.Diagnostics.EventLogPermissionEntry.Kind_Array
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   (
      this : in out EventLogPermissionEntryCollection.Kind;
      value : NetFrameworkBase.System.Diagnostics.EventLogPermissionEntryCollection.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   (
      this : in out EventLogPermissionEntryCollection.Kind;
      array_x : NetFrameworkBase.System.Diagnostics.EventLogPermissionEntry.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
