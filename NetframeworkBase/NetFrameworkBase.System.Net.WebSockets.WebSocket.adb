...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.WebSockets.WebSocket is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.WebSockets.WebSocket";
   ...
   return NetFrameworkBase.System.TimeSpan.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("DefaultKeepAliveInterval");
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsApplicationTargeting45");
      p_RetVal      : aliased VARIANT;
   ...
   is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RegisterPrefixes");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
