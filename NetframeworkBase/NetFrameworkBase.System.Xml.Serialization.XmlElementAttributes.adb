...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Serialization.XmlElementAttributes is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Serialization.XmlElementAttributes";
   ...
   function Item
   (
      this : in out XmlElementAttributes.Kind;
   ...
   return NetFrameworkBase.System.Xml.Serialization.XmlElementAttribute.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Xml.Serialization.XmlElementAttribute.Kind_Ptr := new NetFrameworkBase.System.Xml.Serialization.XmlElementAttribute.Kind;
   begin
   ...
   (
      this : in out XmlElementAttributes.Kind;
      index : NetFrameworkBase.Int32; 
      value : NetFrameworkBase.System.Xml.Serialization.XmlElementAttribute.Kind_Ptr
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   (
      this : in out XmlElementAttributes.Kind;
      attribute : NetFrameworkBase.System.Xml.Serialization.XmlElementAttribute.Kind_Ptr
   )
   ...
   (
      this : in out XmlElementAttributes.Kind;
      array_x : NetFrameworkBase.System.Xml.Serialization.XmlElementAttribute.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Xml.Serialization.XmlElementAttribute[]
   ...
   function Constructor return NetFrameworkBase.System.Xml.Serialization.XmlElementAttributes.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Serialization.XmlElementAttributes.Kind_Ptr := new NetFrameworkBase.System.Xml.Serialization.XmlElementAttributes.Kind do
