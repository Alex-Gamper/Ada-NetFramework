...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.SHA256Managed is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.SHA256Managed";
   ...
   (
      this : in out SHA256Managed.Kind
   ) is
      Hr            : HResult := 0;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.SHA256Managed.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.SHA256Managed.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.SHA256Managed.Kind do
