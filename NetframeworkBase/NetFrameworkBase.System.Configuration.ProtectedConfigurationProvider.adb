...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.ProtectedConfigurationProvider is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.ProtectedConfigurationProvider";
   ...
   function Encrypt
   (
      this : in out ProtectedConfigurationProvider.Kind;
