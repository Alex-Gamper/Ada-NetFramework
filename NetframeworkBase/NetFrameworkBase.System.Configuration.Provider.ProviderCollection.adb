...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.Provider.ProviderCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.Provider.ProviderCollection";
   ...
   return NetFrameworkBase.System.Configuration.Provider.ProviderBase.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      p_Bounds      : aliased SAFEARRAYBOUND := (1 , 0);
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Configuration.Provider.ProviderBase.Kind_Ptr := new NetFrameworkBase.System.Configuration.Provider.ProviderBase.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Configuration.Provider.ProviderBase[]
   ...
   function Constructor return NetFrameworkBase.System.Configuration.Provider.ProviderCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.Provider.ProviderCollection.Kind_Ptr := new NetFrameworkBase.System.Configuration.Provider.ProviderCollection.Kind do
