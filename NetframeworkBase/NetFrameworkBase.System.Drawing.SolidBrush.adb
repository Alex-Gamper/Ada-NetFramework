...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Drawing.SolidBrush is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Drawing.SolidBrush";
   ...
   return NetFrameworkBase.System.Drawing.SolidBrush.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Drawing.SolidBrush.Kind_Ptr := new NetFrameworkBase.System.Drawing.SolidBrush.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
