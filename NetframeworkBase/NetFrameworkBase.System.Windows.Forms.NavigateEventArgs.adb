...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.NavigateEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.NavigateEventArgs";
   ...
   function Forward
   (
      this : in out NavigateEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.NavigateEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.NavigateEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.NavigateEventArgs.Kind do
      declare
