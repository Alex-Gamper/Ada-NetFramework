...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.MemoryMappedFiles.MemoryMappedViewStream is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.MemoryMappedFiles.MemoryMappedViewStream";
   ...
   procedure SetLength
   (
      this : in out MemoryMappedViewStream.Kind;
