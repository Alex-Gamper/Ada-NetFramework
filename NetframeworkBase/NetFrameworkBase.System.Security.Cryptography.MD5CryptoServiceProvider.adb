...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.MD5CryptoServiceProvider is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.MD5CryptoServiceProvider";
   ...
   (
      this : in out MD5CryptoServiceProvider.Kind
   ) is
      Hr            : HResult := 0;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.MD5CryptoServiceProvider.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.MD5CryptoServiceProvider.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.MD5CryptoServiceProvider.Kind do
