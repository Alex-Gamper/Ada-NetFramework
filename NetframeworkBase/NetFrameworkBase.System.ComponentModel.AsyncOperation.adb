...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.AsyncOperation is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.AsyncOperation";
   ...
   return NetFrameworkBase.System.Object.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("UserSuppliedState");
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("PostOperationCompleted");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
