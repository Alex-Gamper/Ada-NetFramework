...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Linq.Expressions.MemberAssignment is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Linq.Expressions.MemberAssignment";
   ...
   function Expression
   (
      this : in out MemberAssignment.Kind
   )
