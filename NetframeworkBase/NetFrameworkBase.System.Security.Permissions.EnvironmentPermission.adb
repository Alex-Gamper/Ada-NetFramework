...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.EnvironmentPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.EnvironmentPermission";
   ...
   (
      ...
      p_flagEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Permissions.EnvironmentPermissionAccess.Instance;
   ...
   return NetFrameworkBase.System.Security.Permissions.EnvironmentPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.EnvironmentPermission.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.EnvironmentPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
