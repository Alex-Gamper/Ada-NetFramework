...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Mail.AlternateView is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Mail.AlternateView";
   ...
   return NetFrameworkBase.System.Net.Mail.LinkedResourceCollection.Kind_Ptr is
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Net.Mail.LinkedResourceCollection.Kind_Ptr := new NetFrameworkBase.System.Net.Mail.LinkedResourceCollection.Kind;
   begin
   ...
   return NetFrameworkBase.System.Net.Mail.AlternateView.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      p_Bounds      : aliased SAFEARRAYBOUND := (1 , 0);
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CreateAlternateViewFromString");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Net.Mail.AlternateView.Kind_Ptr := new NetFrameworkBase.System.Net.Mail.AlternateView.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.Net.Mail.AlternateView.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Mail.AlternateView.Kind_Ptr := new NetFrameworkBase.System.Net.Mail.AlternateView.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
