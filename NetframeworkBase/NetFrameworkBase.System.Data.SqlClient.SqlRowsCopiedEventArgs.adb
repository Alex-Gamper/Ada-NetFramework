...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.SqlClient.SqlRowsCopiedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.SqlClient.SqlRowsCopiedEventArgs";
   ...
   function Abort_x
   (
      this : in out SqlRowsCopiedEventArgs.Kind
   )
   ...
   return NetFrameworkBase.Int64 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RowsCopied");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Data.SqlClient.SqlRowsCopiedEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Data.SqlClient.SqlRowsCopiedEventArgs.Kind_Ptr := new NetFrameworkBase.System.Data.SqlClient.SqlRowsCopiedEventArgs.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
