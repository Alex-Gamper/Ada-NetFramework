...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.TypeConverter.StandardValuesCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.TypeConverter+StandardValuesCollection";
   ...
   function Count
   (
      this : in out StandardValuesCollection.Kind
   )
   ...
   (
      values : NetFrameworkBase.System.Collections.ICollection.Kind_Ptr
   )
   return NetFrameworkBase.System.ComponentModel.TypeConverter.StandardValuesCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.TypeConverter.StandardValuesCollection.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.TypeConverter.StandardValuesCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         p_Value.field_1.field_1.field_1.punkVal := values;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
