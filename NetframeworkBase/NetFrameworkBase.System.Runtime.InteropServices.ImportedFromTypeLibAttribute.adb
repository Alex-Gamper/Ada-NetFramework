...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.InteropServices.ImportedFromTypeLibAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.InteropServices.ImportedFromTypeLibAttribute";
   ...
   function Value
   (
      this : in out ImportedFromTypeLibAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Runtime.InteropServices.ImportedFromTypeLibAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.InteropServices.ImportedFromTypeLibAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.InteropServices.ImportedFromTypeLibAttribute.Kind do
      declare
