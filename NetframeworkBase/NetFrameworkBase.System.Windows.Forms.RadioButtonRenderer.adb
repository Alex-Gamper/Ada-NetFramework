...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.RadioButtonRenderer is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.RadioButtonRenderer";
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_RetVal      : aliased VARIANT;
      p_stateEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Windows.Forms.VisualStyles.RadioButtonState.Instance;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 3;
      p_Value := To_Variant(radioButtonText);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 4;
