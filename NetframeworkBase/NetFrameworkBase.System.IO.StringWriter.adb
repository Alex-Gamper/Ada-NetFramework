...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.StringWriter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.StringWriter";
   ...
   return NetFrameworkBase.System.Text.StringBuilder.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetStringBuilder");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   function Constructor return NetFrameworkBase.System.IO.StringWriter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.IO.StringWriter.Kind_Ptr := new NetFrameworkBase.System.IO.StringWriter.Kind do
   ...
   return NetFrameworkBase.System.IO.StringWriter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.IO.StringWriter.Kind_Ptr := new NetFrameworkBase.System.IO.StringWriter.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
