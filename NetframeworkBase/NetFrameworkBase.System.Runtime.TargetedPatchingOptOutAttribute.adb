...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.TargetedPatchingOptOutAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.TargetedPatchingOptOutAttribute";
   ...
   function Reason
   (
      this : in out TargetedPatchingOptOutAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Runtime.TargetedPatchingOptOutAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.TargetedPatchingOptOutAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.TargetedPatchingOptOutAttribute.Kind do
      declare
