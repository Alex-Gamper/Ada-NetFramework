...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Linq.Expressions.LoopExpression is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Linq.Expressions.LoopExpression";
   ...
   function Type_x
   (
      this : in out LoopExpression.Kind
   )
   ...
   return NetFrameworkBase.System.Linq.Expressions.LabelTarget.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("BreakLabel");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Linq.Expressions.LabelTarget.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ContinueLabel");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Linq.Expressions.LabelTarget.Kind_Ptr := new NetFrameworkBase.System.Linq.Expressions.LabelTarget.Kind;
   begin
   ...
   (
      this : in out LoopExpression.Kind;
      breakLabel : NetFrameworkBase.System.Linq.Expressions.LabelTarget.Kind_Ptr; 
      continueLabel : NetFrameworkBase.System.Linq.Expressions.LabelTarget.Kind_Ptr; 
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (breakLabel.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := GetObject (continueLabel.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 2;
