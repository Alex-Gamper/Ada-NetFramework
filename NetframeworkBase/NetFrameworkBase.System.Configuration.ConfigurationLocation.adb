...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.ConfigurationLocation is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.ConfigurationLocation";
   ...
   function Path
   (
      this : in out ConfigurationLocation.Kind
   )
   ...
   return NetFrameworkBase.System.Configuration.Configuration.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("OpenConfiguration");
      p_RetVal      : aliased VARIANT;
