...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ListView.ColumnHeaderCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ListView+ColumnHeaderCollection";
   ...
   return NetFrameworkBase.System.Windows.Forms.ColumnHeader.Kind_Ptr is
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_textAlignEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Windows.Forms.HorizontalAlignment.Instance;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Windows.Forms.ColumnHeader[]
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ListView.ColumnHeaderCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ListView.ColumnHeaderCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
