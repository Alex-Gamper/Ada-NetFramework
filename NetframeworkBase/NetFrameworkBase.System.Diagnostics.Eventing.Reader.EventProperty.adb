...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.Eventing.Reader.EventProperty is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.Eventing.Reader.EventProperty";
   ...
   function Value
   (
      this : in out EventProperty.Kind
   )
