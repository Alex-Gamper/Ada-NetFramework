...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Dynamic.SetMemberBinder is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Dynamic.SetMemberBinder";
   ...
   function ReturnType
   (
      this : in out SetMemberBinder.Kind
   )
   ...
   return NetFrameworkBase.System.Dynamic.DynamicMetaObject.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("FallbackSetMember");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Dynamic.DynamicMetaObject.Kind_Ptr := new NetFrameworkBase.System.Dynamic.DynamicMetaObject.Kind;
   begin
