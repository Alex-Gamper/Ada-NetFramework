...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.IO.Compression.DeflateStream is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.IO.Compression.DeflateStream";
   ...
   return NetFrameworkBase.System.IO.Compression.DeflateStream.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.IO.Compression.DeflateStream.Kind_Ptr := new NetFrameworkBase.System.IO.Compression.DeflateStream.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_modeEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.IO.Compression.CompressionMode.Instance;
   ...
   begin
      ...
      declare
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_compressionLevelEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.IO.Compression.CompressionLevel.Instance;
         p_compressionLevelEnum : aliased VARIANT := To_Variant (CreateEnum (p_compressionLevelEnumType, compressionLevel'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := p_compressionLevelEnum;
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
