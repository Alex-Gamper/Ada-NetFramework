...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.AesManaged is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.AesManaged";
   ...
   return NetFrameworkBase.System.Security.Cryptography.ICryptoTransform.Kind_Ptr is
      ...
      p1_Bounds     : aliased SAFEARRAYBOUND := (iv'Length , 0);
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.AesManaged.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.AesManaged.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.AesManaged.Kind do
