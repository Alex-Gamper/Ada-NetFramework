...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.Eventing.Reader.EventLogWatcher is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.Eventing.Reader.EventLogWatcher";
   ...
   function Enabled
   (
      this : in out EventLogWatcher.Kind
   )
   ...
   return NetFrameworkBase.System.Diagnostics.Eventing.Reader.EventLogWatcher.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.Eventing.Reader.EventLogWatcher.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.Eventing.Reader.EventLogWatcher.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 2;
         p_Value := To_Variant(readExistingEvents);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
