...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Deployment.Application.CompatibleFrameworks is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Deployment.Application.CompatibleFrameworks";
   ...
   function SupportUrl
   (
      this : in out CompatibleFrameworks.Kind
   )
