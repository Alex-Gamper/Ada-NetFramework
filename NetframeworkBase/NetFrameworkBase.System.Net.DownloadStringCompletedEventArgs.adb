...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.DownloadStringCompletedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.DownloadStringCompletedEventArgs";
   ...
   function Result
   (
      this : in out DownloadStringCompletedEventArgs.Kind
   )
