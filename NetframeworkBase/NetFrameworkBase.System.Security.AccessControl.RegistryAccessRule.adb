...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.AccessControl.RegistryAccessRule is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.AccessControl.RegistryAccessRule";
   ...
   (
      this : in out RegistryAccessRule.Kind
   )
   return NetFrameworkBase.System.Security.AccessControl.RegistryRights.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Security.AccessControl.RegistryRights.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RegistryRights");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.AccessControl.RegistryRights.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.AccessControl.RegistryAccessRule.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.AccessControl.RegistryAccessRule.Kind_Ptr := new NetFrameworkBase.System.Security.AccessControl.RegistryAccessRule.Kind do
      declare
         ...
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_registryRightsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.AccessControl.RegistryRights.Instance;
         p_registryRightsEnum : aliased VARIANT := To_Variant (CreateEnum (p_registryRightsEnumType, registryRights'Enum_rep));
