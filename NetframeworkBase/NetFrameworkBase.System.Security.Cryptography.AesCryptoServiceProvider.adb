...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.AesCryptoServiceProvider is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.AesCryptoServiceProvider";
   ...
   procedure Key
   (
      this : in out AesCryptoServiceProvider.Kind;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.AesCryptoServiceProvider.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.AesCryptoServiceProvider.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.AesCryptoServiceProvider.Kind do
