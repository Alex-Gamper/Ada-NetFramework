...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.Eventing.EventProviderTraceListener is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.Eventing.EventProviderTraceListener";
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Delimiter");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Diagnostics.Eventing.EventProviderTraceListener.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.Eventing.EventProviderTraceListener.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.Eventing.EventProviderTraceListener.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
