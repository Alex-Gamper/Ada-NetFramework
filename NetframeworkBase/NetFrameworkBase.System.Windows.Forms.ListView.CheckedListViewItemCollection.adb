...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ListView.CheckedListViewItemCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ListView+CheckedListViewItemCollection";
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ListView.CheckedListViewItemCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ListView.CheckedListViewItemCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
