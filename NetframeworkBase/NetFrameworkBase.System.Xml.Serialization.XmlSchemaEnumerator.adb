...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Serialization.XmlSchemaEnumerator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Serialization.XmlSchemaEnumerator";
   ...
   procedure Dispose
   (
      this : in out XmlSchemaEnumerator.Kind
   ) is
      Hr            : HResult := 0;
   ...
   return NetFrameworkBase.System.Xml.Serialization.XmlSchemaEnumerator.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Serialization.XmlSchemaEnumerator.Kind_Ptr := new NetFrameworkBase.System.Xml.Serialization.XmlSchemaEnumerator.Kind do
      declare
