...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.HttpListenerPrefixCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.HttpListenerPrefixCollection";
   ...
   procedure CopyTo
   (
      this : in out HttpListenerPrefixCollection.Kind;
   ...
   (
      this : in out HttpListenerPrefixCollection.Kind;
      uriPrefix : NetFrameworkBase.BSTR
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
