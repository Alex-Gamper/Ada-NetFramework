...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Xsl.XsltSettings is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Xsl.XsltSettings";
   ...
   function Default
   return NetFrameworkBase.System.Xml.Xsl.XsltSettings.Kind_Ptr is
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Xml.Xsl.XsltSettings.Kind_Ptr := new NetFrameworkBase.System.Xml.Xsl.XsltSettings.Kind;
   begin
   ...
   function TrustedXslt
   return NetFrameworkBase.System.Xml.Xsl.XsltSettings.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("TrustedXslt");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Xml.Xsl.XsltSettings.Kind_Ptr := new NetFrameworkBase.System.Xml.Xsl.XsltSettings.Kind;
   begin
   ...
   function EnableDocumentFunction
   (
      this : in out XsltSettings.Kind
   )
   return NetFrameworkBase.Boolean is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EnableDocumentFunction");
      p_RetVal      : aliased VARIANT;
   ...
   procedure EnableDocumentFunction
   (
      this : in out XsltSettings.Kind;
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("EnableScript");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Boolean;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Xml.Xsl.XsltSettings.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Xsl.XsltSettings.Kind_Ptr := new NetFrameworkBase.System.Xml.Xsl.XsltSettings.Kind do
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(enableDocumentFunction);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(enableScript);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
