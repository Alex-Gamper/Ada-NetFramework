...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Policy.ApplicationTrust is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Policy.ApplicationTrust";
   ...
   return NetFrameworkBase.System.Security.Policy.PolicyStatement.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("DefaultGrantSet");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsApplicationTrustedToRun");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Object.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ExtraInfo");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   begin
      return RetVal : NetFrameworkBase.System.Security.Policy.ApplicationTrust.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.ApplicationTrust.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   function Constructor return NetFrameworkBase.System.Security.Policy.ApplicationTrust.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Policy.ApplicationTrust.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.ApplicationTrust.Kind do
