...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DataGridViewRowErrorTextNeededEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DataGridViewRowErrorTextNeededEventArgs";
   ...
   function ErrorText
   (
      this : in out DataGridViewRowErrorTextNeededEventArgs.Kind
   )
