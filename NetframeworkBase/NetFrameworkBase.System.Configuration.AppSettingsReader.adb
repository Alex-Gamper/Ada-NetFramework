...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.AppSettingsReader is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.AppSettingsReader";
   ...
   function GetValue
   (
      this : in out AppSettingsReader.Kind;
   ...
   function Constructor return NetFrameworkBase.System.Configuration.AppSettingsReader.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.AppSettingsReader.Kind_Ptr := new NetFrameworkBase.System.Configuration.AppSettingsReader.Kind do
