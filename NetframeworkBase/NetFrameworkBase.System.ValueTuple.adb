...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ValueTuple is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ValueTuple";
   ...
   (
      this : in out ValueTuple.Kind;
      other : NetFrameworkBase.System.ValueTuple.Kind_Ptr
   )
   return NetFrameworkBase.Boolean is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   function Create
   return NetFrameworkBase.System.ValueTuple.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      RetVal        : NetFrameworkBase.System.ValueTuple.Kind_Ptr := new NetFrameworkBase.System.ValueTuple.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
