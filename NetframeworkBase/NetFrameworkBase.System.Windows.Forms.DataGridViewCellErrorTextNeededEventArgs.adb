...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DataGridViewCellErrorTextNeededEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DataGridViewCellErrorTextNeededEventArgs";
   ...
   function ErrorText
   (
      this : in out DataGridViewCellErrorTextNeededEventArgs.Kind
   )
