...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.AsnEncodedDataCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.AsnEncodedDataCollection";
   ...
   return NetFrameworkBase.System.Security.Cryptography.AsnEncodedDataEnumerator.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.AsnEncodedDataEnumerator.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.AsnEncodedDataEnumerator.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Security.Cryptography.AsnEncodedData[]
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.AsnEncodedDataCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.AsnEncodedDataCollection.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.AsnEncodedDataCollection.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.AsnEncodedDataCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.AsnEncodedDataCollection.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.AsnEncodedDataCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
