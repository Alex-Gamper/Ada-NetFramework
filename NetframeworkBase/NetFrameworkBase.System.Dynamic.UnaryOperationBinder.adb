...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Dynamic.UnaryOperationBinder is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Dynamic.UnaryOperationBinder";
   ...
   function ReturnType
   (
      this : in out UnaryOperationBinder.Kind
   )
   ...
   function FallbackUnaryOperation
   (
      this : in out UnaryOperationBinder.Kind;
   ...
   return NetFrameworkBase.System.Dynamic.DynamicMetaObject.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("FallbackUnaryOperation");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
