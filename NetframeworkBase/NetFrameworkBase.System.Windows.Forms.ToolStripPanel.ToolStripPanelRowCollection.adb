...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ToolStripPanel.ToolStripPanelRowCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ToolStripPanel+ToolStripPanelRowCollection";
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Windows.Forms.ToolStripPanelRow[]
   ...
   return NetFrameworkBase.System.Windows.Forms.ToolStripPanel.ToolStripPanelRowCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ToolStripPanel.ToolStripPanelRowCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ToolStripPanel.ToolStripPanelRowCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
