...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Xsl.Runtime.AttributeIterator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Xsl.Runtime.AttributeIterator";
   ...
   procedure Create
   (
      this : in out AttributeIterator.Kind;
