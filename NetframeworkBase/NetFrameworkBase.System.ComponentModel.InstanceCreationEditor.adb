...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.InstanceCreationEditor is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.InstanceCreationEditor";
   ...
   function Text
   (
      this : in out InstanceCreationEditor.Kind
   )
   ...
   (
      ...
      instanceType : NetFrameworkBase.System.Type_x.Kind_Ptr
   )
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := GetObject (instanceType.m_Kind);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
