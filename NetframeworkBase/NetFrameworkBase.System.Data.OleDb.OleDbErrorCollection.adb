...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.OleDb.OleDbErrorCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.OleDb.OleDbErrorCollection";
   ...
   function Count
   (
      this : in out OleDbErrorCollection.Kind
   )
   ...
   return NetFrameworkBase.System.Data.OleDb.OleDbError.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.Data.OleDb.OleDbError.Kind_Ptr := new NetFrameworkBase.System.Data.OleDb.OleDbError.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   (
      this : in out OleDbErrorCollection.Kind;
      array_x : NetFrameworkBase.System.Data.OleDb.OleDbError.Kind_Array; 
      index : NetFrameworkBase.Int32
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Data.OleDb.OleDbError[]
