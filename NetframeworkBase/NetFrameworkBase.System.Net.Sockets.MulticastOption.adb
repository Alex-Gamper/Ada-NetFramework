...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Sockets.MulticastOption is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Sockets.MulticastOption";
   ...
   function Group
   (
      this : in out MulticastOption.Kind
   )
   ...
   return NetFrameworkBase.System.Net.IPAddress.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("LocalAddress");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Net.IPAddress.Kind_Ptr := new NetFrameworkBase.System.Net.IPAddress.Kind;
   begin
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("InterfaceIndex");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Net.Sockets.MulticastOption.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Sockets.MulticastOption.Kind_Ptr := new NetFrameworkBase.System.Net.Sockets.MulticastOption.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := GetObject (mcint.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(interfaceIndex);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
