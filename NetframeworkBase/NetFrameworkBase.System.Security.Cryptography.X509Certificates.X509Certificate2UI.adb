...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509Certificate2UI is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.X509Certificates.X509Certificate2UI";
   ...
   is
      ...
      p_MethodName  : BSTR := To_BSTR("DisplayCertificate");
   ...
   (
      certificate : NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509Certificate2.Kind_Ptr; 
      hwndParent : NetFrameworkBase.IntPtr
   )
   is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   (
      ...
      selectionFlag : NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509SelectionFlag.Kind
   )
   return NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509Certificate2Collection.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SelectFromCollection");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_selectionFlagEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.Cryptography.X509Certificates.X509SelectionFlag.Instance;
      p_selectionFlagEnum : aliased VARIANT := To_Variant (CreateEnum (p_selectionFlagEnumType, selectionFlag'Enum_rep));
