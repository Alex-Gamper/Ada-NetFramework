...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.SqlClient.SqlClientPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.SqlClient.SqlClientPermission";
   ...
   (
      ...
      p_behaviorEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Data.KeyRestrictionBehavior.Instance;
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := To_Variant(restrictions);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 2;
   ...
   function Constructor return NetFrameworkBase.System.Data.SqlClient.SqlClientPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Data.SqlClient.SqlClientPermission.Kind_Ptr := new NetFrameworkBase.System.Data.SqlClient.SqlClientPermission.Kind do
   ...
   return NetFrameworkBase.System.Data.SqlClient.SqlClientPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Data.SqlClient.SqlClientPermission.Kind_Ptr := new NetFrameworkBase.System.Data.SqlClient.SqlClientPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(allowBlankPassword);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
