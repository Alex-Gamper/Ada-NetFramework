...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Resources.ResXResourceReader is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Resources.ResXResourceReader";
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("UseResXDataNodes");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Resources.ResXResourceReader.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      p_Bounds      : aliased SAFEARRAYBOUND := (1 , 0);
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("FromFileContents");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Resources.ResXResourceReader.Kind_Ptr := new NetFrameworkBase.System.Resources.ResXResourceReader.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := To_Variant(fileContents);
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      ...
      p_Value.field_1.field_1.field_1.punkVal := typeResolver;
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   return NetFrameworkBase.System.Resources.ResXResourceReader.Kind_Ptr is
      ...
      p1_Bounds     : aliased SAFEARRAYBOUND := (assemblyNames'Length , 0);
   ...
   begin
      ...
      begin
         ...
         for i in assemblyNames'range loop
            ...
            p1_Tmp := GetObject (assemblyNames(i).m_Kind);
   ...
   return NetFrameworkBase.System.Collections.IDictionaryEnumerator.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetMetadataEnumerator");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Collections.IDictionaryEnumerator.Kind_Ptr;
   begin
   ...
   return NetFrameworkBase.System.Resources.ResXResourceReader.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Resources.ResXResourceReader.Kind_Ptr := new NetFrameworkBase.System.Resources.ResXResourceReader.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
