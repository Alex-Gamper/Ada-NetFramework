...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ArgumentOutOfRangeException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ArgumentOutOfRangeException";
   ...
   (
      this : in out ArgumentOutOfRangeException.Kind
   )
   return NetFrameworkBase.System.Object.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ActualValue");
   ...
   function Constructor return NetFrameworkBase.System.ArgumentOutOfRangeException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ArgumentOutOfRangeException.Kind_Ptr := new NetFrameworkBase.System.ArgumentOutOfRangeException.Kind do
   ...
   return NetFrameworkBase.System.ArgumentOutOfRangeException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ArgumentOutOfRangeException.Kind_Ptr := new NetFrameworkBase.System.ArgumentOutOfRangeException.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := GetObject (actualValue.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 2;
         p_Value := To_Variant(message);
