...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Serialization.XmlElementEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Serialization.XmlElementEventArgs";
   ...
   (
      this : in out XmlElementEventArgs.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ExpectedElements");
      p_RetVal      : aliased VARIANT;
