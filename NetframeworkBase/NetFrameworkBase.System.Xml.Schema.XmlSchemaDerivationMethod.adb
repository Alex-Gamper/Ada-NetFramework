...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.XmlSchemaDerivationMethod is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.XmlSchemaDerivationMethod";
