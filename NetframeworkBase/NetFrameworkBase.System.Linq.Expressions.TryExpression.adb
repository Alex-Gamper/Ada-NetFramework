...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Linq.Expressions.TryExpression is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Linq.Expressions.TryExpression";
   ...
   function Type_x
   (
      this : in out TryExpression.Kind
   )
   ...
   return NetFrameworkBase.System.Linq.Expressions.Expression.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Finally");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Linq.Expressions.Expression.Kind_Ptr := new NetFrameworkBase.System.Linq.Expressions.Expression.Kind;
   begin
   ...
   return NetFrameworkBase.System.Linq.Expressions.Expression.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Fault");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Linq.Expressions.Expression.Kind_Ptr := new NetFrameworkBase.System.Linq.Expressions.Expression.Kind;
   begin
