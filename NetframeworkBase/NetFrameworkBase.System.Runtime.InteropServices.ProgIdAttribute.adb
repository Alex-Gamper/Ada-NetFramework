...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.InteropServices.ProgIdAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.InteropServices.ProgIdAttribute";
   ...
   function Value
   (
      this : in out ProgIdAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Runtime.InteropServices.ProgIdAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.InteropServices.ProgIdAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.InteropServices.ProgIdAttribute.Kind do
      declare
