...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Policy.HashMembershipCondition is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Policy.HashMembershipCondition";
   ...
   (
      this : in out HashMembershipCondition.Kind;
      value : NetFrameworkBase.System.Security.Cryptography.HashAlgorithm.Kind_Ptr
   ) is
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("HashValue");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Security.Policy.HashMembershipCondition.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Policy.HashMembershipCondition.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.HashMembershipCondition.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
