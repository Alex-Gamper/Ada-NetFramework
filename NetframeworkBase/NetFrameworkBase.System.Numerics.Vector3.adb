...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Numerics.Vector3 is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Numerics.Vector3";
   ...
   return NetFrameworkBase.System.Numerics.Vector3.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Numerics.Vector3.Kind_Ptr := new NetFrameworkBase.System.Numerics.Vector3.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
