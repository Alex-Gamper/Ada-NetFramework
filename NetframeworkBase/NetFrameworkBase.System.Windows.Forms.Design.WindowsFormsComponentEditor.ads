...
--------------------------------------------------------------------------------
package NetFrameworkBase.System.Windows.Forms.Design.WindowsFormsComponentEditor is
   
   type Kind is new NetFrameworkBase.System.ComponentModel.ComponentEditor.Kind with null record;
