...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Serialization.XmlNodeEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Serialization.XmlNodeEventArgs";
   ...
   (
      this : in out XmlNodeEventArgs.Kind
   )
