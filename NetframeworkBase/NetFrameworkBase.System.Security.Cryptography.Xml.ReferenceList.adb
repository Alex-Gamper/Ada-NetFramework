...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Xml.ReferenceList is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Xml.ReferenceList";
   ...
   return NetFrameworkBase.System.Security.Cryptography.Xml.EncryptedReference.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      p_Bounds      : aliased SAFEARRAYBOUND := (1 , 0);
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.Xml.EncryptedReference.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Xml.EncryptedReference.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.Xml.ReferenceList.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Xml.ReferenceList.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Xml.ReferenceList.Kind do
