...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.GacIdentityPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.GacIdentityPermission";
   ...
   function Copy
   (
      this : in out GacIdentityPermission.Kind
   )
   ...
   return NetFrameworkBase.System.Security.Permissions.GacIdentityPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.GacIdentityPermission.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.GacIdentityPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   function Constructor return NetFrameworkBase.System.Security.Permissions.GacIdentityPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.GacIdentityPermission.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.GacIdentityPermission.Kind do
