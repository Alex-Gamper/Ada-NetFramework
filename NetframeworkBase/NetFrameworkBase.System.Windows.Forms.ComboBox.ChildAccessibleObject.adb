...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ComboBox.ChildAccessibleObject is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ComboBox+ChildAccessibleObject";
   ...
   function Name
   (
      this : in out ChildAccessibleObject.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.ComboBox.ChildAccessibleObject.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ComboBox.ChildAccessibleObject.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ComboBox.ChildAccessibleObject.Kind do
      declare
