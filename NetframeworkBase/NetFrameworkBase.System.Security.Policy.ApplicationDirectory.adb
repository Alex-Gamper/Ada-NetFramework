...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Policy.ApplicationDirectory is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Policy.ApplicationDirectory";
   ...
   function Directory
   (
      this : in out ApplicationDirectory.Kind
   )
   ...
   return NetFrameworkBase.System.Security.Policy.ApplicationDirectory.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Policy.ApplicationDirectory.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.ApplicationDirectory.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
