...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.RegexStringValidator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.RegexStringValidator";
   ...
   (
      this : in out RegexStringValidator.Kind;
   ...
   return NetFrameworkBase.System.Configuration.RegexStringValidator.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.RegexStringValidator.Kind_Ptr := new NetFrameworkBase.System.Configuration.RegexStringValidator.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
