...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Collections.DictionaryBase is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Collections.DictionaryBase";
   ...
   function Count
   (
      this : in out DictionaryBase.Kind
   )
