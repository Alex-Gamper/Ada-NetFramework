...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.EnterpriseServices.ResourcePool is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.EnterpriseServices.ResourcePool";
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_MethodName  : BSTR := To_BSTR("PutResource");
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (resource.m_Kind);
   ...
   return NetFrameworkBase.System.Object.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetResource");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.EnterpriseServices.ResourcePool.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.EnterpriseServices.ResourcePool.Kind_Ptr := new NetFrameworkBase.System.EnterpriseServices.ResourcePool.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (cb.m_Kind); -- Parameter Type = Delegate
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
