...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.DesignerSerializationVisibilityAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.DesignerSerializationVisibilityAttribute";
   ...
   function Visibility
   (
      this : in out DesignerSerializationVisibilityAttribute.Kind
   )
   return NetFrameworkBase.System.ComponentModel.DesignerSerializationVisibility.Kind is
      ...
      p_MethodName  : BSTR := To_BSTR("Visibility");
   ...
   return NetFrameworkBase.System.ComponentModel.DesignerSerializationVisibilityAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.DesignerSerializationVisibilityAttribute.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.DesignerSerializationVisibilityAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_visibilityEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.ComponentModel.DesignerSerializationVisibility.Instance;
