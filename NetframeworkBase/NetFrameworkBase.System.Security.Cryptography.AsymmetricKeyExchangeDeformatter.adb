...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.AsymmetricKeyExchangeDeformatter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.AsymmetricKeyExchangeDeformatter";
   ...
   function Parameters
   (
      this : in out AsymmetricKeyExchangeDeformatter.Kind
   )
