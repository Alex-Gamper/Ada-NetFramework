...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.InstanceData is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.InstanceData";
   ...
   return NetFrameworkBase.System.Diagnostics.CounterSample.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Sample");
      p_RetVal      : aliased VARIANT;
   ...
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.InstanceData.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.InstanceData.Kind do
      declare
