...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.TableLayoutRowStyleCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.TableLayoutRowStyleCollection";
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (rowStyle.m_Kind);
   ...
   return NetFrameworkBase.System.Windows.Forms.RowStyle.Kind_Ptr is
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Windows.Forms.RowStyle.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.RowStyle.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
