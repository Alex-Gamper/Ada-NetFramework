...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.DataColumnChangeEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.DataColumnChangeEventArgs";
   ...
   return NetFrameworkBase.System.Object.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ProposedValue");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Data.DataColumnChangeEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Data.DataColumnChangeEventArgs.Kind_Ptr := new NetFrameworkBase.System.Data.DataColumnChangeEventArgs.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
