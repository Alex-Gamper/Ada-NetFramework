...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.BindingManagerDataErrorEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.BindingManagerDataErrorEventArgs";
   ...
   (
      this : in out BindingManagerDataErrorEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.BindingManagerDataErrorEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.BindingManagerDataErrorEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.BindingManagerDataErrorEventArgs.Kind do
      declare
