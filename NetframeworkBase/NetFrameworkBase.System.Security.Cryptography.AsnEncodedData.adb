...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.AsnEncodedData is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.AsnEncodedData";
   ...
   procedure RawData
   (
      this : in out AsnEncodedData.Kind;
   ...
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.AsnEncodedData.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.AsnEncodedData.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      declare
         ...
         p1_Bounds     : aliased SAFEARRAYBOUND := (rawData'Length , 0);
