...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.RunWorkerCompletedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.RunWorkerCompletedEventArgs";
   ...
   function Result
   (
      this : in out RunWorkerCompletedEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.ComponentModel.RunWorkerCompletedEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.RunWorkerCompletedEventArgs.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.RunWorkerCompletedEventArgs.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (result.m_Kind);
