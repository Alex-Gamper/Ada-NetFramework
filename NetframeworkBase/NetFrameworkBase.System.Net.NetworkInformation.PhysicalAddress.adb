...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.NetworkInformation.PhysicalAddress is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.NetworkInformation.PhysicalAddress";
   ...
   (
      this : in out PhysicalAddress.Kind
   )
   ...
   return NetFrameworkBase.System.Net.NetworkInformation.PhysicalAddress.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.NetworkInformation.PhysicalAddress.Kind_Ptr := new NetFrameworkBase.System.Net.NetworkInformation.PhysicalAddress.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
