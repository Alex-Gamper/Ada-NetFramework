...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.UrlIdentityPermissionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.UrlIdentityPermissionAttribute";
   ...
   function Url
   (
      this : in out UrlIdentityPermissionAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Security.Permissions.UrlIdentityPermissionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.UrlIdentityPermissionAttribute.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.UrlIdentityPermissionAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
