...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.FileDialogCustomPlace is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.FileDialogCustomPlace";
   ...
   function Path
   (
      this : in out FileDialogCustomPlace.Kind
   )
   ...
   return NetFrameworkBase.System.Guid.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("KnownFolderGuid");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Windows.Forms.FileDialogCustomPlace.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.FileDialogCustomPlace.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.FileDialogCustomPlace.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (knownFolderGuid.m_Kind); -- Parameter Type = ValueType
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
