...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Text.UTF8Encoding is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Text.UTF8Encoding";
   ...
   function Constructor return NetFrameworkBase.System.Text.UTF8Encoding.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Text.UTF8Encoding.Kind_Ptr := new NetFrameworkBase.System.Text.UTF8Encoding.Kind do
   ...
   return NetFrameworkBase.System.Text.UTF8Encoding.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Text.UTF8Encoding.Kind_Ptr := new NetFrameworkBase.System.Text.UTF8Encoding.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(encoderShouldEmitUTF8Identifier);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(throwOnInvalidBytes);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
