...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.EnumConverter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.EnumConverter";
   ...
   (
      this : in out EnumConverter.Kind;
   ...
   return NetFrameworkBase.System.ComponentModel.EnumConverter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.EnumConverter.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.EnumConverter.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
