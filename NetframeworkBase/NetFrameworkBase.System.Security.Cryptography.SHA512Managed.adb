...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.SHA512Managed is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.SHA512Managed";
   ...
   (
      this : in out SHA512Managed.Kind
   ) is
      Hr            : HResult := 0;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.SHA512Managed.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.SHA512Managed.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.SHA512Managed.Kind do
