...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Threading.Tasks.ConcurrentExclusiveSchedulerPair is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Threading.Tasks.ConcurrentExclusiveSchedulerPair";
   ...
   procedure Complete
   (
      this : in out ConcurrentExclusiveSchedulerPair.Kind
   ) is
      Hr            : HResult := 0;
   ...
   return NetFrameworkBase.System.Threading.Tasks.Task_x.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Completion");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Threading.Tasks.TaskScheduler.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ConcurrentScheduler");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Threading.Tasks.TaskScheduler.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ExclusiveScheduler");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Threading.Tasks.TaskScheduler.Kind_Ptr := new NetFrameworkBase.System.Threading.Tasks.TaskScheduler.Kind;
   begin
   ...
   function Constructor return NetFrameworkBase.System.Threading.Tasks.ConcurrentExclusiveSchedulerPair.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Threading.Tasks.ConcurrentExclusiveSchedulerPair.Kind_Ptr := new NetFrameworkBase.System.Threading.Tasks.ConcurrentExclusiveSchedulerPair.Kind do
   ...
   return NetFrameworkBase.System.Threading.Tasks.ConcurrentExclusiveSchedulerPair.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Threading.Tasks.ConcurrentExclusiveSchedulerPair.Kind_Ptr := new NetFrameworkBase.System.Threading.Tasks.ConcurrentExclusiveSchedulerPair.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (taskScheduler.m_Kind);
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(maxConcurrencyLevel);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 2;
         p_Value := To_Variant(maxItemsPerTask);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         NetFrameworkAdaRuntime.CreateInstance (RetVal.m_Kind, This_AssemblyName, This_TypeName, Instance, NetFrameworkWin32.BindingFlags'(CreateInstance)'Enum_rep, p_Parameters);
         Hr := SafeArrayDestroy(p_Parameters);
      end;
