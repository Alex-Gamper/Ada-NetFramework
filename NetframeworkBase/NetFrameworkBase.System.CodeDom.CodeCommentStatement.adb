...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.CodeDom.CodeCommentStatement is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.CodeDom.CodeCommentStatement";
   ...
   function Comment
   (
      this : in out CodeCommentStatement.Kind
   )
   return NetFrameworkBase.System.CodeDom.CodeComment.Kind_Ptr is
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.CodeDom.CodeComment.Kind_Ptr := new NetFrameworkBase.System.CodeDom.CodeComment.Kind;
   begin
   ...
   (
      this : in out CodeCommentStatement.Kind;
      value : NetFrameworkBase.System.CodeDom.CodeComment.Kind_Ptr
   ) is
   ...
   function Constructor return NetFrameworkBase.System.CodeDom.CodeCommentStatement.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.CodeDom.CodeCommentStatement.Kind_Ptr := new NetFrameworkBase.System.CodeDom.CodeCommentStatement.Kind do
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (comment.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
