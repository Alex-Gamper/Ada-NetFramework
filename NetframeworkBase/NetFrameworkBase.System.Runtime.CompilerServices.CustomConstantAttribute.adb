...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.CompilerServices.CustomConstantAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.CompilerServices.CustomConstantAttribute";
   ...
   function Value
   (
      this : in out CustomConstantAttribute.Kind
   )
