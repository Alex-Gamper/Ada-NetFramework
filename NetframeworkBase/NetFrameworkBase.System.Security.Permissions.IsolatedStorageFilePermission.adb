...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.IsolatedStorageFilePermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.IsolatedStorageFilePermission";
   ...
   return NetFrameworkBase.System.Security.Permissions.IsolatedStorageFilePermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.IsolatedStorageFilePermission.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.IsolatedStorageFilePermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
