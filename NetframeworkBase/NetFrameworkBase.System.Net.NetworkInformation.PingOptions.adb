...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.NetworkInformation.PingOptions is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.NetworkInformation.PingOptions";
   ...
   begin
      return RetVal : NetFrameworkBase.System.Net.NetworkInformation.PingOptions.Kind_Ptr := new NetFrameworkBase.System.Net.NetworkInformation.PingOptions.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(ttl);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(dontFragment);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   function Constructor return NetFrameworkBase.System.Net.NetworkInformation.PingOptions.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.NetworkInformation.PingOptions.Kind_Ptr := new NetFrameworkBase.System.Net.NetworkInformation.PingOptions.Kind do
