...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Drawing.Design.CategoryNameCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Drawing.Design.CategoryNameCollection";
   ...
   function Item
   (
      this : in out CategoryNameCollection.Kind;
   ...
   return NetFrameworkBase.System.Drawing.Design.CategoryNameCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Drawing.Design.CategoryNameCollection.Kind_Ptr := new NetFrameworkBase.System.Drawing.Design.CategoryNameCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
