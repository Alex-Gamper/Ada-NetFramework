...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.LongValidator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.LongValidator";
   ...
   (
      this : in out LongValidator.Kind;
   ...
   return NetFrameworkBase.System.Configuration.LongValidator.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.LongValidator.Kind_Ptr := new NetFrameworkBase.System.Configuration.LongValidator.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
