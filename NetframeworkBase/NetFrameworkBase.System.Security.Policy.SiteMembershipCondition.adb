...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Policy.SiteMembershipCondition is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Policy.SiteMembershipCondition";
   ...
   procedure Site
   (
      this : in out SiteMembershipCondition.Kind;
   ...
   return NetFrameworkBase.System.Security.Policy.SiteMembershipCondition.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Policy.SiteMembershipCondition.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.SiteMembershipCondition.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
