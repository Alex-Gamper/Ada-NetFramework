...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.UploadDataCompletedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.UploadDataCompletedEventArgs";
   ...
   function Result
   (
      this : in out UploadDataCompletedEventArgs.Kind
   )
