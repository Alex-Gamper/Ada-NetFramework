...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.CodeDom.Compiler.CompilerError is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.CodeDom.Compiler.CompilerError";
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ErrorNumber");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsWarning");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.CodeDom.Compiler.CompilerError.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.CodeDom.Compiler.CompilerError.Kind_Ptr := new NetFrameworkBase.System.CodeDom.Compiler.CompilerError.Kind do
   ...
   begin
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 3;
         p_Value := To_Variant(errorNumber);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 4;
