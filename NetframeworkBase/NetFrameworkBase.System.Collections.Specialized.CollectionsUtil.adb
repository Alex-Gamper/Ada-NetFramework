...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Collections.Specialized.CollectionsUtil is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Collections.Specialized.CollectionsUtil";
   ...
   return NetFrameworkBase.System.Collections.Hashtable.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("CreateCaseInsensitiveHashtable");
   ...
   return NetFrameworkBase.System.Collections.SortedList.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("CreateCaseInsensitiveSortedList");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   function Constructor return NetFrameworkBase.System.Collections.Specialized.CollectionsUtil.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Collections.Specialized.CollectionsUtil.Kind_Ptr := new NetFrameworkBase.System.Collections.Specialized.CollectionsUtil.Kind do
