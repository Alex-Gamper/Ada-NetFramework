...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.UriTypeConverter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.UriTypeConverter";
   ...
   (
      this : in out UriTypeConverter.Kind;
   ...
   function Constructor return NetFrameworkBase.System.UriTypeConverter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.UriTypeConverter.Kind_Ptr := new NetFrameworkBase.System.UriTypeConverter.Kind do
