...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.AppSettingsSection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.AppSettingsSection";
   ...
   function Settings
   (
      this : in out AppSettingsSection.Kind
   )
   return NetFrameworkBase.System.Configuration.KeyValueConfigurationCollection.Kind_Ptr is
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Configuration.KeyValueConfigurationCollection.Kind_Ptr := new NetFrameworkBase.System.Configuration.KeyValueConfigurationCollection.Kind;
   begin
   ...
   function Constructor return NetFrameworkBase.System.Configuration.AppSettingsSection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.AppSettingsSection.Kind_Ptr := new NetFrameworkBase.System.Configuration.AppSettingsSection.Kind do
