...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.DnsEndPoint is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.DnsEndPoint";
   ...
   return NetFrameworkBase.System.Net.DnsEndPoint.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.DnsEndPoint.Kind_Ptr := new NetFrameworkBase.System.Net.DnsEndPoint.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
