...
--------------------------------------------------------------------------------
package NetFrameworkBase.System.Security.AccessControl.PrivilegeNotHeldException is
   
   type Kind is new NetFrameworkBase.System.UnauthorizedAccessException.Kind with null record;
   ...
   type Kind_Array_Ptr is access all Kind_Array;
      ...
      function Constructor return NetFrameworkBase.System.Security.AccessControl.PrivilegeNotHeldException.Kind_Ptr;
      
      function Constructor
      (
         privilege : NetFrameworkBase.BSTR
      )
      return NetFrameworkBase.System.Security.AccessControl.PrivilegeNotHeldException.Kind_Ptr;
