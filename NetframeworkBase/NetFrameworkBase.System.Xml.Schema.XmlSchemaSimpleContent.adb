...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleContent is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.XmlSchemaSimpleContent";
   ...
   function Content
   (
      this : in out XmlSchemaSimpleContent.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleContent.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleContent.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleContent.Kind do
