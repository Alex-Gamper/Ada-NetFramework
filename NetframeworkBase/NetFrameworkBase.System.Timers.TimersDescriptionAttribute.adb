...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Timers.TimersDescriptionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Timers.TimersDescriptionAttribute";
   ...
   (
      this : in out TimersDescriptionAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Timers.TimersDescriptionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Timers.TimersDescriptionAttribute.Kind_Ptr := new NetFrameworkBase.System.Timers.TimersDescriptionAttribute.Kind do
      declare
