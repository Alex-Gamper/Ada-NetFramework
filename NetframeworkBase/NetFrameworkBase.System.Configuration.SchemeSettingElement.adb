...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.SchemeSettingElement is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.SchemeSettingElement";
   ...
   function Name
   (
      this : in out SchemeSettingElement.Kind
   )
   ...
   return NetFrameworkBase.System.GenericUriParserOptions.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.GenericUriParserOptions.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GenericUriParserOptions");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.GenericUriParserOptions.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Configuration.SchemeSettingElement.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.SchemeSettingElement.Kind_Ptr := new NetFrameworkBase.System.Configuration.SchemeSettingElement.Kind do
