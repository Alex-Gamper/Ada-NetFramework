...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.IPHostEntry is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.IPHostEntry";
   ...
   return NetFrameworkBase.BSTR_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Aliases");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Net.IPAddress.Kind_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AddressList");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   procedure AddressList
   (
      this : in out IPHostEntry.Kind;
      value : NetFrameworkBase.System.Net.IPAddress.Kind_Array
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
   ...
   function Constructor return NetFrameworkBase.System.Net.IPHostEntry.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.IPHostEntry.Kind_Ptr := new NetFrameworkBase.System.Net.IPHostEntry.Kind do
