...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9DocumentName is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Pkcs.Pkcs9DocumentName";
   ...
   (
      this : in out Pkcs9DocumentName.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9DocumentName.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9DocumentName.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9DocumentName.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9DocumentName.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9DocumentName.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9DocumentName.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(documentName);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      ...
      declare
         ...
         p0_Bounds     : aliased SAFEARRAYBOUND := (encodedDocumentName'Length , 0);
      ...
      begin
         ...
         begin
            ...
            for i in encodedDocumentName'range loop
               p0_Index(1) := Interfaces.C.long(i) - 1;
               p0_Tmp := encodedDocumentName(i);
