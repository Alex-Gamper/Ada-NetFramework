...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.LocalizableAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.LocalizableAttribute";
   ...
   (
      this : in out LocalizableAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.ComponentModel.LocalizableAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.LocalizableAttribute.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.LocalizableAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(isLocalizable);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
