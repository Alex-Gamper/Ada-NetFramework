...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.PropertyInformationCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.PropertyInformationCollection";
   ...
   (
      this : in out PropertyInformationCollection.Kind;
   ...
   return NetFrameworkBase.System.Configuration.PropertyInformation.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Configuration.PropertyInformation.Kind_Ptr := new NetFrameworkBase.System.Configuration.PropertyInformation.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   (
      this : in out PropertyInformationCollection.Kind;
      array_x : NetFrameworkBase.System.Configuration.PropertyInformation.Kind_Array; 
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Configuration.PropertyInformation[]
