...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.OleDb.OleDbInfoMessageEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.OleDb.OleDbInfoMessageEventArgs";
   ...
   function ErrorCode
   (
      this : in out OleDbInfoMessageEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Data.OleDb.OleDbErrorCollection.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      RetVal        : NetFrameworkBase.System.Data.OleDb.OleDbErrorCollection.Kind_Ptr := new NetFrameworkBase.System.Data.OleDb.OleDbErrorCollection.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
