...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.PerformanceCounterPermissionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.PerformanceCounterPermissionAttribute";
   ...
   (
      this : in out PerformanceCounterPermissionAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Diagnostics.PerformanceCounterPermissionAccess.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Diagnostics.PerformanceCounterPermissionAccess.Kind);
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("PermissionAccess");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Diagnostics.PerformanceCounterPermissionAccess.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   procedure PermissionAccess
   (
      this : in out PerformanceCounterPermissionAttribute.Kind;
      value : NetFrameworkBase.System.Diagnostics.PerformanceCounterPermissionAccess.Kind
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_valueEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Diagnostics.PerformanceCounterPermissionAccess.Instance;
   ...
   return NetFrameworkBase.System.Diagnostics.PerformanceCounterPermissionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.PerformanceCounterPermissionAttribute.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.PerformanceCounterPermissionAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
