...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DataGridViewRowHeightInfoPushedEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DataGridViewRowHeightInfoPushedEventArgs";
   ...
   function Height
   (
      this : in out DataGridViewRowHeightInfoPushedEventArgs.Kind
   )
