...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Data.SqlClient.SqlEnclaveSession is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Data.SqlClient.SqlEnclaveSession";
   ...
   function SessionId
   (
      this : in out SqlEnclaveSession.Kind
   )
   ...
   return NetFrameworkBase.Byte_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetSessionKey");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Data.SqlClient.SqlEnclaveSession.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Data.SqlClient.SqlEnclaveSession.Kind_Ptr := new NetFrameworkBase.System.Data.SqlClient.SqlEnclaveSession.Kind do
      declare
         ...
         p0_Bounds     : aliased SAFEARRAYBOUND := (sessionKey'Length , 0);
      ...
      begin
         ...
         begin
            ...
            for i in sessionKey'range loop
