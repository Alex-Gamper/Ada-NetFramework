...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Serialization.SoapIncludeAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Serialization.SoapIncludeAttribute";
   ...
   function Type_x
   (
      this : in out SoapIncludeAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Xml.Serialization.SoapIncludeAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Serialization.SoapIncludeAttribute.Kind_Ptr := new NetFrameworkBase.System.Xml.Serialization.SoapIncludeAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
