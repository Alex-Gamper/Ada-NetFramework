...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Drawing.Text.PrivateFontCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Drawing.Text.PrivateFontCollection";
   ...
   (
      this : in out PrivateFontCollection.Kind;
      ...
      p_MethodName  : BSTR := To_BSTR("AddFontFile");
   ...
   (
      this : in out PrivateFontCollection.Kind;
      memory : NetFrameworkBase.IntPtr; 
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AddMemoryFont");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Drawing.Text.PrivateFontCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Drawing.Text.PrivateFontCollection.Kind_Ptr := new NetFrameworkBase.System.Drawing.Text.PrivateFontCollection.Kind do
