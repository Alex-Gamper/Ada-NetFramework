...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Configuration.HttpCachePolicyElement is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Configuration.HttpCachePolicyElement";
   ...
   function MaximumAge
   (
      this : in out HttpCachePolicyElement.Kind
   )
   return NetFrameworkBase.System.TimeSpan.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("MaximumAge");
   ...
   return NetFrameworkBase.System.TimeSpan.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("MaximumStale");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.TimeSpan.Kind_Ptr := new NetFrameworkBase.System.TimeSpan.Kind;
   begin
   ...
   return NetFrameworkBase.System.TimeSpan.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("MinimumFresh");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.TimeSpan.Kind_Ptr := new NetFrameworkBase.System.TimeSpan.Kind;
   begin
   ...
   return NetFrameworkBase.System.Net.Cache.HttpRequestCacheLevel.Kind is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("PolicyLevel");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   procedure PolicyLevel
   (
      this : in out HttpCachePolicyElement.Kind;
      value : NetFrameworkBase.System.Net.Cache.HttpRequestCacheLevel.Kind
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_valueEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Net.Cache.HttpRequestCacheLevel.Instance;
   ...
   function Constructor return NetFrameworkBase.System.Net.Configuration.HttpCachePolicyElement.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Configuration.HttpCachePolicyElement.Kind_Ptr := new NetFrameworkBase.System.Net.Configuration.HttpCachePolicyElement.Kind do
