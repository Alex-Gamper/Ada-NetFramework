...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Threading.ThreadAbortException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Threading.ThreadAbortException";
   ...
   (
      this : in out ThreadAbortException.Kind
   )
   return NetFrameworkBase.System.Object.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ExceptionState");
