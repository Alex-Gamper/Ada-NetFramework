...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Drawing.PointF is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Drawing.PointF";
   ...
   return NetFrameworkBase.System.Drawing.PointF.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Drawing.PointF.Kind_Ptr := new NetFrameworkBase.System.Drawing.PointF.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
