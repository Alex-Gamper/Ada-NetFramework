...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Sockets.IPv6MulticastOption is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Sockets.IPv6MulticastOption";
   ...
   function Group
   (
      this : in out IPv6MulticastOption.Kind
   )
   ...
   return NetFrameworkBase.System.Net.Sockets.IPv6MulticastOption.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Sockets.IPv6MulticastOption.Kind_Ptr := new NetFrameworkBase.System.Net.Sockets.IPv6MulticastOption.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
