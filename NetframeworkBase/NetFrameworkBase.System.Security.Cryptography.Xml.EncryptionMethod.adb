...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionMethod is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Xml.EncryptionMethod";
   ...
   function KeySize
   (
      this : in out EncryptionMethod.Kind
   )
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionMethod.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionMethod.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Xml.EncryptionMethod.Kind do
