...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.InteropServices.TypeLibTypeAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.InteropServices.TypeLibTypeAttribute";
   ...
   function Value
   (
      this : in out TypeLibTypeAttribute.Kind
   )
   return NetFrameworkBase.System.Runtime.InteropServices.TypeLibTypeFlags.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Runtime.InteropServices.TypeLibTypeFlags.Kind);
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Runtime.InteropServices.TypeLibTypeFlags.Kind;
   begin
   ...
   return NetFrameworkBase.System.Runtime.InteropServices.TypeLibTypeAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.InteropServices.TypeLibTypeAttribute.Kind_Ptr := new NetFrameworkBase.System.Runtime.InteropServices.TypeLibTypeAttribute.Kind do
      declare
         ...
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_flagsEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Runtime.InteropServices.TypeLibTypeFlags.Instance;
