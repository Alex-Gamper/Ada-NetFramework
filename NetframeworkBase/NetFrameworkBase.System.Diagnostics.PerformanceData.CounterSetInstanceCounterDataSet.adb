...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.PerformanceData.CounterSetInstanceCounterDataSet is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.PerformanceData.CounterSetInstanceCounterDataSet";
   ...
   procedure Dispose
   (
      this : in out CounterSetInstanceCounterDataSet.Kind
   ) is
      Hr            : HResult := 0;
   ...
   return NetFrameworkBase.System.Diagnostics.PerformanceData.CounterData.Kind_Ptr is
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Diagnostics.PerformanceData.CounterData.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.PerformanceData.CounterData.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
