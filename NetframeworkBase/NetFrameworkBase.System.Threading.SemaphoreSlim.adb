...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Threading.SemaphoreSlim is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Threading.SemaphoreSlim";
   ...
   return NetFrameworkBase.System.Threading.WaitHandle.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("AvailableWaitHandle");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.System.Threading.Tasks.Task_x.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("WaitAsync");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Threading.SemaphoreSlim.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Threading.SemaphoreSlim.Kind_Ptr := new NetFrameworkBase.System.Threading.SemaphoreSlim.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
