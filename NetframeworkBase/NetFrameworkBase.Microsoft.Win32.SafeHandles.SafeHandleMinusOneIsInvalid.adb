...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.Microsoft.Win32.SafeHandles.SafeHandleMinusOneIsInvalid is
   ...
   This_TypeName     : constant Standard.Wide_String := "Microsoft.Win32.SafeHandles.SafeHandleMinusOneIsInvalid";
   ...
   function IsInvalid
   (
      this : in out SafeHandleMinusOneIsInvalid.Kind
   )
