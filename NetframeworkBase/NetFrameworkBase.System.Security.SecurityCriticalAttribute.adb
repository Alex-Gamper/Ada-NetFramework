...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.SecurityCriticalAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.SecurityCriticalAttribute";
   ...
   function Scope
   (
      this : in out SecurityCriticalAttribute.Kind
   )
   return NetFrameworkBase.System.Security.SecurityCriticalScope.Kind is
      function ConvertEnum is new Ada.Unchecked_Conversion (Interfaces.C.long,NetFrameworkBase.System.Security.SecurityCriticalScope.Kind);
      Hr            : HResult := 0;
      ...
      RetVal        : NetFrameworkBase.System.Security.SecurityCriticalScope.Kind;
   begin
   ...
   function Constructor return NetFrameworkBase.System.Security.SecurityCriticalAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.SecurityCriticalAttribute.Kind_Ptr := new NetFrameworkBase.System.Security.SecurityCriticalAttribute.Kind do
   ...
   return NetFrameworkBase.System.Security.SecurityCriticalAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.SecurityCriticalAttribute.Kind_Ptr := new NetFrameworkBase.System.Security.SecurityCriticalAttribute.Kind do
      declare
         ...
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_scopeEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Security.SecurityCriticalScope.Instance;
