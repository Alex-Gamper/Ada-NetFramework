...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.LicenseException is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.LicenseException";
   ...
   return NetFrameworkBase.System.Type_x.Kind_Ptr is
      ...
      p_MethodName  : BSTR := To_BSTR("LicensedType");
   ...
   return NetFrameworkBase.System.ComponentModel.LicenseException.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.LicenseException.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.LicenseException.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
