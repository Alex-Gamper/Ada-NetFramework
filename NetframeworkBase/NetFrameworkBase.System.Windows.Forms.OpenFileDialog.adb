...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.OpenFileDialog is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.OpenFileDialog";
   ...
   (
      this : in out OpenFileDialog.Kind
   )
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ReadOnlyChecked");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Boolean;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ShowReadOnly");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.Boolean;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SafeFileName");
      p_RetVal      : aliased VARIANT;
   ...
   return NetFrameworkBase.BSTR_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SafeFileNames");
      p_RetVal      : aliased VARIANT;
   ...
   function Constructor return NetFrameworkBase.System.Windows.Forms.OpenFileDialog.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.OpenFileDialog.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.OpenFileDialog.Kind do
