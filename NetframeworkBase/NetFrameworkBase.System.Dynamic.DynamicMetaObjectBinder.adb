...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Dynamic.DynamicMetaObjectBinder is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Dynamic.DynamicMetaObjectBinder";
   ...
   function ReturnType
   (
      this : in out DynamicMetaObjectBinder.Kind
   )
   ...
   return NetFrameworkBase.System.Linq.Expressions.Expression.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("GetUpdateExpression");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Dynamic.DynamicMetaObject.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Defer");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
