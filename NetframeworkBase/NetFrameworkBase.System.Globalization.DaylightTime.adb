...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Globalization.DaylightTime is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Globalization.DaylightTime";
   ...
   begin
      return RetVal : NetFrameworkBase.System.Globalization.DaylightTime.Kind_Ptr := new NetFrameworkBase.System.Globalization.DaylightTime.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 2;
         p_Value := GetObject (delta_x.m_Kind); -- Parameter Type = ValueType
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
