...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Permissions.SiteIdentityPermission is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Permissions.SiteIdentityPermission";
   ...
   procedure Site
   (
      this : in out SiteIdentityPermission.Kind;
   ...
   return NetFrameworkBase.System.Security.Permissions.SiteIdentityPermission.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Permissions.SiteIdentityPermission.Kind_Ptr := new NetFrameworkBase.System.Security.Permissions.SiteIdentityPermission.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
