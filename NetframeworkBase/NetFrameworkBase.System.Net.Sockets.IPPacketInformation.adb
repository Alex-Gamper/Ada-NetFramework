...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Sockets.IPPacketInformation is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Sockets.IPPacketInformation";
   ...
   function Address
   (
      this : in out IPPacketInformation.Kind
   )
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Interface");
      p_RetVal      : aliased VARIANT;
   ...
   (
      packetInformation1 : NetFrameworkBase.System.Net.Sockets.IPPacketInformation.Kind_Ptr; 
      packetInformation2 : NetFrameworkBase.System.Net.Sockets.IPPacketInformation.Kind_Ptr
   )
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (packetInformation1.m_Kind); -- Parameter Type = ValueType
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
      ------------------------------------------------------------
      p_Index(1) := 1;
      p_Value := GetObject (packetInformation2.m_Kind); -- Parameter Type = ValueType
      Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
