...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.RSAPKCS1SignatureDeformatter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.RSAPKCS1SignatureDeformatter";
   ...
   (
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("SetHashAlgorithm");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.RSAPKCS1SignatureDeformatter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.RSAPKCS1SignatureDeformatter.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.RSAPKCS1SignatureDeformatter.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.RSAPKCS1SignatureDeformatter.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.RSAPKCS1SignatureDeformatter.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.RSAPKCS1SignatureDeformatter.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
