...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ColumnClickEventArgs is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ColumnClickEventArgs";
   ...
   function Column
   (
      this : in out ColumnClickEventArgs.Kind
   )
   ...
   return NetFrameworkBase.System.Windows.Forms.ColumnClickEventArgs.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ColumnClickEventArgs.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ColumnClickEventArgs.Kind do
      declare
