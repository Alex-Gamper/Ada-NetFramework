...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Reflection.AssemblySignatureKeyAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Reflection.AssemblySignatureKeyAttribute";
   ...
   function PublicKey
   (
      this : in out AssemblySignatureKeyAttribute.Kind
   )
   ...
   return NetFrameworkBase.BSTR is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("Countersignature");
      p_RetVal      : aliased VARIANT;
      RetVal        : NetFrameworkBase.BSTR;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
   ...
   return NetFrameworkBase.System.Reflection.AssemblySignatureKeyAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Reflection.AssemblySignatureKeyAttribute.Kind_Ptr := new NetFrameworkBase.System.Reflection.AssemblySignatureKeyAttribute.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(publicKey);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(countersignature);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
