...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.ComponentModel.ListSortDescriptionCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.ComponentModel.ListSortDescriptionCollection";
   ...
   return NetFrameworkBase.System.ComponentModel.ListSortDescription.Kind_Ptr is
      ...
      RetVal        : NetFrameworkBase.System.ComponentModel.ListSortDescription.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.ListSortDescription.Kind;
   begin
   ...
   function Constructor return NetFrameworkBase.System.ComponentModel.ListSortDescriptionCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.ComponentModel.ListSortDescriptionCollection.Kind_Ptr := new NetFrameworkBase.System.ComponentModel.ListSortDescriptionCollection.Kind do
   ...
   begin
      ...
      declare
         ...
         p0_Bounds     : aliased SAFEARRAYBOUND := (sorts'Length , 0);
      ...
      begin
         ...
         begin
            ...
            for i in sorts'range loop
               p0_Index(1) := Interfaces.C.long(i) - 1;
               p0_Tmp := GetObject (sorts(i).m_Kind);
         ...
         -- fixme parameter type := [array] System.ComponentModel.ListSortDescription[]
