...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.MACTripleDES is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.MACTripleDES";
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.MACTripleDES.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.MACTripleDES.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.MACTripleDES.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.MACTripleDES.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.MACTripleDES.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.MACTripleDES.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
   ...
   begin
      ...
      declare
         ...
         p1_Bounds     : aliased SAFEARRAYBOUND := (rgbKey'Length , 0);
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(strTripleDES);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         declare
