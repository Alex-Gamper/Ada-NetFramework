...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.DataGridViewSelectedColumnCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.DataGridViewSelectedColumnCollection";
   ...
   function Item
   (
      this : in out DataGridViewSelectedColumnCollection.Kind;
