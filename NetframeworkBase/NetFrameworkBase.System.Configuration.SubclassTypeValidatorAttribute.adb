...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Configuration.SubclassTypeValidatorAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Configuration.SubclassTypeValidatorAttribute";
   ...
   (
      this : in out SubclassTypeValidatorAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Type_x.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("BaseClass");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Configuration.SubclassTypeValidatorAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Configuration.SubclassTypeValidatorAttribute.Kind_Ptr := new NetFrameworkBase.System.Configuration.SubclassTypeValidatorAttribute.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (baseClass.m_Kind);
