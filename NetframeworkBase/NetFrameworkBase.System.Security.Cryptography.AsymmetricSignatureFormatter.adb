...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.AsymmetricSignatureFormatter is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.AsymmetricSignatureFormatter";
   ...
   (
      this : in out AsymmetricSignatureFormatter.Kind;
