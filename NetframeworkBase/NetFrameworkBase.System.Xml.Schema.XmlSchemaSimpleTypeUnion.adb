...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleTypeUnion is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Xml.Schema.XmlSchemaSimpleTypeUnion";
   ...
   return NetFrameworkBase.System.Xml.XmlQualifiedName.Kind_Array is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("MemberTypes");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   ...
   return NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleType.Kind_Array is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("BaseMemberTypes");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   
      function GetArray (sa : access NetFrameworkWin32.SAFEARRAY) return NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleType.Kind_Array is
         Hr     : NetFrameworkWin32.HRESULT := 0;
         LBound : aliased NetFrameworkWin32.LONG := 0;
         UBound : aliased NetFrameworkWin32.LONG := 0;
         Index  : aliased NetFrameworkWin32.LONG := 0;
      ...
      begin
         ...
         Index := UBound - LBound + 1;
         declare
            RetVal : NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleType.Kind_Array(1..integer(Index));
         ...
         begin
            ...
            for I in RetVal'range loop
               ...
               Var.field_1.field_1.vt := VT_UNKNOWN'Enum_rep;
               Var.field_1.field_1.field_1.byref := Item;
               Value := new NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleType.Kind;
               SetObject (Value.m_Kind, Var);
               RetVal(integer(I)) := Value;
               Index := Index + 1;
            end loop;
   ...
   function Constructor return NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleTypeUnion.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleTypeUnion.Kind_Ptr := new NetFrameworkBase.System.Xml.Schema.XmlSchemaSimpleTypeUnion.Kind do
