...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Policy.UnionCodeGroup is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Policy.UnionCodeGroup";
   ...
   return NetFrameworkBase.System.Security.Policy.UnionCodeGroup.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Policy.UnionCodeGroup.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.UnionCodeGroup.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
