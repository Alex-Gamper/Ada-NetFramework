...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.NumericUpDownAccelerationCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.NumericUpDownAccelerationCollection";
   ...
   procedure Add
   (
      this : in out NumericUpDownAccelerationCollection.Kind;
      acceleration : NetFrameworkBase.System.Windows.Forms.NumericUpDownAcceleration.Kind_Ptr
   ) is
   ...
   begin
      ...
      ------------------------------------------------------------
      p_Index(1) := 0;
      p_Value := GetObject (acceleration.m_Kind);
   ...
   (
      this : in out NumericUpDownAccelerationCollection.Kind;
      array_x : NetFrameworkBase.System.Windows.Forms.NumericUpDownAcceleration.Kind_Array; 
   ...
   begin
      ...
      -- fixme parameter type := [array] System.Windows.Forms.NumericUpDownAcceleration[]
   ...
   (
      this : in out NumericUpDownAccelerationCollection.Kind;
      accelerations : NetFrameworkBase.System.Windows.Forms.NumericUpDownAcceleration.Kind_Array
   ) is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p0_Parameters : aliased LPSAFEARRAY := null;
      p0_Bounds     : aliased SAFEARRAYBOUND := (accelerations'Length , 0);
      p0_Index      : aliased array(1..1) of aliased LONG := (others => 0);
      p0_Tmp        : aliased IUnknown_Ptr;
      p0_Tmp_Ptr    : access IUnknown_Ptr := p0_Tmp'access;
   begin
      ...
      begin
         p0_Parameters := SafeArrayCreate (VT_UNKNOWN'enum_rep, 1, p0_Bounds'access);
         for i in accelerations'range loop
            p0_Index(1) := Interfaces.C.long(i) - 1;
            p0_Tmp := GetObject (accelerations(i).m_Kind);
            Hr := SafeArrayPutElement (p0_Parameters, p0_Index (p0_Index'first)'access, Convert (p0_Tmp));
         end loop;
         p_Value := To_Variant (p0_Parameters, VT_UNKNOWN);
      end;
   ...
   return NetFrameworkBase.System.Windows.Forms.NumericUpDownAcceleration.Kind_Ptr is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      p_Parameters  : aliased LPSAFEARRAY := null;
      p_Bounds      : aliased SAFEARRAYBOUND := (1 , 0);
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Windows.Forms.NumericUpDownAcceleration.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.NumericUpDownAcceleration.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(GetProperty)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   function Constructor return NetFrameworkBase.System.Windows.Forms.NumericUpDownAccelerationCollection.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.NumericUpDownAccelerationCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.NumericUpDownAccelerationCollection.Kind do
