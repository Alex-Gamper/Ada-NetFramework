...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Windows.Forms.ListView.SelectedListViewItemCollection is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Windows.Forms.ListView+SelectedListViewItemCollection";
   ...
   function Count
   (
      this : in out SelectedListViewItemCollection.Kind
   )
   ...
   begin
      return RetVal : NetFrameworkBase.System.Windows.Forms.ListView.SelectedListViewItemCollection.Kind_Ptr := new NetFrameworkBase.System.Windows.Forms.ListView.SelectedListViewItemCollection.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
