...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.CodeDom.Compiler.CodeGenerator is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.CodeDom.Compiler.CodeGenerator";
   ...
   (
      this : in out CodeGenerator.Kind;
   ...
   return NetFrameworkBase.Boolean is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("IsValidLanguageIndependentIdentifier");
      p_RetVal      : aliased VARIANT;
   ...
   (
      e : NetFrameworkBase.System.CodeDom.CodeObject.Kind_Ptr
   )
   is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("ValidateIdentifiers");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
