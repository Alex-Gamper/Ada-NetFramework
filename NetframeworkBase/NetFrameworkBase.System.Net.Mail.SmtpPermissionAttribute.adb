...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Net.Mail.SmtpPermissionAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Net.Mail.SmtpPermissionAttribute";
   ...
   function Access_x
   (
      this : in out SmtpPermissionAttribute.Kind
   )
   ...
   return NetFrameworkBase.System.Net.Mail.SmtpPermissionAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Net.Mail.SmtpPermissionAttribute.Kind_Ptr := new NetFrameworkBase.System.Net.Mail.SmtpPermissionAttribute.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
