...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Runtime.InteropServices.HandleRef is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Runtime.InteropServices.HandleRef";
   ...
   (
      value : NetFrameworkBase.System.Runtime.InteropServices.HandleRef.Kind_Ptr
   )
   return NetFrameworkBase.IntPtr is
   ...
   return NetFrameworkBase.System.Runtime.InteropServices.HandleRef.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Runtime.InteropServices.HandleRef.Kind_Ptr := new NetFrameworkBase.System.Runtime.InteropServices.HandleRef.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := GetObject (wrapper.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
