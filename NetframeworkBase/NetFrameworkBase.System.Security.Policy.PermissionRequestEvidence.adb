...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Policy.PermissionRequestEvidence is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Policy.PermissionRequestEvidence";
   ...
   (
      this : in out PermissionRequestEvidence.Kind
   )
   return NetFrameworkBase.System.Security.PermissionSet.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("RequestedPermissions");
   ...
   return NetFrameworkBase.System.Security.PermissionSet.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("OptionalPermissions");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.PermissionSet.Kind_Ptr := new NetFrameworkBase.System.Security.PermissionSet.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.PermissionSet.Kind_Ptr is
      ...
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("DeniedPermissions");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.PermissionSet.Kind_Ptr := new NetFrameworkBase.System.Security.PermissionSet.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.Policy.PermissionRequestEvidence.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Policy.PermissionRequestEvidence.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.PermissionRequestEvidence.Kind;
   begin
      p_Flags := NetFrameworkWin32.BindingFlags'(Public)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(InvokeMethod)'Enum_rep;
      p_Flags := p_Flags or NetFrameworkWin32.BindingFlags'(Instance)'Enum_rep;
   ...
   return NetFrameworkBase.System.Security.Policy.PermissionRequestEvidence.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Policy.PermissionRequestEvidence.Kind_Ptr := new NetFrameworkBase.System.Security.Policy.PermissionRequestEvidence.Kind do
      declare
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := GetObject (optional.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 2;
         p_Value := GetObject (denied.m_Kind);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
