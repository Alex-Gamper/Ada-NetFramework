...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.SecuritySafeCriticalAttribute is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.SecuritySafeCriticalAttribute";
   ...
   function Constructor return NetFrameworkBase.System.Security.SecuritySafeCriticalAttribute.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.SecuritySafeCriticalAttribute.Kind_Ptr := new NetFrameworkBase.System.Security.SecuritySafeCriticalAttribute.Kind do
