...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9MessageDigest is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.Pkcs.Pkcs9MessageDigest";
   ...
   (
      this : in out Pkcs9MessageDigest.Kind
   )
   return NetFrameworkBase.Byte_Array is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("MessageDigest");
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9MessageDigest.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9MessageDigest.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.Pkcs.Pkcs9MessageDigest.Kind do
