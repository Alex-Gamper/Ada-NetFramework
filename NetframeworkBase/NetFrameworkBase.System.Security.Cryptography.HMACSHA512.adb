...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.HMACSHA512 is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.HMACSHA512";
   ...
   function Constructor return NetFrameworkBase.System.Security.Cryptography.HMACSHA512.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.HMACSHA512.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.HMACSHA512.Kind do
   ...
   return NetFrameworkBase.System.Security.Cryptography.HMACSHA512.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.HMACSHA512.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.HMACSHA512.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
