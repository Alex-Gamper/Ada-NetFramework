...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Diagnostics.EventInstance is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Diagnostics.EventInstance";
   ...
   return NetFrameworkBase.Int32 is
      ...
      p_MethodName  : BSTR := To_BSTR("CategoryId");
   ...
   (
      ...
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      p_valueEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Diagnostics.EventLogEntryType.Instance;
   ...
   return NetFrameworkBase.System.Diagnostics.EventInstance.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Diagnostics.EventInstance.Kind_Ptr := new NetFrameworkBase.System.Diagnostics.EventInstance.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
      ...
      begin
         ...
         ------------------------------------------------------------
         p_Index(1) := 0;
         p_Value := To_Variant(instanceId);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
         ------------------------------------------------------------
         p_Index(1) := 1;
         p_Value := To_Variant(categoryId);
         Hr := SafeArrayPutElement (p_Parameters, p_Index(p_Index'first)'access, Convert (p_Value_Ptr));
   ...
   begin
      ...
      declare
         ...
         p_Value_Ptr   : access VARIANT := p_Value'access;
         p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
         p_entryTypeEnumType : NetFrameworkWin32.IType_Ptr := NetFrameworkBase.System.Diagnostics.EventLogEntryType.Instance;
         p_entryTypeEnum : aliased VARIANT := To_Variant (CreateEnum (p_entryTypeEnumType, entryType'Enum_rep));
      begin
         p_Parameters := SafeArrayCreate (VT_VARIANT'enum_rep, 1, p_Bounds'access);
         ------------------------------------------------------------
         p_Index(1) := 0;
