...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.System.Security.Cryptography.CngProvider is
   ...
   This_TypeName     : constant Standard.Wide_String := "System.Security.Cryptography.CngProvider";
   ...
   (
      left : NetFrameworkBase.System.Security.Cryptography.CngProvider.Kind_Ptr; 
      right : NetFrameworkBase.System.Security.Cryptography.CngProvider.Kind_Ptr
   )
   ...
   (
      this : in out CngProvider.Kind;
      other : NetFrameworkBase.System.Security.Cryptography.CngProvider.Kind_Ptr
   )
   return NetFrameworkBase.Boolean is
      function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
      Hr            : HResult := 0;
   ...
   function MicrosoftSmartCardKeyStorageProvider
   return NetFrameworkBase.System.Security.Cryptography.CngProvider.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("MicrosoftSmartCardKeyStorageProvider");
      p_RetVal      : aliased VARIANT;
   ...
   function MicrosoftSoftwareKeyStorageProvider
   return NetFrameworkBase.System.Security.Cryptography.CngProvider.Kind_Ptr is
      Hr            : HResult := 0;
      p_Flags       : aliased NetFrameworkBase.UInt32 := 0;
      p_Target      : aliased VARIANT;
      p_MethodName  : BSTR := To_BSTR("MicrosoftSoftwareKeyStorageProvider");
      p_RetVal      : aliased VARIANT;
      p_NetRetVal   : aliased IUnknown_Ptr := null;
      RetVal        : NetFrameworkBase.System.Security.Cryptography.CngProvider.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.CngProvider.Kind;
   begin
   ...
   return NetFrameworkBase.System.Security.Cryptography.CngProvider.Kind_Ptr is
   begin
      return RetVal : NetFrameworkBase.System.Security.Cryptography.CngProvider.Kind_Ptr := new NetFrameworkBase.System.Security.Cryptography.CngProvider.Kind do
      declare
         function Convert is new Ada.Unchecked_Conversion (LPVARIANT,LPVOID);
         Hr            : HResult := 0;
         p_Parameters  : aliased LPSAFEARRAY := null;
