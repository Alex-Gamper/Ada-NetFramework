...
with Interfaces.C;
--------------------------------------------------------------------------------
package body NetFrameworkBase.Microsoft.Win32.SafeHandles.SafeHandleZeroOrMinusOneIsInvalid is
   ...
   This_TypeName     : constant Standard.Wide_String := "Microsoft.Win32.SafeHandles.SafeHandleZeroOrMinusOneIsInvalid";
   ...
   function IsInvalid
   (
      this : in out SafeHandleZeroOrMinusOneIsInvalid.Kind
   )
